...
@OriginalClass("com.jagex.client!dr")
public final class TextureOp23 extends TextureOp {

	@OriginalMember(owner = "com.jagex.client!dr", name = "<init>", descriptor = "()V")
	public TextureOp23() {
		super(1, false);
	}

	@OriginalMember(owner = "com.jagex.client!dr", name = "a", descriptor = "(ILclient!bt;I)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!dr", name = "b", descriptor = "(IB)[[I")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!dr", name = "b", descriptor = "(III)V")
	...
	@OriginalMember(owner = "com.jagex.client!dr", name = "a", descriptor = "(BI)[I")
	@Override
