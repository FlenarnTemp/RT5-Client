...
public final class Static387 {
	...
	@OriginalMember(owner = "com.jagex.client!wm", name = "g", descriptor = "I")
	public static int anInt2831 = 0;

	@OriginalMember(owner = "com.jagex.client!wm", name = "a", descriptor = "(IILclient!ml;Lclient!ci;Ljava/awt/Canvas;I)Lclient!wm;")
	public static synchronized Renderer method2822(@OriginalArg(1) int arg0, @OriginalArg(2) Signlink arg1, @OriginalArg(3) TextureProviderInterface arg2, @OriginalArg(4) Canvas arg3, @OriginalArg(5) int arg4) {
		@Pc(7) int local7 = -1;
	...
	@OriginalMember(owner = "com.jagex.client!wm", name = "c", descriptor = "(IIII)V")
