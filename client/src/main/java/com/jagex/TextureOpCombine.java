...
@OriginalClass("com.jagex.client!ri")
public final class TextureOpCombine extends TextureOp {

	@OriginalMember(owner = "com.jagex.client!ri", name = "W", descriptor = "I")
	private int anInt5701 = 6;

	@OriginalMember(owner = "com.jagex.client!ri", name = "<init>", descriptor = "()V")
	public TextureOpCombine() {
		super(2, false);
	}

	@OriginalMember(owner = "com.jagex.client!ri", name = "a", descriptor = "(BI)[I")
	@Override
	public int[] getMonochromeOutput(@OriginalArg(1) int arg0) {
		...
		if (super.monochromeImageCache.invalid) {
			...
			@Pc(32) int[] local32 = this.getChildMonochromeOutput(1, arg0);
			@Pc(35) int local35 = this.anInt5701;
			if (local35 == 1) {
				for (local35 = 0; local35 < Texture.width; local35++) {
	...
	@OriginalMember(owner = "com.jagex.client!ri", name = "b", descriptor = "(IB)[[I")
	@Override
	public int[][] getColorOutput(@OriginalArg(0) int arg0) {
		...
		if (super.colorImageCache.invalid) {
			...
			if (local71 == 1) {
				for (local71 = 0; local71 < Texture.width; local71++) {
	...
	@OriginalMember(owner = "com.jagex.client!ri", name = "a", descriptor = "(ILclient!bt;I)V")
	@Override
	public void decode(@OriginalArg(0) int code, @OriginalArg(1) Packet buf) {
		if (code == 0) {
			this.anInt5701 = buf.g1();
		} else if (code == 1) {
