...
public final class Static24 {
	...
	@OriginalMember(owner = "com.jagex.client!bh", name = "m", descriptor = "Lclient!rc;")
	public static Class42 aClass42_2;

	@OriginalMember(owner = "com.jagex.client!bh", name = "a", descriptor = "(ILclient!nk;)V")
	...
	@OriginalMember(owner = "com.jagex.client!bh", name = "a", descriptor = "(IBI)Lclient!dg;")
	...
	@OriginalMember(owner = "com.jagex.client!bh", name = "a", descriptor = "(IIIIIIIII)Z")
