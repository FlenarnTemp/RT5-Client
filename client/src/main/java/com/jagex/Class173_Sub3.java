...
@OriginalClass("com.jagex.client!rm")
public final class Class173_Sub3 extends Class173 {

	@OriginalMember(owner = "com.jagex.client!rm", name = "r", descriptor = "I")
	private final int anInt5717;

	@OriginalMember(owner = "com.jagex.client!rm", name = "x", descriptor = "I")
	private final int anInt5723;

	@OriginalMember(owner = "com.jagex.client!rm", name = "w", descriptor = "I")
	private final int anInt5722;

	@OriginalMember(owner = "com.jagex.client!rm", name = "t", descriptor = "I")
	private final int anInt5719;

	@OriginalMember(owner = "com.jagex.client!rm", name = "<init>", descriptor = "(IIIIIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!rm", name = "a", descriptor = "(III)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!rm", name = "b", descriptor = "(III)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!rm", name = "a", descriptor = "(IBI)V")
	@Override
