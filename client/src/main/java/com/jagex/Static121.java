...
public final class Static121 {
	...
	@OriginalMember(owner = "com.jagex.client!gu", name = "u", descriptor = "[I")
	public static int[] anIntArray156;

	@OriginalMember(owner = "com.jagex.client!gu", name = "x", descriptor = "[I")
	public static int[] anIntArray157;

	@OriginalMember(owner = "com.jagex.client!gu", name = "w", descriptor = "Lclient!gd;")
	...
	@OriginalMember(owner = "com.jagex.client!gu", name = "a", descriptor = "(ZI)I")
	public static int method2393(@OriginalArg(1) int arg0) {
		return arg0 & 0xFF;
	}

	@OriginalMember(owner = "com.jagex.client!gu", name = "a", descriptor = "(IIIIIIIII)V")
