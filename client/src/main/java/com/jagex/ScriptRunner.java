...
public final class ScriptRunner {
	...
	@OriginalMember(owner = "com.jagex.client!ef", name = "t", descriptor = "Lclient!gd;")
	public static final LocalizedString CHATCOL_YELLOW = new LocalizedString("yellow:", "gelb:", "jaune:", "amarelo:");
	@OriginalMember(owner = "com.jagex.client!cu", name = "u", descriptor = "Lclient!gd;")
	public static final LocalizedString CHATCOL_RED = new LocalizedString("red:", "rot:", "rouge:", "vermelho:");
	@OriginalMember(owner = "com.jagex.client!ab", name = "H", descriptor = "Lclient!gd;")
	public static final LocalizedString CHATCOL_GREEN = new LocalizedString("green:", "grün:", "vert:", "verde:");
	@OriginalMember(owner = "com.jagex.client!is", name = "l", descriptor = "Lclient!gd;")
	public static final LocalizedString CHATCOL_CYAN = new LocalizedString("cyan:", "blaugrün:", "cyan:", "cyan:");
	@OriginalMember(owner = "com.jagex.client!qb", name = "N", descriptor = "Lclient!gd;")
	public static final LocalizedString CHATCOL_PURPLE = new LocalizedString("purple:", "lila:", "violet:", "roxo:");
	@OriginalMember(owner = "com.jagex.client!bg", name = "h", descriptor = "Lclient!gd;")
	public static final LocalizedString aClass79_17 = new LocalizedString("white:", "weiss:", "blanc:", "branco:");
	@OriginalMember(owner = "com.jagex.client!ft", name = "S", descriptor = "Lclient!gd;")
	public static final LocalizedString aClass79_45 = new LocalizedString("flash1:", "blinken1:", "clignotant1:", "flash1:");
	@OriginalMember(owner = "com.jagex.client!hg", name = "l", descriptor = "Lclient!gd;")
	public static final LocalizedString aClass79_57 = new LocalizedString("flash2:", "blinken2:", "clignotant2:", "flash2:");
	@OriginalMember(owner = "com.jagex.client!lm", name = "s", descriptor = "Lclient!gd;")
	public static final LocalizedString aClass79_120 = new LocalizedString("flash3:", "blinken3:", "clignotant3:", "brilho3:");
	@OriginalMember(owner = "com.jagex.client!ca", name = "y", descriptor = "Lclient!gd;")
	public static final LocalizedString aClass79_24 = new LocalizedString("glow1:", "leuchten1:", "brillant1:", "brilho1:");
	@OriginalMember(owner = "com.jagex.client!qj", name = "d", descriptor = "Lclient!gd;")
	public static final LocalizedString aClass79_113 = new LocalizedString("glow2:", "leuchten2:", "brillant2:", "brilho2:");
	@OriginalMember(owner = "com.jagex.client!hs", name = "x", descriptor = "Lclient!gd;")
	public static final LocalizedString CHATCOL_GLOW3 = new LocalizedString("glow3:", "leuchten3:", "brillant3:", "brilho3:");
	@OriginalMember(owner = "com.jagex.client!hp", name = "d", descriptor = "Lclient!gd;")
	public static final LocalizedString CHATEFF_WAVE = new LocalizedString("wave:", "welle:", "ondulation:", "onda:");
	@OriginalMember(owner = "com.jagex.client!qm", name = "O", descriptor = "Lclient!gd;")
	public static final LocalizedString aClass79_114 = new LocalizedString("wave2:", "welle2:", "ondulation2:", "onda2:");
	@OriginalMember(owner = "com.jagex.client!eg", name = "a", descriptor = "Lclient!gd;")
	public static final LocalizedString aClass79_39 = new LocalizedString("shake:", "schütteln:", "tremblement:", "tremor:");
	@OriginalMember(owner = "com.jagex.client!lh", name = "e", descriptor = "Lclient!gd;")
	public static final LocalizedString aClass79_70 = new LocalizedString("scroll:", "scrollen:", "déroulement:", "rolagem:");
	@OriginalMember(owner = "com.jagex.client!mt", name = "b", descriptor = "Lclient!gd;")
	public static final LocalizedString CHATEFF_SLIDE = new LocalizedString("slide:", "gleiten:", "glissement:", "deslizamento:");
	@OriginalMember(owner = "com.jagex.client!ok", name = "g", descriptor = "S")
	public static short aShort73 = 256;
	@OriginalMember(owner = "com.jagex.client!oo", name = "i", descriptor = "S")
	public static short aShort78 = 205;
	@OriginalMember(owner = "com.jagex.client!pj", name = "w", descriptor = "S")
	public static short aShort79 = 256;
	@OriginalMember(owner = "com.jagex.client!gs", name = "l", descriptor = "S")
	public static short aShort36 = 320;
	@OriginalMember(owner = "com.jagex.client!ei", name = "i", descriptor = "S")
	public static short aShort86 = 1;
	@OriginalMember(owner = "com.jagex.client!gs", name = "j", descriptor = "S")
	public static short aShort35 = 32767;
	@OriginalMember(owner = "com.jagex.client!ui", name = "p", descriptor = "S")
	public static short aShort92 = 1;
	@OriginalMember(owner = "com.jagex.client!dt", name = "k", descriptor = "S")
	public static short aShort19 = 32767;
	@OriginalMember(owner = "com.jagex.client!lk", name = "h", descriptor = "[I")
	private static int[] anIntArray212;

	@OriginalMember(owner = "com.jagex.client!lk", name = "o", descriptor = "[Ljava/lang/String;")
	private static String[] aStringArray30;

	@OriginalMember(owner = "com.jagex.client!lk", name = "r", descriptor = "Lclient!gr;")
	private static QuickChatPhrase activePhrase;

	@OriginalMember(owner = "com.jagex.client!lk", name = "v", descriptor = "Lclient!nk;")
	private static Component staticActiveComponent2;

	@OriginalMember(owner = "com.jagex.client!lk", name = "w", descriptor = "Lclient!nk;")
	private static Component staticActiveComponent1;

	@OriginalMember(owner = "com.jagex.client!lk", name = "a", descriptor = "I")
	private static int isp = 0;

	@OriginalMember(owner = "com.jagex.client!lk", name = "b", descriptor = "[Ljava/lang/String;")
	private static final String[] stringStack = new String[1000];

	@OriginalMember(owner = "com.jagex.client!lk", name = "d", descriptor = "[Lclient!ol;")
	private static final Class172[] aClass172Array1 = new Class172[50];

	@OriginalMember(owner = "com.jagex.client!lk", name = "e", descriptor = "I")
	private static int ssp = 0;

	@OriginalMember(owner = "com.jagex.client!lk", name = "k", descriptor = "[I")
	private static final int[] intStack = new int[1000];

	@OriginalMember(owner = "com.jagex.client!lk", name = "q", descriptor = "I")
	private static int anInt3661 = 0;

	@OriginalMember(owner = "com.jagex.client!lk", name = "s", descriptor = "Ljava/util/Calendar;")
	private static final Calendar calendar = Calendar.getInstance();

	@OriginalMember(owner = "com.jagex.client!lk", name = "t", descriptor = "[[I")
	private static final int[][] anIntArrayArray27 = new int[5][5000];

	@OriginalMember(owner = "com.jagex.client!lk", name = "y", descriptor = "[I")
	private static final int[] anIntArray214 = new int[5];

	@OriginalMember(owner = "com.jagex.client!lk", name = "z", descriptor = "[I")
	private static final int[] coord = new int[3];

	@OriginalMember(owner = "com.jagex.client!lk", name = "A", descriptor = "Lclient!hu;")
	...
	@OriginalMember(owner = "com.jagex.client!lk", name = "a", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!lk", name = "a", descriptor = "(Lclient!fn;)V")
	public static void execute(@OriginalArg(0) HookRequest arg0) {
		method3593(arg0, 200000);
	}

	@OriginalMember(owner = "com.jagex.client!lk", name = "a", descriptor = "(Lclient!fn;I)V")
	...
	@OriginalMember(owner = "com.jagex.client!lk", name = "b", descriptor = "(I)Ljava/lang/String;")
	...
	@OriginalMember(owner = "com.jagex.client!lk", name = "a", descriptor = "(IZ)V")
	...
	@OriginalMember(owner = "com.jagex.client!lk", name = "a", descriptor = "(Lclient!bc;II)V")
	...
	@OriginalMember(owner = "com.jagex.client!lk", name = "c", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!lk", name = "d", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!lk", name = "b", descriptor = "(IZ)V")
			...
			if (opcode < 5300) {
				...
				if (opcode == 5231) {
					...
					if (WorldMap.visibleMapElementCategories != null) {
						...
						if (local2421 == null && local1292) {
							local2421 = new Node();
							WorldMap.visibleMapElementCategories.pushNode(local2421, (long) local157);
						}
					}
					return;
				}
				...
				if (opcode == 5233) {
					...
					if (WorldMap.visibleMapElementIds != null) {
						...
						if (local2421 == null && local1292) {
							local2421 = new Node();
							WorldMap.visibleMapElementIds.pushNode(local2421, (long) local157);
						}
					}
					return;
				}
				...
				if (opcode < 5400) {
					...
					if (opcode < 5500) {
						...
						if (opcode == 5401) {
							// hsvtorgb
							isp -= 2;
							client.aShortArray79[intStack[isp]] = (short) ColourUtils.hslToRgb(intStack[isp + 1]);
						...
						if (opcode == 5424) {
							...
							client.jsArchive8.requestDownload(LoginManager.anInt3731);
							client.jsArchive8.requestDownload(LoginManager.anInt1636);
							client.jsArchive8.requestDownload(LoginManager.anInt1722);
							client.jsArchive8.requestDownload(LoginManager.anInt6804);
							client.jsArchive8.requestDownload(LoginManager.anInt7211);
	...
	@OriginalMember(owner = "com.jagex.client!lk", name = "a", descriptor = "(Lclient!js;I)V")
	private static void method3600(@OriginalArg(0) Class2_Sub2_Sub11 arg0, @OriginalArg(1) int arg1) {
		...
		try {
			...
			if (arg0.aString27 == null) {
				...
				local855.append("CS2: ").append(arg0.nodeId).append(" ");
				for (local603 = anInt3661 - 1; local603 >= 0; local603--) {
					local855.append("v: ").append(aClass172Array1[local603].aClass2_Sub2_Sub11_1.nodeId).append(" ");
				}
	...
	@OriginalMember(owner = "com.jagex.client!gn", name = "a", descriptor = "(IIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!rr", name = "a", descriptor = "(IIZIIB)V")
