...
public final class Static231 {
	...
	@OriginalMember(owner = "com.jagex.client!nf", name = "i", descriptor = "I")
	public static int anInt4071;

	@OriginalMember(owner = "com.jagex.client!nf", name = "j", descriptor = "[I")
	public static final int[] anIntArray265 = new int[1000];

	@OriginalMember(owner = "com.jagex.client!nf", name = "w", descriptor = "[Lclient!bt;")
	public static final Packet[] aClass2_Sub4Array1 = new Packet[2048];

	@OriginalMember(owner = "com.jagex.client!nf", name = "a", descriptor = "(III)I")
