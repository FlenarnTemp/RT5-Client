...
public final class Static257 {
	...
	@OriginalMember(owner = "com.jagex.client!on", name = "a", descriptor = "Ljava/lang/String;")
	public static String aString39;

	@OriginalMember(owner = "com.jagex.client!on", name = "b", descriptor = "[Ljava/lang/String;")
	public static final String[] aStringArray34 = new String[100];

	@OriginalMember(owner = "com.jagex.client!on", name = "h", descriptor = "[I")
	public static final int[] anIntArray257 = new int[4096];

	@OriginalMember(owner = "com.jagex.client!on", name = "a", descriptor = "(IIIIIIIBII)V")
	...
	@OriginalMember(owner = "com.jagex.client!on", name = "a", descriptor = "(IIIIILclient!wm;)V")
	public static void method3928(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) Renderer arg4) {
		...
		for (@Pc(205) MapElement local205 = (MapElement) MapList.aClass135_36.head(); local205 != null; local205 = (MapElement) MapList.aClass135_36.next()) {
			@Pc(213) MapElementType local213 = MapList.aClass125_4.get(local205.id);
	...
	@OriginalMember(owner = "com.jagex.client!on", name = "f", descriptor = "(I)V")
