...
public final class Static339 {
	...
	@OriginalMember(owner = "com.jagex.client!to", name = "G", descriptor = "F")
	public static float aFloat76;

	@OriginalMember(owner = "com.jagex.client!to", name = "K", descriptor = "Lclient!jd;")
	public static Sprite aClass13_18;

	@OriginalMember(owner = "com.jagex.client!to", name = "j", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!to", name = "a", descriptor = "(IIIIZIIIII)V")
