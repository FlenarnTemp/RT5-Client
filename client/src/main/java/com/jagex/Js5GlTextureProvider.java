...
@OriginalClass("com.jagex.client!ia")
public final class Js5GlTextureProvider implements TextureProviderInterface {

	@OriginalMember(owner = "com.jagex.client!ia", name = "b", descriptor = "Lclient!jm;")
	private final Class116 aClass116_4 = new Class116(256);

	@OriginalMember(owner = "com.jagex.client!ia", name = "j", descriptor = "Lclient!r;")
	private final Js5 aClass197_36;

	@OriginalMember(owner = "com.jagex.client!ia", name = "l", descriptor = "Lclient!r;")
	private final Js5 aClass197_38;

	@OriginalMember(owner = "com.jagex.client!ia", name = "m", descriptor = "[Lclient!uc;")
	private final Class229[] aClass229Array1;

	@OriginalMember(owner = "com.jagex.client!ia", name = "<init>", descriptor = "(Lclient!r;Lclient!r;Lclient!r;)V")
	...
	@OriginalMember(owner = "com.jagex.client!ia", name = "a", descriptor = "(FIIZII)[I")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!ia", name = "a", descriptor = "(II)Z")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!ia", name = "c", descriptor = "(II)Lclient!qm;")
	...
	@OriginalMember(owner = "com.jagex.client!ia", name = "b", descriptor = "(II)Lclient!uc;")
	@Override
	public Class229 method2658(@OriginalArg(1) int arg0) {
		return this.aClass229Array1[arg0];
	}

	@OriginalMember(owner = "com.jagex.client!ia", name = "a", descriptor = "(BZIIFI)[F")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!ia", name = "a", descriptor = "(IZIIFI)[I")
	@Override
