...
@OriginalClass("com.jagex.client!or")
public final class MaterialRenderer7 extends MaterialRenderer {

	@OriginalMember(owner = "com.jagex.client!or", name = "c", descriptor = "Z")
	private boolean aBoolean327 = false;

	@OriginalMember(owner = "com.jagex.client!or", name = "b", descriptor = "Lclient!rj;")
	private Class203 aClass203_5;

	@OriginalMember(owner = "com.jagex.client!or", name = "<init>", descriptor = "(Lclient!bf;)V")
	...
	@OriginalMember(owner = "com.jagex.client!or", name = "b", descriptor = "(Z)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!or", name = "a", descriptor = "(Lclient!kq;)V")
	@Override
	public void method5710(@OriginalArg(0) Class8 arg0) {
		this.aClass19_Sub1_35.method848(arg0);
	}

	@OriginalMember(owner = "com.jagex.client!or", name = "a", descriptor = "(I)V")
	@Override
	public void method5712(@OriginalArg(0) int arg0) {
	}

	@OriginalMember(owner = "com.jagex.client!or", name = "b", descriptor = "()V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!or", name = "a", descriptor = "(Z)V")
	@Override
	public void method5713(@OriginalArg(0) boolean arg0) {
		this.aClass19_Sub1_35.method794(8448, 7681);
	}

	@OriginalMember(owner = "com.jagex.client!or", name = "a", descriptor = "()Z")
	@Override
