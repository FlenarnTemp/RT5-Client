...
@OriginalClass("com.jagex.client!dk")
public final class SpriteData {

	@OriginalMember(owner = "com.jagex.client!dk", name = "a", descriptor = "I")
	public int anInt1530;

	@OriginalMember(owner = "com.jagex.client!dk", name = "b", descriptor = "[B")
	public byte[] aByteArray20;

	@OriginalMember(owner = "com.jagex.client!dk", name = "c", descriptor = "I")
	public int anInt1531;

	@OriginalMember(owner = "com.jagex.client!dk", name = "d", descriptor = "I")
	public int anInt1532;

	@OriginalMember(owner = "com.jagex.client!dk", name = "e", descriptor = "I")
	public int anInt1533;

	@OriginalMember(owner = "com.jagex.client!dk", name = "f", descriptor = "[I")
	public int[] anIntArray108;

	@OriginalMember(owner = "com.jagex.client!dk", name = "g", descriptor = "I")
	public int anInt1534;

	@OriginalMember(owner = "com.jagex.client!dk", name = "h", descriptor = "I")
	public int anInt1535;

	@OriginalMember(owner = "com.jagex.client!dk", name = "i", descriptor = "[B")
	public byte[] aByteArray21;

	@OriginalMember(owner = "com.jagex.client!dk", name = "a", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!dk", name = "a", descriptor = "()V")
	...
	@OriginalMember(owner = "com.jagex.client!dk", name = "b", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!dk", name = "b", descriptor = "()I")
	public int method1680() {
		return this.anInt1531 + this.anInt1535 + this.anInt1532;
	}

	@OriginalMember(owner = "com.jagex.client!dk", name = "c", descriptor = "()V")
	...
	@OriginalMember(owner = "com.jagex.client!dk", name = "e", descriptor = "()V")
	...
	@OriginalMember(owner = "com.jagex.client!dk", name = "c", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!dk", name = "g", descriptor = "()V")
