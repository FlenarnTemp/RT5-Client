...
public final class Static4 {
	...
	@OriginalMember(owner = "com.jagex.client!ac", name = "A", descriptor = "I")
	public static int anInt87;

	@OriginalMember(owner = "com.jagex.client!ac", name = "C", descriptor = "I")
	public static int anInt89;

	@OriginalMember(owner = "com.jagex.client!ac", name = "z", descriptor = "Lclient!nl;")
	public static Class162 aClass162_1 = new Class162();

	@OriginalMember(owner = "com.jagex.client!ac", name = "B", descriptor = "I")
	public static int anInt88 = -1;

	@OriginalMember(owner = "com.jagex.client!ac", name = "a", descriptor = "(IIIIIIIIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!ac", name = "a", descriptor = "(IIILclient!gq;Lclient!gq;)V")
	...
	@OriginalMember(owner = "com.jagex.client!ac", name = "b", descriptor = "(B)V")
