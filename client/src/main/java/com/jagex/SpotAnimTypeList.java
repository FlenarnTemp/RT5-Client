...
@OriginalClass("com.jagex.client!sg")
public final class SpotAnimTypeList {

	@OriginalMember(owner = "com.jagex.client!sg", name = "n", descriptor = "I")
	public int anInt5958;

	@OriginalMember(owner = "com.jagex.client!sg", name = "h", descriptor = "Lclient!hu;")
	private final LruHashTable aClass98_50 = new LruHashTable(64);

	@OriginalMember(owner = "com.jagex.client!sg", name = "m", descriptor = "Lclient!hu;")
	public final LruHashTable aClass98_51 = new LruHashTable(30);

	@OriginalMember(owner = "com.jagex.client!sg", name = "d", descriptor = "Lclient!r;")
	private final Js5 aClass197_82;

	@OriginalMember(owner = "com.jagex.client!sg", name = "b", descriptor = "Lclient!r;")
	public final Js5 aClass197_81;

	@OriginalMember(owner = "com.jagex.client!sg", name = "<init>", descriptor = "(Lclient!dn;ILclient!r;Lclient!r;)V")
	...
	@OriginalMember(owner = "com.jagex.client!sg", name = "a", descriptor = "(II)Lclient!hf;")
	public SpotAnimType method5407(@OriginalArg(0) int arg0) {
		...
		@Pc(48) byte[] local48 = this.aClass197_82.getfile(Static298.method2427(arg0), Static117.method2370(arg0));
	...
	@OriginalMember(owner = "com.jagex.client!sg", name = "a", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!sg", name = "a", descriptor = "(Z)V")
	...
	@OriginalMember(owner = "com.jagex.client!sg", name = "b", descriptor = "(II)V")
	...
	@OriginalMember(owner = "com.jagex.client!sg", name = "c", descriptor = "(II)V")
