...
@OriginalClass("com.jagex.client!lo")
public final class HuffmanCodec {

	@OriginalMember(owner = "com.jagex.client!lo", name = "g", descriptor = "[I")
	private final int[] anIntArray217;

	@OriginalMember(owner = "com.jagex.client!lo", name = "n", descriptor = "[B")
	private final byte[] aByteArray38;

	@OriginalMember(owner = "com.jagex.client!lo", name = "h", descriptor = "[I")
	private int[] anIntArray218;

	@OriginalMember(owner = "com.jagex.client!lo", name = "<init>", descriptor = "([B)V")
	...
	@OriginalMember(owner = "com.jagex.client!lo", name = "a", descriptor = "([B[BIIII)I")
	...
	@OriginalMember(owner = "com.jagex.client!lo", name = "a", descriptor = "(I[BIII[B)I")
