...
@OriginalClass("com.jagex.client!ba")
public final class Class14_Sub1 extends Class14 {

	@OriginalMember(owner = "com.jagex.client!ba", name = "j", descriptor = "I")
	public int anInt496;

	@OriginalMember(owner = "com.jagex.client!ba", name = "k", descriptor = "I")
	public int anInt497;

	@OriginalMember(owner = "com.jagex.client!ba", name = "l", descriptor = "I")
	public int anInt498;

	@OriginalMember(owner = "com.jagex.client!ba", name = "m", descriptor = "I")
	public int anInt499;

	@OriginalMember(owner = "com.jagex.client!ba", name = "n", descriptor = "I")
	public int anInt500;

	@OriginalMember(owner = "com.jagex.client!ba", name = "o", descriptor = "I")
	public int anInt501;

	@OriginalMember(owner = "com.jagex.client!ba", name = "p", descriptor = "I")
	public int anInt502;

	@OriginalMember(owner = "com.jagex.client!ba", name = "q", descriptor = "I")
	public int anInt503;

	@OriginalMember(owner = "com.jagex.client!ba", name = "r", descriptor = "I")
	public int anInt504;

	@OriginalMember(owner = "com.jagex.client!ba", name = "s", descriptor = "I")
	public int anInt505;

	@OriginalMember(owner = "com.jagex.client!ba", name = "t", descriptor = "I")
	public int anInt506;

	@OriginalMember(owner = "com.jagex.client!ba", name = "u", descriptor = "I")
	public int anInt507;

	@OriginalMember(owner = "com.jagex.client!ba", name = "<init>", descriptor = "()V")
	public Class14_Sub1() {
		this.method3932();
	}

	@OriginalMember(owner = "com.jagex.client!ba", name = "a", descriptor = "([I)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!ba", name = "d", descriptor = "(I)V")
	@Override
	public void method3931(@OriginalArg(0) int arg0) {
		this.anInt503 = 32768;
		this.anInt505 = this.anInt506 = Renderer.anIntArray177[arg0 & 0x3FFF];
		this.anInt507 = Renderer.anIntArray178[arg0 & 0x3FFF];
	...
	@OriginalMember(owner = "com.jagex.client!ba", name = "a", descriptor = "()V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!ba", name = "a", descriptor = "(IIIIII)V")
	@Override
	public void method3930(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		@Pc(5) int local5 = Renderer.anIntArray177[arg3 & 0x3FFF];
		@Pc(11) int local11 = Renderer.anIntArray178[arg3 & 0x3FFF];
		@Pc(17) int local17 = Renderer.anIntArray177[arg4 & 0x3FFF];
		@Pc(23) int local23 = Renderer.anIntArray178[arg4 & 0x3FFF];
		@Pc(29) int local29 = Renderer.anIntArray177[arg5 & 0x3FFF];
		@Pc(35) int local35 = Renderer.anIntArray178[arg5 & 0x3FFF];
	...
	@OriginalMember(owner = "com.jagex.client!ba", name = "a", descriptor = "(III)V")
	@Override
	...
	public void method3925(@OriginalArg(0) int arg0) {
		this.anInt506 = 32768;
		this.anInt505 = this.anInt503 = Renderer.anIntArray177[arg0 & 0x3FFF];
		this.anInt497 = Renderer.anIntArray178[arg0 & 0x3FFF];
	...
	@OriginalMember(owner = "com.jagex.client!ba", name = "c", descriptor = "(I)V")
	@Override
	public void method3929(@OriginalArg(0) int arg0) {
		@Pc(5) int local5 = Renderer.anIntArray177[arg0 & 0x3FFF];
		@Pc(11) int local11 = Renderer.anIntArray178[arg0 & 0x3FFF];
	...
	@OriginalMember(owner = "com.jagex.client!ba", name = "a", descriptor = "(Lclient!on;)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!ba", name = "e", descriptor = "(I)V")
	@Override
	public void method3933(@OriginalArg(0) int arg0) {
		this.anInt505 = 32768;
		this.anInt506 = this.anInt503 = Renderer.anIntArray177[arg0 & 0x3FFF];
		this.anInt502 = Renderer.anIntArray178[arg0 & 0x3FFF];
	...
	@OriginalMember(owner = "com.jagex.client!ba", name = "b", descriptor = "(III)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!ba", name = "b", descriptor = "(I)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!ba", name = "a", descriptor = "(III[I)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!ba", name = "b", descriptor = "()Lclient!ba;")
