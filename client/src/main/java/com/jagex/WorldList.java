...
public class WorldList {
	...
	@OriginalMember(owner = "com.jagex.client!e", name = "e", descriptor = "Z")
	public static boolean loaded = false;
	@OriginalMember(owner = "com.jagex.client!r", name = "Q", descriptor = "[Lclient!ac;")
	public static World[] worlds;
	@OriginalMember(owner = "com.jagex.client!vs", name = "g", descriptor = "I")
	public static int minId;
	@OriginalMember(owner = "com.jagex.client!sa", name = "V", descriptor = "I")
	public static int maxId;
	@OriginalMember(owner = "com.jagex.client!vf", name = "Y", descriptor = "[Lclient!kh;")
	public static Country[] countries;
	@OriginalMember(owner = "com.jagex.client!rf", name = "S", descriptor = "I")
	public static int size;
	@OriginalMember(owner = "com.jagex.client!vc", name = "b", descriptor = "I")
	public static int checksum;
	@OriginalMember(owner = "com.jagex.client!eh", name = "s", descriptor = "I")
	public static int step = 0;
	@OriginalMember(owner = "com.jagex.client!ud", name = "b", descriptor = "J")
	public static long closeTime = 0L;
	@OriginalMember(owner = "com.jagex.client!qi", name = "e", descriptor = "J")
	public static long openTime = 0L;
	@OriginalMember(owner = "com.jagex.client!qp", name = "a", descriptor = "I")
	public static int bufferLen = 0;
	@OriginalMember(owner = "com.jagex.client!rc", name = "d", descriptor = "[B")
	public static byte[] buffer;
	@OriginalMember(owner = "com.jagex.client!mo", name = "D", descriptor = "I")
	public static int bufferOff = 0;
	@OriginalMember(owner = "com.jagex.client!rh", name = "p", descriptor = "[Lclient!ac;")
	public static World[] sorted = new World[0];
	@OriginalMember(owner = "com.jagex.client!am", name = "j", descriptor = "I")
	public static int errors = 0;
	@OriginalMember(owner = "com.jagex.client!nf", name = "v", descriptor = "I")
	public static int iterator = 999999;
	@OriginalMember(owner = "com.jagex.client!fa", name = "d", descriptor = "I")
	public static int pingIterator = 0;
	@OriginalMember(owner = "com.jagex.client!qc", name = "e", descriptor = "Lclient!ha;")
	public static Class2_Sub16 pinger = null;
	@OriginalMember(owner = "com.jagex.client!c", name = "e", descriptor = "Z")
	public static boolean refreshing = false;

	@OriginalMember(owner = "com.jagex.client!ag", name = "a", descriptor = "(IB)Lclient!ac;")
	public static World get(@OriginalArg(0) int id) {
		return loaded && id >= minId && maxId >= id ? worlds[id - minId] : null;
	}

	@OriginalMember(owner = "com.jagex.client!vs", name = "a", descriptor = "(IB)Z")
	...
	@OriginalMember(owner = "com.jagex.client!jc", name = "a", descriptor = "(I[B)Z")
	...
	@OriginalMember(owner = "com.jagex.client!sh", name = "a", descriptor = "(Lclient!bt;I)V")
	...
	@OriginalMember(owner = "com.jagex.client!ac", name = "a", descriptor = "(ZLclient!bt;)V")
	...
	@OriginalMember(owner = "com.jagex.client!sk", name = "a", descriptor = "(B)I")
	...
	@OriginalMember(owner = "com.jagex.client!fo", name = "a", descriptor = "(II)I")
	...
	@OriginalMember(owner = "com.jagex.client!oq", name = "b", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!ts", name = "a", descriptor = "(ZZBII)V")
	...
	@OriginalMember(owner = "com.jagex.client!tc", name = "a", descriptor = "(IZIIIIZ)V")
	...
	@OriginalMember(owner = "com.jagex.client!mi", name = "a", descriptor = "(IZLclient!ac;Lclient!ac;IBZ)I")
	...
	@OriginalMember(owner = "com.jagex.client!e", name = "a", descriptor = "(ZLclient!ac;Lclient!ac;BI)I")
	...
	@OriginalMember(owner = "com.jagex.client!pg", name = "g", descriptor = "(I)Lclient!ac;")
	public static World next() {
		return sorted.length > iterator ? sorted[iterator++] : null;
	}

	@OriginalMember(owner = "com.jagex.client!bc", name = "a", descriptor = "(I)Lclient!ac;")
