...
public class LoginManager {
	...
	@OriginalMember(owner = "com.jagex.client!ub", name = "Z", descriptor = "I")
	public static int step = 0;
	@OriginalMember(owner = "com.jagex.client!kk", name = "a", descriptor = "I")
	public static int loops = 0;
	@OriginalMember(owner = "com.jagex.client!mm", name = "h", descriptor = "I")
	public static int errors = 0;
	@OriginalMember(owner = "com.jagex.client!ch", name = "ab", descriptor = "I")
	public static int loginResult = -2;
	@OriginalMember(owner = "com.jagex.client!vr", name = "j", descriptor = "Ljava/lang/String;")
	public static String usernameInput = "";
	@OriginalMember(owner = "com.jagex.client!nq", name = "g", descriptor = "J")
	public static long encodedUsername;
	@OriginalMember(owner = "com.jagex.client!lp", name = "e", descriptor = "J")
	public static long serverKey = 0L;
	@OriginalMember(owner = "com.jagex.client!as", name = "f", descriptor = "Ljava/lang/String;")
	public static String password = "";
	@OriginalMember(owner = "com.jagex.client!co", name = "l", descriptor = "I")
	public static int hopTime = 0;
	@OriginalMember(owner = "com.jagex.client!mb", name = "a", descriptor = "Z")
	public static boolean mapMembers = false;
	@OriginalMember(owner = "com.jagex.client!gb", name = "n", descriptor = "Z")
	public static boolean mapQuickChat = false;
	@OriginalMember(owner = "com.jagex.client!ub", name = "X", descriptor = "Z")
	public static boolean parentalAdvertConsent = false;
	@OriginalMember(owner = "com.jagex.client!fo", name = "i", descriptor = "Z")
	public static boolean parentalChatConsent = false;
	@OriginalMember(owner = "com.jagex.client!dd", name = "q", descriptor = "Z")
	...
	@OriginalMember(owner = "com.jagex.client!ut", name = "B", descriptor = "I")
	public static int disallowResult = -1;
	@OriginalMember(owner = "com.jagex.client!ac", name = "D", descriptor = "I")
	public static int staffModLevel = 0;
	@OriginalMember(owner = "com.jagex.client!lq", name = "s", descriptor = "I")
	public static int anInt3714 = -1;
	@OriginalMember(owner = "com.jagex.client!wd", name = "o", descriptor = "Z")
	public static boolean playerMember = false;
	@OriginalMember(owner = "com.jagex.client!nr", name = "a", descriptor = "I")
	public static int anInt4446;
	@OriginalMember(owner = "com.jagex.client!os", name = "f", descriptor = "I")
	public static int anInt6717;
	@OriginalMember(owner = "com.jagex.client!lo", name = "o", descriptor = "I")
	public static int anInt3697;
	@OriginalMember(owner = "com.jagex.client!eq", name = "E", descriptor = "I")
	public static int anInt1868;
	@OriginalMember(owner = "com.jagex.client!kp", name = "c", descriptor = "I")
	public static int anInt3731;
	@OriginalMember(owner = "com.jagex.client!ds", name = "p", descriptor = "I")
	public static int anInt1636;
	@OriginalMember(owner = "com.jagex.client!ee", name = "d", descriptor = "I")
	public static int anInt1722;
	@OriginalMember(owner = "com.jagex.client!vf", name = "V", descriptor = "I")
	public static int anInt6804;
	@OriginalMember(owner = "com.jagex.client!wp", name = "g", descriptor = "I")
	public static int anInt7211;
	@OriginalMember(owner = "com.jagex.client!so", name = "i", descriptor = "I")
	public static int anInt6030;
	@OriginalMember(owner = "com.jagex.client!wd", name = "n", descriptor = "I")
	public static int anInt7118;
	@OriginalMember(owner = "com.jagex.client!is", name = "d", descriptor = "I")
	public static int autoStep = 0;
	@OriginalMember(owner = "com.jagex.client!fo", name = "g", descriptor = "Z")
	public static boolean aBoolean158 = false;
	@OriginalMember(owner = "com.jagex.client!pg", name = "N", descriptor = "I")
	public static int anInt4955 = 0;

	@OriginalMember(owner = "com.jagex.client!f", name = "a", descriptor = "(B)V")
	...
	@OriginalMember(owner = "com.jagex.client!vi", name = "a", descriptor = "(ILclient!qg;)V")
	...
	@OriginalMember(owner = "com.jagex.client!jl", name = "f", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!fm", name = "i", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!so", name = "a", descriptor = "(I)V")
	public static void rebuildMap() {
		...
		for (@Pc(14) int local14 = 0; local14 < Static106.aByteArrayArray6.length; local14++) {
			if (Static221.mapGroupIds[local14] != -1 && Static106.aByteArrayArray6[local14] == null) {
				Static106.aByteArrayArray6[local14] = client.jsArchive5.getfile(0, Static221.mapGroupIds[local14]);
			...
			if (Static374.locGroupIds[local14] != -1 && Static82.aByteArrayArray5[local14] == null) {
				Static82.aByteArrayArray5[local14] = client.jsArchive5.getfile(Static374.locGroupIds[local14], 0, Static277.anIntArrayArray43[local14]);
			...
			if (Static51.underwaterMapGroupIds[local14] != -1 && Static232.aByteArrayArray9[local14] == null) {
				Static232.aByteArrayArray9[local14] = client.jsArchive5.getfile(0, Static51.underwaterMapGroupIds[local14]);
			...
			if (Static62.underwaterLocGroupIds[local14] != -1 && Static270.aByteArrayArray15[local14] == null) {
				Static270.aByteArrayArray15[local14] = client.jsArchive5.getfile(0, Static62.underwaterLocGroupIds[local14]);
			...
			if (Static190.anIntArray208 != null && Static210.aByteArrayArray7[local14] == null && Static190.anIntArray208[local14] != -1) {
				Static210.aByteArrayArray7[local14] = client.jsArchive5.getfile(Static190.anIntArray208[local14], 0, Static277.anIntArrayArray43[local14]);
	...
	@OriginalMember(owner = "com.jagex.client!fk", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;IB)V")
	...
	@OriginalMember(owner = "com.jagex.client!kt", name = "f", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!sk", name = "c", descriptor = "(B)V")
	...
	@OriginalMember(owner = "com.jagex.client!ne", name = "c", descriptor = "(I)V")
