...
public class MidiPlayer {
	...
	@OriginalMember(owner = "com.jagex.client!ws", name = "a", descriptor = "Z")
	public static boolean jingle = false;

	@OriginalMember(owner = "com.jagex.client!kh", name = "a", descriptor = "(Lclient!r;Lclient!r;Lclient!r;Lclient!od;I)Z")
	...
	@OriginalMember(owner = "com.jagex.client!ff", name = "a", descriptor = "(IBIZILclient!r;)V")
	...
	@OriginalMember(owner = "com.jagex.client!vl", name = "g", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!rm", name = "a", descriptor = "(IZ)V")
	...
	@OriginalMember(owner = "com.jagex.client!kb", name = "a", descriptor = "(II)V")
	...
	@OriginalMember(owner = "com.jagex.client!of", name = "a", descriptor = "(IIIILclient!r;ZI)V")
