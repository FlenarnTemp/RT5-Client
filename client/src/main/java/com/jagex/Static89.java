...
public final class Static89 {
	...
	@OriginalMember(owner = "com.jagex.client!et", name = "l", descriptor = "[Z")
	public static boolean[] aBooleanArray18;

	@OriginalMember(owner = "com.jagex.client!et", name = "k", descriptor = "I")
	public static int anInt1885 = 0;

	@OriginalMember(owner = "com.jagex.client!et", name = "a", descriptor = "(II[Ljava/lang/String;I)Ljava/lang/String;")
