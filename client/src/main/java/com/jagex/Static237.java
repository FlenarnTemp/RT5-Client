...
public final class Static237 {
	...
	@OriginalMember(owner = "com.jagex.client!nl", name = "b", descriptor = "Z")
	public static boolean aBoolean297 = false;

	@OriginalMember(owner = "com.jagex.client!nl", name = "a", descriptor = "(IIIIIIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!nl", name = "a", descriptor = "(III)V")
