...
@OriginalClass("com.jagex.client!sl")
public final class Song extends Node {

	@OriginalMember(owner = "com.jagex.client!sl", name = "s", descriptor = "Lclient!ad;")
	public HashTable programs;

	@OriginalMember(owner = "com.jagex.client!sl", name = "t", descriptor = "[B")
	public final byte[] aByteArray77;

	@OriginalMember(owner = "com.jagex.client!sl", name = "<init>", descriptor = "(Lclient!bt;)V")
	...
	@OriginalMember(owner = "com.jagex.client!sl", name = "a", descriptor = "()V")
	public void method5447() {
		this.programs = null;
	}

	@OriginalMember(owner = "com.jagex.client!sl", name = "b", descriptor = "()V")
				...
				while (local29.anIntArray195[local51] == local56) {
					...
					if (local80 == 144) {
						...
						if (local99 > 0) {
							...
							@Pc(182) ByteArrayNode local182 = (ByteArrayNode) this.programs.getNode((long) local174);
							if (local182 == null) {
								local182 = new ByteArrayNode(new byte[128]);
								this.programs.pushNode(local182, (long) local174);
							}
