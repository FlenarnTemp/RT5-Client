...
@OriginalClass("com.jagex.client!ph")
public final class SynthInstrument {

	@OriginalMember(owner = "com.jagex.client!ph", name = "t", descriptor = "[I")
	private static final int[] anIntArray344 = new int[32768];

	@OriginalMember(owner = "com.jagex.client!ph", name = "p", descriptor = "[I")
	private static final int[] anIntArray342;

	@OriginalMember(owner = "com.jagex.client!ph", name = "a", descriptor = "Lclient!uf;")
	private SynthEnvelope aClass232_1;

	@OriginalMember(owner = "com.jagex.client!ph", name = "c", descriptor = "Lclient!uf;")
	private SynthEnvelope aClass232_2;

	@OriginalMember(owner = "com.jagex.client!ph", name = "d", descriptor = "Lclient!uf;")
	private SynthEnvelope aClass232_3;

	@OriginalMember(owner = "com.jagex.client!ph", name = "i", descriptor = "Lclient!uf;")
	private SynthEnvelope aClass232_4;

	@OriginalMember(owner = "com.jagex.client!ph", name = "k", descriptor = "Lclient!uf;")
	private SynthEnvelope aClass232_5;

	@OriginalMember(owner = "com.jagex.client!ph", name = "l", descriptor = "Lclient!uf;")
	private SynthEnvelope aClass232_6;

	@OriginalMember(owner = "com.jagex.client!ph", name = "n", descriptor = "Lclient!uf;")
	private SynthEnvelope aClass232_7;

	@OriginalMember(owner = "com.jagex.client!ph", name = "o", descriptor = "Lclient!pc;")
	private SynthFilter aClass176_1;

	@OriginalMember(owner = "com.jagex.client!ph", name = "q", descriptor = "Lclient!uf;")
	private SynthEnvelope aClass232_8;

	@OriginalMember(owner = "com.jagex.client!ph", name = "s", descriptor = "Lclient!uf;")
	private SynthEnvelope aClass232_9;

	@OriginalMember(owner = "com.jagex.client!ph", name = "b", descriptor = "I")
	public int anInt4960 = 500;

	@OriginalMember(owner = "com.jagex.client!ph", name = "e", descriptor = "I")
	private int anInt4961 = 0;

	@OriginalMember(owner = "com.jagex.client!ph", name = "f", descriptor = "I")
	private int anInt4962 = 100;

	@OriginalMember(owner = "com.jagex.client!ph", name = "j", descriptor = "I")
	public int anInt4963 = 0;

	@OriginalMember(owner = "com.jagex.client!ph", name = "m", descriptor = "[I")
	private final int[] anIntArray341 = new int[5];

	@OriginalMember(owner = "com.jagex.client!ph", name = "h", descriptor = "[I")
	private final int[] anIntArray340 = new int[5];

	@OriginalMember(owner = "com.jagex.client!ph", name = "r", descriptor = "[I")
	...
	@OriginalMember(owner = "com.jagex.client!ph", name = "a", descriptor = "(III)I")
	...
	@OriginalMember(owner = "com.jagex.client!ph", name = "a", descriptor = "(Lclient!bt;)V")
