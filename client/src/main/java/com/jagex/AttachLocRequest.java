...
@OriginalClass("com.jagex.client!cl")
public final class AttachLocRequest extends Node {

	@OriginalMember(owner = "com.jagex.client!vi", name = "p", descriptor = "Lclient!ld;")
	public static final LinkedList queue = new LinkedList();
	@OriginalMember(owner = "com.jagex.client!cl", name = "v", descriptor = "I")
	public int anInt1100;

	@OriginalMember(owner = "com.jagex.client!cl", name = "w", descriptor = "I")
	public int anInt1101;

	@OriginalMember(owner = "com.jagex.client!cl", name = "x", descriptor = "I")
	public int anInt1102;

	@OriginalMember(owner = "com.jagex.client!cl", name = "z", descriptor = "I")
	public int anInt1104;

	@OriginalMember(owner = "com.jagex.client!cl", name = "C", descriptor = "I")
	public int anInt1107;

	@OriginalMember(owner = "com.jagex.client!cl", name = "D", descriptor = "I")
	public int anInt1108;

	@OriginalMember(owner = "com.jagex.client!cl", name = "E", descriptor = "I")
	public int anInt1109;

	@OriginalMember(owner = "com.jagex.client!cl", name = "F", descriptor = "I")
	public int anInt1110;

	@OriginalMember(owner = "com.jagex.client!cl", name = "G", descriptor = "I")
	public int anInt1111;

	@OriginalMember(owner = "com.jagex.client!cl", name = "H", descriptor = "I")
	public int anInt1112;

	@OriginalMember(owner = "com.jagex.client!cl", name = "I", descriptor = "I")
	public int anInt1113;

	@OriginalMember(owner = "com.jagex.client!cl", name = "J", descriptor = "I")
	public int anInt1114;

	@OriginalMember(owner = "com.jagex.client!cl", name = "N", descriptor = "I")
	public int shape;

	@OriginalMember(owner = "com.jagex.client!cl", name = "O", descriptor = "I")
	public int anInt1117;

	@OriginalMember(owner = "com.jagex.client!cl", name = "P", descriptor = "I")
	public int anInt1118;

	@OriginalMember(owner = "com.jagex.client!ge", name = "a", descriptor = "(I)V")
				...
				if (layer == 0) {
					...
					if (local162 instanceof Class11_Sub5_Sub6) {
						...
						if (request.anInt1111 == 1 || request.anInt1111 == 3) {
							local204 = local191.width;
							local207 = local191.length;
						} else {
							local207 = local191.width;
							local204 = local191.length;
						}
    ...
    @OriginalMember(owner = "com.jagex.client!nt", name = "a", descriptor = "(IIIIIIIIIIIIII)V")
    public static void push(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(12) int arg11, @OriginalArg(13) int arg12) {
        ...
        @Pc(65) int local65;
        if (arg10 == 1 || arg10 == 3) {
            local62 = local51.length;
            local65 = local51.width;
        } else {
            local62 = local51.width;
            local65 = local51.length;
        }
    ...
    @OriginalMember(owner = "com.jagex.client!cl", name = "a", descriptor = "(Lclient!wm;II)Lclient!gn;")
	public Model method1360(@OriginalArg(0) Renderer arg0, @OriginalArg(1) int arg1) {
