...
@OriginalClass("com.jagex.client!rn")
public final class Class205 {

	@OriginalMember(owner = "com.jagex.client!rn", name = "c", descriptor = "J")
	private long aLong169;

	@OriginalMember(owner = "com.jagex.client!rn", name = "m", descriptor = "I")
	private int anInt5728;

	@OriginalMember(owner = "com.jagex.client!rn", name = "a", descriptor = "I")
	private int anInt5724 = 0;

	@OriginalMember(owner = "com.jagex.client!rn", name = "e", descriptor = "J")
	private long aLong170 = -1L;

	@OriginalMember(owner = "com.jagex.client!rn", name = "g", descriptor = "J")
	private long aLong171 = -1L;

	@OriginalMember(owner = "com.jagex.client!rn", name = "h", descriptor = "Lclient!rl;")
	private final FileOnDisk aClass204_4;

	@OriginalMember(owner = "com.jagex.client!rn", name = "n", descriptor = "J")
	private long aLong172;

	@OriginalMember(owner = "com.jagex.client!rn", name = "r", descriptor = "J")
	private long aLong173;

	@OriginalMember(owner = "com.jagex.client!rn", name = "l", descriptor = "[B")
	private final byte[] aByteArray75;

	@OriginalMember(owner = "com.jagex.client!rn", name = "i", descriptor = "[B")
	private final byte[] aByteArray74;

	@OriginalMember(owner = "com.jagex.client!rn", name = "b", descriptor = "J")
	private long aLong168;

	@OriginalMember(owner = "com.jagex.client!rn", name = "<init>", descriptor = "(Lclient!rl;II)V")
	...
	@OriginalMember(owner = "com.jagex.client!rn", name = "a", descriptor = "(JB)V")
	...
	@OriginalMember(owner = "com.jagex.client!rn", name = "a", descriptor = "(II[BI)V")
	public void method5215(@OriginalArg(1) int arg0, @OriginalArg(2) byte[] arg1, @OriginalArg(3) int arg2) throws IOException {
		try {
			...
			if (this.aLong171 != -1L && this.aLong171 + (long) this.aByteArray74.length < this.aLong168 + (long) arg2) {
				...
				ArrayUtil.method4607(arg1, arg0, this.aByteArray74, (int) (this.aLong168 - this.aLong171), local92);
				arg0 += local92;
				arg2 -= local92;
			...
			if (arg2 > this.aByteArray74.length) {
				...
				if (local181 > -1L && local183 > local181) {
					...
					ArrayUtil.method4607(arg1, (int) ((long) arg0 + local181 - this.aLong168), this.aByteArray75, (int) (local181 - this.aLong170), local319);
				}
				this.aLong168 += arg2;
			} else if (arg2 > 0) {
				if (this.aLong171 == -1L) {
				...
				ArrayUtil.method4607(arg1, arg0, this.aByteArray74, (int) (this.aLong168 - this.aLong171), arg2);
				this.aLong168 += arg2;
	...
	@OriginalMember(owner = "com.jagex.client!rn", name = "a", descriptor = "(B)V")
	...
	@OriginalMember(owner = "com.jagex.client!rn", name = "a", descriptor = "(I)Ljava/io/File;")
	private File method5217() {
		return this.aClass204_4.getFile();
	}

	@OriginalMember(owner = "com.jagex.client!rn", name = "b", descriptor = "(B)J")
	public long method5218() {
		return this.aLong173;
	}

	@OriginalMember(owner = "com.jagex.client!rn", name = "c", descriptor = "(B)V")
	private void method5219() throws IOException {
		...
		if (local64 > -1L && local66 > local64) {
			...
			ArrayUtil.method4607(this.aByteArray74, (int) (local64 - this.aLong171), this.aByteArray75, (int) (local64 - this.aLong170), local199);
		}
		this.aLong171 = -1L;
		this.anInt5724 = 0;
	}

	@OriginalMember(owner = "com.jagex.client!rn", name = "a", descriptor = "([BB)V")
	public void method5220(@OriginalArg(0) byte[] arg0) throws IOException {
		this.method5222(arg0, 0, arg0.length);
	}

	@OriginalMember(owner = "com.jagex.client!rn", name = "a", descriptor = "([BZII)V")
	public void method5222(@OriginalArg(0) byte[] arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) throws IOException {
		try {
			...
			if (this.aLong171 != -1L && this.aLong168 >= this.aLong171 && this.aLong168 + (long) arg2 <= this.aLong171 + (long) this.anInt5724) {
				ArrayUtil.method4607(this.aByteArray74, (int) (this.aLong168 - this.aLong171), arg0, 0, arg2);
				this.aLong168 += arg2;
				return;
			}
			...
			if (this.aLong168 >= this.aLong170 && this.aLong168 < this.aLong170 + (long) this.anInt5728) {
				...
				ArrayUtil.method4607(this.aByteArray75, (int) (this.aLong168 - this.aLong170), arg0, 0, local119);
				arg1 = local119;
			...
			if (this.aByteArray75.length < arg2) {
				...
				ArrayUtil.method4607(this.aByteArray75, 0, arg0, arg1, local119);
				arg1 += local119;
				this.aLong168 += local119;
				arg2 -= local119;
			}
			if (this.aLong171 != -1L) {
				...
				if (local307 > -1L && local307 < local309) {
					...
					ArrayUtil.method4607(this.aByteArray74, (int) (local307 - this.aLong171), arg0, (int) (local307 - local86), local431);
