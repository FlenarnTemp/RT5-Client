...
public final class Static329 {
	...
	@OriginalMember(owner = "com.jagex.client!tc", name = "U", descriptor = "I")
	public static int anInt6167;

	@OriginalMember(owner = "com.jagex.client!tc", name = "W", descriptor = "[[Z")
	...
	@OriginalMember(owner = "com.jagex.client!tc", name = "ab", descriptor = "[I")
	public static final int[] anIntArray420 = new int[3];

	@OriginalMember(owner = "com.jagex.client!tc", name = "a", descriptor = "(Lclient!hb;Z)Z")
