...
public final class Static178 {
	...
	@OriginalMember(owner = "com.jagex.client!kf", name = "a", descriptor = "I")
	public static int anInt2317;

	@OriginalMember(owner = "com.jagex.client!kf", name = "a", descriptor = "(IIIILclient!nb;IILclient!gn;ILclient!wm;IZIII)Lclient!gn;")
	public static Model method2340(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) Class157 arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) Model arg7, @OriginalArg(8) int arg8, @OriginalArg(9) Renderer arg9, @OriginalArg(10) int arg10, @OriginalArg(11) boolean arg11, @OriginalArg(12) int arg12, @OriginalArg(13) int arg13) {
		if (arg7 == null) {
			return null;
		}
		...
		if (local58 == null || arg9.method2863(local58.method3827(), local11) != 0) {
			...
			for (local163 = 0; local163 < 3; local163++) {
				...
				for (local175 = 0; local175 < local93; local175++) {
					...
					@Pc(191) int local191 = Renderer.anIntArray178[local183] * local169 >> 15;
					local199 = local173 * Renderer.anIntArray177[local183] >> 15;
	...
	@OriginalMember(owner = "com.jagex.client!kf", name = "b", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!kf", name = "a", descriptor = "(III)Ljava/lang/String;")
	...
	@OriginalMember(owner = "com.jagex.client!kf", name = "b", descriptor = "(III)I")
