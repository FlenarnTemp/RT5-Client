...
@OriginalClass("com.jagex.client!dq")
public final class TextureOp22 extends TextureOp {

	@OriginalMember(owner = "com.jagex.client!dq", name = "<init>", descriptor = "()V")
	public TextureOp22() {
		super(1, false);
	}

	@OriginalMember(owner = "com.jagex.client!dq", name = "a", descriptor = "(ILclient!bt;I)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!dq", name = "a", descriptor = "(BI)[I")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!dq", name = "b", descriptor = "(IB)[[I")
	@Override
