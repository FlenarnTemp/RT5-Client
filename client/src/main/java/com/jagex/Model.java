...
@OriginalClass("com.jagex.client!gn")
public abstract class Model {

	@OriginalMember(owner = "com.jagex.client!gn", name = "<init>", descriptor = "()V")
	protected Model() {
	}

	@OriginalMember(owner = "com.jagex.client!gn", name = "a", descriptor = "(BIZ)Lclient!gn;")
	public abstract Model method3800(@OriginalArg(0) byte arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2);

	@OriginalMember(owner = "com.jagex.client!gn", name = "a", descriptor = "()Z")
	public abstract boolean method3801();

	@OriginalMember(owner = "com.jagex.client!gn", name = "b", descriptor = "()I")
	public abstract int method3802();

	@OriginalMember(owner = "com.jagex.client!gn", name = "a", descriptor = "(Lclient!gn;IIIZ)V")
	...
	@OriginalMember(owner = "com.jagex.client!gn", name = "c", descriptor = "()Z")
	protected abstract boolean method3804();

	@OriginalMember(owner = "com.jagex.client!gn", name = "d", descriptor = "()I")
	public abstract int method3805();

	@OriginalMember(owner = "com.jagex.client!gn", name = "e", descriptor = "()I")
	public abstract int method3806();

	@OriginalMember(owner = "com.jagex.client!gn", name = "a", descriptor = "(I)V")
	public abstract void method3807(@OriginalArg(0) int arg0);

	@OriginalMember(owner = "com.jagex.client!gn", name = "f", descriptor = "()[Lclient!jf;")
	public abstract Class114[] method3808();

	@OriginalMember(owner = "com.jagex.client!gn", name = "g", descriptor = "()V")
	public abstract void method3810();

	@OriginalMember(owner = "com.jagex.client!gn", name = "a", descriptor = "(II[ZIZIIILclient!nt;Lclient!nt;ILclient!nt;Lclient!nt;II)V")
	...
	@OriginalMember(owner = "com.jagex.client!gn", name = "h", descriptor = "()I")
	public abstract int method3812();

	@OriginalMember(owner = "com.jagex.client!gn", name = "a", descriptor = "(III)V")
	public abstract void method3813(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2);

	@OriginalMember(owner = "com.jagex.client!gn", name = "b", descriptor = "(I)V")
	public abstract void method3814(@OriginalArg(0) int arg0);

	@OriginalMember(owner = "com.jagex.client!gn", name = "c", descriptor = "(I)V")
	public abstract void method3815(@OriginalArg(0) int arg0);

	@OriginalMember(owner = "com.jagex.client!gn", name = "a", descriptor = "(SS)V")
	public abstract void method3816(@OriginalArg(0) short arg0, @OriginalArg(1) short arg1);

	@OriginalMember(owner = "com.jagex.client!gn", name = "i", descriptor = "()I")
	public abstract int method3817();

	@OriginalMember(owner = "com.jagex.client!gn", name = "a", descriptor = "(Lclient!nt;BI)V")
	...
	@OriginalMember(owner = "com.jagex.client!gn", name = "a", descriptor = "(IILclient!tf;Lclient!tf;III)V")
	...
	@OriginalMember(owner = "com.jagex.client!gn", name = "a", descriptor = "(IILclient!on;Z)Z")
	...
	@OriginalMember(owner = "com.jagex.client!gn", name = "a", descriptor = "(I[IIIIIZ)V")
	...
	@OriginalMember(owner = "com.jagex.client!gn", name = "j", descriptor = "()I")
	public abstract int method3822();

	@OriginalMember(owner = "com.jagex.client!gn", name = "a", descriptor = "(IILclient!nt;IIIILclient!nt;ZZ[I)V")
	...
	@OriginalMember(owner = "com.jagex.client!gn", name = "d", descriptor = "(I)V")
	public abstract void method3824(@OriginalArg(0) int arg0);

	@OriginalMember(owner = "com.jagex.client!gn", name = "b", descriptor = "(IIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!gn", name = "k", descriptor = "()I")
	public abstract int method3826();

	@OriginalMember(owner = "com.jagex.client!gn", name = "l", descriptor = "()I")
	public abstract int method3827();

	@OriginalMember(owner = "com.jagex.client!gn", name = "a", descriptor = "(ILclient!nt;IBZIILclient!nt;I)V")
	...
	@OriginalMember(owner = "com.jagex.client!gn", name = "f", descriptor = "(I)V")
	public abstract void method3830(@OriginalArg(0) int arg0);

	@OriginalMember(owner = "com.jagex.client!gn", name = "m", descriptor = "()I")
	public abstract int method3831();

	@OriginalMember(owner = "com.jagex.client!gn", name = "n", descriptor = "()I")
	public abstract int method3832();

	@OriginalMember(owner = "com.jagex.client!gn", name = "g", descriptor = "(I)V")
	public abstract void method3833(@OriginalArg(0) int arg0);

	@OriginalMember(owner = "com.jagex.client!gn", name = "a", descriptor = "(I[IIIIZI[I)V")
	...
	@OriginalMember(owner = "com.jagex.client!gn", name = "a", descriptor = "(Lclient!on;Lclient!au;I)V")
	public abstract void method3835(@OriginalArg(0) Class14 arg0, @OriginalArg(1) Class12_Sub2 arg1, @OriginalArg(2) int arg2);

	@OriginalMember(owner = "com.jagex.client!gn", name = "o", descriptor = "()V")
	protected abstract void method3836();

	@OriginalMember(owner = "com.jagex.client!gn", name = "p", descriptor = "()V")
	public abstract void method3837();

	@OriginalMember(owner = "com.jagex.client!gn", name = "b", descriptor = "(SS)V")
	public abstract void method3838(@OriginalArg(0) short arg0, @OriginalArg(1) short arg1);

	@OriginalMember(owner = "com.jagex.client!gn", name = "a", descriptor = "(Lclient!kb;)Lclient!kb;")
	public abstract Class2_Sub2_Sub4 method3839(@OriginalArg(0) Class2_Sub2_Sub4 arg0);

	@OriginalMember(owner = "com.jagex.client!gn", name = "q", descriptor = "()[Lclient!nm;")
	public abstract Class163[] method3840();

	@OriginalMember(owner = "com.jagex.client!gn", name = "b", descriptor = "(III)V")
	public abstract void method3842(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2);

	@OriginalMember(owner = "com.jagex.client!gn", name = "a", descriptor = "(Lclient!on;Lclient!au;II)V")
	public abstract void method3844(@OriginalArg(0) Class14 arg0, @OriginalArg(1) Class12_Sub2 arg1, @OriginalArg(2) int arg2);

	@OriginalMember(owner = "com.jagex.client!gn", name = "i", descriptor = "(I)V")
	public abstract void method3845(@OriginalArg(0) int arg0);

	@OriginalMember(owner = "com.jagex.client!gn", name = "a", descriptor = "(II[III[IZIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!gn", name = "a", descriptor = "(IBIIILclient!tf;I)V")
	...
	@OriginalMember(owner = "com.jagex.client!gn", name = "a", descriptor = "(Z[ILclient!ib;[ZLclient!nd;IIIZBLclient!nd;I)V")
