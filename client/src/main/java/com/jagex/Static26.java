...
public final class Static26 {
	...
	@OriginalMember(owner = "com.jagex.client!bj", name = "f", descriptor = "[[B")
	public static byte[][] aByteArrayArray3;

	@OriginalMember(owner = "com.jagex.client!bj", name = "g", descriptor = "[[Lclient!nk;")
	public static Component[][] components;

	@OriginalMember(owner = "com.jagex.client!bj", name = "d", descriptor = "Lclient!gd;")
	...
	@OriginalMember(owner = "com.jagex.client!bj", name = "a", descriptor = "(II)S")
	...
	@OriginalMember(owner = "com.jagex.client!bj", name = "a", descriptor = "(III)Lclient!el;")
	...
	@OriginalMember(owner = "com.jagex.client!bj", name = "a", descriptor = "(IIIILclient!da;)V")
