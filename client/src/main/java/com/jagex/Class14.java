...
@OriginalClass("com.jagex.client!on")
public abstract class Class14 {

	@OriginalMember(owner = "com.jagex.client!on", name = "a", descriptor = "(III)V")
	public abstract void method3922(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2);

	@OriginalMember(owner = "com.jagex.client!on", name = "a", descriptor = "(Lclient!on;)V")
	public abstract void method3924(@OriginalArg(0) Class14 arg0);

	@OriginalMember(owner = "com.jagex.client!on", name = "a", descriptor = "(I)V")
	public abstract void method3925(@OriginalArg(0) int arg0);

	@OriginalMember(owner = "com.jagex.client!on", name = "b", descriptor = "(I)V")
	public abstract void method3926(@OriginalArg(0) int arg0);

	@OriginalMember(owner = "com.jagex.client!on", name = "c", descriptor = "(I)V")
	public abstract void method3929(@OriginalArg(0) int arg0);

	@OriginalMember(owner = "com.jagex.client!on", name = "a", descriptor = "(IIIIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!on", name = "d", descriptor = "(I)V")
	public abstract void method3931(@OriginalArg(0) int arg0);

	@OriginalMember(owner = "com.jagex.client!on", name = "a", descriptor = "()V")
	public abstract void method3932();

	@OriginalMember(owner = "com.jagex.client!on", name = "e", descriptor = "(I)V")
	public abstract void method3933(@OriginalArg(0) int arg0);

	@OriginalMember(owner = "com.jagex.client!on", name = "a", descriptor = "(III[I)V")
	...
	@OriginalMember(owner = "com.jagex.client!on", name = "b", descriptor = "(III)V")
