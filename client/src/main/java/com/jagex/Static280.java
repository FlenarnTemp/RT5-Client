...
public final class Static280 {
	...
	@OriginalMember(owner = "com.jagex.client!qe", name = "Q", descriptor = "I")
	public static int anInt5197 = 0;

	@OriginalMember(owner = "com.jagex.client!qe", name = "a", descriptor = "(Ljava/lang/String;Lclient!ml;BZZ)V")
	...
	@OriginalMember(owner = "com.jagex.client!qe", name = "a", descriptor = "(BZZ)V")
	...
	@OriginalMember(owner = "com.jagex.client!qe", name = "a", descriptor = "(IIII)I")
