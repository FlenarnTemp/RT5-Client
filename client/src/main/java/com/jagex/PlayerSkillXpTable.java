...
public class PlayerSkillXpTable {
	...
	@OriginalMember(owner = "com.jagex.client!ek", name = "ab", descriptor = "[I")
	public static final int[] experience = new int[25];

	@OriginalMember(owner = "com.jagex.client!sr", name = "i", descriptor = "[I")
	public static final int[] baseLevels = new int[25];

	@OriginalMember(owner = "com.jagex.client!pg", name = "U", descriptor = "[I")
	public static final int[] boostedLevels = new int[25];

	@OriginalMember(owner = "com.jagex.client!at", name = "L", descriptor = "[I")
