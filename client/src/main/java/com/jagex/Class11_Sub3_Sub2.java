...
@OriginalClass("com.jagex.client!ni")
public final class Class11_Sub3_Sub2 extends Class11_Sub3 implements Interface6 {

	@OriginalMember(owner = "com.jagex.client!ni", name = "M", descriptor = "B")
	private final byte aByte42;

	@OriginalMember(owner = "com.jagex.client!ni", name = "O", descriptor = "S")
	private final short aShort60;

	@OriginalMember(owner = "com.jagex.client!ni", name = "H", descriptor = "B")
	private final byte aByte41;

	@OriginalMember(owner = "com.jagex.client!ni", name = "R", descriptor = "B")
	private final byte aByte43;

	@OriginalMember(owner = "com.jagex.client!ni", name = "B", descriptor = "Z")
	private final boolean aBoolean277;

	@OriginalMember(owner = "com.jagex.client!ni", name = "D", descriptor = "Z")
	private final boolean aBoolean278;

	@OriginalMember(owner = "com.jagex.client!ni", name = "L", descriptor = "Z")
	private final boolean aBoolean279;

	@OriginalMember(owner = "com.jagex.client!ni", name = "T", descriptor = "Lclient!kb;")
	private Class2_Sub2_Sub4 aClass2_Sub2_Sub4_5;

	@OriginalMember(owner = "com.jagex.client!ni", name = "u", descriptor = "Lclient!gn;")
	private Model aClass31_6;

	@OriginalMember(owner = "com.jagex.client!ni", name = "<init>", descriptor = "(Lclient!wm;Lclient!ct;IIIIZIIIII)V")
	public Class11_Sub3_Sub2(@OriginalArg(0) Renderer arg0, @OriginalArg(1) LocType arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) boolean arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11) {
		...
		this.aBoolean278 = arg1.active != 0 && !arg6;
		this.aBoolean279 = arg0.method2878() && arg1.hardshadow && !this.aBoolean277 && client.preferences.shadows != 0;
	...
	@OriginalMember(owner = "com.jagex.client!ni", name = "a", descriptor = "(Lclient!wm;I)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!ni", name = "d", descriptor = "(I)I")
	@Override
	public int method6085() {
		return this.aShort60 & 0xFFFF;
	}

	@OriginalMember(owner = "com.jagex.client!ni", name = "a", descriptor = "(Lclient!wm;B)V")
	@Override
	public void method6070(@OriginalArg(0) Renderer arg0) {
	}

	@OriginalMember(owner = "com.jagex.client!ni", name = "a", descriptor = "(BLclient!wm;)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!ni", name = "c", descriptor = "(I)I")
	@Override
	public int method6084() {
		return this.aByte41;
	}

	@OriginalMember(owner = "com.jagex.client!ni", name = "a", descriptor = "(Z)Z")
	@Override
	public boolean method6086() {
		return this.aBoolean279;
	}

	@OriginalMember(owner = "com.jagex.client!ni", name = "a", descriptor = "(I)I")
	@Override
	public int method6081() {
		return this.aByte43;
	}

	@OriginalMember(owner = "com.jagex.client!ni", name = "h", descriptor = "(I)I")
	@Override
	public int method5748() {
		return this.aClass31_6 == null ? 0 : this.aClass31_6.method3802();
	}

	@OriginalMember(owner = "com.jagex.client!ni", name = "a", descriptor = "(Lclient!wm;II)Lclient!gn;")
	private Model method4096(@OriginalArg(0) Renderer arg0, @OriginalArg(1) int arg1) {
	...
	@OriginalMember(owner = "com.jagex.client!ni", name = "a", descriptor = "(IIBLclient!wm;)Z")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!ni", name = "a", descriptor = "(IBZLclient!wm;)Lclient!ij;")
	private Class105 method4097(@OriginalArg(0) int arg0, @OriginalArg(2) boolean arg1, @OriginalArg(3) Renderer arg2) {
		@Pc(13) LocType local13 = client.LocTypes.get(this.aShort60 & 0xFFFF);
	...
	@OriginalMember(owner = "com.jagex.client!ni", name = "a", descriptor = "(ILclient!wm;I)Lclient!gn;")
	@Override
	public Model method6088(@OriginalArg(0) int arg0, @OriginalArg(1) Renderer arg1) {
		return this.method4096(arg1, arg0);
	}

	@OriginalMember(owner = "com.jagex.client!ni", name = "b", descriptor = "(Lclient!wm;B)Lclient!nf;")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!ni", name = "b", descriptor = "(I)V")
	@Override
