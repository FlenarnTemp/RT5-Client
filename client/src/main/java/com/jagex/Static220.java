...
public final class Static220 {
	...
	@OriginalMember(owner = "com.jagex.client!mq", name = "n", descriptor = "Lclient!gd;")
	public static final LocalizedString aClass79_83 = new LocalizedString("Take", "Nehmen", "Prendre", "Pegar");

	@OriginalMember(owner = "com.jagex.client!mq", name = "q", descriptor = "Z")
	public static boolean aBoolean252 = false;

	@OriginalMember(owner = "com.jagex.client!mq", name = "a", descriptor = "(BIIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!mq", name = "a", descriptor = "(ILjava/lang/String;ILjava/lang/String;IILjava/lang/String;Ljava/lang/String;)V")
	...
	@OriginalMember(owner = "com.jagex.client!mq", name = "a", descriptor = "(ZII)I")
