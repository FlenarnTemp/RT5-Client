...
public final class Static314 {
	...
	@OriginalMember(owner = "com.jagex.client!sd", name = "b", descriptor = "(II)Lclient!bp;")
	public static Class28 method5367(@OriginalArg(0) int arg0) {
		@Pc(10) Class28 local10 = (Class28) Static119.aClass98_16.get((long) arg0);
		if (local10 != null) {
			return local10;
		}
		@Pc(20) byte[] local20 = Static188.aClass197_52.getfile(arg0, 1);
		local10 = new Class28();
	...
	@OriginalMember(owner = "com.jagex.client!sd", name = "a", descriptor = "(Lclient!nn;)V")
