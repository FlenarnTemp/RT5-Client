...
public final class Static373 {
	...
	@OriginalMember(owner = "com.jagex.client!vq", name = "i", descriptor = "I")
	public static int anInt7029 = -1;

	@OriginalMember(owner = "com.jagex.client!vq", name = "l", descriptor = "I")
	public static int anInt7032 = 0;

	@OriginalMember(owner = "com.jagex.client!vq", name = "m", descriptor = "I")
	public static int buildAreaLimitX = 104;

	@OriginalMember(owner = "com.jagex.client!vq", name = "a", descriptor = "(ZIZIZ)V")
