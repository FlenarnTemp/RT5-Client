...
@OriginalClass("com.jagex.client!d")
public final class Class2_Sub2_Sub5 extends SecondaryNode {

	@OriginalMember(owner = "com.jagex.client!d", name = "B", descriptor = "I")
	public int anInt1389;

	@OriginalMember(owner = "com.jagex.client!d", name = "C", descriptor = "I")
	public int anInt1390;

	@OriginalMember(owner = "com.jagex.client!d", name = "E", descriptor = "I")
	public int anInt1391;

	@OriginalMember(owner = "com.jagex.client!d", name = "O", descriptor = "I")
	public int anInt1395;

	@OriginalMember(owner = "com.jagex.client!d", name = "P", descriptor = "I")
	public int anInt1396;

	@OriginalMember(owner = "com.jagex.client!d", name = "D", descriptor = "Lclient!nm;")
	public final Class163 aClass163_1;

	@OriginalMember(owner = "com.jagex.client!d", name = "K", descriptor = "Lclient!bp;")
	public final Class28 aClass28_1;

	@OriginalMember(owner = "com.jagex.client!d", name = "<init>", descriptor = "(Lclient!nm;Lclient!oh;)V")
	...
	@OriginalMember(owner = "com.jagex.client!d", name = "b", descriptor = "(I)V")
