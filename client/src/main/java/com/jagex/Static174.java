...
public final class Static174 {
	...
	@OriginalMember(owner = "com.jagex.client!kb", name = "D", descriptor = "[Ljava/awt/Color;")
	public static final Color[] aColorArray2 = new Color[] { new Color(9179409), new Color(3289650) };

	@OriginalMember(owner = "com.jagex.client!kb", name = "G", descriptor = "I")
	public static int anInt1300 = 0;

	@OriginalMember(owner = "com.jagex.client!kb", name = "b", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!kb", name = "a", descriptor = "(BLclient!bt;)Lclient!vo;")
	public static Class173_Sub4 method1508(@OriginalArg(1) Packet arg0) {
		return new Class173_Sub4(arg0.g2s(), arg0.g2s(), arg0.g2s(), arg0.g2s(), arg0.g2s(), arg0.g2s(), arg0.g2s(), arg0.g2s(), arg0.g3(), arg0.g1());
	}

	@OriginalMember(owner = "com.jagex.client!kb", name = "a", descriptor = "(ILjava/lang/Throwable;)Ljava/lang/String;")
