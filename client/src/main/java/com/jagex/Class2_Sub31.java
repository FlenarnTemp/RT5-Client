...
@OriginalClass("com.jagex.client!qt")
public final class Class2_Sub31 extends Node {

	@OriginalMember(owner = "com.jagex.client!qt", name = "K", descriptor = "I")
	public final int anInt5547;

	@OriginalMember(owner = "com.jagex.client!qt", name = "y", descriptor = "I")
	private final int anInt5536;

	@OriginalMember(owner = "com.jagex.client!qt", name = "F", descriptor = "I")
	public final int anInt5542;

	@OriginalMember(owner = "com.jagex.client!qt", name = "G", descriptor = "I")
	private final int anInt5543;

	@OriginalMember(owner = "com.jagex.client!qt", name = "s", descriptor = "I")
	private final int anInt5532;

	@OriginalMember(owner = "com.jagex.client!qt", name = "z", descriptor = "I")
	public final int anInt5537;

	@OriginalMember(owner = "com.jagex.client!qt", name = "t", descriptor = "I")
	private final int anInt5533;

	@OriginalMember(owner = "com.jagex.client!qt", name = "I", descriptor = "I")
	private final int anInt5545;

	@OriginalMember(owner = "com.jagex.client!qt", name = "w", descriptor = "I")
	public final int anInt5534;

	@OriginalMember(owner = "com.jagex.client!qt", name = "<init>", descriptor = "(IIIIIIIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!qt", name = "a", descriptor = "(II[II)V")
	...
	@OriginalMember(owner = "com.jagex.client!qt", name = "a", descriptor = "(IIB)Z")
	...
	@OriginalMember(owner = "com.jagex.client!qt", name = "b", descriptor = "(II[II)V")
	...
	@OriginalMember(owner = "com.jagex.client!qt", name = "a", descriptor = "(IIIB)Z")
	...
	@OriginalMember(owner = "com.jagex.client!qt", name = "b", descriptor = "(IZI)Z")
