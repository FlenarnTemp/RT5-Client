...
@OriginalClass("com.jagex.client!gj")
public final class Class78_Sub2 extends Class78 {

	@OriginalMember(owner = "com.jagex.client!gj", name = "h", descriptor = "Lclient!ln;")
	public final Class8_Sub1_Sub1 aClass8_Sub1_Sub1_2;

	@OriginalMember(owner = "com.jagex.client!gj", name = "<init>", descriptor = "(Lclient!bf;II[B)V")
