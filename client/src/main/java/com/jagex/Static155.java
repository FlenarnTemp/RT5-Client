...
public final class Static155 {
	...
	@OriginalMember(owner = "com.jagex.client!it", name = "a", descriptor = "I")
	public static int anInt2808 = 0;

	@OriginalMember(owner = "com.jagex.client!it", name = "a", descriptor = "([II[B[[BI[I[[BI)I")
	...
	@OriginalMember(owner = "com.jagex.client!it", name = "b", descriptor = "(I)V")
