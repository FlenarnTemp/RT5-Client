...
@OriginalClass("com.jagex.client!jd")
public abstract class Sprite {

	@OriginalMember(owner = "com.jagex.client!jd", name = "<init>", descriptor = "()V")
	protected Sprite() {
	}

	@OriginalMember(owner = "com.jagex.client!jd", name = "a", descriptor = "()I")
	public abstract int method6382();

	@OriginalMember(owner = "com.jagex.client!jd", name = "a", descriptor = "(IILclient!kf;II)V")
	...
	@OriginalMember(owner = "com.jagex.client!jd", name = "b", descriptor = "()I")
	public abstract int method6384();

	@OriginalMember(owner = "com.jagex.client!jd", name = "a", descriptor = "(II)V")
	public final void method6385(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.method6401(arg0, arg1, 0, 0);
	}

	@OriginalMember(owner = "com.jagex.client!jd", name = "a", descriptor = "(FFII)V")
	...
	@OriginalMember(owner = "com.jagex.client!jd", name = "a", descriptor = "(FFFFFFLclient!kf;II)V")
	...
	@OriginalMember(owner = "com.jagex.client!jd", name = "a", descriptor = "(IIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!jd", name = "c", descriptor = "()I")
	public abstract int method6389();

	@OriginalMember(owner = "com.jagex.client!jd", name = "a", descriptor = "(IIIIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!jd", name = "b", descriptor = "(IIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!jd", name = "a", descriptor = "(III)V")
	public abstract void method6392(@OriginalArg(2) int arg0);

	@OriginalMember(owner = "com.jagex.client!jd", name = "a", descriptor = "(FFFFIIIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!jd", name = "a", descriptor = "(FFFFFFIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!jd", name = "a", descriptor = "(IIIIIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!jd", name = "a", descriptor = "(FFFFIILclient!kf;II)V")
	...
	@OriginalMember(owner = "com.jagex.client!jd", name = "b", descriptor = "(IIIIIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!jd", name = "a", descriptor = "(FFIILclient!kf;II)V")
	...
	@OriginalMember(owner = "com.jagex.client!jd", name = "d", descriptor = "()I")
	public abstract int method6399();

	@OriginalMember(owner = "com.jagex.client!jd", name = "a", descriptor = "(FFIIIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!jd", name = "a", descriptor = "(IIIII)V")
