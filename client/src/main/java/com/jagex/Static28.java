...
public final class Static28 {
	...
	@OriginalMember(owner = "com.jagex.client!bl", name = "o", descriptor = "I")
	public static int anInt675 = 0;

	@OriginalMember(owner = "com.jagex.client!bl", name = "F", descriptor = "I")
	public static int anInt686 = 16777215;

	@OriginalMember(owner = "com.jagex.client!bl", name = "a", descriptor = "(III)Lclient!cj;")
