...
public final class Static276 {
	...
	@OriginalMember(owner = "com.jagex.client!pr", name = "s", descriptor = "Lclient!ur;")
	public static BitmapFont aClass130_4;

	@OriginalMember(owner = "com.jagex.client!pr", name = "o", descriptor = "Lclient!gd;")
	...
	@OriginalMember(owner = "com.jagex.client!pr", name = "a", descriptor = "(ILjava/lang/String;)I")
	...
	@OriginalMember(owner = "com.jagex.client!pr", name = "a", descriptor = "(ZZLclient!cu;Z)V")
	public static void method4655(@OriginalArg(0) boolean arg0, @OriginalArg(2) SubInterface arg1, @OriginalArg(3) boolean arg2) {
		...
		@Pc(12) int local12 = (int) arg1.nodeId;
		arg1.remove();
		if (arg2) {
		...
		for (@Pc(54) SubInterface local54 = (SubInterface) local49.method3561(); local54 != null; local54 = (SubInterface) local49.method3560()) {
			...
			if (local54.anInt1373 == 3) {
				@Pc(76) int local76 = (int) local54.nodeId;
