...
public final class Static289 {
	...
	@OriginalMember(owner = "com.jagex.client!qo", name = "i", descriptor = "Lclient!r;")
	public static Js5 aClass197_73;

	@OriginalMember(owner = "com.jagex.client!qo", name = "f", descriptor = "Z")
	public static final boolean aBoolean391 = false;

	@OriginalMember(owner = "com.jagex.client!qo", name = "a", descriptor = "(IZ)I")
	...
	@OriginalMember(owner = "com.jagex.client!qo", name = "a", descriptor = "(IIII)I")
	...
	@OriginalMember(owner = "com.jagex.client!qo", name = "a", descriptor = "(ILclient!bh;IB)V")
