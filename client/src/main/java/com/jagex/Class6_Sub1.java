...
@OriginalClass("com.jagex.client!ah")
public final class Class6_Sub1 extends Class6 {

	@OriginalMember(owner = "com.jagex.client!ah", name = "k", descriptor = "I")
	private int anInt179;

	@OriginalMember(owner = "com.jagex.client!ah", name = "l", descriptor = "I")
	private int anInt180;

	@OriginalMember(owner = "com.jagex.client!ah", name = "p", descriptor = "[[[I")
	private int[][][] anIntArrayArrayArray2;

	@OriginalMember(owner = "com.jagex.client!ah", name = "H", descriptor = "I")
	private int anInt185;

	@OriginalMember(owner = "com.jagex.client!ah", name = "I", descriptor = "I")
	private int anInt186;

	@OriginalMember(owner = "com.jagex.client!ah", name = "J", descriptor = "Lclient!kj;")
	public Class126 aClass126_1;

	@OriginalMember(owner = "com.jagex.client!ah", name = "K", descriptor = "Lclient!fg;")
	private Interface5 anInterface5_1;

	@OriginalMember(owner = "com.jagex.client!ah", name = "M", descriptor = "Lclient!kj;")
	public Class126 aClass126_2;

	@OriginalMember(owner = "com.jagex.client!ah", name = "N", descriptor = "Lclient!kj;")
	private Class126 aClass126_3;

	@OriginalMember(owner = "com.jagex.client!ah", name = "P", descriptor = "[Lclient!t;")
	private Class2_Sub36[] aClass2_Sub36Array1;

	@OriginalMember(owner = "com.jagex.client!ah", name = "S", descriptor = "Lclient!kj;")
	public Class126 aClass126_4;

	@OriginalMember(owner = "com.jagex.client!ah", name = "A", descriptor = "Lclient!ld;")
	private final LinkedList aClass135_3 = new LinkedList();

	@OriginalMember(owner = "com.jagex.client!ah", name = "s", descriptor = "Lclient!bf;")
	public final Class19_Sub1 aClass19_Sub1_1;

	@OriginalMember(owner = "com.jagex.client!ah", name = "n", descriptor = "[[I")
	private final int[][] anIntArrayArray1;

	@OriginalMember(owner = "com.jagex.client!ah", name = "r", descriptor = "I")
	public final int anInt181;

	@OriginalMember(owner = "com.jagex.client!ah", name = "z", descriptor = "I")
	public int anInt183;

	@OriginalMember(owner = "com.jagex.client!ah", name = "w", descriptor = "I")
	public final int anInt182;

	@OriginalMember(owner = "com.jagex.client!ah", name = "y", descriptor = "[[[I")
	private int[][][] anIntArrayArrayArray5;

	@OriginalMember(owner = "com.jagex.client!ah", name = "x", descriptor = "[[[Lclient!t;")
	private Class2_Sub36[][][] aClass2_Sub36ArrayArrayArray1;

	@OriginalMember(owner = "com.jagex.client!ah", name = "u", descriptor = "[[[I")
	public int[][][] anIntArrayArrayArray4;

	@OriginalMember(owner = "com.jagex.client!ah", name = "t", descriptor = "[[[I")
	public int[][][] anIntArrayArrayArray3;

	@OriginalMember(owner = "com.jagex.client!ah", name = "m", descriptor = "[[[I")
	private int[][][] anIntArrayArrayArray1;

	@OriginalMember(owner = "com.jagex.client!ah", name = "C", descriptor = "[[[I")
	private int[][][] anIntArrayArrayArray6;

	@OriginalMember(owner = "com.jagex.client!ah", name = "j", descriptor = "[[S")
	public final short[][] aShortArrayArray1;

	@OriginalMember(owner = "com.jagex.client!ah", name = "v", descriptor = "[[B")
	private final byte[][] aByteArrayArray1;

	@OriginalMember(owner = "com.jagex.client!ah", name = "R", descriptor = "[[B")
	private byte[][] aByteArrayArray2;

	@OriginalMember(owner = "com.jagex.client!ah", name = "F", descriptor = "[[F")
	private float[][] aFloatArrayArray1;

	@OriginalMember(owner = "com.jagex.client!ah", name = "O", descriptor = "[[F")
	private float[][] aFloatArrayArray3;

	@OriginalMember(owner = "com.jagex.client!ah", name = "G", descriptor = "[[F")
	private float[][] aFloatArrayArray2;

	@OriginalMember(owner = "com.jagex.client!ah", name = "L", descriptor = "Lclient!ad;")
	private HashTable aClass4_7;

	@OriginalMember(owner = "com.jagex.client!ah", name = "q", descriptor = "Lclient!ic;")
	private ShadowManager aClass100_1;

	@OriginalMember(owner = "com.jagex.client!ah", name = "<init>", descriptor = "(Lclient!bf;IIII[[I[[II)V")
	...
	@OriginalMember(owner = "com.jagex.client!ah", name = "a", descriptor = "(II[I[I[I[I[I[I[I[I[I[I[IIIIZ)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!ah", name = "a", descriptor = "(II[I[I[I[I[I[I[I[IIIIZ)V")
	@Override
	public void method5727(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int[] arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) int[] arg8, @OriginalArg(9) int[] arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) int arg12, @OriginalArg(13) boolean arg13) {
		...
		for (@Pc(84) int local84 = 0; local84 < arg6.length; local84++) {
			...
			if (local121 == null) {
				...
				this.aClass4_7.pushNode(local82[local84], local115);
			} else {
	...
	@OriginalMember(owner = "com.jagex.client!ah", name = "c", descriptor = "(Lclient!kb;IIIIZ)Z")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!ah", name = "a", descriptor = "(II)I")
	@Override
	public int method5719(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return this.anIntArrayArray1[arg0][arg1];
	}

	@OriginalMember(owner = "com.jagex.client!ah", name = "b", descriptor = "(Lclient!kb;IIIIZ)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!ah", name = "a", descriptor = "(III[[ZZ)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!ah", name = "a", descriptor = "(Lclient!cs;II)V")
	...
	@OriginalMember(owner = "com.jagex.client!ah", name = "c", descriptor = "(II)I")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!ah", name = "b", descriptor = "(II)V")
	@Override
	public void method5720(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	}

	@OriginalMember(owner = "com.jagex.client!ah", name = "a", descriptor = "(III)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!ah", name = "a", descriptor = "()V")
	@Override
	public void method5718() {
		if (this.anInt185 > 0) {
					...
					if (this.anIntArrayArrayArray1[local155][local161] != null) {
						...
						for (@Pc(432) int local432 = 0; local432 < local208.length; local432++) {
							...
							if (local773 == null) {
								...
								local149.pushNode(new Class2_Sub9(local430[local432]), local488);
							} else {
								local430[local432] = ((Class2_Sub9) local773).aShort20;
								local398 = local430[local432] & 0xFFFF;
								if (local458 != -1 && local180[local432].nodeId < local141[local398].nodeId) {
									local141[local398] = local180[local432];
								}
							}
					...
					if (local1145 != null) {
						...
						while (local1151 < local1145.length) {
							...
							if (local1184 != null) {
								...
								if (local1190 == null || local1184.nodeId < local1190.nodeId) {
									local1190 = local1184;
								}
							}
							if (local1188 != null) {
								local1188.method5567(local1149, local155, local161);
								if (local1190 == null || local1188.nodeId < local1190.nodeId) {
									local1190 = local1188;
								}
							}
							if (local1190 != null) {
			...
			for (@Pc(1359) int local1359 = 0; local1359 < this.aClass2_Sub36Array1.length; local1359++) {
				...
				local1357[local1359] = local1369.nodeId;
	...
	@OriginalMember(owner = "com.jagex.client!ah", name = "a", descriptor = "(Lclient!of;[I)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!ah", name = "a", descriptor = "(IILclient!kb;)Lclient!kb;")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!ah", name = "a", descriptor = "(IIIIIII[[Z)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!ah", name = "a", descriptor = "(Lclient!kb;IIIIZ)V")
	@Override
