...
@OriginalClass("com.jagex.client!fs")
public final class Class76 {

	@OriginalMember(owner = "com.jagex.client!fs", name = "b", descriptor = "Lclient!vk;")
	public Class8_Sub4 aClass8_Sub4_1 = null;

	@OriginalMember(owner = "com.jagex.client!fs", name = "d", descriptor = "[Lclient!al;")
	public Class8_Sub1[] aClass8_Sub1Array1 = null;

	@OriginalMember(owner = "com.jagex.client!fs", name = "e", descriptor = "[Lclient!al;")
	public Class8_Sub1[] aClass8_Sub1Array2 = null;

	@OriginalMember(owner = "com.jagex.client!fs", name = "f", descriptor = "Lclient!vk;")
	public Class8_Sub4 aClass8_Sub4_2 = null;

	@OriginalMember(owner = "com.jagex.client!fs", name = "g", descriptor = "Z")
	public final boolean aBoolean160;

	@OriginalMember(owner = "com.jagex.client!fs", name = "<init>", descriptor = "(Lclient!bf;)V")
