...
@OriginalClass("com.jagex.client!ng")
public final class SkyboxSphereTypeList {

	@OriginalMember(owner = "com.jagex.client!ng", name = "f", descriptor = "Lclient!hu;")
	private final LruHashTable aClass98_35 = new LruHashTable(16);

	@OriginalMember(owner = "com.jagex.client!ng", name = "a", descriptor = "Lclient!r;")
	private final Js5 aClass197_62;

	@OriginalMember(owner = "com.jagex.client!ng", name = "<init>", descriptor = "(Lclient!dn;ILclient!r;)V")
	...
	@OriginalMember(owner = "com.jagex.client!ng", name = "a", descriptor = "(IZ)V")
	...
	@OriginalMember(owner = "com.jagex.client!ng", name = "a", descriptor = "(B)V")
	...
	@OriginalMember(owner = "com.jagex.client!ng", name = "b", descriptor = "(II)Lclient!ie;")
	public SkyboxSphereType method4031(@OriginalArg(0) int arg0) {
		...
		@Pc(38) byte[] local38 = this.aClass197_62.getfile(arg0, 30);
	...
	@OriginalMember(owner = "com.jagex.client!ng", name = "b", descriptor = "(B)V")
