...
public final class Static222 {
	...
	@OriginalMember(owner = "com.jagex.client!ms", name = "t", descriptor = "I")
	public static int anInt3949;

	@OriginalMember(owner = "com.jagex.client!ms", name = "l", descriptor = "I")
	public static int anInt3944 = 0;

	@OriginalMember(owner = "com.jagex.client!ms", name = "a", descriptor = "(IB)Z")
		...
		if (Static128.aBooleanArray21[arg0]) {
			...
			for (@Pc(45) int local45 = 0; local45 < local23; local45++) {
				if (Static26.components[arg0][local45] == null) {
					@Pc(59) byte[] local59 = Static283.aClass197_68.getfile(local45, arg0);
					if (local59 != null) {
	...
	@OriginalMember(owner = "com.jagex.client!ms", name = "b", descriptor = "(I)V")
