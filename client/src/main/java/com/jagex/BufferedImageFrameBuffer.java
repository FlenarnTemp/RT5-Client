...
@OriginalClass("com.jagex.client!rg")
public final class BufferedImageFrameBuffer extends FrameBuffer {

	@OriginalMember(owner = "com.jagex.client!rg", name = "j", descriptor = "Ljava/awt/Canvas;")
	private Canvas aCanvas5;

	@OriginalMember(owner = "com.jagex.client!rg", name = "k", descriptor = "Ljava/awt/Rectangle;")
	private Rectangle aRectangle1;

	@OriginalMember(owner = "com.jagex.client!rg", name = "l", descriptor = "Ljava/awt/Image;")
	private Image anImage3;

	@OriginalMember(owner = "com.jagex.client!rg", name = "m", descriptor = "Ljava/awt/Shape;")
	private Shape aShape1;

	@OriginalMember(owner = "com.jagex.client!rg", name = "a", descriptor = "(Ljava/awt/Canvas;B)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!rg", name = "a", descriptor = "(Ljava/awt/Graphics;III)V")
	@Override
	public void method5152(@OriginalArg(0) Graphics arg0) {
		arg0.drawImage(this.anImage3, 0, 0, this.aCanvas5);
	}

	@OriginalMember(owner = "com.jagex.client!rg", name = "a", descriptor = "(IIIILjava/awt/Graphics;I)V")
	@Override
