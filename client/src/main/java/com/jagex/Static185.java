...
public final class Static185 {
	...
	@OriginalMember(owner = "com.jagex.client!kn", name = "a", descriptor = "(IIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!kn", name = "a", descriptor = "(BILclient!bc;I)Lclient!js;")
	public static Class2_Sub2_Sub11 method3399(@OriginalArg(1) int arg0, @OriginalArg(2) Class16 arg1, @OriginalArg(3) int arg2) {
		...
		@Pc(39) byte[] local39 = client.jsArchive12.method5082(client.jsArchive12.getGroupId(local10));
		if (local39 == null) {
			...
			local39 = client.jsArchive12.method5082(client.jsArchive12.getGroupId(local10));
			if (local39 == null) {
	...
	@OriginalMember(owner = "com.jagex.client!kn", name = "a", descriptor = "(IIIIBII)V")
	public static void method3400(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
		@Pc(8) Component local8 = InterfaceList.getCreatedComponent(arg2, arg3);
		if (local8 == null) {
			return;
		}
		if (local8.onTargetEnter != null) {
			@Pc(18) HookRequest local18 = new HookRequest();
			local18.source = local8;
			local18.anObjectArray4 = local8.onTargetEnter;
	...
	@OriginalMember(owner = "com.jagex.client!kn", name = "a", descriptor = "(IIIIIII)V")
