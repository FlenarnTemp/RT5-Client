...
public class WorldMap {
	...
	@OriginalMember(owner = "com.jagex.client!i", name = "V", descriptor = "Lclient!ad;")
	public static final HashTable visibleMapElementCategories = new HashTable(8);
	@OriginalMember(owner = "com.jagex.client!mq", name = "p", descriptor = "Lclient!ad;")
	public static final HashTable visibleMapElementIds = new HashTable(8);
	@OriginalMember(owner = "com.jagex.client!cl", name = "A", descriptor = "I")
	public static int anInt1105;
	@OriginalMember(owner = "com.jagex.client!vl", name = "hb", descriptor = "I")
	public static int anInt6930;
	@OriginalMember(owner = "com.jagex.client!im", name = "D", descriptor = "I")
	public static int anInt2772;
	@OriginalMember(owner = "com.jagex.client!fj", name = "g", descriptor = "I")
	public static int anInt2003;
	@OriginalMember(owner = "com.jagex.client!uo", name = "u", descriptor = "I")
	public static int loadPercentage = 0;
	@OriginalMember(owner = "com.jagex.client!nb", name = "C", descriptor = "Lclient!nk;")
	public static Component aClass161_11;
	@OriginalMember(owner = "com.jagex.client!kc", name = "a", descriptor = "Z")
	public static boolean aBoolean225 = false;
	@OriginalMember(owner = "com.jagex.client!tt", name = "a", descriptor = "Lclient!vj;")
	public static Map currentMap;
	@OriginalMember(owner = "com.jagex.client!tt", name = "E", descriptor = "I")
	public static int originX;
	@OriginalMember(owner = "com.jagex.client!tt", name = "B", descriptor = "I")
	public static int originZ;

	@OriginalMember(owner = "com.jagex.client!mh", name = "a", descriptor = "(II)V")
	...
	@OriginalMember(owner = "com.jagex.client!tg", name = "f", descriptor = "(I)I")
	...
	@OriginalMember(owner = "com.jagex.client!oo", name = "a", descriptor = "(ZIIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!me", name = "b", descriptor = "(I)Lclient!jg;")
	...
	@OriginalMember(owner = "com.jagex.client!gn", name = "e", descriptor = "(I)Lclient!jg;")
	...
	@OriginalMember(owner = "com.jagex.client!wa", name = "a", descriptor = "(I)Lclient!vj;")
	public static Map getCurrentMap() {
		return currentMap;
	}

	@OriginalMember(owner = "com.jagex.client!ar", name = "b", descriptor = "(IIB)V")
	...
	@OriginalMember(owner = "com.jagex.client!n", name = "a", descriptor = "(II)V")
	...
	@OriginalMember(owner = "com.jagex.client!ng", name = "a", descriptor = "(BI)V")
