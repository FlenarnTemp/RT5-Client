...
public final class Static129 {
	...
	@OriginalMember(owner = "com.jagex.client!hg", name = "d", descriptor = "I")
	public static int anInt2458;

	@OriginalMember(owner = "com.jagex.client!hg", name = "f", descriptor = "I")
	public static int anInt2460 = -1;

	@OriginalMember(owner = "com.jagex.client!hg", name = "j", descriptor = "Lclient!ld;")
	public static final LinkedList aClass135_19 = new LinkedList();

	@OriginalMember(owner = "com.jagex.client!hg", name = "m", descriptor = "Lclient!ld;")
	public static final LinkedList spotAnims = new LinkedList();

	@OriginalMember(owner = "com.jagex.client!hg", name = "a", descriptor = "(IIZII)V")
	...
	@OriginalMember(owner = "com.jagex.client!hg", name = "a", descriptor = "(IIZBI)V")
	...
	@OriginalMember(owner = "com.jagex.client!hg", name = "a", descriptor = "(I)Lclient!gg;")
	...
	@OriginalMember(owner = "com.jagex.client!hg", name = "a", descriptor = "(IIBI)V")
	...
	@OriginalMember(owner = "com.jagex.client!hg", name = "b", descriptor = "(I)V")
