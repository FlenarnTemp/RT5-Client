...
@OriginalClass("com.jagex.client!bh")
public final class Environment {

	@OriginalMember(owner = "com.jagex.client!bh", name = "a", descriptor = "F")
	public float aFloat22 = 1.0F;

	@OriginalMember(owner = "com.jagex.client!bh", name = "q", descriptor = "F")
	public float aFloat26 = 0.25F;

	@OriginalMember(owner = "com.jagex.client!bh", name = "r", descriptor = "F")
	public float aFloat27 = 1.0F;

	@OriginalMember(owner = "com.jagex.client!bh", name = "l", descriptor = "I")
	public final int anInt636;

	@OriginalMember(owner = "com.jagex.client!bh", name = "e", descriptor = "I")
	public final int anInt632;

	@OriginalMember(owner = "com.jagex.client!bh", name = "t", descriptor = "I")
	public final int anInt641;

	@OriginalMember(owner = "com.jagex.client!bh", name = "h", descriptor = "I")
	public final int anInt634;

	@OriginalMember(owner = "com.jagex.client!bh", name = "n", descriptor = "I")
	public final int anInt637;

	@OriginalMember(owner = "com.jagex.client!bh", name = "s", descriptor = "I")
	public final int anInt640;

	@OriginalMember(owner = "com.jagex.client!bh", name = "k", descriptor = "Lclient!rc;")
	public final Class42 aClass42_1;

	@OriginalMember(owner = "com.jagex.client!bh", name = "c", descriptor = "F")
	public final float aFloat23;

	@OriginalMember(owner = "com.jagex.client!bh", name = "g", descriptor = "F")
	public final float aFloat24;

	@OriginalMember(owner = "com.jagex.client!bh", name = "i", descriptor = "F")
	public final float aFloat25;

	@OriginalMember(owner = "com.jagex.client!bh", name = "<init>", descriptor = "()V")
	public Environment() {
		this.anInt636 = -60;
		this.anInt632 = -50;
	...
	@OriginalMember(owner = "com.jagex.client!bh", name = "<init>", descriptor = "(Lclient!bt;)V")
	...
	@OriginalMember(owner = "com.jagex.client!bh", name = "a", descriptor = "(ILclient!bt;)V")
	...
	@OriginalMember(owner = "com.jagex.client!bh", name = "a", descriptor = "(BLclient!bh;)Z")
