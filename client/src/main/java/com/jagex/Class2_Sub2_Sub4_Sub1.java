...
@OriginalClass("com.jagex.client!cs")
public final class Class2_Sub2_Sub4_Sub1 extends Class2_Sub2_Sub4 {

	@OriginalMember(owner = "com.jagex.client!cs", name = "F", descriptor = "I")
	public int anInt1302;

	@OriginalMember(owner = "com.jagex.client!cs", name = "J", descriptor = "I")
	public int anInt1303;

	@OriginalMember(owner = "com.jagex.client!cs", name = "K", descriptor = "I")
	public int anInt1304;

	@OriginalMember(owner = "com.jagex.client!cs", name = "L", descriptor = "I")
	public int anInt1305;

	@OriginalMember(owner = "com.jagex.client!cs", name = "M", descriptor = "[B")
	public final byte[] aByteArray14;

	@OriginalMember(owner = "com.jagex.client!cs", name = "<init>", descriptor = "(Lclient!bf;II)V")
	...
	@OriginalMember(owner = "com.jagex.client!cs", name = "a", descriptor = "(IZIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!cs", name = "a", descriptor = "(IIIIIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!cs", name = "a", descriptor = "(IIZ)Z")
	public boolean method1514(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return this.aByteArray14.length >= arg0 * arg1;
	}

	@OriginalMember(owner = "com.jagex.client!cs", name = "d", descriptor = "(B)V")
