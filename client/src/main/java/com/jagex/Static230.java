...
public final class Static230 {
	...
	@OriginalMember(owner = "com.jagex.client!ne", name = "t", descriptor = "[[[B")
	public static byte[][][] aByteArrayArrayArray13;

	@OriginalMember(owner = "com.jagex.client!ne", name = "B", descriptor = "[Lclient!jd;")
	public static Sprite[] aClass13Array16;

	@OriginalMember(owner = "com.jagex.client!ne", name = "a", descriptor = "(IIIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!ne", name = "b", descriptor = "(IIIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!ne", name = "a", descriptor = "(IIIIIIIILclient!dg;II)Z")
	public static boolean method4017(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) CollisionMap arg7, @OriginalArg(9) int arg8, @OriginalArg(10) int arg9) {
