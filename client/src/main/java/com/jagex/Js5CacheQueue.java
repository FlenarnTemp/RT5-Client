...
@OriginalClass("com.jagex.client!ro")
public final class Js5CacheQueue implements Runnable {

	@OriginalMember(owner = "com.jagex.client!ro", name = "c", descriptor = "Lclient!wc;")
	private final SecondaryLinkedList aClass246_9 = new SecondaryLinkedList();

	@OriginalMember(owner = "com.jagex.client!ro", name = "j", descriptor = "Z")
	private boolean aBoolean404 = false;

	@OriginalMember(owner = "com.jagex.client!ro", name = "k", descriptor = "I")
	public int anInt5741 = 0;

	@OriginalMember(owner = "com.jagex.client!ro", name = "i", descriptor = "Ljava/lang/Thread;")
	private Thread aThread3;

	@OriginalMember(owner = "com.jagex.client!ro", name = "<init>", descriptor = "(Lclient!ml;)V")
	...
	@OriginalMember(owner = "com.jagex.client!ro", name = "run", descriptor = "()V")
	@Override
	public void run() {
		while (!this.aBoolean404) {
			...
			try {
				...
				TracingException.report(local74, null);
			}
			local14.incomplete = false;
		}
	}

	@OriginalMember(owner = "com.jagex.client!ro", name = "a", descriptor = "(BLclient!td;)V")
	...
	@OriginalMember(owner = "com.jagex.client!ro", name = "a", descriptor = "(IBLclient!rq;)Lclient!td;")
	...
	@OriginalMember(owner = "com.jagex.client!ro", name = "a", descriptor = "(ILclient!rq;Z)Lclient!td;")
	...
	@OriginalMember(owner = "com.jagex.client!ro", name = "a", descriptor = "(Z)V")
	...
	@OriginalMember(owner = "com.jagex.client!ro", name = "a", descriptor = "([BILclient!rq;I)Lclient!td;")
