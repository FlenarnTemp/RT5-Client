...
@OriginalClass("com.jagex.client!wk")
public final class SynthSound {

	@OriginalMember(owner = "com.jagex.client!wk", name = "b", descriptor = "[Lclient!ph;")
	private final SynthInstrument[] instruments = new SynthInstrument[10];

	@OriginalMember(owner = "com.jagex.client!wk", name = "c", descriptor = "I")
	private int start;

	@OriginalMember(owner = "com.jagex.client!wk", name = "a", descriptor = "I")
	private int end;

	@OriginalMember(owner = "com.jagex.client!wk", name = "<init>", descriptor = "(Lclient!bt;)V")
	...
	@OriginalMember(owner = "com.jagex.client!wk", name = "a", descriptor = "(Lclient!r;II)Lclient!wk;")
	...
	@OriginalMember(owner = "com.jagex.client!wk", name = "a", descriptor = "()[B")
	...
	@OriginalMember(owner = "com.jagex.client!wk", name = "b", descriptor = "()Lclient!jn;")
