...
@OriginalClass("com.jagex.client!mo")
public class Class29 {

	@OriginalMember(owner = "com.jagex.client!mo", name = "i", descriptor = "[[[B")
	public byte[][][] aByteArrayArrayArray11;

	@OriginalMember(owner = "com.jagex.client!mo", name = "e", descriptor = "Lclient!vq;")
	private final FloorUnderlayTypeList aClass241_2;

	@OriginalMember(owner = "com.jagex.client!mo", name = "p", descriptor = "Z")
	public final boolean aBoolean73;

	@OriginalMember(owner = "com.jagex.client!mo", name = "m", descriptor = "I")
	protected final int anInt900;

	@OriginalMember(owner = "com.jagex.client!mo", name = "z", descriptor = "I")
	protected final int anInt911;

	@OriginalMember(owner = "com.jagex.client!mo", name = "A", descriptor = "I")
	public final int anInt912;

	@OriginalMember(owner = "com.jagex.client!mo", name = "k", descriptor = "Lclient!fl;")
	private final FloorOverlayTypeList aClass72_2;

	@OriginalMember(owner = "com.jagex.client!mo", name = "a", descriptor = "[[[B")
	private final byte[][][] aByteArrayArrayArray7;

	@OriginalMember(owner = "com.jagex.client!mo", name = "w", descriptor = "[[[B")
	private final byte[][][] aByteArrayArrayArray12;

	@OriginalMember(owner = "com.jagex.client!mo", name = "b", descriptor = "[[[B")
	private final byte[][][] aByteArrayArrayArray8;

	@OriginalMember(owner = "com.jagex.client!mo", name = "l", descriptor = "[[[I")
	public final int[][][] levelHeightmap;

	@OriginalMember(owner = "com.jagex.client!mo", name = "h", descriptor = "[[[B")
	private final byte[][][] aByteArrayArrayArray10;

	@OriginalMember(owner = "com.jagex.client!mo", name = "d", descriptor = "[[[B")
	protected byte[][][] levelOccludemap;

	@OriginalMember(owner = "com.jagex.client!mo", name = "<init>", descriptor = "(IIIZLclient!fl;Lclient!vq;)V")
	protected Class29(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) FloorOverlayTypeList arg4, @OriginalArg(5) FloorUnderlayTypeList arg5) {
	...
	@OriginalMember(owner = "com.jagex.client!io", name = "a", descriptor = "(ZZ)Z")
	public static boolean or(@OriginalArg(0) boolean a, @OriginalArg(1) boolean b) {
		return a | b;
	}

	@OriginalMember(owner = "com.jagex.client!mo", name = "a", descriptor = "(B[[[I[Lclient!dg;Lclient!wm;)V")
	public final void method1085(@OriginalArg(1) int[][][] arg0, @OriginalArg(2) CollisionMap[] arg1, @OriginalArg(3) Renderer arg2) {
		@Pc(6) int local6;
		@Pc(10) int local10;
		@Pc(14) int local14;
		if (!this.aBoolean73) {
	...
	@OriginalMember(owner = "com.jagex.client!mo", name = "a", descriptor = "(Lclient!tf;[[ILclient!tf;Lclient!wm;IILclient!tf;)V")
	private void method1086(@OriginalArg(0) Class6 arg0, @OriginalArg(1) int[][] arg1, @OriginalArg(2) Class6 arg2, @OriginalArg(3) Renderer arg3, @OriginalArg(4) int arg4, @OriginalArg(6) Class6 arg5) {
		for (@Pc(7) int local7 = 0; local7 < this.anInt900; local7++) {
			for (@Pc(11) int local11 = 0; local11 < this.anInt911; local11++) {
				if (Static158.anInt2911 == -1 || Static142.method2661(local11, Static158.anInt2911, arg4, local7)) {
					...
					@Pc(82) FloorOverlayType local82 = local54 == 0 ? null : this.aClass72_2.get(local54 - 1);
					@Pc(97) FloorUnderlayType local97 = local65 == 0 ? null : this.aClass241_2.method6271(local65 - 1);
					@Pc(99) int local99 = 0;
					...
					if (local139 != 0) {
						...
						if (local97 == null) {
							...
							local181 = local97.material;
							if (Static141.aBoolean190) {
								local181 = -1;
							}
							for (local187 = 0; local187 < local99; local187++) {
								local152[local141] = local181;
								local155[local141] = local97.materialscale;
	...
	@OriginalMember(owner = "com.jagex.client!mo", name = "a", descriptor = "(I[Lclient!dg;ILclient!bt;III)V")
	...
	@OriginalMember(owner = "com.jagex.client!mo", name = "a", descriptor = "(IIIZIIZLclient!bt;III)V")
		...
		while (true) {
			...
			if (local69 <= 49) {
				if (arg3) {
					...
					this.aByteArrayArrayArray10[arg8][arg4][arg0] = arg6.g1b();
	...
	@OriginalMember(owner = "com.jagex.client!mo", name = "a", descriptor = "(IILclient!bt;[Lclient!dg;IIIIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!mo", name = "a", descriptor = "(IIIBII)V")
	...
	@OriginalMember(owner = "com.jagex.client!mo", name = "a", descriptor = "(Lclient!tf;ILclient!wm;Lclient!tf;)V")
	public final void method1093(@OriginalArg(0) Class6 arg0, @OriginalArg(2) Renderer arg1, @OriginalArg(3) Class6 arg2) {
			...
			for (@Pc(89) int local89 = -5; local89 < this.anInt900; local89++) {
				...
				for (@Pc(93) int local93 = 0; local93 < this.anInt911; local93++) {
					...
					if (this.anInt900 > local99) {
						...
						if (local118 > 0) {
							@Pc(128) FloorUnderlayType local128 = this.aClass241_2.method6271(local118 - 1);
							Static65.anIntArray110[local93] += local128.hue;
							Static274.anIntArray352[local93] += local128.anInt6379;
							Static322.anIntArray404[local93] += local128.anInt6381;
							Static375.anIntArray481[local93] += local128.chroma;
					...
					if (local118 >= 0) {
						...
						if (local187 > 0) {
							@Pc(199) FloorUnderlayType local199 = this.aClass241_2.method6271(local187 - 1);
							Static65.anIntArray110[local93] -= local199.hue;
							Static274.anIntArray352[local93] -= local199.anInt6379;
							Static322.anIntArray404[local93] -= local199.anInt6381;
							Static375.anIntArray481[local93] -= local199.chroma;
							local164 = Static332.anIntArray428[local93]--;
						}
					}
				}
	...
	@OriginalMember(owner = "com.jagex.client!mo", name = "a", descriptor = "(Lclient!tq;Lclient!mg;II[[B[ZILclient!wm;III[[BI[[B)V")
	private void method1095(@OriginalArg(0) FloorUnderlayType arg0, @OriginalArg(1) FloorOverlayType arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) byte[][] arg4, @OriginalArg(5) boolean[] arg5, @OriginalArg(6) int arg6, @OriginalArg(7) Renderer arg7, @OriginalArg(9) int arg8, @OriginalArg(10) int arg9, @OriginalArg(11) byte[][] arg10, @OriginalArg(12) int arg11, @OriginalArg(13) byte[][] arg12) {
		@Pc(49) int local49;
		if (arg1 != null && arg0 != null || arg0 != null && arg6 == 12 || arg1 != null && arg6 == 0) {
			...
			@Pc(59) FloorOverlayType local59;
			@Pc(76) byte local76;
			@Pc(92) int local92;
			@Pc(99) int local99;
			if (arg2 > 0) {
	...
	@OriginalMember(owner = "com.jagex.client!mo", name = "a", descriptor = "(IZ[[I)V")
	...
	@OriginalMember(owner = "com.jagex.client!mo", name = "a", descriptor = "(IIIBI)V")
	...
	@OriginalMember(owner = "com.jagex.client!mo", name = "a", descriptor = "(IILclient!wm;Lclient!tf;Lclient!tf;Lclient!tf;[[I)V")
	private void method1099(@OriginalArg(1) int arg0, @OriginalArg(2) Renderer arg1, @OriginalArg(3) Class6 arg2, @OriginalArg(4) Class6 arg3, @OriginalArg(5) Class6 arg4, @OriginalArg(6) int[][] arg5) {
			...
			for (@Pc(51) int local51 = 0; local51 < this.anInt911; local51++) {
				...
				if (Static158.anInt2911 == -1 || Static142.method2661(local51, Static158.anInt2911, arg0, local35)) {
					...
					if (local104 != 0 || local112 != 0) {
						@Pc(158) FloorOverlayType local158 = local104 == 0 ? null : this.aClass72_2.get(local104 - 1);
						if (local90 == 0 && local158 == null) {
							local90 = 12;
						}
						@Pc(179) FloorUnderlayType local179 = local112 == 0 ? null : this.aClass241_2.method6271(local112 - 1);
						@Pc(181) FloorOverlayType local181 = local158;
						if (local158 != null) {
						...
						if (local903 <= 0) {
							...
							if (local158 != null) {
								...
								if (local90 != 12 && local158.baseColor != -1 && local158.hardshadow) {
									local79 = true;
								}
							} else if (local798) {
							...
							if (local179 != null) {
								...
								@Pc(1581) FloorUnderlayType local1581 = this.aClass241_2.method6271(local112 - 1);
								@Pc(1589) FloorUnderlayType local1589 = this.aClass241_2.method6271(local120 - 1);
								@Pc(1597) FloorUnderlayType local1597 = this.aClass241_2.method6271(local128 - 1);
								@Pc(1605) FloorUnderlayType local1605 = this.aClass241_2.method6271(local136 - 1);
									...
									for (local1286 = 0; local1286 < local1134; local1286++) {
										...
										if (local1302 < 8 && Static6.anIntArray4[local1290] >= 0) {
											...
											if (local81 && Static375.aBooleanArrayArray6[local90][local1302]) {
												...
												local958[local935] = local1581.material;
												local961[local935] = local1581.materialscale;
											} else if (local1354 == 0 && local1875 == 128) {
												local955[local935] = arg5[local35][local65];
												local958[local935] = local1589.material;
												local961[local935] = local1589.materialscale;
											} else if (local1354 == 128 && local1875 == 128) {
												local955[local935] = arg5[local49][local65];
												local958[local935] = local1597.material;
												local961[local935] = local1597.materialscale;
											} else if (local1354 == 128 && local1875 == 0) {
												local955[local935] = arg5[local49][local51];
												local958[local935] = local1605.material;
												local961[local935] = local1605.materialscale;
											} else {
												if (local1354 < 64) {
													if (local1875 < 64) {
														local958[local935] = local1581.material;
								...
								if (local90 != 0 && local179.hardshadow) {
									local79 = true;
								}
							}
