...
@OriginalClass("com.jagex.client!he")
public final class Class42_Sub1_Sub2 extends Class42_Sub1 {

	@OriginalMember(owner = "com.jagex.client!he", name = "k", descriptor = "Lclient!qd;")
	private Class8_Sub3 aClass8_Sub3_2;

	@OriginalMember(owner = "com.jagex.client!he", name = "n", descriptor = "I")
	private final int anInt2441;

	@OriginalMember(owner = "com.jagex.client!he", name = "o", descriptor = "I")
	private final int anInt2442;

	@OriginalMember(owner = "com.jagex.client!he", name = "l", descriptor = "I")
	private final int anInt2440;

	@OriginalMember(owner = "com.jagex.client!he", name = "i", descriptor = "I")
	private final int anInt2438;

	@OriginalMember(owner = "com.jagex.client!he", name = "r", descriptor = "Lclient!bf;")
	private final Class19_Sub1 aClass19_Sub1_12;

	@OriginalMember(owner = "com.jagex.client!he", name = "j", descriptor = "I")
	private final int anInt2439;

	@OriginalMember(owner = "com.jagex.client!he", name = "p", descriptor = "I")
	private final int anInt2443;

	@OriginalMember(owner = "com.jagex.client!he", name = "<init>", descriptor = "(Lclient!bf;IIIIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!he", name = "b", descriptor = "(I)Lclient!qd;")
	@Override
