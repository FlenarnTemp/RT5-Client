...
@OriginalClass("com.jagex.client!db")
public final class Class15_Sub2 extends Class15 {

	@OriginalMember(owner = "com.jagex.client!db", name = "k", descriptor = "I")
	private int anInt1415 = 0;

	@OriginalMember(owner = "com.jagex.client!db", name = "r", descriptor = "Lclient!hc;")
	private final Class90 aClass90_1 = new Class90();

	@OriginalMember(owner = "com.jagex.client!db", name = "a", descriptor = "(ILclient!f;)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!db", name = "d", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!db", name = "a", descriptor = "(Lclient!f;B)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!db", name = "a", descriptor = "(BI)V")
	@Override
	public void method1582(@OriginalArg(1) int arg0) {
	}

	@OriginalMember(owner = "com.jagex.client!db", name = "a", descriptor = "(Lclient!f;I)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!db", name = "a", descriptor = "(II)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!db", name = "a", descriptor = "(Lclient!tf;ZFII)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!db", name = "c", descriptor = "(I)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!db", name = "b", descriptor = "(I)V")
	@Override
