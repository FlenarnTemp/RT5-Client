...
public final class Static310 {
	...
	@OriginalMember(owner = "com.jagex.client!rt", name = "h", descriptor = "[[[I")
	public static int[][][] anIntArrayArrayArray12;

	@OriginalMember(owner = "com.jagex.client!rt", name = "g", descriptor = "[Lclient!pr;")
	public static final Class185[] aClass185Array1 = new Class185[4];

	@OriginalMember(owner = "com.jagex.client!rt", name = "a", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!rt", name = "a", descriptor = "(IIILclient!id;)J")
