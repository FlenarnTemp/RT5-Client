...
public class QuickChatCatTypeList {
	...
	@OriginalMember(owner = "com.jagex.client!on", name = "e", descriptor = "Lclient!jm;")
	public static final Class116 aClass116_5 = new Class116(64);
	@OriginalMember(owner = "com.jagex.client!ck", name = "U", descriptor = "Lclient!r;")
	public static Js5 aClass197_7;
	@OriginalMember(owner = "com.jagex.client!vj", name = "ab", descriptor = "Lclient!r;")
	public static Js5 aClass197_92;

	@OriginalMember(owner = "com.jagex.client!gp", name = "a", descriptor = "(Lclient!r;Lclient!r;Z)V")
	public static void init(@OriginalArg(0) Js5 arg0, @OriginalArg(1) Js5 arg1) {
		aClass197_7 = arg1;
		aClass197_92 = arg0;
	}

	@OriginalMember(owner = "com.jagex.client!hr", name = "c", descriptor = "(II)Lclient!mn;")
	public static QuickChatCatType get(@OriginalArg(1) int arg0) {
		...
		@Pc(25) byte[] local25;
		if (arg0 >= 32768) {
			local25 = aClass197_7.getfile(arg0 & 0x7FFF, 0);
		} else {
			local25 = aClass197_92.getfile(arg0, 0);
		}
