...
@OriginalClass("com.jagex.client!hh")
public final class MaterialRenderer4 extends MaterialRenderer {

	@OriginalMember(owner = "com.jagex.client!hh", name = "e", descriptor = "Lclient!rj;")
	private Class203 aClass203_2;

	@OriginalMember(owner = "com.jagex.client!hh", name = "c", descriptor = "Lclient!fs;")
	private final Class76 aClass76_2;

	@OriginalMember(owner = "com.jagex.client!hh", name = "d", descriptor = "Lclient!ht;")
	private final Class8_Sub2 aClass8_Sub2_1;

	@OriginalMember(owner = "com.jagex.client!hh", name = "<init>", descriptor = "(Lclient!bf;Lclient!fs;)V")
	...
	@OriginalMember(owner = "com.jagex.client!hh", name = "b", descriptor = "(Z)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!hh", name = "a", descriptor = "()Z")
	@Override
	public boolean method5711() {
		return true;
	}

	@OriginalMember(owner = "com.jagex.client!hh", name = "a", descriptor = "(Z)V")
	@Override
	public void method5713(@OriginalArg(0) boolean arg0) {
		this.aClass19_Sub1_35.method794(260, 8448);
	}

	@OriginalMember(owner = "com.jagex.client!hh", name = "c", descriptor = "()V")
	...
	@OriginalMember(owner = "com.jagex.client!hh", name = "a", descriptor = "(I)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!hh", name = "b", descriptor = "()V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!hh", name = "a", descriptor = "(Lclient!kq;)V")
	@Override
