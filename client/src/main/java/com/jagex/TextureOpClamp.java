...
@OriginalClass("com.jagex.client!i")
public final class TextureOpClamp extends TextureOp {

	@OriginalMember(owner = "com.jagex.client!i", name = "O", descriptor = "I")
	private int anInt2646 = 4096;

	@OriginalMember(owner = "com.jagex.client!i", name = "S", descriptor = "I")
	private int anInt2649 = 0;

	@OriginalMember(owner = "com.jagex.client!i", name = "<init>", descriptor = "()V")
	public TextureOpClamp() {
		super(1, false);
	}

	@OriginalMember(owner = "com.jagex.client!i", name = "b", descriptor = "(IB)[[I")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!i", name = "a", descriptor = "(BI)[I")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!i", name = "a", descriptor = "(ILclient!bt;I)V")
	@Override
	public void decode(@OriginalArg(0) int code, @OriginalArg(1) Packet buf) {
		if (code == 0) {
			this.anInt2649 = buf.g2();
		} else if (code == 1) {
			this.anInt2646 = buf.g2();
		} else if (code == 2) {
