...
public final class Static214 {
	...
	@OriginalMember(owner = "com.jagex.client!mk", name = "b", descriptor = "I")
	public static int anInt3792 = -1;

	@OriginalMember(owner = "com.jagex.client!mk", name = "c", descriptor = "I")
	public static int anInt3793 = 0;

	@OriginalMember(owner = "com.jagex.client!mk", name = "a", descriptor = "([BI)Lclient!js;")
	public static Class2_Sub2_Sub11 method3745(@OriginalArg(0) byte[] arg0) {
		...
		if (local74 > 0) {
			...
			for (local85 = 0; local85 < local74; local85++) {
				local91 = local21.g2();
				@Pc(98) HashTable local98 = new HashTable(Static162.bitCeil(local91));
				local16.aClass4Array1[local85] = local98;
				while (local91-- > 0) {
					@Pc(109) int local109 = local21.g4();
					@Pc(115) int local115 = local21.g4();
					local98.pushNode(new IntWrapper(local115), (long) local109);
				}
			}
		}
		local21.pos = 0;
