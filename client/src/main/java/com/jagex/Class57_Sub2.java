...
@OriginalClass("com.jagex.client!fp")
public class Class57_Sub2 extends Class57 {

	@OriginalMember(owner = "com.jagex.client!fp", name = "p", descriptor = "I")
	private int anInt3588;

	@OriginalMember(owner = "com.jagex.client!fp", name = "t", descriptor = "[B")
	private byte[] subData;

	@OriginalMember(owner = "com.jagex.client!fp", name = "v", descriptor = "I")
	private int anInt3593;

	@OriginalMember(owner = "com.jagex.client!fp", name = "x", descriptor = "I")
	private int writerIndex;

	@OriginalMember(owner = "com.jagex.client!fp", name = "E", descriptor = "I")
	private int anInt3599;

	@OriginalMember(owner = "com.jagex.client!fp", name = "F", descriptor = "I")
	private final int anInt3600;

	@OriginalMember(owner = "com.jagex.client!fp", name = "y", descriptor = "I")
	private final int anInt3596;

	@OriginalMember(owner = "com.jagex.client!fp", name = "q", descriptor = "I")
	private final int anInt3589;

	@OriginalMember(owner = "com.jagex.client!fp", name = "o", descriptor = "I")
	private int anInt3587;

	@OriginalMember(owner = "com.jagex.client!fp", name = "<init>", descriptor = "(IIIIIFFF)V")
	...
	@OriginalMember(owner = "com.jagex.client!fp", name = "a", descriptor = "(Z)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!fp", name = "a", descriptor = "(I)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!fp", name = "a", descriptor = "(III)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!fp", name = "a", descriptor = "(IB)V")
