...
@OriginalClass("com.jagex.client!we")
public final class Class2_Sub41 extends Node {

	@OriginalMember(owner = "com.jagex.client!we", name = "u", descriptor = "[I")
	public int[] anIntArray488 = new int[1];

	@OriginalMember(owner = "com.jagex.client!we", name = "x", descriptor = "[I")
	...
	@OriginalMember(owner = "com.jagex.client!we", name = "a", descriptor = "([II[IZI)J")
