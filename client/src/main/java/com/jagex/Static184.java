...
public final class Static184 {
	...
	@OriginalMember(owner = "com.jagex.client!km", name = "k", descriptor = "I")
	public static int anInt3435;

	@OriginalMember(owner = "com.jagex.client!km", name = "l", descriptor = "F")
	public static float aFloat39 = 0.0F;

	@OriginalMember(owner = "com.jagex.client!km", name = "m", descriptor = "I")
	public static int anInt3436 = -1;

	@OriginalMember(owner = "com.jagex.client!km", name = "a", descriptor = "(ZLclient!nh;I)V")
