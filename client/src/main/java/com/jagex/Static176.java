...
public final class Static176 {
	...
	@OriginalMember(owner = "com.jagex.client!kd", name = "c", descriptor = "[I")
	private static final int[] anIntArray202 = new int[1];

	@OriginalMember(owner = "com.jagex.client!kd", name = "a", descriptor = "(Lclient!bf;ILjava/lang/String;)Lclient!kd;")
