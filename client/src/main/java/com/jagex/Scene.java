...
public class Scene {
	...
	@OriginalMember(owner = "com.jagex.client!oc", name = "b", descriptor = "[Lclient!ec;")
	public static Occluder[] levelOccluders;

	@OriginalMember(owner = "com.jagex.client!so", name = "g", descriptor = "I")
	public static int scale;
	@OriginalMember(owner = "com.jagex.client!pe", name = "R", descriptor = "I")
	public static int levelOccluderCount;
	@OriginalMember(owner = "com.jagex.client!om", name = "A", descriptor = "I")
	public static int anInt4716;
	@OriginalMember(owner = "com.jagex.client!oj", name = "h", descriptor = "I")
	public static int anInt4693;
	@OriginalMember(owner = "com.jagex.client!ec", name = "b", descriptor = "I")
	public static int anInt1684;
	@OriginalMember(owner = "com.jagex.client!sb", name = "U", descriptor = "I")
	public static int anInt5876;
	@OriginalMember(owner = "com.jagex.client!mg", name = "y", descriptor = "I")
	public static int anInt3773;
	@OriginalMember(owner = "com.jagex.client!mi", name = "k", descriptor = "I")
	public static int anInt3788;
	@OriginalMember(owner = "com.jagex.client!wp", name = "j", descriptor = "[[[Lclient!f;")
	public static Class67[][][] aClass67ArrayArrayArray5;
	@OriginalMember(owner = "com.jagex.client!td", name = "U", descriptor = "[Lclient!tf;")
	public static Class6[] aClass6Array3;
	@OriginalMember(owner = "com.jagex.client!em", name = "c", descriptor = "[[I")
	public static int[][] anIntArrayArray16;
	@OriginalMember(owner = "com.jagex.client!sd", name = "N", descriptor = "[[B")
	public static byte[][] aByteArrayArray17;
	@OriginalMember(owner = "com.jagex.client!br", name = "P", descriptor = "[[B")
	public static byte[][] aByteArrayArray4;
	@OriginalMember(owner = "com.jagex.client!eu", name = "G", descriptor = "[[[Lclient!f;")
	public static Class67[][][] aClass67ArrayArrayArray4;
	@OriginalMember(owner = "com.jagex.client!kp", name = "e", descriptor = "[Lclient!tf;")
	public static Class6[] aClass6Array2;
	@OriginalMember(owner = "com.jagex.client!cu", name = "B", descriptor = "[[[J")
	public static long[][][] aLongArrayArrayArray1;
	@OriginalMember(owner = "com.jagex.client!rp", name = "J", descriptor = "[Lclient!nn;")
	public static Class2_Sub26_Sub1[] aClass2_Sub26_Sub1Array2;
	@OriginalMember(owner = "com.jagex.client!ug", name = "x", descriptor = "[Z")
	public static boolean[] aBooleanArray57;
	@OriginalMember(owner = "com.jagex.client!jl", name = "Z", descriptor = "I")
	public static int anInt3139;
	@OriginalMember(owner = "com.jagex.client!kl", name = "j", descriptor = "[Lclient!ec;")
	public static Occluder[] aClass58Array2;
	@OriginalMember(owner = "com.jagex.client!dr", name = "S", descriptor = "I")
	public static int anInt1622 = 0;
	@OriginalMember(owner = "com.jagex.client!jm", name = "p", descriptor = "[[[I")
	public static int[][][] anIntArrayArrayArray9;
	@OriginalMember(owner = "com.jagex.client!fl", name = "j", descriptor = "[Lclient!hb;")
	public static Entity[] aClass11_Sub5Array1;
	@OriginalMember(owner = "com.jagex.client!wa", name = "g", descriptor = "I")
	public static int anInt7077 = 0;
	@OriginalMember(owner = "com.jagex.client!ae", name = "X", descriptor = "[[Z")
	public static boolean[][] aBooleanArrayArray1;
	@OriginalMember(owner = "com.jagex.client!vg", name = "u", descriptor = "[[Z")
	public static boolean[][] aBooleanArrayArray5;
	@OriginalMember(owner = "com.jagex.client!jj", name = "Y", descriptor = "Lclient!ku;")
	public static Class15 aClass15_1;
	@OriginalMember(owner = "com.jagex.client!td", name = "V", descriptor = "[[[Lclient!f;")
	public static Class67[][][] aClass67ArrayArrayArray3;
	@OriginalMember(owner = "com.jagex.client!vh", name = "w", descriptor = "[Lclient!tf;")
	public static Class6[] aClass6Array4;
	@OriginalMember(owner = "com.jagex.client!fa", name = "f", descriptor = "I")
	public static int anInt1914;

	@OriginalMember(owner = "com.jagex.client!jq", name = "a", descriptor = "(IIIIIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!un", name = "a", descriptor = "(IIIIIZZ)V")
	...
	@OriginalMember(owner = "com.jagex.client!tq", name = "a", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "com.jagex.client!wj", name = "a", descriptor = "(IIII)I")
