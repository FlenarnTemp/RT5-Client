...
public final class Static147 {
	...
	@OriginalMember(owner = "com.jagex.client!ii", name = "a", descriptor = "I")
	public static final int anInt2708 = 1403;

	@OriginalMember(owner = "com.jagex.client!ii", name = "k", descriptor = "[S")
	public static short[] aShortArray54 = new short[256];

	@OriginalMember(owner = "com.jagex.client!ii", name = "a", descriptor = "(B)V")
	...
	@OriginalMember(owner = "com.jagex.client!ii", name = "a", descriptor = "(IB)Lclient!nf;")
