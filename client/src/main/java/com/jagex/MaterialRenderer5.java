...
@OriginalClass("com.jagex.client!lr")
public final class MaterialRenderer5 extends MaterialRenderer {

	@OriginalMember(owner = "com.jagex.client!lr", name = "d", descriptor = "Lclient!fs;")
	private final Class76 aClass76_4;

	@OriginalMember(owner = "com.jagex.client!lr", name = "b", descriptor = "Lclient!rj;")
	private final Class203 aClass203_4;

	@OriginalMember(owner = "com.jagex.client!lr", name = "<init>", descriptor = "(Lclient!bf;Lclient!fs;)V")
	...
	@OriginalMember(owner = "com.jagex.client!lr", name = "a", descriptor = "(I)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!lr", name = "b", descriptor = "()V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!lr", name = "b", descriptor = "(Z)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!lr", name = "a", descriptor = "()Z")
	@Override
	public boolean method5711() {
		return true;
	}

	@OriginalMember(owner = "com.jagex.client!lr", name = "a", descriptor = "(Lclient!kq;)V")
	@Override
	public void method5710(@OriginalArg(0) Class8 arg0) {
		this.aClass19_Sub1_35.method848(arg0);
	}

	@OriginalMember(owner = "com.jagex.client!lr", name = "a", descriptor = "(Z)V")
	@Override
