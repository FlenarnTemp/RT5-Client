...
@OriginalClass("com.jagex.client!vb")
public final class JavaAudioChannel extends AudioChannel {

	@OriginalMember(owner = "com.jagex.client!vb", name = "L", descriptor = "Ljavax/sound/sampled/SourceDataLine;")
	private SourceDataLine aSourceDataLine1;

	@OriginalMember(owner = "com.jagex.client!vb", name = "M", descriptor = "Ljavax/sound/sampled/AudioFormat;")
	private AudioFormat anAudioFormat1;

	@OriginalMember(owner = "com.jagex.client!vb", name = "O", descriptor = "[B")
	private byte[] aByteArray97;

	@OriginalMember(owner = "com.jagex.client!vb", name = "P", descriptor = "I")
	private int anInt6765;

	@OriginalMember(owner = "com.jagex.client!vb", name = "N", descriptor = "Z")
	private boolean aBoolean462 = false;

	@OriginalMember(owner = "com.jagex.client!vb", name = "c", descriptor = "()V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!vb", name = "g", descriptor = "(I)V")
	@Override
	public void method6332(@OriginalArg(0) int arg0) throws LineUnavailableException {
		try {
			...
			if (Static29.method941(arg0) == 1) {
				...
				this.method6332(Static162.bitCeil(arg0));
			}
		}
	}

	@OriginalMember(owner = "com.jagex.client!vb", name = "a", descriptor = "(Ljava/awt/com.jagex.Component;)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!vb", name = "a", descriptor = "()I")
	@Override
	protected int method6321() {
		return this.anInt6765 - (this.aSourceDataLine1.available() >> (Static354.stereo ? 2 : 1));
	}

	@OriginalMember(owner = "com.jagex.client!vb", name = "d", descriptor = "()V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!vb", name = "b", descriptor = "()V")
	@Override
