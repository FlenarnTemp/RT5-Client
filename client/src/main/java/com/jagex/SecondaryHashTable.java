...
@OriginalClass("com.jagex.client!jh")
public final class SecondaryHashTable {

	@OriginalMember(owner = "com.jagex.client!jh", name = "f", descriptor = "Lclient!tl;")
	private SecondaryNode aClass2_Sub2_25;

	@OriginalMember(owner = "com.jagex.client!jh", name = "h", descriptor = "J")
	private long aLong92;

	@OriginalMember(owner = "com.jagex.client!jh", name = "m", descriptor = "I")
	private final int anInt2961;

	@OriginalMember(owner = "com.jagex.client!jh", name = "c", descriptor = "[Lclient!tl;")
	private final SecondaryNode[] buckets;

	@OriginalMember(owner = "com.jagex.client!jh", name = "<init>", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!jh", name = "a", descriptor = "(IJ)Lclient!tl;")
	...
	@OriginalMember(owner = "com.jagex.client!jh", name = "a", descriptor = "(I)Lclient!tl;")
	...
	@OriginalMember(owner = "com.jagex.client!jh", name = "a", descriptor = "(IJLclient!tl;)V")
