...
@OriginalClass("com.jagex.client!wg")
public final class GlSprite extends Sprite {

	@OriginalMember(owner = "com.jagex.client!wg", name = "g", descriptor = "Lclient!ln;")
	private Class8_Sub1_Sub1 aClass8_Sub1_Sub1_4;

	@OriginalMember(owner = "com.jagex.client!wg", name = "b", descriptor = "Z")
	private boolean aBoolean484 = false;

	@OriginalMember(owner = "com.jagex.client!wg", name = "e", descriptor = "I")
	private int anInt7161 = 0;

	@OriginalMember(owner = "com.jagex.client!wg", name = "c", descriptor = "I")
	private int anInt7159 = 0;

	@OriginalMember(owner = "com.jagex.client!wg", name = "a", descriptor = "I")
	private int anInt7158 = 0;

	@OriginalMember(owner = "com.jagex.client!wg", name = "d", descriptor = "I")
	private int anInt7160 = 0;

	@OriginalMember(owner = "com.jagex.client!wg", name = "h", descriptor = "I")
	private int anInt7162 = 0;

	@OriginalMember(owner = "com.jagex.client!wg", name = "f", descriptor = "Lclient!bf;")
	private final Class19_Sub1 aClass19_Sub1_42;

	@OriginalMember(owner = "com.jagex.client!wg", name = "i", descriptor = "Lclient!ln;")
	private final Class8_Sub1_Sub1 aClass8_Sub1_Sub1_5;

	@OriginalMember(owner = "com.jagex.client!wg", name = "<init>", descriptor = "(Lclient!bf;IIII)V")
	public GlSprite(@OriginalArg(0) Class19_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		this.aClass19_Sub1_42 = arg0;
		this.aClass8_Sub1_Sub1_5 = Static402.method3642(arg1, arg2, arg3, arg4, arg0);
	}

	@OriginalMember(owner = "com.jagex.client!wg", name = "<init>", descriptor = "(Lclient!bf;II[III)V")
	public GlSprite(@OriginalArg(0) Class19_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		this.aClass19_Sub1_42 = arg0;
		this.aClass8_Sub1_Sub1_5 = Static402.method3640(arg0, arg3, arg1, arg2);
	}

	@OriginalMember(owner = "com.jagex.client!wg", name = "b", descriptor = "(IIIIIII)V")
	@Override
	public void method6397(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		@Pc(3) opengl local3 = this.aClass19_Sub1_42.gl;
	...
	@OriginalMember(owner = "com.jagex.client!wg", name = "a", descriptor = "(IIIII)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!wg", name = "a", descriptor = "(IIIIIII)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!wg", name = "e", descriptor = "()V")
	...
	@OriginalMember(owner = "com.jagex.client!wg", name = "a", descriptor = "(FFFFFFIII)V")
	@Override
	protected void method6394(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		...
		@Pc(138) opengl local138 = this.aClass19_Sub1_42.gl;
		this.aClass8_Sub1_Sub1_5.method6160(true);
		this.aClass19_Sub1_42.method824();
		this.aClass19_Sub1_42.method848(this.aClass8_Sub1_Sub1_5);
		this.aClass19_Sub1_42.method779(1);
	...
	@OriginalMember(owner = "com.jagex.client!wg", name = "a", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!wg", name = "b", descriptor = "()I")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!wg", name = "a", descriptor = "(FFFFFFLclient!kf;II)V")
	@Override
	protected void method6387(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) Class78 arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		...
		@Pc(142) opengl local142 = this.aClass19_Sub1_42.gl;
		this.aClass8_Sub1_Sub1_5.method6160(true);
		this.aClass19_Sub1_42.method824();
		this.aClass19_Sub1_42.method848(this.aClass8_Sub1_Sub1_5);
	...
	@OriginalMember(owner = "com.jagex.client!wg", name = "a", descriptor = "(IIIIII)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!wg", name = "a", descriptor = "(III)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!wg", name = "a", descriptor = "(IILclient!kf;II)V")
	@Override
	public void method6383(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class78 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		@Pc(118) opengl local118 = this.aClass19_Sub1_42.gl;
	...
	@OriginalMember(owner = "com.jagex.client!wg", name = "b", descriptor = "(IIII)V")
	@Override
