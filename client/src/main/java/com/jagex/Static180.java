...
public final class Static180 {
	...
	@OriginalMember(owner = "com.jagex.client!kh", name = "e", descriptor = "I")
	public static int anInt3404;

	@OriginalMember(owner = "com.jagex.client!kh", name = "i", descriptor = "Lclient!gd;")
	...
	@OriginalMember(owner = "com.jagex.client!kh", name = "k", descriptor = "I")
	public static int anInt3408 = 0;

	@OriginalMember(owner = "com.jagex.client!kh", name = "m", descriptor = "I")
	public static final int anInt3410 = 205;

	@OriginalMember(owner = "com.jagex.client!kh", name = "a", descriptor = "(IIIZIILclient!r;)V")
	...
	@OriginalMember(owner = "com.jagex.client!kh", name = "a", descriptor = "(ILclient!bt;)V")
	...
	@OriginalMember(owner = "com.jagex.client!kh", name = "a", descriptor = "(II)V")
