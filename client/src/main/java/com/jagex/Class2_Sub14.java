...
@OriginalClass("com.jagex.client!ga")
public final class Class2_Sub14 extends Node {

	@OriginalMember(owner = "com.jagex.client!ga", name = "t", descriptor = "I")
	public int anInt2233;

	@OriginalMember(owner = "com.jagex.client!ga", name = "v", descriptor = "Z")
	public boolean aBoolean165;

	@OriginalMember(owner = "com.jagex.client!ga", name = "w", descriptor = "I")
	public final int anInt2234;

	@OriginalMember(owner = "com.jagex.client!ga", name = "x", descriptor = "I")
	private final int anInt2235;

	@OriginalMember(owner = "com.jagex.client!ga", name = "s", descriptor = "[I")
	private int[] anIntArray137;

	@OriginalMember(owner = "com.jagex.client!ga", name = "<init>", descriptor = "(II[IZ)V")
	...
	@OriginalMember(owner = "com.jagex.client!ga", name = "a", descriptor = "(II)V")
	...
	@OriginalMember(owner = "com.jagex.client!ga", name = "b", descriptor = "()[I")
