...
@OriginalClass("com.jagex.client!ik")
public abstract class SoftwareSprite extends Sprite {

	@OriginalMember(owner = "com.jagex.client!ik", name = "b", descriptor = "I")
	protected int anInt1916;

	@OriginalMember(owner = "com.jagex.client!ik", name = "e", descriptor = "I")
	protected int anInt1919;

	@OriginalMember(owner = "com.jagex.client!ik", name = "o", descriptor = "I")
	protected int anInt1929;

	@OriginalMember(owner = "com.jagex.client!ik", name = "x", descriptor = "I")
	protected int anInt1938;

	@OriginalMember(owner = "com.jagex.client!ik", name = "G", descriptor = "[I")
	private int[] anIntArray124;

	@OriginalMember(owner = "com.jagex.client!ik", name = "y", descriptor = "Lclient!j;")
	protected final Class19_Sub2 aClass19_Sub2_5;

	@OriginalMember(owner = "com.jagex.client!ik", name = "v", descriptor = "I")
	protected final int anInt1936;

	@OriginalMember(owner = "com.jagex.client!ik", name = "E", descriptor = "I")
	protected final int anInt1944;

	@OriginalMember(owner = "com.jagex.client!ik", name = "<init>", descriptor = "(Lclient!j;II)V")
	...
	@OriginalMember(owner = "com.jagex.client!ik", name = "a", descriptor = "(FFFFFFLclient!kf;II)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!ik", name = "a", descriptor = "([I[III)V")
	...
	@OriginalMember(owner = "com.jagex.client!ik", name = "a", descriptor = "(IIIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!ik", name = "a", descriptor = "(FFFFFFIII)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!ik", name = "a", descriptor = "(IILclient!kf;II)V")
	...
	@OriginalMember(owner = "com.jagex.client!ik", name = "a", descriptor = "()I")
	@Override
	public final int method6382() {
		return this.anInt1944;
	}

	@OriginalMember(owner = "com.jagex.client!ik", name = "b", descriptor = "(IIII)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!ik", name = "a", descriptor = "(IIIIIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!ik", name = "c", descriptor = "()I")
	@Override
	public final int method6389() {
		return this.anInt1936;
	}

	@OriginalMember(owner = "com.jagex.client!ik", name = "b", descriptor = "(IIIIIII)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!ik", name = "d", descriptor = "()I")
	@Override
	public final int method6399() {
		return this.anInt1938 + this.anInt1936 + this.anInt1919;
	}

	@OriginalMember(owner = "com.jagex.client!ik", name = "a", descriptor = "(FFFFFF)V")
	...
	@OriginalMember(owner = "com.jagex.client!ik", name = "b", descriptor = "(II)V")
