...
@OriginalClass("com.jagex.client!fm")
public final class Class11_Sub5_Sub1 extends Entity implements Interface6 {

	@OriginalMember(owner = "com.jagex.client!fm", name = "I", descriptor = "B")
	private final byte aByte23;

	@OriginalMember(owner = "com.jagex.client!fm", name = "A", descriptor = "B")
	private final byte aByte22;

	@OriginalMember(owner = "com.jagex.client!fm", name = "E", descriptor = "Z")
	private boolean aBoolean153;

	@OriginalMember(owner = "com.jagex.client!fm", name = "y", descriptor = "Z")
	private final boolean aBoolean152;

	@OriginalMember(owner = "com.jagex.client!fm", name = "Q", descriptor = "Z")
	private final boolean aBoolean154;

	@OriginalMember(owner = "com.jagex.client!fm", name = "L", descriptor = "S")
	private final short aShort34;

	@OriginalMember(owner = "com.jagex.client!fm", name = "Y", descriptor = "B")
	private final byte aByte24;

	@OriginalMember(owner = "com.jagex.client!fm", name = "S", descriptor = "Z")
	private final boolean aBoolean155;

	@OriginalMember(owner = "com.jagex.client!fm", name = "U", descriptor = "Lclient!gn;")
	public Model aClass31_2;

	@OriginalMember(owner = "com.jagex.client!fm", name = "N", descriptor = "Lclient!kb;")
	private Class2_Sub2_Sub4 aClass2_Sub2_Sub4_2;

	@OriginalMember(owner = "com.jagex.client!fm", name = "<init>", descriptor = "(Lclient!wm;Lclient!ct;IIIIIZIIIIIIZ)V")
	public Class11_Sub5_Sub1(@OriginalArg(0) Renderer arg0, @OriginalArg(1) LocType arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) boolean arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) int arg12, @OriginalArg(13) int arg13, @OriginalArg(14) boolean arg14) {
		super(arg2, arg4, arg5, arg6, arg8, arg9, arg10, arg11, arg1.raiseobject == 1, Static394.method6487(arg13, arg12));
	...
	@OriginalMember(owner = "com.jagex.client!fm", name = "a", descriptor = "(Z)Z")
	@Override
	public boolean method6086() {
		return this.aBoolean155;
	}

	@OriginalMember(owner = "com.jagex.client!fm", name = "a", descriptor = "(IIILclient!wm;ZLclient!hp;Z)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!fm", name = "b", descriptor = "(Lclient!wm;B)Lclient!nf;")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!fm", name = "g", descriptor = "(I)Z")
	@Override
	public boolean method6076() {
		return this.aBoolean153;
	}

	@OriginalMember(owner = "com.jagex.client!fm", name = "b", descriptor = "(I)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!fm", name = "d", descriptor = "(I)I")
	@Override
	public int method6085() {
		return this.aShort34 & 0xFFFF;
	}

	@OriginalMember(owner = "com.jagex.client!fm", name = "a", descriptor = "(IILclient!wm;)Lclient!gn;")
	private Model method2145(@OriginalArg(0) int arg0, @OriginalArg(2) Renderer arg1) {
	...
	@OriginalMember(owner = "com.jagex.client!fm", name = "h", descriptor = "(I)I")
	@Override
	public int method6080() {
		return this.aClass31_2 == null ? 0 : this.aClass31_2.method3802();
	}

	@OriginalMember(owner = "com.jagex.client!fm", name = "e", descriptor = "(I)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!fm", name = "a", descriptor = "(BLclient!wm;)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!fm", name = "a", descriptor = "(BZLclient!wm;I)Lclient!ij;")
	private Class105 method2147(@OriginalArg(1) boolean arg0, @OriginalArg(2) Renderer arg1, @OriginalArg(3) int arg2) {
	...
	@OriginalMember(owner = "com.jagex.client!fm", name = "a", descriptor = "(Lclient!wm;B)V")
	@Override
	public void method6070(@OriginalArg(0) Renderer arg0) {
	}

	@OriginalMember(owner = "com.jagex.client!fm", name = "a", descriptor = "(I)I")
	@Override
	public int method6081() {
		return this.aByte23;
	}

	@OriginalMember(owner = "com.jagex.client!fm", name = "a", descriptor = "(ILclient!wm;I)Lclient!gn;")
	@Override
	public Model method6088(@OriginalArg(0) int arg0, @OriginalArg(1) Renderer arg1) {
		return this.method2145(arg0, arg1);
	}

	@OriginalMember(owner = "com.jagex.client!fm", name = "k", descriptor = "(I)I")
	public int method2148() {
		return this.aClass31_2 == null ? 15 : this.aClass31_2.method3831() / 4;
	}

	@OriginalMember(owner = "com.jagex.client!fm", name = "a", descriptor = "(IIBLclient!wm;)Z")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!fm", name = "c", descriptor = "(I)I")
	@Override
	public int method6084() {
		return this.aByte24;
	}

	@OriginalMember(owner = "com.jagex.client!fm", name = "a", descriptor = "(Lclient!wm;I)V")
	@Override
