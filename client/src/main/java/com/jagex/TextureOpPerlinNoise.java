...
@OriginalClass("com.jagex.client!ch")
public final class TextureOpPerlinNoise extends TextureOp {

	@OriginalMember(owner = "com.jagex.client!ch", name = "U", descriptor = "[S")
	private short[] aShortArray18;

	@OriginalMember(owner = "com.jagex.client!ch", name = "jb", descriptor = "[S")
	private short[] aShortArray19;

	@OriginalMember(owner = "com.jagex.client!ch", name = "S", descriptor = "[B")
	private byte[] aByteArray12 = new byte[512];

	@OriginalMember(owner = "com.jagex.client!ch", name = "Z", descriptor = "I")
	public int anInt1045 = 0;

	@OriginalMember(owner = "com.jagex.client!ch", name = "db", descriptor = "I")
	public int anInt1049 = 1638;

	@OriginalMember(owner = "com.jagex.client!ch", name = "eb", descriptor = "I")
	public int anInt1050 = 4;

	@OriginalMember(owner = "com.jagex.client!ch", name = "O", descriptor = "Z")
	public boolean aBoolean85 = true;

	@OriginalMember(owner = "com.jagex.client!ch", name = "X", descriptor = "I")
	public int anInt1043 = 4;

	@OriginalMember(owner = "com.jagex.client!ch", name = "hb", descriptor = "I")
	public int anInt1051 = 4;

	@OriginalMember(owner = "com.jagex.client!ch", name = "<init>", descriptor = "()V")
	public TextureOpPerlinNoise() {
		super(0, true);
	}

	@OriginalMember(owner = "com.jagex.client!ch", name = "a", descriptor = "(BI)[I")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!ch", name = "d", descriptor = "(I)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!ch", name = "b", descriptor = "(IIIIIII)I")
	...
	@OriginalMember(owner = "com.jagex.client!ch", name = "a", descriptor = "(ILclient!bt;I)V")
	@Override
	public void decode(@OriginalArg(0) int code, @OriginalArg(1) Packet buf) {
		if (code == 0) {
			this.aBoolean85 = buf.g1() == 1;
		} else if (code == 1) {
			this.anInt1043 = buf.g1();
		} else if (code == 2) {
			this.anInt1049 = buf.g2s();
			if (this.anInt1049 < 0) {
				this.aShortArray18 = new short[this.anInt1043];
				for (@Pc(80) int local80 = 0; local80 < this.anInt1043; local80++) {
					this.aShortArray18[local80] = (short) buf.g2s();
				}
			}
		} else if (code == 3) {
			this.anInt1051 = this.anInt1050 = buf.g1();
		} else if (code == 4) {
			this.anInt1045 = buf.g1();
		} else if (code == 5) {
			this.anInt1051 = buf.g1();
		} else if (code == 6) {
			this.anInt1050 = buf.g1();
		}
	}

	@OriginalMember(owner = "com.jagex.client!ch", name = "a", descriptor = "([III)V")
	...
	@OriginalMember(owner = "com.jagex.client!ch", name = "g", descriptor = "(I)V")
