...
public final class Static338 {
	...
	@OriginalMember(owner = "com.jagex.client!tl", name = "v", descriptor = "J")
	public static long aLong214 = 0L;

	@OriginalMember(owner = "com.jagex.client!tl", name = "A", descriptor = "Z")
	public static final boolean aBoolean465 = false;

	@OriginalMember(owner = "com.jagex.client!tl", name = "b", descriptor = "(B)V")
