...
@OriginalClass("com.jagex.client!wt")
public final class TextureOpCurve extends TextureOp {

	@OriginalMember(owner = "com.jagex.client!wt", name = "S", descriptor = "[I")
	private int[] anIntArray525;

	@OriginalMember(owner = "com.jagex.client!wt", name = "T", descriptor = "[[I")
	private int[][] anIntArrayArray65;

	@OriginalMember(owner = "com.jagex.client!wt", name = "Z", descriptor = "[I")
	private int[] anIntArray526;

	@OriginalMember(owner = "com.jagex.client!wt", name = "R", descriptor = "I")
	private int anInt7259 = 0;

	@OriginalMember(owner = "com.jagex.client!wt", name = "V", descriptor = "[S")
	private final short[] aShortArray129 = new short[257];

	@OriginalMember(owner = "com.jagex.client!wt", name = "<init>", descriptor = "()V")
	public TextureOpCurve() {
		super(1, true);
	}

	@OriginalMember(owner = "com.jagex.client!wt", name = "a", descriptor = "(BI)[I")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!wt", name = "f", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!wt", name = "g", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!wt", name = "d", descriptor = "(I)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!wt", name = "b", descriptor = "(II)[I")
	...
	@OriginalMember(owner = "com.jagex.client!wt", name = "a", descriptor = "(ILclient!bt;I)V")
	@Override
	public void decode(@OriginalArg(0) int code, @OriginalArg(1) Packet buf) {
		if (code != 0) {
			return;
		}
		this.anInt7259 = buf.g1();
		this.anIntArrayArray65 = new int[buf.g1()][2];
		for (@Pc(22) int local22 = 0; local22 < this.anIntArrayArray65.length; local22++) {
			this.anIntArrayArray65[local22][0] = buf.g2();
			this.anIntArrayArray65[local22][1] = buf.g2();
		}
	}
}
