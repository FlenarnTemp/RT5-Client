...
@OriginalClass("com.jagex.client!mn")
public final class QuickChatCatType extends SecondaryNode {

	@OriginalMember(owner = "com.jagex.client!mn", name = "C", descriptor = "[I")
	public int[] phrases;

	@OriginalMember(owner = "com.jagex.client!mn", name = "D", descriptor = "[C")
	public char[] subcategoryShortcuts;

	@OriginalMember(owner = "com.jagex.client!mn", name = "E", descriptor = "[I")
	public int[] subcategories;

	@OriginalMember(owner = "com.jagex.client!mn", name = "G", descriptor = "Ljava/lang/String;")
	public String aString37;

	@OriginalMember(owner = "com.jagex.client!mn", name = "M", descriptor = "[C")
	public char[] phraseShortcuts;

	@OriginalMember(owner = "com.jagex.client!mn", name = "d", descriptor = "(B)V")
	...
	@OriginalMember(owner = "com.jagex.client!mn", name = "a", descriptor = "(CZ)I")
	...
	@OriginalMember(owner = "com.jagex.client!mn", name = "a", descriptor = "(BILclient!bt;)V")
	...
	@OriginalMember(owner = "com.jagex.client!mn", name = "a", descriptor = "(Lclient!bt;B)V")
	...
	@OriginalMember(owner = "com.jagex.client!mn", name = "a", descriptor = "(ZC)I")
