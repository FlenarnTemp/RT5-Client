...
@OriginalClass("com.jagex.client!k")
public final class Class119_Sub1 extends Class119 implements MouseListener, MouseMotionListener {

	@OriginalMember(owner = "com.jagex.client!k", name = "m", descriptor = "I")
	private int anInt3323;

	@OriginalMember(owner = "com.jagex.client!k", name = "x", descriptor = "I")
	private int anInt3333;

	@OriginalMember(owner = "com.jagex.client!k", name = "I", descriptor = "I")
	private int anInt3343;

	@OriginalMember(owner = "com.jagex.client!k", name = "K", descriptor = "I")
	private int anInt3345;

	@OriginalMember(owner = "com.jagex.client!k", name = "L", descriptor = "I")
	private int anInt3346;

	@OriginalMember(owner = "com.jagex.client!k", name = "M", descriptor = "I")
	private int anInt3347;

	@OriginalMember(owner = "com.jagex.client!k", name = "P", descriptor = "Ljava/awt/com.jagex.Component;")
	private Component aComponent1;

	@OriginalMember(owner = "com.jagex.client!k", name = "p", descriptor = "Lclient!ld;")
	private LinkedList aClass135_22 = new LinkedList();

	@OriginalMember(owner = "com.jagex.client!k", name = "N", descriptor = "Lclient!ld;")
	private LinkedList aClass135_23 = new LinkedList();

	@OriginalMember(owner = "com.jagex.client!k", name = "O", descriptor = "Z")
	private final boolean aBoolean224;

	@OriginalMember(owner = "com.jagex.client!k", name = "<init>", descriptor = "(Ljava/awt/com.jagex.Component;Z)V")
	public Class119_Sub1(@OriginalArg(0) Component arg0, @OriginalArg(1) boolean arg1) {
		this.method3319(arg0);
		this.aBoolean224 = arg1;
	}

	@OriginalMember(owner = "com.jagex.client!k", name = "g", descriptor = "(I)V")
	@Override
	public void method3312() {
		this.method3321();
	}

	@OriginalMember(owner = "com.jagex.client!k", name = "a", descriptor = "(ILjava/awt/event/MouseEvent;)V")
	...
	@OriginalMember(owner = "com.jagex.client!k", name = "mouseEntered", descriptor = "(Ljava/awt/event/MouseEvent;)V")
	@Override
	public synchronized void mouseEntered(@OriginalArg(0) MouseEvent arg0) {
		this.method3314(arg0);
	}

	@OriginalMember(owner = "com.jagex.client!k", name = "mouseClicked", descriptor = "(Ljava/awt/event/MouseEvent;)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!k", name = "a", descriptor = "(IIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!k", name = "h", descriptor = "(I)I")
	@Override
	public int method3313() {
		return this.anInt3323;
	}

	@OriginalMember(owner = "com.jagex.client!k", name = "c", descriptor = "(B)Z")
	@Override
	protected boolean method3309() {
		return (this.anInt3333 & 0x2) != 0;
	}

	@OriginalMember(owner = "com.jagex.client!k", name = "a", descriptor = "(B)I")
	@Override
	public int method3304() {
		return this.anInt3343;
	}

	@OriginalMember(owner = "com.jagex.client!k", name = "a", descriptor = "(Ljava/awt/com.jagex.Component;I)V")
	...
	@OriginalMember(owner = "com.jagex.client!k", name = "mouseDragged", descriptor = "(Ljava/awt/event/MouseEvent;)V")
	@Override
	public synchronized void mouseDragged(@OriginalArg(0) MouseEvent arg0) {
		this.method3314(arg0);
	}

	@OriginalMember(owner = "com.jagex.client!k", name = "mouseExited", descriptor = "(Ljava/awt/event/MouseEvent;)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!k", name = "mouseMoved", descriptor = "(Ljava/awt/event/MouseEvent;)V")
	@Override
	public synchronized void mouseMoved(@OriginalArg(0) MouseEvent arg0) {
		this.method3314(arg0);
	}

	@OriginalMember(owner = "com.jagex.client!k", name = "a", descriptor = "(Ljava/awt/event/MouseEvent;I)I")
	...
	@OriginalMember(owner = "com.jagex.client!k", name = "mouseReleased", descriptor = "(Ljava/awt/event/MouseEvent;)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!k", name = "e", descriptor = "(B)V")
	...
	@OriginalMember(owner = "com.jagex.client!k", name = "mousePressed", descriptor = "(Ljava/awt/event/MouseEvent;)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!k", name = "a", descriptor = "(I)Z")
	@Override
	protected boolean method3303() {
		return (this.anInt3333 & 0x4) != 0;
	}

	@OriginalMember(owner = "com.jagex.client!k", name = "c", descriptor = "(I)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!k", name = "f", descriptor = "(I)Z")
	@Override
	public boolean method3311() {
		return (this.anInt3333 & 0x1) != 0;
	}

	@OriginalMember(owner = "com.jagex.client!k", name = "d", descriptor = "(I)Lclient!lm;")
	@Override
