...
public final class Static141 {
	...
	@OriginalMember(owner = "com.jagex.client!i", name = "ab", descriptor = "F")
	public static float aFloat34;

	@OriginalMember(owner = "com.jagex.client!i", name = "P", descriptor = "Lclient!jh;")
	public static SecondaryHashTable aClass115_1 = new SecondaryHashTable(8);

	@OriginalMember(owner = "com.jagex.client!i", name = "X", descriptor = "Z")
	public static boolean aBoolean189 = false;

	@OriginalMember(owner = "com.jagex.client!i", name = "Y", descriptor = "I")
	public static int anInt2653 = 0;

	@OriginalMember(owner = "com.jagex.client!i", name = "bb", descriptor = "Z")
	public static boolean aBoolean190 = true;

	@OriginalMember(owner = "com.jagex.client!i", name = "a", descriptor = "(Z[IIIIIILclient!dg;III[IIII)I")
	...
	@OriginalMember(owner = "com.jagex.client!i", name = "f", descriptor = "(I)V")
