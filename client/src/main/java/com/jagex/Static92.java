...
public final class Static92 {
	...
	@OriginalMember(owner = "com.jagex.client!fa", name = "b", descriptor = "Lclient!hu;")
	...
	@OriginalMember(owner = "com.jagex.client!fa", name = "a", descriptor = "(Lclient!nk;Lclient!wm;IIB)V")
	public static void method1967(@OriginalArg(0) Component arg0, @OriginalArg(1) Renderer arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		@Pc(185) int local185;
		@Pc(196) int local196;
		for (@Pc(149) IntWrapper local149 = (IntWrapper) Static56.aClass135_13.head(); local149 != null; local149 = (IntWrapper) Static56.aClass135_13.next()) {
		...
		for (local165 = 0; local165 < Static387.anInt2831; local165++) {
			...
			if (local253.multiloc != null) {
				local253 = local253.method1533(VarpDomain.instance);
				if (local253 == null || local253.mapelement == -1) {
					continue;
				}
			}
			Static216.method3776(arg3, arg0, local253.mapelement, arg1, local185, local14, local174, arg2);
		}
		for (@Pc(293) Class2_Sub32 local293 = (Class2_Sub32) Static120.objStacks.head(); local293 != null; local293 = (Class2_Sub32) Static120.objStacks.next()) {
			local185 = (int) (local293.nodeId >> 28 & 0x3L);
			if (local185 == Static343.anInt6389) {
				local196 = (int) (local293.nodeId & 0x3FFFL) * 4 + 2 - local61 / 32;
				@Pc(337) int local337 = (int) (local293.nodeId >> 14 & 0x3FFFL) * 4 + 2 - local58 / 32;
