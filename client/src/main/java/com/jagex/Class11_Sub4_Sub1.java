...
@OriginalClass("com.jagex.client!n")
public final class Class11_Sub4_Sub1 extends Class11_Sub4 {

	@OriginalMember(owner = "com.jagex.client!n", name = "v", descriptor = "I")
	public int anInt3978;

	@OriginalMember(owner = "com.jagex.client!n", name = "A", descriptor = "I")
	public int anInt3982;

	@OriginalMember(owner = "com.jagex.client!n", name = "D", descriptor = "I")
	public int anInt3984;

	@OriginalMember(owner = "com.jagex.client!n", name = "E", descriptor = "I")
	public int anInt3985;

	@OriginalMember(owner = "com.jagex.client!n", name = "y", descriptor = "I")
	public int anInt3980 = -1;

	@OriginalMember(owner = "com.jagex.client!n", name = "z", descriptor = "I")
	public int anInt3981 = -1;

	@OriginalMember(owner = "com.jagex.client!n", name = "b", descriptor = "(Lclient!wm;B)Lclient!nf;")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!n", name = "a", descriptor = "(IIBLclient!wm;)Z")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!n", name = "a", descriptor = "(Lclient!wm;B)V")
	@Override
