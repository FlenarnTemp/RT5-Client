...
public class FriendsList {
	...
	@OriginalMember(owner = "com.jagex.client!me", name = "d", descriptor = "[Ljava/lang/String;")
	public static final String[] worldNames = new String[200];
	@OriginalMember(owner = "com.jagex.client!at", name = "Q", descriptor = "[Ljava/lang/String;")
	public static final String[] usernames = new String[200];
	@OriginalMember(owner = "com.jagex.client!gm", name = "b", descriptor = "[I")
	public static final int[] ranks = new int[200];
	@OriginalMember(owner = "com.jagex.client!pd", name = "o", descriptor = "[I")
	public static final int[] worlds = new int[200];
	@OriginalMember(owner = "com.jagex.client!rk", name = "b", descriptor = "[Z")
	public static final boolean[] sameGame = new boolean[200];
	@OriginalMember(owner = "com.jagex.client!nj", name = "c", descriptor = "I")
	public static int status = 0;

	@OriginalMember(owner = "com.jagex.client!wh", name = "y", descriptor = "I")
	public static int size = 0;

	@OriginalMember(owner = "com.jagex.client!wq", name = "a", descriptor = "(ILjava/lang/String;)Z")
	...
	@OriginalMember(owner = "com.jagex.client!bt", name = "a", descriptor = "(ILjava/lang/String;)V")
	...
	@OriginalMember(owner = "com.jagex.client!dj", name = "a", descriptor = "(Ljava/lang/String;I)V")
	...
	@OriginalMember(owner = "com.jagex.client!jt", name = "a", descriptor = "(IILjava/lang/String;)V")
	...
	@OriginalMember(owner = "com.jagex.client!gp", name = "a", descriptor = "(Ljava/lang/String;B)I")
