...
public final class Static196 {
	...
	@OriginalMember(owner = "com.jagex.client!lh", name = "h", descriptor = "I")
	public static int anInt3318;

	@OriginalMember(owner = "com.jagex.client!lh", name = "f", descriptor = "I")
	public static int anInt3317 = -1;

	@OriginalMember(owner = "com.jagex.client!lh", name = "e", descriptor = "(I)Z")
