...
public final class Static325 {
	...
	@OriginalMember(owner = "com.jagex.client!sr", name = "b", descriptor = "Lclient!gd;")
	...
	@OriginalMember(owner = "com.jagex.client!sr", name = "f", descriptor = "I")
	public static int anInt6079 = 0;

	@OriginalMember(owner = "com.jagex.client!sr", name = "h", descriptor = "[I")
	public static final int[] anIntArray413 = new int[] { 1, 0, -1, 0 };

	@OriginalMember(owner = "com.jagex.client!sr", name = "a", descriptor = "(BII)Z")
