...
@OriginalClass("com.jagex.client!ic")
public final class ShadowManager {

	@OriginalMember(owner = "com.jagex.client!ic", name = "h", descriptor = "[[Lclient!u;")
	private Shadow[][] shadows;

	@OriginalMember(owner = "com.jagex.client!ic", name = "d", descriptor = "Lclient!ah;")
	private final Class6_Sub1 aClass6_Sub1_1;

	@OriginalMember(owner = "com.jagex.client!ic", name = "g", descriptor = "Lclient!bf;")
	private final Class19_Sub1 aClass19_Sub1_16;

	@OriginalMember(owner = "com.jagex.client!ic", name = "i", descriptor = "I")
	public final int anInt2684;

	@OriginalMember(owner = "com.jagex.client!ic", name = "f", descriptor = "I")
	private final int anInt2683;

	@OriginalMember(owner = "com.jagex.client!ic", name = "c", descriptor = "I")
	private final int anInt2681;

	@OriginalMember(owner = "com.jagex.client!ic", name = "b", descriptor = "[B")
	public final byte[] aByteArray28;

	@OriginalMember(owner = "com.jagex.client!ic", name = "a", descriptor = "I")
	private final int anInt2680;

	@OriginalMember(owner = "com.jagex.client!ic", name = "e", descriptor = "I")
	private final int anInt2682;

	@OriginalMember(owner = "com.jagex.client!ic", name = "<init>", descriptor = "(Lclient!bf;Lclient!ah;)V")
	...
	@OriginalMember(owner = "com.jagex.client!ic", name = "a", descriptor = "(B)V")
	...
	@OriginalMember(owner = "com.jagex.client!ic", name = "a", descriptor = "(Lclient!kb;IIB)V")
	...
	@OriginalMember(owner = "com.jagex.client!ic", name = "a", descriptor = "(BIIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!ic", name = "a", descriptor = "(IILclient!kb;I)Z")
	...
	@OriginalMember(owner = "com.jagex.client!ic", name = "a", descriptor = "(ILclient!kb;II)V")
	...
	@OriginalMember(owner = "com.jagex.client!ic", name = "a", descriptor = "([[ZIZIII)V")
