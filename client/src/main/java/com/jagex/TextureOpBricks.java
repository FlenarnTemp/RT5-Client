...
@OriginalClass("com.jagex.client!pk")
public final class TextureOpBricks extends TextureOp {

	@OriginalMember(owner = "com.jagex.client!pk", name = "N", descriptor = "[[I")
	private int[][] anIntArrayArray41;

	@OriginalMember(owner = "com.jagex.client!pk", name = "R", descriptor = "I")
	private int anInt5008;

	@OriginalMember(owner = "com.jagex.client!pk", name = "U", descriptor = "I")
	private int anInt5011;

	@OriginalMember(owner = "com.jagex.client!pk", name = "W", descriptor = "[[I")
	private int[][] anIntArrayArray42;

	@OriginalMember(owner = "com.jagex.client!pk", name = "Y", descriptor = "[I")
	private int[] anIntArray350;

	@OriginalMember(owner = "com.jagex.client!pk", name = "fb", descriptor = "I")
	private int anInt5020;

	@OriginalMember(owner = "com.jagex.client!pk", name = "T", descriptor = "I")
	private int anInt5010 = 1024;

	@OriginalMember(owner = "com.jagex.client!pk", name = "X", descriptor = "I")
	private int anInt5013 = 8;

	@OriginalMember(owner = "com.jagex.client!pk", name = "O", descriptor = "I")
	private int anInt5006 = 409;

	@OriginalMember(owner = "com.jagex.client!pk", name = "S", descriptor = "I")
	private int anInt5009 = 0;

	@OriginalMember(owner = "com.jagex.client!pk", name = "cb", descriptor = "I")
	private int anInt5017 = 81;

	@OriginalMember(owner = "com.jagex.client!pk", name = "db", descriptor = "I")
	private int anInt5018 = 1024;

	@OriginalMember(owner = "com.jagex.client!pk", name = "ab", descriptor = "I")
	private int anInt5015 = 204;

	@OriginalMember(owner = "com.jagex.client!pk", name = "gb", descriptor = "I")
	private int anInt5021 = 4;

	@OriginalMember(owner = "com.jagex.client!pk", name = "<init>", descriptor = "()V")
	public TextureOpBricks() {
		super(0, true);
	}

	@OriginalMember(owner = "com.jagex.client!pk", name = "d", descriptor = "(I)V")
	@Override
	public void postDecode() {
		this.method4595();
	}

	@OriginalMember(owner = "com.jagex.client!pk", name = "a", descriptor = "(BI)[I")
	@Override
	public int[] getMonochromeOutput(@OriginalArg(1) int arg0) {
		...
		if (super.monochromeImageCache.invalid) {
			@Pc(22) int local22 = 0;
			@Pc(29) int local29;
			for (local29 = Texture.heightFractions[arg0] + this.anInt5009; local29 < 0; local29 += 4096) {
			}
			while (local29 > 4096) {
				local29 -= 4096;
			}
			...
			if (local29 > this.anInt5020 + local85 && local29 < local78 - this.anInt5020) {
				for (@Pc(103) int local103 = 0; local103 < Texture.width; local103++) {
					@Pc(107) int local107 = 0;
					@Pc(116) int local116 = local73 ? this.anInt5018 : -this.anInt5018;
					@Pc(128) int local128;
					for (local128 = Texture.widthFractions[local103] + (this.anInt5011 * local116 >> 12); local128 < 0; local128 += 4096) {
					}
					while (local128 > 4096) {
						local128 -= 4096;
					}
				...
				ArrayUtil.method4610(local11, 0, Texture.width, 0);
			}
		}
		return local11;
	}

	@OriginalMember(owner = "com.jagex.client!pk", name = "a", descriptor = "(ILclient!bt;I)V")
	@Override
	public void decode(@OriginalArg(0) int code, @OriginalArg(1) Packet buf) {
		if (code == 0) {
			this.anInt5021 = buf.g1();
		} else if (code == 1) {
			this.anInt5013 = buf.g1();
		} else if (code == 2) {
			this.anInt5006 = buf.g2();
		} else if (code == 3) {
			this.anInt5015 = buf.g2();
		} else if (code == 4) {
			this.anInt5018 = buf.g2();
		} else if (code == 5) {
			this.anInt5009 = buf.g2();
		} else if (code == 6) {
			this.anInt5017 = buf.g2();
		} else if (code == 7) {
			this.anInt5010 = buf.g2();
		}
	}

	@OriginalMember(owner = "com.jagex.client!pk", name = "c", descriptor = "(Z)V")
