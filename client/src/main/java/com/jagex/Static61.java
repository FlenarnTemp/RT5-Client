...
public final class Static61 {
	...
	@OriginalMember(owner = "com.jagex.client!dj", name = "Y", descriptor = "Lclient!hu;")
	public static final LruHashTable aClass98_5 = new LruHashTable(8);

	@OriginalMember(owner = "com.jagex.client!dj", name = "a", descriptor = "(B[JI[II)V")
	...
	@OriginalMember(owner = "com.jagex.client!dj", name = "a", descriptor = "(IIBLclient!r;)Lclient!vj;")
	public static Map method1672(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) Js5 arg2) {
		@Pc(14) Packet local14 = new Packet(arg2.getfile(arg0, arg1));
