...
@OriginalClass("com.jagex.client!vk")
public final class Class8_Sub4 extends Class8 {

	@OriginalMember(owner = "com.jagex.client!vk", name = "l", descriptor = "I")
	private int anInt6888 = -1;

	@OriginalMember(owner = "com.jagex.client!vk", name = "i", descriptor = "I")
	private final int anInt6885;

	@OriginalMember(owner = "com.jagex.client!vk", name = "j", descriptor = "I")
	private final int anInt6886;

	@OriginalMember(owner = "com.jagex.client!vk", name = "k", descriptor = "I")
	private final int anInt6887;

	@OriginalMember(owner = "com.jagex.client!vk", name = "<init>", descriptor = "(Lclient!bf;IIII[BI)V")
	...
	@OriginalMember(owner = "com.jagex.client!vk", name = "a", descriptor = "()V")
	@Override
