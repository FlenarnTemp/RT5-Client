...
public final class Static258 {
	...
	@OriginalMember(owner = "com.jagex.client!oo", name = "n", descriptor = "[S")
	public static short[] aShortArray95 = new short[256];

	@OriginalMember(owner = "com.jagex.client!oo", name = "a", descriptor = "(Lclient!wm;Lclient!hp;IIIII)V")
	public static void method4403(@OriginalArg(0) Renderer arg0, @OriginalArg(1) BaseEntity arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
