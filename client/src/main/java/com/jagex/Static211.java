...
public final class Static211 {
	...
	@OriginalMember(owner = "com.jagex.client!mh", name = "d", descriptor = "I")
	public static int anInt3777;

	@OriginalMember(owner = "com.jagex.client!mh", name = "f", descriptor = "Lclient!jd;")
	public static Sprite aClass13_13;

	@OriginalMember(owner = "com.jagex.client!mh", name = "j", descriptor = "I")
	public static int anInt3780;

	@OriginalMember(owner = "com.jagex.client!mh", name = "a", descriptor = "(I)V")
