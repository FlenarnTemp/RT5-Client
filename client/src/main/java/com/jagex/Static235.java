...
public final class Static235 {
	...
	@OriginalMember(owner = "com.jagex.client!nj", name = "j", descriptor = "I")
	public static int anInt3368 = 0;

	@OriginalMember(owner = "com.jagex.client!nj", name = "k", descriptor = "Lclient!gd;")
	public static final LocalizedString aClass79_72 = new LocalizedString("Loaded sprites", "com.jagex.Sprites geladen.", "com.jagex.Sprites chargés", "com.jagex.Sprites carregados");

	@OriginalMember(owner = "com.jagex.client!nj", name = "a", descriptor = "(IIII)Z")
	...
	@OriginalMember(owner = "com.jagex.client!nj", name = "b", descriptor = "(IIII)I")
