...
@OriginalClass("com.jagex.client!bt")
public class Packet extends Node {

	@OriginalMember(owner = "com.jagex.client!n", name = "r", descriptor = "[I")
	public static final int[] CRC32_TABLE = new int[256];

	@OriginalMember(owner = "com.jagex.client!ad", name = "t", descriptor = "[J")
	public static final long[] CRC64_TABLE = new long[256];

	@OriginalMember(owner = "com.jagex.client!bt", name = "kb", descriptor = "[B")
	public byte[] data;

	@OriginalMember(owner = "com.jagex.client!bt", name = "U", descriptor = "I")
	public int pos;
	...
	@OriginalMember(owner = "com.jagex.client!bt", name = "<init>", descriptor = "(I)V")
	public Packet(@OriginalArg(0) int size) {
		this.data = ByteArrayPool.alloc(size);
		this.pos = 0;
	}

	@OriginalMember(owner = "com.jagex.client!bt", name = "<init>", descriptor = "([B)V")
	...
	@OriginalMember(owner = "com.jagex.client!bk", name = "a", descriptor = "(BLjava/lang/String;)I")
	public static int pjstrlen(@OriginalArg(1) String str) {
		return str.length() + 1;
	}

	// calculate checksum
	@OriginalMember(owner = "com.jagex.client!ek", name = "a", descriptor = "(III[B)I")
	...
	// get, data
	@OriginalMember(owner = "com.jagex.client!bt", name = "a", descriptor = "([BIIZ)V")
	...
	@OriginalMember(owner = "com.jagex.client!bt", name = "c", descriptor = "(I)I")
	public int g2s_alt2() {
		this.pos += 2;
	...
	@OriginalMember(owner = "com.jagex.client!bt", name = "b", descriptor = "(B)B")
	public byte g1b_alt2() {
		return (byte) -this.data[this.pos++];
	}

	// add checksum
	@OriginalMember(owner = "com.jagex.client!bt", name = "a", descriptor = "(II)I")
	...
	@OriginalMember(owner = "com.jagex.client!bt", name = "b", descriptor = "(Z)I")
	public int g2_alt1() {
		this.pos += 2;
	...
	// get, 1 byte, alt method 2
	@OriginalMember(owner = "com.jagex.client!bt", name = "d", descriptor = "(I)I")
	public int g1_alt2() {
		return -this.data[this.pos++] & 0xFF;
	}

	// put, 4 bytes, alt method 3
	@OriginalMember(owner = "com.jagex.client!bt", name = "b", descriptor = "(II)V")
	...
	@OriginalMember(owner = "com.jagex.client!bt", name = "c", descriptor = "(B)I")
	public int g2_alt2() {
		this.pos += 2;
	...
	@OriginalMember(owner = "com.jagex.client!bt", name = "a", descriptor = "(IIJ)V")
	...
	// compare checksums
	@OriginalMember(owner = "com.jagex.client!bt", name = "c", descriptor = "(Z)Z")
	...
	// get, jag str
	@OriginalMember(owner = "com.jagex.client!bt", name = "e", descriptor = "(I)Ljava/lang/String;")
	public String gjstr() {
		@Pc(14) int start = this.pos;
		while (this.data[this.pos++] != 0) {}
		@Pc(37) int length = this.pos - start - 1;
		return length == 0 ? "" : Cp1252.decodeString(start, this.data, length);
	}

	// get, 1 byte, alt method 3
	@OriginalMember(owner = "com.jagex.client!bt", name = "f", descriptor = "(I)I")
	public int g1_alt3() {
		return 128 - this.data[this.pos++] & 0xFF;
	}

	// get, variable length int
	@OriginalMember(owner = "com.jagex.client!bt", name = "d", descriptor = "(B)I")
	public int gVarInt() {
	...
	// put, 4 bytes
	@OriginalMember(owner = "com.jagex.client!bt", name = "a", descriptor = "(BI)V")
	...
	@OriginalMember(owner = "com.jagex.client!bt", name = "b", descriptor = "(IB)V")
	public void p1_alt2(@OriginalArg(0) int value) {
		this.data[this.pos++] = (byte) -value;
	}

	// get, 1 byte
	@OriginalMember(owner = "com.jagex.client!bt", name = "e", descriptor = "(B)I")
	public int g1() {
		return this.data[this.pos++] & 0xFF;
	}

	// get, 2 bytes signed, alt method 3
	@OriginalMember(owner = "com.jagex.client!bt", name = "f", descriptor = "(B)I")
	public int g2s_alt3() {
		this.pos += 2;
	...
	@OriginalMember(owner = "com.jagex.client!bt", name = "g", descriptor = "(B)I")
	public int gsmart() {
	...
	@OriginalMember(owner = "com.jagex.client!bt", name = "h", descriptor = "(B)I")
	public int gsmarts() {
	...
	@OriginalMember(owner = "com.jagex.client!bt", name = "c", descriptor = "(II)V")
	...
	@OriginalMember(owner = "com.jagex.client!bt", name = "a", descriptor = "(II[II)V")
	...
	// put, jag str
	@OriginalMember(owner = "com.jagex.client!bt", name = "a", descriptor = "(Ljava/lang/String;I)V")
	public void pjstr(@OriginalArg(0) String str) {
		...
		this.pos += Cp1252.encodeString(str.length(), str, this.data, this.pos);
		this.data[this.pos++] = 0;
	}

	// get, 2 bytes signed
	@OriginalMember(owner = "com.jagex.client!bt", name = "i", descriptor = "(B)I")
	public int g2s() {
		this.pos += 2;
	...
	// put, smart
	@OriginalMember(owner = "com.jagex.client!bt", name = "b", descriptor = "(BI)V")
	...
	// get, 1 byte, as byte
	@OriginalMember(owner = "com.jagex.client!bt", name = "g", descriptor = "(I)B")
	public byte g1b() {
		return this.data[this.pos++];
	}

	// put, size, 4 bytes
	@OriginalMember(owner = "com.jagex.client!bt", name = "a", descriptor = "(ZI)V")
	...
	@OriginalMember(owner = "com.jagex.client!bt", name = "c", descriptor = "(BI)V")
	public void p1_alt1(@OriginalArg(1) int value) {
		this.data[this.pos++] = (byte) (value + 128);
	}

	// get, 2 bytes
	@OriginalMember(owner = "com.jagex.client!bt", name = "j", descriptor = "(B)I")
	public int g2() {
		this.pos += 2;
	...
	@OriginalMember(owner = "com.jagex.client!bt", name = "d", descriptor = "(II)V")
	...
	@OriginalMember(owner = "com.jagex.client!bt", name = "a", descriptor = "(II[BI)V")
	...
	// put, 8 bytes
	@OriginalMember(owner = "com.jagex.client!bt", name = "a", descriptor = "(IJ)V")
	...
	// get, 3 bytes
	@OriginalMember(owner = "com.jagex.client!bt", name = "h", descriptor = "(I)I")
	public int g3() {
		this.pos += 3;
	...
	// rsa, encrypt
	@OriginalMember(owner = "com.jagex.client!bt", name = "a", descriptor = "(Ljava/math/BigInteger;ILjava/math/BigInteger;)V")
	...
	@OriginalMember(owner = "com.jagex.client!bt", name = "d", descriptor = "(Z)I")
	public int g4_alt3() {
		this.pos += 4;
	...
	// get, 4 bytes
	@OriginalMember(owner = "com.jagex.client!bt", name = "i", descriptor = "(I)I")
	public int g4() {
		this.pos += 4;
	...
	// inverse, put, 4 bytes
	@OriginalMember(owner = "com.jagex.client!bt", name = "d", descriptor = "(BI)V")
	...
	@OriginalMember(owner = "com.jagex.client!bt", name = "e", descriptor = "(II)V")
	...
	@OriginalMember(owner = "com.jagex.client!bt", name = "k", descriptor = "(B)I")
	...
	@OriginalMember(owner = "com.jagex.client!bt", name = "e", descriptor = "(BI)V")
	...
	@OriginalMember(owner = "com.jagex.client!bt", name = "j", descriptor = "(I)B")
	public byte g1b_alt3() {
		return (byte) (128 - this.data[this.pos++]);
	}

	// put, 1 byte
	@OriginalMember(owner = "com.jagex.client!bt", name = "f", descriptor = "(II)V")
	public void p1(@OriginalArg(0) int value) {
		this.data[this.pos++] = (byte) value;
	}

	// put, 2 bytes
	@OriginalMember(owner = "com.jagex.client!bt", name = "g", descriptor = "(II)V")
	...
	@OriginalMember(owner = "com.jagex.client!bt", name = "l", descriptor = "(B)I")
	public int g4_alt1() {
		this.pos += 4;
	...
	// inverse, put, 2 bytes
	@OriginalMember(owner = "com.jagex.client!bt", name = "h", descriptor = "(II)V")
	...
	// put, 3 bytes
	@OriginalMember(owner = "com.jagex.client!bt", name = "i", descriptor = "(II)V")
	...
	@OriginalMember(owner = "com.jagex.client!bt", name = "f", descriptor = "(BI)V")
	...
	@OriginalMember(owner = "com.jagex.client!bt", name = "g", descriptor = "(BI)V")
	...
	@OriginalMember(owner = "com.jagex.client!bt", name = "m", descriptor = "(B)I")
	public int g2s_alt1() {
		this.pos += 2;
	...
	// put, size, 2 bytes
	@OriginalMember(owner = "com.jagex.client!bt", name = "j", descriptor = "(II)V")
	...
	@OriginalMember(owner = "com.jagex.client!bt", name = "l", descriptor = "(I)I")
	public int g4_alt2() {
		this.pos += 4;
	...
	@OriginalMember(owner = "com.jagex.client!bt", name = "n", descriptor = "(B)I")
	public int g2_alt3() {
		this.pos += 2;
		return ((this.data[this.pos - 1] & 0xFF) << 8) |
	...
	@OriginalMember(owner = "com.jagex.client!bt", name = "o", descriptor = "(B)B")
	public byte g1b_alt1() {
		return (byte) (this.data[this.pos++] - 128);
	}

	// put, 2 bytes, alt method 2
	@OriginalMember(owner = "com.jagex.client!bt", name = "c", descriptor = "(IB)V")
	...
	@OriginalMember(owner = "com.jagex.client!bt", name = "m", descriptor = "(I)Ljava/lang/String;")
	...
	// put, data
	@OriginalMember(owner = "com.jagex.client!bt", name = "a", descriptor = "(BI[BI)V")
	...
	@OriginalMember(owner = "com.jagex.client!bt", name = "a", descriptor = "([BIII)V")
	...
	// (fast) get, jag str
	@OriginalMember(owner = "com.jagex.client!bt", name = "p", descriptor = "(B)Ljava/lang/String;")
	...
	@OriginalMember(owner = "com.jagex.client!bt", name = "b", descriptor = "(ZI)J")
	...
	// put, size, 1 byte
	@OriginalMember(owner = "com.jagex.client!bt", name = "c", descriptor = "(ZI)V")
	public void psize1(@OriginalArg(1) int length) {
		this.data[this.pos - length - 1] = (byte) length;
	}

	// (eXtended) tiny (encryption algorithm) (XTEA), encrypt
	@OriginalMember(owner = "com.jagex.client!bt", name = "a", descriptor = "([II)V")
	...
	@OriginalMember(owner = "com.jagex.client!bt", name = "q", descriptor = "(B)I")
	public int g1_alt1() {
