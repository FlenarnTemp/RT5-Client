...
@OriginalClass("com.jagex.client!qg")
public final class PacketBit extends Packet {

	@OriginalMember(owner = "com.jagex.client!bp", name = "w", descriptor = "[I")
	...
	@OriginalMember(owner = "com.jagex.client!qg", name = "Mb", descriptor = "I")
	private int bitOffset;

	@OriginalMember(owner = "com.jagex.client!qg", name = "Qb", descriptor = "Lclient!sq;")
	private IsaacRandom random;

	@OriginalMember(owner = "com.jagex.client!qg", name = "<init>", descriptor = "(I)V")
	public PacketBit(@OriginalArg(0) int size) {
		super(size);
	}

	@OriginalMember(owner = "com.jagex.client!qg", name = "n", descriptor = "(I)I")
	public int g1isaac() {
	...
	@OriginalMember(owner = "com.jagex.client!qg", name = "r", descriptor = "(B)V")
	public void accessBytes() {
		super.pos = (this.bitOffset + 7) / 8;
	}

	// get, data, encrypted with isaac
	@OriginalMember(owner = "com.jagex.client!qg", name = "b", descriptor = "([BIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!qg", name = "k", descriptor = "(II)V")
	public void p1isaac(@OriginalArg(0) int op) {
		super.data[super.pos++] = (byte) (this.random.getNext() + op);
	}

	// get, n bits
	@OriginalMember(owner = "com.jagex.client!qg", name = "h", descriptor = "(BI)I")
	...
	@OriginalMember(owner = "com.jagex.client!qg", name = "o", descriptor = "(I)V")
	public void accessBits() {
		this.bitOffset = super.pos * 8;
	}

	// peek (do not advance), 1 byte, encrypted with isaac
	@OriginalMember(owner = "com.jagex.client!qg", name = "s", descriptor = "(B)Z")
	...
	// initialize isaac
	@OriginalMember(owner = "com.jagex.client!qg", name = "a", descriptor = "([IB)V")
	public void setKey(@OriginalArg(0) int[] key) {
		this.random = new IsaacRandom(key);
	}

	// get remaining bits at a position
	@OriginalMember(owner = "com.jagex.client!qg", name = "i", descriptor = "(BI)I")
