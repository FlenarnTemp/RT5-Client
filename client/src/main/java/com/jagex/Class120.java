...
@OriginalClass("com.jagex.client!ka")
public final class Class120 {

	@OriginalMember(owner = "com.jagex.client!ka", name = "a", descriptor = "[F")
	public static final float[] aFloatArray14 = new float[16384];

	@OriginalMember(owner = "com.jagex.client!ka", name = "b", descriptor = "[F")
