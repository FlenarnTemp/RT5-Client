...
@OriginalClass("com.jagex.client!lq")
public final class Class11_Sub2_Sub3 extends Class11_Sub2 implements Interface6 {

	@OriginalMember(owner = "com.jagex.client!lq", name = "p", descriptor = "Lclient!ql;")
	public final Class192 aClass192_2;

	@OriginalMember(owner = "com.jagex.client!lq", name = "C", descriptor = "Z")
	private final boolean aBoolean240;

	@OriginalMember(owner = "com.jagex.client!lq", name = "<init>", descriptor = "(Lclient!wm;Lclient!ct;IIIIIZII)V")
	public Class11_Sub2_Sub3(@OriginalArg(0) Renderer arg0, @OriginalArg(1) LocType arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) boolean arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9) {
		...
		this.aBoolean240 = arg1.active != 0 && !arg7;
	}

	@OriginalMember(owner = "com.jagex.client!lq", name = "a", descriptor = "(BLclient!wm;)V")
	@Override
	public void method6087(@OriginalArg(1) Renderer arg0) {
		this.aClass192_2.method4930(arg0);
	}

	@OriginalMember(owner = "com.jagex.client!lq", name = "e", descriptor = "(I)V")
	@Override
	public void method6069() {
		throw new IllegalStateException();
	}

	@OriginalMember(owner = "com.jagex.client!lq", name = "c", descriptor = "(I)I")
	@Override
	public int method6084() {
		return this.aClass192_2.anInt5429;
	}

	@OriginalMember(owner = "com.jagex.client!lq", name = "d", descriptor = "(I)I")
	@Override
	public int method6085() {
		return this.aClass192_2.anInt5432;
	}

	@OriginalMember(owner = "com.jagex.client!lq", name = "a", descriptor = "(IIBLclient!wm;)Z")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!lq", name = "a", descriptor = "(Z)Z")
	@Override
	public boolean method6086() {
		return this.aClass192_2.method4938();
	}

	@OriginalMember(owner = "com.jagex.client!lq", name = "b", descriptor = "(I)V")
	@Override
	public void method6082() {
	}

	@OriginalMember(owner = "com.jagex.client!lq", name = "a", descriptor = "(Lclient!wm;B)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!lq", name = "g", descriptor = "(I)Z")
	@Override
	public boolean method6076() {
		return false;
	}

	@OriginalMember(owner = "com.jagex.client!lq", name = "a", descriptor = "(ILclient!wm;I)Lclient!gn;")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!lq", name = "a", descriptor = "(I)I")
	@Override
	public int method6081() {
		return this.aClass192_2.anInt5433;
	}

	@OriginalMember(owner = "com.jagex.client!lq", name = "a", descriptor = "(IIILclient!wm;ZLclient!hp;Z)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!lq", name = "b", descriptor = "(Lclient!wm;B)Lclient!nf;")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!lq", name = "a", descriptor = "(Lclient!wm;I)V")
	@Override
