...
public final class Static79 {
	...
	@OriginalMember(owner = "com.jagex.client!ej", name = "E", descriptor = "Lclient!rc;")
	public static Class42 aClass42_4;

	@OriginalMember(owner = "com.jagex.client!ej", name = "H", descriptor = "Lclient!r;")
	public static Js5 aClass197_19;

	@OriginalMember(owner = "com.jagex.client!ej", name = "N", descriptor = "Z")
	public static boolean aBoolean131 = true;

	@OriginalMember(owner = "com.jagex.client!ej", name = "a", descriptor = "()V")
	...
	@OriginalMember(owner = "com.jagex.client!ej", name = "a", descriptor = "(IIIIIBIII)V")
	public static void method1871(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7) {
		if (arg1 < 1 || arg7 < 1 || Static373.buildAreaLimitX - 2 < arg1 || Static242.buildAreaLimitZ - 2 < arg7) {
			return;
		}
