...
@OriginalClass("com.jagex.client!ve")
public final class Class180_Sub2 extends Class180 implements Interface4 {

	@OriginalMember(owner = "com.jagex.client!ve", name = "c", descriptor = "I")
	private int anInt6773;

	@OriginalMember(owner = "com.jagex.client!ve", name = "d", descriptor = "I")
	private int anInt6774;

	@OriginalMember(owner = "com.jagex.client!ve", name = "<init>", descriptor = "(Lclient!bf;I[BI)V")
	...
	@OriginalMember(owner = "com.jagex.client!ve", name = "a", descriptor = "(III)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!ve", name = "a", descriptor = "()I")
	@Override
	public int method6066() {
		return 0;
	}

	@OriginalMember(owner = "com.jagex.client!ve", name = "a", descriptor = "(I[BI)V")
	@Override
