...
import com.jagex.Static362;
import org.openrs2.deob.annotation.OriginalArg;
import org.openrs2.deob.annotation.OriginalClass;
import org.openrs2.deob.annotation.OriginalMember;
import org.openrs2.deob.annotation.Pc;

@OriginalClass("com.jagex.client!vd")
public final class VorbisFloor {

	@OriginalMember(owner = "com.jagex.client!vd", name = "d", descriptor = "[I")
	public static final int[] RANGES = new int[] { 256, 128, 86, 64 };
	@OriginalMember(owner = "com.jagex.client!vd", name = "e", descriptor = "[F")
	...
	@OriginalMember(owner = "com.jagex.client!vd", name = "k", descriptor = "[I")
	private final int[] anIntArray474;

	@OriginalMember(owner = "com.jagex.client!vd", name = "h", descriptor = "[I")
	private final int[] anIntArray472;

	@OriginalMember(owner = "com.jagex.client!vd", name = "j", descriptor = "[I")
	private final int[] anIntArray473;

	@OriginalMember(owner = "com.jagex.client!vd", name = "b", descriptor = "[I")
	private final int[] anIntArray469;

	@OriginalMember(owner = "com.jagex.client!vd", name = "f", descriptor = "[[I")
	private final int[][] anIntArrayArray60;

	@OriginalMember(owner = "com.jagex.client!vd", name = "g", descriptor = "I")
	private final int anInt6772;

	@OriginalMember(owner = "com.jagex.client!vd", name = "l", descriptor = "[I")
	private final int[] anIntArray475;

	@OriginalMember(owner = "com.jagex.client!vd", name = "<init>", descriptor = "()V")
	public VorbisFloor() {
		@Pc(4) int local4 = Static267.read(16);
		if (local4 != 1) {
			throw new RuntimeException();
		}
		@Pc(14) int local14 = Static267.read(5);
		@Pc(16) int local16 = 0;
		this.anIntArray474 = new int[local14];
		@Pc(26) int local26;
		for (@Pc(22) int local22 = 0; local22 < local14; local22++) {
			local26 = Static267.read(4);
		...
		for (local26 = 0; local26 < local16; local26++) {
			this.anIntArray472[local26] = Static267.read(3) + 1;
			local77 = this.anIntArray473[local26] = Static267.read(2);
			if (local77 != 0) {
				this.anIntArray469[local26] = Static267.read(8);
			}
			local77 = 0x1 << local77;
			@Pc(92) int[] local92 = new int[local77];
			this.anIntArrayArray60[local26] = local92;
			for (local99 = 0; local99 < local77; local99++) {
				local92[local99] = Static267.read(8) - 1;
			}
		}
		this.anInt6772 = Static267.read(2) + 1;
		local77 = Static267.read(4);
	...
	public void method6057(@OriginalArg(0) float[] arg0, @OriginalArg(1) int arg1) {
		...
		for (@Pc(20) int local20 = 2; local20 < local3; local20++) {
			...
			local47 = this.method6062(Static362.anIntArray470[local25], Static362.y[local25], Static362.anIntArray470[local29], Static362.y[local29], Static362.anIntArray470[local20]);
			local51 = Static362.y[local20];
			local55 = local10 - local47;
			@Pc(66) int local66 = (local55 < local47 ? local55 : local47) << 1;
			if (local51 == 0) {
				Static362.aBooleanArray60[local20] = false;
				Static362.y[local20] = local47;
			} else {
				Static362.aBooleanArray60[local25] = Static362.aBooleanArray60[local29] = true;
				Static362.aBooleanArray60[local20] = true;
				if (local51 >= local66) {
					Static362.y[local20] = local55 > local47 ? local51 + local47 - local47 : local47 - local51 + local55 - 1;
				} else {
					Static362.y[local20] = (local51 & 0x1) == 0 ? local47 + local51 / 2 : local47 - (local51 + 1) / 2;
				}
			}
		}
		this.method6058(0, local3 - 1);
		local25 = 0;
		local29 = Static362.y[0] * this.anInt6772;
		for (local47 = 1; local47 < local3; local47++) {
			if (Static362.aBooleanArray60[local47]) {
				local51 = Static362.anIntArray470[local47];
				local55 = Static362.y[local47] * this.anInt6772;
		...
		@Pc(193) float local193 = INVERSE_DB_TABLE[local29];
		for (local55 = local25; local55 < arg1; local55++) {
			arg0[local55] *= local193;
		}
	}

	@OriginalMember(owner = "com.jagex.client!vd", name = "a", descriptor = "(II)V")
	private void method6058(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		@Pc(13) int local13 = Static362.y[arg0];
		...
		for (@Pc(21) int local21 = arg0 + 1; local21 <= arg1; local21++) {
			...
			if (local26 < local9) {
				...
				Static362.y[local5] = Static362.y[local21];
	...
	public boolean method6061() {
		...
		@Pc(34) int local34 = RANGES[this.anInt6772 - 1];
		@Pc(40) int local40 = Static287.ilog(local34 - 1);
		Static362.y[0] = Static267.read(local40);
		Static362.y[1] = Static267.read(local40);
		@Pc(52) int local52 = 2;
		for (@Pc(54) int local54 = 0; local54 < this.anIntArray474.length; local54++) {
			...
			for (@Pc(90) int local90 = 0; local90 < local65; local90++) {
				...
				local78 >>>= local70;
				Static362.y[local52++] = local100 >= 0 ? Static267.codebooks[local100].decodeScalar() : 0;
			}
		}
		return true;
	}

	@OriginalMember(owner = "com.jagex.client!vd", name = "a", descriptor = "(IIIII)I")
