...
@OriginalClass("com.jagex.client!ts")
public final class Class226 implements Interface11 {

	@OriginalMember(owner = "com.jagex.client!ts", name = "d", descriptor = "Lclient!ad;")
	private HashTable aClass4_132 = new HashTable(128);

	@OriginalMember(owner = "com.jagex.client!ts", name = "j", descriptor = "[I")
	private final int[] anIntArray431 = new int[client.VarpTypes.anInt5596];

	@OriginalMember(owner = "com.jagex.client!ts", name = "b", descriptor = "[I")
	...
	@OriginalMember(owner = "com.jagex.client!ts", name = "a", descriptor = "(B)V")
	...
	@OriginalMember(owner = "com.jagex.client!ts", name = "a", descriptor = "(IZ)I")
		...
		for (@Pc(27) Class2_Sub35 local27 = arg0 ? (Class2_Sub35) this.aClass4_132.head() : (Class2_Sub35) this.aClass4_132.next(); local27 != null; local27 = (Class2_Sub35) this.aClass4_132.next()) {
			if (local13 > (local27.aLong183 & 0x3FFFFFFFFFFFFFFFL)) {
				if ((local27.aLong183 & 0x4000000000000000L) != 0L) {
					@Pc(54) int local54 = (int) local27.nodeId;
	...
	@OriginalMember(owner = "com.jagex.client!ts", name = "a", descriptor = "(II)I")
	@Override
