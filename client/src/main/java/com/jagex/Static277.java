...
public final class Static277 {
	...
	@OriginalMember(owner = "com.jagex.client!q", name = "l", descriptor = "[[I")
	public static int[][] anIntArrayArray43;

	@OriginalMember(owner = "com.jagex.client!q", name = "a", descriptor = "(IIIIB)V")
	...
	@OriginalMember(owner = "com.jagex.client!q", name = "a", descriptor = "(Lclient!mr;B)V")
	public static void method4682(@OriginalArg(0) PathingEntity arg0) {
		...
		if (arg0.anInt4584 == client.cycle || arg0.anInt4597 == -1 || arg0.anInt4590 != 0) {
			...
			@Pc(25) SeqType local25 = client.SeqTypes.method2371(arg0.anInt4597);
			if (local25.aBoolean264 || arg0.anInt4624 + 1 > local25.frames[arg0.anInt4607]) {
				local5 = true;
			}
		}
		if (local5) {
