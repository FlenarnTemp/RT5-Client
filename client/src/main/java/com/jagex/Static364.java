...
public final class Static364 {
	...
	@OriginalMember(owner = "com.jagex.client!vg", name = "w", descriptor = "I")
	public static int anInt6817;

	@OriginalMember(owner = "com.jagex.client!vg", name = "s", descriptor = "[I")
	public static final int[] anIntArray477 = new int[4096];

	@OriginalMember(owner = "com.jagex.client!vg", name = "a", descriptor = "(BIIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!vg", name = "a", descriptor = "(ZII[Lclient!nk;ZI)V")
