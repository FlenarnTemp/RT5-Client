...
public final class Static290 {
	...
	@OriginalMember(owner = "com.jagex.client!qp", name = "g", descriptor = "Lclient!bi;")
	public static Class22 aClass22_3;

	@OriginalMember(owner = "com.jagex.client!qp", name = "c", descriptor = "I")
	public static int anInt5498 = -1;

	@OriginalMember(owner = "com.jagex.client!qp", name = "i", descriptor = "Ljava/lang/String;")
	public static String aString56 = null;

	@OriginalMember(owner = "com.jagex.client!qp", name = "a", descriptor = "(II)V")
	public static void method5023(@OriginalArg(0) int arg0) {
		@Pc(8) DelayedStateChange local8 = Static316.method5413(2, arg0);
		local8.method2312();
	}

	@OriginalMember(owner = "com.jagex.client!qp", name = "a", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!qp", name = "a", descriptor = "(ILclient!bt;)Lclient!gr;")
