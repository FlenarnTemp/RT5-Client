...
public final class Static29 {
	...
	@OriginalMember(owner = "com.jagex.client!bm", name = "E", descriptor = "I")
	public static int anInt722;

	@OriginalMember(owner = "com.jagex.client!bm", name = "D", descriptor = "I")
	public static int anInt721 = -1;

	@OriginalMember(owner = "com.jagex.client!bm", name = "S", descriptor = "J")
	public static long aLong22 = 0L;

	@OriginalMember(owner = "com.jagex.client!bm", name = "b", descriptor = "(Z)V")
	...
	@OriginalMember(owner = "com.jagex.client!bm", name = "a", descriptor = "(IIILclient!el;)V")
	...
	@OriginalMember(owner = "com.jagex.client!bm", name = "a", descriptor = "(II)I")
