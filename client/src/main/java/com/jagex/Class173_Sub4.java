...
@OriginalClass("com.jagex.client!vo")
public final class Class173_Sub4 extends Class173 {

	@OriginalMember(owner = "com.jagex.client!vo", name = "G", descriptor = "I")
	private final int anInt7016;

	@OriginalMember(owner = "com.jagex.client!vo", name = "n", descriptor = "I")
	private final int anInt7003;

	@OriginalMember(owner = "com.jagex.client!vo", name = "E", descriptor = "I")
	private final int anInt7015;

	@OriginalMember(owner = "com.jagex.client!vo", name = "o", descriptor = "I")
	private final int anInt7004;

	@OriginalMember(owner = "com.jagex.client!vo", name = "v", descriptor = "I")
	private final int anInt7010;

	@OriginalMember(owner = "com.jagex.client!vo", name = "u", descriptor = "I")
	private final int anInt7009;

	@OriginalMember(owner = "com.jagex.client!vo", name = "s", descriptor = "I")
	private final int anInt7007;

	@OriginalMember(owner = "com.jagex.client!vo", name = "l", descriptor = "I")
	private final int anInt7002;

	@OriginalMember(owner = "com.jagex.client!vo", name = "<init>", descriptor = "(IIIIIIIIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!vo", name = "b", descriptor = "(III)V")
	@Override
	public void method6251(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
	}

	@OriginalMember(owner = "com.jagex.client!vo", name = "a", descriptor = "(III)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!vo", name = "a", descriptor = "(IBI)V")
	@Override
