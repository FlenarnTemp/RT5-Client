...
public final class Static77 {
	...
	@OriginalMember(owner = "com.jagex.client!eh", name = "x", descriptor = "I")
	public static int anInt1756;

	@OriginalMember(owner = "com.jagex.client!eh", name = "D", descriptor = "I")
	public static int anInt1762 = 0;

	@OriginalMember(owner = "com.jagex.client!eh", name = "E", descriptor = "I")
	public static int anInt1763 = -1;

	@OriginalMember(owner = "com.jagex.client!eh", name = "d", descriptor = "(I)V")
