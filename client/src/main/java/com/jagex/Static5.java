...
public final class Static5 {
	...
	@OriginalMember(owner = "com.jagex.client!ad", name = "y", descriptor = "I")
	public static int anInt105;

	@OriginalMember(owner = "com.jagex.client!ad", name = "p", descriptor = "J")
	public static long aLong11 = 0L;

	@OriginalMember(owner = "com.jagex.client!ad", name = "w", descriptor = "Lclient!gd;")
	public static final LocalizedString aClass79_2 = new LocalizedString("skill: ", "Fertigkeit: ", "compétence ", "habilidade: ");

	@OriginalMember(owner = "com.jagex.client!ad", name = "a", descriptor = "(IIILclient!ml;II)Ljava/awt/Frame;")
