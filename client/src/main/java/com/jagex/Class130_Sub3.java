...
@OriginalClass("com.jagex.client!sf")
public final class Class130_Sub3 extends BitmapFont {

	@OriginalMember(owner = "com.jagex.client!sf", name = "A", descriptor = "Lclient!j;")
	private Class19_Sub2 aClass19_Sub2_8;

	@OriginalMember(owner = "com.jagex.client!sf", name = "z", descriptor = "[I")
	private int[] anIntArray395;

	@OriginalMember(owner = "com.jagex.client!sf", name = "u", descriptor = "[I")
	private int[] anIntArray391;

	@OriginalMember(owner = "com.jagex.client!sf", name = "x", descriptor = "[[B")
	private byte[][] aByteArrayArray18;

	@OriginalMember(owner = "com.jagex.client!sf", name = "v", descriptor = "[I")
	private int[] anIntArray392;

	@OriginalMember(owner = "com.jagex.client!sf", name = "w", descriptor = "[I")
	private int[] anIntArray393;

	@OriginalMember(owner = "com.jagex.client!sf", name = "y", descriptor = "[I")
	private int[] anIntArray394;

	protected Class130_Sub3(Renderer arg0, Class239 arg1) {
		super(arg0, arg1);
	}

	@OriginalMember(owner = "com.jagex.client!sf", name = "a", descriptor = "(CIIIZLclient!kf;II)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!sf", name = "a", descriptor = "([B[I[IIIIIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!sf", name = "a", descriptor = "([B[IIIIIIIIIIILclient!kf;II)V")
	...
	@OriginalMember(owner = "com.jagex.client!sf", name = "a", descriptor = "([B[I[IIIIIIIIIIILclient!kf;II)V")
	...
	@OriginalMember(owner = "com.jagex.client!sf", name = "a", descriptor = "(CIIIZ)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!sf", name = "a", descriptor = "([B[IIIIIIII)V")
