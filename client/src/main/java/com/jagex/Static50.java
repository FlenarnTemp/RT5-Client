...
public final class Static50 {
	...
	@OriginalMember(owner = "com.jagex.client!ct", name = "N", descriptor = "I")
	public static int anInt1332 = 0;

	@OriginalMember(owner = "com.jagex.client!ct", name = "xb", descriptor = "[Lclient!go;")
	public static final Class84[] aClass84Array1 = new Class84[8];

	@OriginalMember(owner = "com.jagex.client!ct", name = "a", descriptor = "(ZZ)V")
	...
	@OriginalMember(owner = "com.jagex.client!ct", name = "a", descriptor = "(IBIIIII)I")
	...
	@OriginalMember(owner = "com.jagex.client!ct", name = "e", descriptor = "(B)V")
