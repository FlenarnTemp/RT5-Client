...
public final class Static372 {
	...
	@OriginalMember(owner = "com.jagex.client!vp", name = "a", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!vp", name = "a", descriptor = "(BII)V")
	public static void method6262(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
		...
		for (@Pc(15) Class2_Sub32 local15 = (Class2_Sub32) Static120.objStacks.head(); local15 != null; local15 = (Class2_Sub32) Static120.objStacks.next()) {
			local15.remove();
			@Pc(26) int local26 = (int) (local15.nodeId >> 28);
			@Pc(36) int local36 = (int) (local15.nodeId >> 14 & 0x3FFFL) - arg0;
			@Pc(45) int local45 = (int) (local15.nodeId & 0x3FFFL) - arg1;
			if (local45 >= 0 && local36 >= 0 && local45 < Static373.buildAreaLimitX && local36 < Static242.buildAreaLimitZ) {
				local10.pushNode(local15, (long) (local26 << 28 | local36 << 14 | local45));
			}
		}
		Static120.objStacks = local10;
	}

	@OriginalMember(owner = "com.jagex.client!vp", name = "a", descriptor = "(BLclient!bt;)Lclient!rm;")
