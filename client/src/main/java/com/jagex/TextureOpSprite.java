...
@OriginalClass("com.jagex.client!ek")
public class TextureOpSprite extends TextureOp {

	@OriginalMember(owner = "com.jagex.client!ek", name = "Q", descriptor = "I")
	protected int anInt6672;

	@OriginalMember(owner = "com.jagex.client!ek", name = "U", descriptor = "[I")
	protected int[] anIntArray463;

	@OriginalMember(owner = "com.jagex.client!ek", name = "bb", descriptor = "I")
	protected int anInt6680;

	@OriginalMember(owner = "com.jagex.client!ek", name = "T", descriptor = "I")
	private int anInt6675 = -1;

	@OriginalMember(owner = "com.jagex.client!ek", name = "<init>", descriptor = "()V")
	public TextureOpSprite() {
		super(0, false);
	}

	@OriginalMember(owner = "com.jagex.client!ek", name = "a", descriptor = "(ILclient!bt;I)V")
	@Override
	public final void decode(@OriginalArg(0) int code, @OriginalArg(1) Packet buf) {
		if (code == 0) {
			this.anInt6675 = buf.g2();
		}
	}

	@OriginalMember(owner = "com.jagex.client!ek", name = "f", descriptor = "(I)Z")
	protected final boolean method5983() {
		if (this.anIntArray463 != null) {
			return true;
		} else if (this.anInt6675 >= 0) {
			@Pc(34) SpriteData local34 = Static123.anInt2421 >= 0 ? Static396.method1682(Texture.spritesArchive, Static123.anInt2421, this.anInt6675) : Static396.method1676(Texture.spritesArchive, this.anInt6675);
			local34.method1681();
	...
	@OriginalMember(owner = "com.jagex.client!ek", name = "b", descriptor = "(I)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!ek", name = "c", descriptor = "(I)I")
	@Override
	public final int method6478() {
		return this.anInt6675;
	}

	@OriginalMember(owner = "com.jagex.client!ek", name = "b", descriptor = "(IB)[[I")
	@Override
