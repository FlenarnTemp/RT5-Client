...
public final class Static219 {
	...
	@OriginalMember(owner = "com.jagex.client!mp", name = "r", descriptor = "F")
	public static float aFloat45;

	@OriginalMember(owner = "com.jagex.client!mp", name = "x", descriptor = "F")
	public static float aFloat46;

	@OriginalMember(owner = "com.jagex.client!mp", name = "J", descriptor = "[J")
	public static long[] aLongArray6;

	@OriginalMember(owner = "com.jagex.client!mp", name = "O", descriptor = "F")
	public static float aFloat47;

	@OriginalMember(owner = "com.jagex.client!mp", name = "S", descriptor = "F")
	public static float aFloat48;

	@OriginalMember(owner = "com.jagex.client!mp", name = "W", descriptor = "F")
	public static float aFloat49;

	@OriginalMember(owner = "com.jagex.client!mp", name = "hb", descriptor = "F")
	public static float aFloat50;

	@OriginalMember(owner = "com.jagex.client!mp", name = "sb", descriptor = "Z")
	public static boolean aBoolean251;

	@OriginalMember(owner = "com.jagex.client!mp", name = "tb", descriptor = "I")
	public static int anInt3845;

	@OriginalMember(owner = "com.jagex.client!mp", name = "Bb", descriptor = "I")
	public static int anInt3846;

	@OriginalMember(owner = "com.jagex.client!mp", name = "Db", descriptor = "I")
	public static int anInt3847;

	@OriginalMember(owner = "com.jagex.client!mp", name = "gb", descriptor = "Lclient!ji;")
	public static GlPacket aClass2_Sub4_Sub1_3 = new GlPacket(8192);

	@OriginalMember(owner = "com.jagex.client!mp", name = "ub", descriptor = "[I")
	public static final int[] anIntArray240 = new int[8];

	@OriginalMember(owner = "com.jagex.client!mp", name = "vb", descriptor = "[I")
	public static final int[] anIntArray241 = new int[8];

	@OriginalMember(owner = "com.jagex.client!mp", name = "wb", descriptor = "[I")
	public static int[] anIntArray242 = new int[1];

	@OriginalMember(owner = "com.jagex.client!mp", name = "yb", descriptor = "[I")
	public static int[] anIntArray243 = new int[1];

	@OriginalMember(owner = "com.jagex.client!mp", name = "Ab", descriptor = "[I")
	...
	@OriginalMember(owner = "com.jagex.client!mp", name = "a", descriptor = "(IZI)I")
	...
	@OriginalMember(owner = "com.jagex.client!mp", name = "a", descriptor = "(IFIIIIFF)[F")
	...
	@OriginalMember(owner = "com.jagex.client!mp", name = "a", descriptor = "(IIBIIIFI[FI)V")
	...
	@OriginalMember(owner = "com.jagex.client!mp", name = "a", descriptor = "([FFIFIFBIIIIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!mp", name = "a", descriptor = "(FFFI)I")
	...
	@OriginalMember(owner = "com.jagex.client!mp", name = "a", descriptor = "(IF[FIIIFIIII)V")
