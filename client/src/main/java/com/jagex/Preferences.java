...
@OriginalClass("com.jagex.client!pe")
public final class Preferences extends Class177 {

	@OriginalMember(owner = "com.jagex.client!nk", name = "jc", descriptor = "Z")
	public static boolean sentToServer = true;
	@OriginalMember(owner = "com.jagex.client!pe", name = "O", descriptor = "Z")
	public boolean aBoolean365 = false;

	@OriginalMember(owner = "com.jagex.client!pe", name = "S", descriptor = "Z")
	public boolean neverRemoveRoofs = false;

	@OriginalMember(owner = "com.jagex.client!pe", name = "<init>", descriptor = "(Lclient!ml;)V")
	...
	@OriginalMember(owner = "com.jagex.client!bj", name = "a", descriptor = "(IZ)V")
	...
	@OriginalMember(owner = "com.jagex.client!km", name = "a", descriptor = "(I)I")
	public static int getParticles() {
		return Static153.anInt2794;
	}

	@OriginalMember(owner = "com.jagex.client!pe", name = "a", descriptor = "(BI)I")
	...
	@OriginalMember(owner = "com.jagex.client!pe", name = "a", descriptor = "(ZI)V")
	...
	@OriginalMember(owner = "com.jagex.client!pe", name = "d", descriptor = "(I)Lclient!bt;")
	...
	@OriginalMember(owner = "com.jagex.client!pe", name = "a", descriptor = "(ILclient!bt;)V")
