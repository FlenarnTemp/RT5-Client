...
@OriginalClass("com.jagex.client!sa")
public final class TextureOpPolarDistortion extends TextureOp {

	@OriginalMember(owner = "com.jagex.client!sa", name = "O", descriptor = "I")
	private int anInt5838 = 32768;

	@OriginalMember(owner = "com.jagex.client!sa", name = "<init>", descriptor = "()V")
	public TextureOpPolarDistortion() {
		super(3, false);
	}

	@OriginalMember(owner = "com.jagex.client!sa", name = "a", descriptor = "(ILclient!bt;I)V")
	@Override
	public void decode(@OriginalArg(0) int code, @OriginalArg(1) Packet buf) {
		if (code == 0) {
			this.anInt5838 = buf.g2() << 4;
		} else if (code == 1) {
			super.monochrome = buf.g1() == 1;
		}
	}

	@OriginalMember(owner = "com.jagex.client!sa", name = "b", descriptor = "(IB)[[I")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!sa", name = "a", descriptor = "(BI)[I")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!sa", name = "d", descriptor = "(I)V")
	@Override
