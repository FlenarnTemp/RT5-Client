...
@OriginalClass("com.jagex.client!pc")
public final class SynthFilter {

	@OriginalMember(owner = "com.jagex.client!pc", name = "b", descriptor = "[I")
	private final int[] anIntArray331 = new int[2];

	@OriginalMember(owner = "com.jagex.client!pc", name = "d", descriptor = "[[[I")
	private final int[][][] anIntArrayArrayArray10 = new int[2][2][4];

	@OriginalMember(owner = "com.jagex.client!pc", name = "h", descriptor = "[I")
	public final int[] anIntArray332 = new int[2];

	@OriginalMember(owner = "com.jagex.client!pc", name = "e", descriptor = "[[[I")
	private final int[][][] anIntArrayArrayArray11 = new int[2][2][4];

	@OriginalMember(owner = "com.jagex.client!pc", name = "a", descriptor = "(Lclient!bt;Lclient!uf;)V")
	public void method4468(@OriginalArg(0) Packet arg0, @OriginalArg(1) SynthEnvelope arg1) {
	...
	@OriginalMember(owner = "com.jagex.client!pc", name = "a", descriptor = "(IF)I")
	...
	@OriginalMember(owner = "com.jagex.client!pc", name = "a", descriptor = "(IIF)F")
	...
	@OriginalMember(owner = "com.jagex.client!pc", name = "b", descriptor = "(IIF)F")
