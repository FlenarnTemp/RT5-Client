...
@OriginalClass("com.jagex.client!nd")
public final class AnimFrame {

	@OriginalMember(owner = "com.jagex.client!nd", name = "j", descriptor = "[S")
	public static final short[] tempIndices = new short[500];
	@OriginalMember(owner = "com.jagex.client!nd", name = "d", descriptor = "[S")
	public static final short[] tempX = new short[500];
	@OriginalMember(owner = "com.jagex.client!nd", name = "e", descriptor = "[S")
	public static final short[] tempY = new short[500];
	@OriginalMember(owner = "com.jagex.client!nd", name = "f", descriptor = "[S")
	public static final short[] tempZ = new short[500];
	@OriginalMember(owner = "com.jagex.client!nd", name = "h", descriptor = "[B")
	public static final byte[] tempFlags = new byte[500];
	@OriginalMember(owner = "com.jagex.client!nd", name = "a", descriptor = "[S")
	public static final short[] tempPrevOriginIndices = new short[500];
	@OriginalMember(owner = "com.jagex.client!nd", name = "l", descriptor = "I")
	public int length = 0;

	@OriginalMember(owner = "com.jagex.client!nd", name = "o", descriptor = "Z")
	public boolean transformsAlpha = false;

	@OriginalMember(owner = "com.jagex.client!nd", name = "m", descriptor = "Lclient!ib;")
	public AnimBase base = null;

	@OriginalMember(owner = "com.jagex.client!nd", name = "g", descriptor = "Z")
	public boolean transformsColor = false;

	@OriginalMember(owner = "com.jagex.client!nd", name = "c", descriptor = "[S")
	public short[] indices;

	@OriginalMember(owner = "com.jagex.client!nd", name = "b", descriptor = "[S")
	public short[] x;

	@OriginalMember(owner = "com.jagex.client!nd", name = "k", descriptor = "[S")
	public short[] y;

	@OriginalMember(owner = "com.jagex.client!nd", name = "n", descriptor = "[S")
	public short[] z;

	@OriginalMember(owner = "com.jagex.client!nd", name = "p", descriptor = "[S")
	public short[] prevOriginIndices;

	@OriginalMember(owner = "com.jagex.client!nd", name = "i", descriptor = "[B")
	public byte[] flags;

	@OriginalMember(owner = "com.jagex.client!nd", name = "<init>", descriptor = "([BLclient!ib;)V")
