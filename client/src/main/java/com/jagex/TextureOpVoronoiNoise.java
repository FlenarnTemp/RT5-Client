...
@OriginalClass("com.jagex.client!jt")
public final class TextureOpVoronoiNoise extends TextureOp {

	@OriginalMember(owner = "com.jagex.client!jt", name = "T", descriptor = "I")
	private int anInt3261 = 0;

	@OriginalMember(owner = "com.jagex.client!jt", name = "R", descriptor = "[S")
	private short[] aShortArray55 = new short[512];

	@OriginalMember(owner = "com.jagex.client!jt", name = "O", descriptor = "I")
	private int anInt3257 = 2048;

	@OriginalMember(owner = "com.jagex.client!jt", name = "W", descriptor = "[B")
	private byte[] aByteArray34 = new byte[512];

	@OriginalMember(owner = "com.jagex.client!jt", name = "Y", descriptor = "I")
	private int anInt3263 = 5;

	@OriginalMember(owner = "com.jagex.client!jt", name = "N", descriptor = "I")
	private int anInt3256 = 1;

	@OriginalMember(owner = "com.jagex.client!jt", name = "ab", descriptor = "I")
	private int anInt3265 = 5;

	@OriginalMember(owner = "com.jagex.client!jt", name = "Z", descriptor = "I")
	private int anInt3264 = 2;

	@OriginalMember(owner = "com.jagex.client!jt", name = "<init>", descriptor = "()V")
	public TextureOpVoronoiNoise() {
		super(0, true);
	}

	@OriginalMember(owner = "com.jagex.client!jt", name = "a", descriptor = "(ILclient!bt;I)V")
	@Override
	public void decode(@OriginalArg(0) int code, @OriginalArg(1) Packet buf) {
		if (code == 0) {
			this.anInt3263 = this.anInt3265 = buf.g1();
		} else if (code == 1) {
			this.anInt3261 = buf.g1();
		} else if (code == 2) {
			this.anInt3257 = buf.g2();
		} else if (code == 3) {
			this.anInt3264 = buf.g1();
		} else if (code == 4) {
			this.anInt3256 = buf.g1();
		} else if (code == 5) {
			this.anInt3263 = buf.g1();
		} else if (code == 6) {
			this.anInt3265 = buf.g1();
		}
	}

	@OriginalMember(owner = "com.jagex.client!jt", name = "b", descriptor = "(B)V")
	...
	@OriginalMember(owner = "com.jagex.client!jt", name = "a", descriptor = "(BI)[I")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!jt", name = "d", descriptor = "(I)V")
	@Override
