...
public final class Static120 {
	...
	@OriginalMember(owner = "com.jagex.client!gs", name = "d", descriptor = "Lclient!gd;")
	...
	@OriginalMember(owner = "com.jagex.client!gs", name = "h", descriptor = "Lclient!ad;")
	public static HashTable objStacks = new HashTable(64);

	@OriginalMember(owner = "com.jagex.client!gs", name = "m", descriptor = "I")
	public static int anInt2387 = 0;

	@OriginalMember(owner = "com.jagex.client!gs", name = "a", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!gs", name = "a", descriptor = "([[BBLclient!bu;)V")
	...
	@OriginalMember(owner = "com.jagex.client!gs", name = "a", descriptor = "(IBI)V")
	...
	@OriginalMember(owner = "com.jagex.client!gs", name = "a", descriptor = "(ILclient!bt;B)Ljava/lang/String;")
	public static String method2384(@OriginalArg(1) Packet arg0) {
		try {
			...
			return Cp1252.decodeString(0, local23, local7);
