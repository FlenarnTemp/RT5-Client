...
@OriginalClass("com.jagex.client!ht")
public final class Class8_Sub2 extends Class8 {

	@OriginalMember(owner = "com.jagex.client!ht", name = "i", descriptor = "I")
	private final int anInt2600;

	@OriginalMember(owner = "com.jagex.client!ht", name = "<init>", descriptor = "(Lclient!bf;II[BI)V")
	...
	@OriginalMember(owner = "com.jagex.client!ht", name = "a", descriptor = "(ZI)V")
	...
	@OriginalMember(owner = "com.jagex.client!ht", name = "a", descriptor = "()V")
	@Override
