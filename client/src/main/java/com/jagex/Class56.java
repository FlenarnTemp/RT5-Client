...
@OriginalClass("com.jagex.client!ea")
public final class Class56 {

	@OriginalMember(owner = "com.jagex.client!ea", name = "c", descriptor = "Lclient!hu;")
	private final LruHashTable aClass98_8 = new LruHashTable(256);

	@OriginalMember(owner = "com.jagex.client!ea", name = "a", descriptor = "Lclient!bf;")
	private final Class19_Sub1 aClass19_Sub1_9;

	@OriginalMember(owner = "com.jagex.client!ea", name = "b", descriptor = "Lclient!ci;")
	private final TextureProviderInterface anInterface2_3;

	@OriginalMember(owner = "com.jagex.client!ea", name = "<init>", descriptor = "(Lclient!bf;Lclient!ci;)V")
	...
	@OriginalMember(owner = "com.jagex.client!ea", name = "a", descriptor = "(I)V")
	public void method1787() {
		this.aClass98_8.method2614();
	}

	@OriginalMember(owner = "com.jagex.client!ea", name = "a", descriptor = "(IB)Lclient!al;")
