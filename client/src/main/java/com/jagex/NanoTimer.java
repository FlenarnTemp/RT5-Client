...
@OriginalClass("com.jagex.client!op")
public final class NanoTimer extends Timer {

	@OriginalMember(owner = "com.jagex.client!op", name = "g", descriptor = "J")
	private long aLong139 = 0L;

	@OriginalMember(owner = "com.jagex.client!op", name = "h", descriptor = "J")
	private long aLong140 = 0L;

	@OriginalMember(owner = "com.jagex.client!op", name = "k", descriptor = "J")
	private long aLong141 = 0L;

	@OriginalMember(owner = "com.jagex.client!op", name = "l", descriptor = "I")
	private int anInt4760 = 1;

	@OriginalMember(owner = "com.jagex.client!op", name = "j", descriptor = "I")
	private int anInt4759 = 0;

	@OriginalMember(owner = "com.jagex.client!op", name = "i", descriptor = "[J")
	private final long[] aLongArray8 = new long[10];

	@OriginalMember(owner = "com.jagex.client!op", name = "<init>", descriptor = "()V")
	public NanoTimer() {
		this.aLong139 = System.nanoTime();
		this.aLong140 = System.nanoTime();
	}

	@OriginalMember(owner = "com.jagex.client!op", name = "d", descriptor = "(I)J")
	...
	@OriginalMember(owner = "com.jagex.client!op", name = "a", descriptor = "(ZI)I")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!op", name = "c", descriptor = "(I)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!op", name = "a", descriptor = "(I)J")
	@Override
