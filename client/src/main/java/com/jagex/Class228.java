...
@OriginalClass("com.jagex.client!ua")
public final class Class228 implements Interface8 {

	@OriginalMember(owner = "com.jagex.client!ua", name = "a", descriptor = "I")
	private int anInt6403;

	@OriginalMember(owner = "com.jagex.client!ua", name = "b", descriptor = "I")
	private int anInt6404;

	@OriginalMember(owner = "com.jagex.client!ua", name = "e", descriptor = "I")
	private int anInt6405;

	@OriginalMember(owner = "com.jagex.client!ua", name = "c", descriptor = "[Lclient!aq;")
	private final Interface1[] anInterface1Array1 = new Interface1[9];

	@OriginalMember(owner = "com.jagex.client!ua", name = "h", descriptor = "Lclient!bf;")
	private final Class19_Sub1 aClass19_Sub1_37;

	@OriginalMember(owner = "com.jagex.client!ua", name = "f", descriptor = "I")
	private final int anInt6406;

	@OriginalMember(owner = "com.jagex.client!ua", name = "<init>", descriptor = "(Lclient!bf;)V")
	...
	@OriginalMember(owner = "com.jagex.client!ua", name = "a", descriptor = "(ILclient!al;)V")
	public void method5794(@OriginalArg(0) int arg0, @OriginalArg(1) Class8_Sub1 arg1) {
		this.method5797(arg0, arg1);
	}

	@OriginalMember(owner = "com.jagex.client!ua", name = "a", descriptor = "(ILclient!qd;II)V")
	...
	@OriginalMember(owner = "com.jagex.client!ua", name = "a", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!ua", name = "a", descriptor = "(ILclient!al;I)V")
	...
	@OriginalMember(owner = "com.jagex.client!ua", name = "d", descriptor = "()Z")
	...
	@OriginalMember(owner = "com.jagex.client!ua", name = "finalize", descriptor = "()V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!ua", name = "c", descriptor = "()I")
	@Override
	public int method5793() {
		return this.anInt6403;
	}

	@OriginalMember(owner = "com.jagex.client!ua", name = "a", descriptor = "(ILclient!pq;)V")
	...
	@OriginalMember(owner = "com.jagex.client!ua", name = "a", descriptor = "(ILclient!qd;I)V")
