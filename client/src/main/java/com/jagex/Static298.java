...
public final class Static298 {
	...
	@OriginalMember(owner = "com.jagex.client!rc", name = "h", descriptor = "I")
	public static int anInt2437;

	@OriginalMember(owner = "com.jagex.client!rc", name = "a", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!rc", name = "a", descriptor = "(II)Z")
	...
	@OriginalMember(owner = "com.jagex.client!rc", name = "a", descriptor = "(IZLclient!r;I)Lclient!pr;")
	public static Class185 method2426(@OriginalArg(2) Js5 arg0, @OriginalArg(3) int arg1) {
		@Pc(9) byte[] local9 = arg0.getfile(0, arg1);
		return local9 == null ? null : new Class185(local9);
	}

	@OriginalMember(owner = "com.jagex.client!rc", name = "a", descriptor = "(BI)I")
