...
public final class Static67 {
	...
	@OriginalMember(owner = "com.jagex.client!ds", name = "r", descriptor = "F")
	public static float aFloat31;

	@OriginalMember(owner = "com.jagex.client!ds", name = "t", descriptor = "Lclient!kn;")
	public static Class129 aClass129_1;

	@OriginalMember(owner = "com.jagex.client!ds", name = "q", descriptor = "Lclient!gd;")
	...
	@OriginalMember(owner = "com.jagex.client!ds", name = "s", descriptor = "[I")
	public static final int[] anIntArray111 = new int[6];

	@OriginalMember(owner = "com.jagex.client!ds", name = "v", descriptor = "[[I")
	...
	@OriginalMember(owner = "com.jagex.client!ds", name = "a", descriptor = "()V")
