...
@OriginalClass("com.jagex.client!ji")
public final class GlPacket extends Packet {

	@OriginalMember(owner = "com.jagex.client!ji", name = "<init>", descriptor = "(I)V")
	public GlPacket(@OriginalArg(0) int size) {
		super(size);
	}

	// inverse, put, float
	@OriginalMember(owner = "com.jagex.client!ji", name = "a", descriptor = "(FI)V")
	...
	// put, float
	@OriginalMember(owner = "com.jagex.client!ji", name = "b", descriptor = "(FI)V")
