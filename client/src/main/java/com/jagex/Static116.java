...
public final class Static116 {
	...
	@OriginalMember(owner = "com.jagex.client!go", name = "s", descriptor = "[Lclient!jd;")
	public static Sprite[] aClass13Array8;

	@OriginalMember(owner = "com.jagex.client!go", name = "i", descriptor = "I")
	public static int anInt2357 = 0;

	@OriginalMember(owner = "com.jagex.client!go", name = "l", descriptor = "Lclient!fr;")
	public static final Class75 aClass75_1 = new Class75();

	@OriginalMember(owner = "com.jagex.client!go", name = "m", descriptor = "[I")
	public static final int[] anIntArray149 = new int[5];

	@OriginalMember(owner = "com.jagex.client!go", name = "n", descriptor = "I")
	public static int anInt2360 = 0;

	@OriginalMember(owner = "com.jagex.client!go", name = "q", descriptor = "[Lclient!nt;")
	public static final AnimFrameset[] aClass2_Sub2_Sub13Array3 = new AnimFrameset[14];

	@OriginalMember(owner = "com.jagex.client!go", name = "a", descriptor = "(BI)[B")
