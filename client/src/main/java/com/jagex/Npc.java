...
public final class Npc extends PathingEntity {
	...
	@OriginalMember(owner = "com.jagex.client!oe", name = "Gc", descriptor = "I")
	public int anInt4663 = -1;

	@OriginalMember(owner = "com.jagex.client!oe", name = "a", descriptor = "(IILclient!wm;)Z")
	...
	@OriginalMember(owner = "com.jagex.client!oe", name = "a", descriptor = "(IIILclient!wm;ZLclient!hp;Z)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!oe", name = "d", descriptor = "(I)Z")
	public boolean method4336() {
		return this.type != null;
	}

	@OriginalMember(owner = "com.jagex.client!oe", name = "g", descriptor = "(I)Z")
	@Override
	public boolean method6076() {
		return false;
	}

	@OriginalMember(owner = "com.jagex.client!oe", name = "e", descriptor = "(I)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!oe", name = "b", descriptor = "(Lclient!wm;B)Lclient!nf;")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!oe", name = "a", descriptor = "(IIIIZI)V")
	...
	@OriginalMember(owner = "com.jagex.client!oe", name = "h", descriptor = "(I)I")
	@Override
	public int method6080() {
		return super.anInt4630;
	}

	@OriginalMember(owner = "com.jagex.client!oe", name = "a", descriptor = "(IIBLclient!wm;)Z")
	@Override
