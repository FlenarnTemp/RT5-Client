...
@OriginalClass("com.jagex.client!wn")
public final class Class248 {

	@OriginalMember(owner = "com.jagex.client!wn", name = "b", descriptor = "I")
	public int anInt7197;

	@OriginalMember(owner = "com.jagex.client!wn", name = "m", descriptor = "I")
	private int anInt7205;

	@OriginalMember(owner = "com.jagex.client!wn", name = "a", descriptor = "(B)V")
	public void method6440() {
		this.anInt7197 &= 0x3FFF;
	}

	@OriginalMember(owner = "com.jagex.client!wn", name = "b", descriptor = "(B)I")
	public int method6441() {
		return this.anInt7197 & 0x3FFF;
	}

	@OriginalMember(owner = "com.jagex.client!wn", name = "a", descriptor = "(II)V")
	public void method6442(@OriginalArg(0) int arg0) {
		this.anInt7205 = 0;
		this.anInt7197 = arg0;
	}

	@OriginalMember(owner = "com.jagex.client!wn", name = "a", descriptor = "(IIZI)Z")
