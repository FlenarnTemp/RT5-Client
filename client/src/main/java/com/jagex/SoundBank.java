...
@OriginalClass("com.jagex.client!bk")
public final class SoundBank {

	@OriginalMember(owner = "com.jagex.client!bk", name = "k", descriptor = "Lclient!ad;")
	private final HashTable aClass4_11 = new HashTable(256);

	@OriginalMember(owner = "com.jagex.client!bk", name = "n", descriptor = "Lclient!ad;")
	private final HashTable cache = new HashTable(256);

	@OriginalMember(owner = "com.jagex.client!bk", name = "h", descriptor = "Lclient!r;")
	private final Js5 aClass197_4;

	@OriginalMember(owner = "com.jagex.client!bk", name = "a", descriptor = "Lclient!r;")
	private final Js5 synthArchive;

	@OriginalMember(owner = "com.jagex.client!bk", name = "<init>", descriptor = "(Lclient!r;Lclient!r;)V")
	public SoundBank(@OriginalArg(0) Js5 arg0, @OriginalArg(1) Js5 arg1) {
		this.aClass197_4 = arg1;
		this.synthArchive = arg0;
	}

	@OriginalMember(owner = "com.jagex.client!bk", name = "a", descriptor = "([III)Lclient!jn;")
	...
	@OriginalMember(owner = "com.jagex.client!bk", name = "a", descriptor = "(BI[I)Lclient!jn;")
	...
	@OriginalMember(owner = "com.jagex.client!bk", name = "a", descriptor = "(I[III)Lclient!jn;")
	private PcmSound getSynthSound(@OriginalArg(0) int arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2) {
		...
		if (local31 != null) {
			...
			this.cache.pushNode(local31, local24);
			if (arg1 != null) {
	...
	@OriginalMember(owner = "com.jagex.client!bk", name = "a", descriptor = "(II[II)Lclient!jn;")
	private PcmSound method874(@OriginalArg(0) int arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2) {
		...
		if (local33 != null) {
			...
			if (local55 == null) {
				...
				this.aClass4_11.pushNode(local55, local26);
			}
			...
			if (local33 == null) {
				...
				local55.remove();
				this.cache.pushNode(local33, local26);
				return local33;
			}
		} else {
			return null;
