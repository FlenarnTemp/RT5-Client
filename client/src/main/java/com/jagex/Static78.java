...
public final class Static78 {
	...
	@OriginalMember(owner = "com.jagex.client!ei", name = "f", descriptor = "I")
	public static int anInt6309;

	@OriginalMember(owner = "com.jagex.client!ei", name = "j", descriptor = "Lclient!r;")
	public static Js5 aClass197_89;

	@OriginalMember(owner = "com.jagex.client!ei", name = "g", descriptor = "[S")
	public static final short[] aShortArray123 = new short[] { 6798, 8741, 25238, 4626, 4550 };

	@OriginalMember(owner = "com.jagex.client!ei", name = "h", descriptor = "Lclient!gd;")
	...
	@OriginalMember(owner = "com.jagex.client!ei", name = "k", descriptor = "Lclient!gd;")
	...
	@OriginalMember(owner = "com.jagex.client!ei", name = "a", descriptor = "(BI)V")
	...
	@OriginalMember(owner = "com.jagex.client!ei", name = "a", descriptor = "(IB)C")
	public static char forCharKey(@OriginalArg(1) byte arg0) {
		...
		if (local12 >= 128 && local12 < 160) {
			@Pc(43) char local43 = Cp1252.aCharArray2[local12 - 128];
			if (local43 == '\u0000') {
				local43 = '?';
			}
			local12 = local43;
	...
	@OriginalMember(owner = "com.jagex.client!ei", name = "a", descriptor = "(Lclient!wm;ILclient!mg;)I")
	public static int method5699(@OriginalArg(0) Renderer arg0, @OriginalArg(2) FloorOverlayType arg1) {
	...
	@OriginalMember(owner = "com.jagex.client!ei", name = "b", descriptor = "(IB)V")
