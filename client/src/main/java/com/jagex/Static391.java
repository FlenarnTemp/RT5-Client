...
public final class Static391 {
	...
	@OriginalMember(owner = "com.jagex.client!wq", name = "j", descriptor = "Lclient!r;")
	public static Js5 aClass197_95;

	@OriginalMember(owner = "com.jagex.client!wq", name = "h", descriptor = "[I")
	public static final int[] anIntArray495 = new int[] { 16, 32, 64, 128 };

	@OriginalMember(owner = "com.jagex.client!wq", name = "a", descriptor = "(IIBIIIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!wq", name = "a", descriptor = "(Lclient!cf;B)V")
	...
	@OriginalMember(owner = "com.jagex.client!wq", name = "a", descriptor = "(CI)C")
	...
	@OriginalMember(owner = "com.jagex.client!wq", name = "a", descriptor = "(IIIIIB)V")
	...
	@OriginalMember(owner = "com.jagex.client!wq", name = "a", descriptor = "(I[[[BIBII)V")
