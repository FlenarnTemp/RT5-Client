...
public final class Static190 {
	...
	@OriginalMember(owner = "com.jagex.client!kt", name = "V", descriptor = "[I")
	public static int[] anIntArray208;

	@OriginalMember(owner = "com.jagex.client!kt", name = "db", descriptor = "Lclient!bu;")
	public static SceneBuilder aClass29_Sub1_63;

	@OriginalMember(owner = "com.jagex.client!kt", name = "Y", descriptor = "I")
	public static int anInt3541 = 1;

	@OriginalMember(owner = "com.jagex.client!kt", name = "cb", descriptor = "[Ljava/lang/String;")
	public static final String[] aStringArray28 = new String[100];

	@OriginalMember(owner = "com.jagex.client!kt", name = "a", descriptor = "(IIILclient!wm;)V")
	public static void method3500(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) Renderer arg2) {
	...
	@OriginalMember(owner = "com.jagex.client!kt", name = "a", descriptor = "(IIIII)V")
