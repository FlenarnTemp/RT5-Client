...
@OriginalClass("com.jagex.client!vj")
public final class Map extends SecondaryNode {

	@OriginalMember(owner = "com.jagex.client!vj", name = "C", descriptor = "I")
	public int anInt6864 = -1;

	@OriginalMember(owner = "com.jagex.client!vj", name = "B", descriptor = "I")
	public int displayMinY = 12800;

	@OriginalMember(owner = "com.jagex.client!vj", name = "O", descriptor = "I")
	public int displayMaxY = 0;

	@OriginalMember(owner = "com.jagex.client!vj", name = "U", descriptor = "Z")
	public boolean valid = true;

	@OriginalMember(owner = "com.jagex.client!vj", name = "K", descriptor = "I")
	public int displayMinX = 12800;

	@OriginalMember(owner = "com.jagex.client!vj", name = "Q", descriptor = "I")
	public int defaultZoom = -1;

	@OriginalMember(owner = "com.jagex.client!vj", name = "G", descriptor = "I")
	public int displayMaxX = 0;

	@OriginalMember(owner = "com.jagex.client!vj", name = "I", descriptor = "I")
	public final int id;

	@OriginalMember(owner = "com.jagex.client!vj", name = "P", descriptor = "Ljava/lang/String;")
	public final String name;

	@OriginalMember(owner = "com.jagex.client!vj", name = "M", descriptor = "I")
	public final int origin;

	@OriginalMember(owner = "com.jagex.client!vj", name = "R", descriptor = "Ljava/lang/String;")
	public final String aString67;

	@OriginalMember(owner = "com.jagex.client!vj", name = "H", descriptor = "Lclient!ld;")
	public final LinkedList aClass135_41;

	@OriginalMember(owner = "com.jagex.client!vj", name = "<init>", descriptor = "(ILjava/lang/String;Ljava/lang/String;IIZII)V")
	...
	@OriginalMember(owner = "com.jagex.client!vj", name = "a", descriptor = "(II[III)Z")
	...
	@OriginalMember(owner = "com.jagex.client!vj", name = "a", descriptor = "(IBI)Z")
	...
	@OriginalMember(owner = "com.jagex.client!vj", name = "a", descriptor = "([IIII)Z")
	...
	@OriginalMember(owner = "com.jagex.client!vj", name = "c", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!vj", name = "a", descriptor = "(ZII[I)Z")
