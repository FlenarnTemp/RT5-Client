...
@OriginalClass("com.jagex.client!ju")
public final class TextureOpEmboss extends TextureOp {

	@OriginalMember(owner = "com.jagex.client!ju", name = "V", descriptor = "I")
	private int anInt3301 = 4096;

	@OriginalMember(owner = "com.jagex.client!ju", name = "fb", descriptor = "[I")
	private final int[] anIntArray201 = new int[3];

	@OriginalMember(owner = "com.jagex.client!ju", name = "cb", descriptor = "I")
	private int anInt3308 = 3216;

	@OriginalMember(owner = "com.jagex.client!ju", name = "eb", descriptor = "I")
	private int anInt3310 = 3216;

	@OriginalMember(owner = "com.jagex.client!ju", name = "<init>", descriptor = "()V")
	public TextureOpEmboss() {
		super(1, true);
	}

	@OriginalMember(owner = "com.jagex.client!ju", name = "b", descriptor = "(B)V")
	...
	@OriginalMember(owner = "com.jagex.client!ju", name = "d", descriptor = "(I)V")
	@Override
	public void postDecode() {
		this.method3286();
	}

	@OriginalMember(owner = "com.jagex.client!ju", name = "a", descriptor = "(BI)[I")
	@Override
	public int[] getMonochromeOutput(@OriginalArg(1) int arg0) {
		...
		if (super.monochromeImageCache.invalid) {
			...
			for (@Pc(50) int local50 = 0; local50 < Texture.width; local50++) {
				...
				@Pc(135) int local135 = FloorOverlayType.aByteArray39[((local102 + 1) * local102 >> 1) + local90] & 0xFF;
	...
	@OriginalMember(owner = "com.jagex.client!ju", name = "a", descriptor = "(ILclient!bt;I)V")
	@Override
	public void decode(@OriginalArg(0) int code, @OriginalArg(1) Packet buf) {
		if (code == 0) {
			this.anInt3301 = buf.g2();
		} else if (code == 1) {
			this.anInt3308 = buf.g2();
		} else if (code == 2) {
			this.anInt3310 = buf.g2();
		}
	}
}
