...
public final class Static352 {
	...
	@OriginalMember(owner = "com.jagex.client!uh", name = "x", descriptor = "[Lclient!jd;")
	public static Sprite[] aClass13Array25;

	@OriginalMember(owner = "com.jagex.client!uh", name = "O", descriptor = "I")
	public static int anInt6519;

	@OriginalMember(owner = "com.jagex.client!uh", name = "w", descriptor = "Lclient!cm;")
	public static final Class36 aClass36_9 = new Class36();

	@OriginalMember(owner = "com.jagex.client!uh", name = "V", descriptor = "J")
	public static long aLong202 = -1L;

	@OriginalMember(owner = "com.jagex.client!uh", name = "W", descriptor = "Z")
	public static boolean aBoolean446 = false;

	@OriginalMember(owner = "com.jagex.client!uh", name = "a", descriptor = "(I)V")
