...
public final class Static187 {
	...
	@OriginalMember(owner = "com.jagex.client!kq", name = "e", descriptor = "[I")
	public static final int[] anIntArray478 = new int[1];

	@OriginalMember(owner = "com.jagex.client!kq", name = "a", descriptor = "(Lclient!jaggl/opengl;IIIII[F)V")
	...
	@OriginalMember(owner = "com.jagex.client!kq", name = "b", descriptor = "(I)I")
	...
	@OriginalMember(owner = "com.jagex.client!kq", name = "a", descriptor = "(Lclient!jaggl/opengl;IIIII[B)V")
	...
	@OriginalMember(owner = "com.jagex.client!kq", name = "c", descriptor = "(I)I")
	...
	@OriginalMember(owner = "com.jagex.client!kq", name = "a", descriptor = "(Lclient!jaggl/opengl;IIIIII[I)V")
