...
public final class Static51 {
	...
	@OriginalMember(owner = "com.jagex.client!cu", name = "s", descriptor = "[I")
	public static int[] underwaterMapGroupIds;

	@OriginalMember(owner = "com.jagex.client!cu", name = "v", descriptor = "Lclient!on;")
	public static Class14 aClass14_2;

	@OriginalMember(owner = "com.jagex.client!cu", name = "w", descriptor = "I")
	public static int anInt1369 = 0;

	@OriginalMember(owner = "com.jagex.client!cu", name = "a", descriptor = "(Ljava/lang/String;B)[B")
	...
	@OriginalMember(owner = "com.jagex.client!cu", name = "a", descriptor = "(IIIIIIB)V")
	...
	@OriginalMember(owner = "com.jagex.client!cu", name = "a", descriptor = "(II)I")
