...
public final class Static279 {
	...
	@OriginalMember(owner = "com.jagex.client!qc", name = "a", descriptor = "Lclient!gd;")
	...
	@OriginalMember(owner = "com.jagex.client!qc", name = "f", descriptor = "I")
	public static int anInt5161 = 13156520;

	@OriginalMember(owner = "com.jagex.client!qc", name = "a", descriptor = "(ILclient!wm;)V")
	public static void method4725(@OriginalArg(1) Renderer arg0) {
		...
		for (@Pc(29) int local29 = 0; local29 < 100; local29++) {
			...
			@Pc(60) int local60 = local37 + (Renderer.anIntArray178[(local43 + (local37 & 0x40)) * 64 & 0x3FFF] >> 10);
