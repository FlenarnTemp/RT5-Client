...
@OriginalClass("com.jagex.client!ff")
public final class MidiNoteStream extends PcmStream {

	@OriginalMember(owner = "com.jagex.client!ff", name = "I", descriptor = "Lclient!ld;")
	public final LinkedList aClass135_15 = new LinkedList();

	@OriginalMember(owner = "com.jagex.client!ff", name = "J", descriptor = "Lclient!fi;")
	public final MixerPcmStream mixer = new MixerPcmStream();

	@OriginalMember(owner = "com.jagex.client!ff", name = "z", descriptor = "Lclient!od;")
	private final MidiPcmStream aClass2_Sub12_Sub3_2;

	@OriginalMember(owner = "com.jagex.client!ff", name = "<init>", descriptor = "(Lclient!od;)V")
	public MidiNoteStream(@OriginalArg(0) MidiPcmStream arg0) {
		this.aClass2_Sub12_Sub3_2 = arg0;
	}

	@OriginalMember(owner = "com.jagex.client!ff", name = "d", descriptor = "()Lclient!ll;")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!ff", name = "a", descriptor = "(Lclient!ej;II)V")
	...
	@OriginalMember(owner = "com.jagex.client!ff", name = "a", descriptor = "()Lclient!ll;")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!ff", name = "c", descriptor = "()I")
	@Override
	public int method4977() {
		return 0;
	}

	@OriginalMember(owner = "com.jagex.client!ff", name = "a", descriptor = "([III)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!ff", name = "a", descriptor = "(II[IIBLclient!ej;)V")
	...
	@OriginalMember(owner = "com.jagex.client!ff", name = "b", descriptor = "(I)V")
	@Override
