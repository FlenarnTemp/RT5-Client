...
@OriginalClass("com.jagex.client!rd")
public final class Class200 {

	@OriginalMember(owner = "com.jagex.client!rd", name = "l", descriptor = "Lclient!pq;")
	private Class184 aClass184_1;

	@OriginalMember(owner = "com.jagex.client!rd", name = "o", descriptor = "Lclient!al;")
	private Class8_Sub1 aClass8_Sub1_4;

	@OriginalMember(owner = "com.jagex.client!rd", name = "b", descriptor = "I")
	private int anInt5603 = -1;

	@OriginalMember(owner = "com.jagex.client!rd", name = "f", descriptor = "I")
	private int anInt5605 = -1;

	@OriginalMember(owner = "com.jagex.client!rd", name = "d", descriptor = "I")
	private int anInt5604 = 0;

	@OriginalMember(owner = "com.jagex.client!rd", name = "g", descriptor = "I")
	private int anInt5606 = 0;

	@OriginalMember(owner = "com.jagex.client!rd", name = "c", descriptor = "Lclient!ld;")
	private final LinkedList aClass135_33 = new LinkedList();

	@OriginalMember(owner = "com.jagex.client!rd", name = "h", descriptor = "I")
	private int anInt5607 = -1;

	@OriginalMember(owner = "com.jagex.client!rd", name = "i", descriptor = "Z")
	private boolean aBoolean394 = true;

	@OriginalMember(owner = "com.jagex.client!rd", name = "j", descriptor = "Z")
	private boolean aBoolean395 = true;

	@OriginalMember(owner = "com.jagex.client!rd", name = "k", descriptor = "I")
	private int anInt5608 = 0;

	@OriginalMember(owner = "com.jagex.client!rd", name = "n", descriptor = "[Lclient!al;")
	private Class8_Sub1[] aClass8_Sub1Array3 = new Class8_Sub1[2];

	@OriginalMember(owner = "com.jagex.client!rd", name = "m", descriptor = "Z")
	private boolean aBoolean396 = false;

	@OriginalMember(owner = "com.jagex.client!rd", name = "p", descriptor = "Z")
	private boolean aBoolean397 = true;

	@OriginalMember(owner = "com.jagex.client!rd", name = "a", descriptor = "Lclient!bf;")
	private final Class19_Sub1 aClass19_Sub1_32;

	@OriginalMember(owner = "com.jagex.client!rd", name = "e", descriptor = "Lclient!ua;")
	private Class228 aClass228_2;

	@OriginalMember(owner = "com.jagex.client!rd", name = "<init>", descriptor = "(Lclient!bf;)V")
	...
	@OriginalMember(owner = "com.jagex.client!rd", name = "a", descriptor = "(Lclient!uk;)Z")
	...
	@OriginalMember(owner = "com.jagex.client!rd", name = "a", descriptor = "()V")
	...
	@OriginalMember(owner = "com.jagex.client!rd", name = "b", descriptor = "()V")
	...
	@OriginalMember(owner = "com.jagex.client!rd", name = "a", descriptor = "(Lclient!uk;Z)V")
	...
	@OriginalMember(owner = "com.jagex.client!rd", name = "c", descriptor = "()Z")
	private boolean method5119() {
		return this.aClass19_Sub1_32.method821() == this.aClass228_2;
	}

	@OriginalMember(owner = "com.jagex.client!rd", name = "d", descriptor = "()V")
	public void method5120() {
		if (this.aClass228_2 != null) {
			...
			if (!this.aClass135_33.method3550()) {
				for (@Pc(33) Node local33 = this.aClass135_33.head(); local33 != this.aClass135_33.aClass2_130; local33 = local33.prev) {
	...
	@OriginalMember(owner = "com.jagex.client!rd", name = "a", descriptor = "(IIII)Z")
	public boolean method5121(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		if (this.anInt5603 != arg2 || this.anInt5605 != arg3) {
			this.anInt5603 = arg2;
			this.anInt5605 = arg3;
			for (@Pc(30) Node local30 = this.aClass135_33.head(); local30 != this.aClass135_33.aClass2_130; local30 = local30.prev) {
	...
	@OriginalMember(owner = "com.jagex.client!rd", name = "b", descriptor = "(Lclient!uk;)V")
