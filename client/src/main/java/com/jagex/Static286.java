...
public final class Static286 {
	...
	@OriginalMember(owner = "com.jagex.client!qk", name = "hb", descriptor = "[Ljava/awt/Color;")
	public static final Color[] aColorArray3 = new Color[] { new Color(16777215), new Color(16777215) };

	@OriginalMember(owner = "com.jagex.client!qk", name = "jb", descriptor = "[[I")
	...
	@OriginalMember(owner = "com.jagex.client!qk", name = "c", descriptor = "(Z)V")
	...
	@OriginalMember(owner = "com.jagex.client!qk", name = "b", descriptor = "(B)V")
	...
	@OriginalMember(owner = "com.jagex.client!qk", name = "d", descriptor = "(IZI)V")
	...
	@OriginalMember(owner = "com.jagex.client!qk", name = "a", descriptor = "(IIIIBIILclient!dg;IIII)Z")
	public static boolean method4927(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) CollisionMap arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8, @OriginalArg(10) int arg9, @OriginalArg(11) int arg10) {
	...
	@OriginalMember(owner = "com.jagex.client!qk", name = "a", descriptor = "(Lclient!bt;I)Lclient!jq;")
