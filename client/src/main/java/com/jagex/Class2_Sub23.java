...
@OriginalClass("com.jagex.client!lb")
public final class Class2_Sub23 extends Node {

	@OriginalMember(owner = "com.jagex.client!lb", name = "I", descriptor = "I")
	private int anInt3572;

	@OriginalMember(owner = "com.jagex.client!lb", name = "J", descriptor = "I")
	private int anInt3573;

	@OriginalMember(owner = "com.jagex.client!lb", name = "z", descriptor = "Lclient!bf;")
	private final Class19_Sub1 aClass19_Sub1_20;

	@OriginalMember(owner = "com.jagex.client!lb", name = "L", descriptor = "Lclient!of;")
	private final Class2_Sub26 aClass2_Sub26_1;

	@OriginalMember(owner = "com.jagex.client!lb", name = "v", descriptor = "Lclient!ah;")
	private final Class6_Sub1 aClass6_Sub1_2;

	@OriginalMember(owner = "com.jagex.client!lb", name = "w", descriptor = "I")
	private final int anInt3570;

	@OriginalMember(owner = "com.jagex.client!lb", name = "K", descriptor = "I")
	private final int anInt3574;

	@OriginalMember(owner = "com.jagex.client!lb", name = "u", descriptor = "I")
	private final int anInt3569;

	@OriginalMember(owner = "com.jagex.client!lb", name = "E", descriptor = "I")
	private final int anInt3571;

	@OriginalMember(owner = "com.jagex.client!lb", name = "s", descriptor = "[[F")
	private float[][] aFloatArrayArray4;

	@OriginalMember(owner = "com.jagex.client!lb", name = "x", descriptor = "[[F")
	private float[][] aFloatArrayArray5;

	@OriginalMember(owner = "com.jagex.client!lb", name = "G", descriptor = "[[F")
	private float[][] aFloatArrayArray6;

	@OriginalMember(owner = "com.jagex.client!lb", name = "B", descriptor = "Lclient!bt;")
	private Packet aClass2_Sub4_5;

	@OriginalMember(owner = "com.jagex.client!lb", name = "C", descriptor = "Lclient!ji;")
	private GlPacket aClass2_Sub4_Sub1_1;

	@OriginalMember(owner = "com.jagex.client!lb", name = "t", descriptor = "Lclient!ad;")
	private HashTable aClass4_78;

	@OriginalMember(owner = "com.jagex.client!lb", name = "F", descriptor = "Lclient!fd;")
	private final Interface4 anInterface4_3;

	@OriginalMember(owner = "com.jagex.client!lb", name = "y", descriptor = "Lclient!fg;")
	private final Interface5 anInterface5_4;

	@OriginalMember(owner = "com.jagex.client!lb", name = "A", descriptor = "Lclient!kj;")
	private final Class126 aClass126_5;

	@OriginalMember(owner = "com.jagex.client!lb", name = "H", descriptor = "Lclient!kj;")
	private final Class126 aClass126_6;

	@OriginalMember(owner = "com.jagex.client!lb", name = "<init>", descriptor = "(Lclient!bf;Lclient!ah;Lclient!of;[I)V")
	public Class2_Sub23(@OriginalArg(0) Class19_Sub1 arg0, @OriginalArg(1) Class6_Sub1 arg1, @OriginalArg(2) Class2_Sub26 arg2, @OriginalArg(3) int[] arg3) {
		...
		if (local108 > 0) {
			...
			this.aClass4_78 = new HashTable(Static162.bitCeil(local108));
			local131 = 0;
			local116 = 0;
			...
			this.anInterface4_3 = this.aClass19_Sub1_20.method839(this.aClass2_Sub4_5.data, this.aClass2_Sub4_5.pos, false);
			this.anInterface5_4 = this.aClass19_Sub1_20.method816(16, this.aClass2_Sub4_Sub1_1.data, this.aClass2_Sub4_Sub1_1.pos, false);
	...
	@OriginalMember(owner = "com.jagex.client!lb", name = "a", descriptor = "(SI)V")
	...
	@OriginalMember(owner = "com.jagex.client!lb", name = "a", descriptor = "(III[[ZI)V")
	...
	@OriginalMember(owner = "com.jagex.client!lb", name = "a", descriptor = "(IIIIIII)V")
	private void method3527(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
		...
		if ((arg0 & 0x7F) == 0 || (arg5 & 0x7F) == 0) {
			...
			@Pc(53) Node local53 = this.aClass4_78.getNode(local1);
			if (local53 != null) {
		...
		if (local1 != -1L) {
			this.aClass4_78.pushNode(new Class2_Sub9(local73), local1);
		}
