...
@OriginalClass("com.jagex.client!pf")
public final class Class2_Sub27 extends Node {

	@OriginalMember(owner = "com.jagex.client!pf", name = "t", descriptor = "[[B")
	private byte[][] aByteArrayArray14;

	@OriginalMember(owner = "com.jagex.client!pf", name = "u", descriptor = "I")
	private int anInt4918;

	@OriginalMember(owner = "com.jagex.client!pf", name = "v", descriptor = "I")
	private int anInt4919;

	@OriginalMember(owner = "com.jagex.client!pf", name = "y", descriptor = "I")
	private int anInt4920;

	@OriginalMember(owner = "com.jagex.client!pf", name = "z", descriptor = "I")
	private int anInt4921;

	@OriginalMember(owner = "com.jagex.client!pf", name = "D", descriptor = "Z")
	private boolean aBoolean367;

	@OriginalMember(owner = "com.jagex.client!pf", name = "L", descriptor = "I")
	private int anInt4924;

	@OriginalMember(owner = "com.jagex.client!pf", name = "V", descriptor = "I")
	private int anInt4927;

	@OriginalMember(owner = "com.jagex.client!pf", name = "W", descriptor = "Z")
	private boolean aBoolean369;

	@OriginalMember(owner = "com.jagex.client!pf", name = "X", descriptor = "[F")
	private float[] aFloatArray29;

	@OriginalMember(owner = "com.jagex.client!pf", name = "Y", descriptor = "[B")
	private byte[] aByteArray59;

	@OriginalMember(owner = "com.jagex.client!pf", name = "Z", descriptor = "I")
	private int anInt4928;

	@OriginalMember(owner = "com.jagex.client!pf", name = "ab", descriptor = "I")
	private int anInt4929;

	@OriginalMember(owner = "com.jagex.client!pf", name = "<init>", descriptor = "([B)V")
	public Class2_Sub27(@OriginalArg(0) byte[] arg0) {
		this.method4516(arg0);
	}

	@OriginalMember(owner = "com.jagex.client!pf", name = "d", descriptor = "(I)[F")
	...
	@OriginalMember(owner = "com.jagex.client!pf", name = "b", descriptor = "([B)V")
	...
	@OriginalMember(owner = "com.jagex.client!pf", name = "a", descriptor = "([I)Lclient!jn;")
