...
public class Camera {
	...
	@OriginalMember(owner = "com.jagex.client!vg", name = "v", descriptor = "[[[I")
	public static final int[][][] splines = new int[2][][];
	@OriginalMember(owner = "com.jagex.client!jl", name = "ab", descriptor = "I")
	public static int originX;

	@OriginalMember(owner = "com.jagex.client!ij", name = "d", descriptor = "I")
	public static int originZ;
	@OriginalMember(owner = "com.jagex.client!ii", name = "o", descriptor = "I")
	public static int anInt2717 = -1;
	@OriginalMember(owner = "com.jagex.client!r", name = "w", descriptor = "I")
	public static int anInt5567 = 0;
	@OriginalMember(owner = "com.jagex.client!ui", name = "o", descriptor = "I")
	public static int anInt6533 = 0;
	@OriginalMember(owner = "com.jagex.client!ch", name = "Q", descriptor = "I")
	public static int anInt1038 = 0;
	@OriginalMember(owner = "com.jagex.client!mn", name = "I", descriptor = "I")
	public static int anInt3821 = 0;
	@OriginalMember(owner = "com.jagex.client!ud", name = "r", descriptor = "I")
	public static int anInt6455 = -1;
	@OriginalMember(owner = "com.jagex.client!ts", name = "q", descriptor = "I")
	public static int anInt6398 = 0;
	@OriginalMember(owner = "com.jagex.client!sd", name = "R", descriptor = "I")
	public static int cameraType;
	@OriginalMember(owner = "com.jagex.client!bp", name = "t", descriptor = "F")
	public static float pitch = 1024.0F;
	@OriginalMember(owner = "com.jagex.client!q", name = "q", descriptor = "F")
	public static float yaw = 0.0F;
	@OriginalMember(owner = "com.jagex.client!fn", name = "D", descriptor = "Z")
	public static boolean aBoolean156 = true;
	@OriginalMember(owner = "com.jagex.client!wf", name = "s", descriptor = "I")
	public static int anInt7153 = 0;
	@OriginalMember(owner = "com.jagex.client!da", name = "i", descriptor = "I")
	public static int anInt3966 = 0;
	@OriginalMember(owner = "com.jagex.client!aa", name = "x", descriptor = "I")
	public static int anInt28 = 0;
	@OriginalMember(owner = "com.jagex.client!bh", name = "u", descriptor = "I")
	public static int anInt642 = 0;
	@OriginalMember(owner = "com.jagex.client!ap", name = "r", descriptor = "I")
	public static int anInt327 = 0;
	@OriginalMember(owner = "com.jagex.client!ai", name = "O", descriptor = "I")
	public static int anInt213 = 1;
	@OriginalMember(owner = "com.jagex.client!ih", name = "i", descriptor = "I")
	public static int anInt2705 = 2;
	@OriginalMember(owner = "com.jagex.client!wo", name = "K", descriptor = "I")
	public static int anInt4897 = 2;

	@OriginalMember(owner = "com.jagex.client!cu", name = "a", descriptor = "(IIIIZII)V")
	...
	@OriginalMember(owner = "com.jagex.client!bs", name = "b", descriptor = "(IIIIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!gp", name = "b", descriptor = "(B)V")
	...
	@OriginalMember(owner = "com.jagex.client!nf", name = "a", descriptor = "(IIBI)V")
    ...
    @OriginalMember(owner = "com.jagex.client!ug", name = "b", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!bj", name = "a", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!uh", name = "e", descriptor = "(B)V")
	...
	@OriginalMember(owner = "com.jagex.client!gu", name = "b", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!ue", name = "a", descriptor = "(I)V")
