...
@OriginalClass("com.jagex.client!wc")
public final class SecondaryLinkedList {

	@OriginalMember(owner = "com.jagex.client!wc", name = "g", descriptor = "Lclient!tl;")
	private SecondaryNode aClass2_Sub2_54;

	@OriginalMember(owner = "com.jagex.client!wc", name = "d", descriptor = "Lclient!tl;")
	private final SecondaryNode aClass2_Sub2_53 = new SecondaryNode();

	@OriginalMember(owner = "com.jagex.client!wc", name = "<init>", descriptor = "()V")
	...
	@OriginalMember(owner = "com.jagex.client!wc", name = "a", descriptor = "(B)Lclient!tl;")
	...
	@OriginalMember(owner = "com.jagex.client!wc", name = "a", descriptor = "(I)Lclient!tl;")
	...
	@OriginalMember(owner = "com.jagex.client!wc", name = "b", descriptor = "(I)I")
	...
	@OriginalMember(owner = "com.jagex.client!wc", name = "c", descriptor = "(I)Lclient!tl;")
	...
	@OriginalMember(owner = "com.jagex.client!wc", name = "a", descriptor = "(ILclient!tl;)V")
	...
	@OriginalMember(owner = "com.jagex.client!wc", name = "b", descriptor = "(B)V")
	public void clear() {
		while (true) {
