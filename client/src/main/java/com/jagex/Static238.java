...
public final class Static238 {
	...
	@OriginalMember(owner = "com.jagex.client!nm", name = "m", descriptor = "I")
	public static int anInt4338;

	@OriginalMember(owner = "com.jagex.client!nm", name = "a", descriptor = "I")
	public static int anInt4328 = -1;

	@OriginalMember(owner = "com.jagex.client!nm", name = "n", descriptor = "Z")
	public static boolean aBoolean299 = false;

	@OriginalMember(owner = "com.jagex.client!nm", name = "a", descriptor = "(IZI)I")
	...
	@OriginalMember(owner = "com.jagex.client!nm", name = "a", descriptor = "(IIIIII)V")
