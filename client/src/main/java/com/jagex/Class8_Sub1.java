...
@OriginalClass("com.jagex.client!al")
public class Class8_Sub1 extends Class8 {

	@OriginalMember(owner = "com.jagex.client!al", name = "k", descriptor = "I")
	private int anInt3686 = -1;

	@OriginalMember(owner = "com.jagex.client!al", name = "i", descriptor = "I")
	public final int anInt3684;

	@OriginalMember(owner = "com.jagex.client!al", name = "j", descriptor = "I")
	public final int anInt3685;

	@OriginalMember(owner = "com.jagex.client!al", name = "<init>", descriptor = "(Lclient!bf;IIIIZ[FI)V")
	...
	@OriginalMember(owner = "com.jagex.client!al", name = "<init>", descriptor = "(Lclient!bf;IIIIZ[IZ)V")
	...
	@OriginalMember(owner = "com.jagex.client!al", name = "<init>", descriptor = "(Lclient!bf;IIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!al", name = "<init>", descriptor = "(Lclient!bf;IIIIZ[BIZ)V")
	...
	@OriginalMember(owner = "com.jagex.client!al", name = "<init>", descriptor = "(Lclient!bf;IIIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!al", name = "a", descriptor = "()V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!al", name = "a", descriptor = "(IIII[BIIIZ)V")
	...
	@OriginalMember(owner = "com.jagex.client!al", name = "a", descriptor = "(IIIIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!al", name = "a", descriptor = "(IIII[IIIZ)V")
	...
	@OriginalMember(owner = "com.jagex.client!al", name = "a", descriptor = "(ZZ)V")
	...
	@OriginalMember(owner = "com.jagex.client!al", name = "a", descriptor = "(II)V")
