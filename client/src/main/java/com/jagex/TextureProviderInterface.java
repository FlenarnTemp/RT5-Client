...
@OriginalClass("com.jagex.client!ci")
public interface TextureProviderInterface {

	@OriginalMember(owner = "com.jagex.client!ci", name = "a", descriptor = "(FIIZII)[I")
	int[] method2656(@OriginalArg(0) float arg0, @OriginalArg(2) int arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3);

	@OriginalMember(owner = "com.jagex.client!ci", name = "a", descriptor = "(II)Z")
	boolean method2657(@OriginalArg(1) int arg0);

	@OriginalMember(owner = "com.jagex.client!ci", name = "b", descriptor = "(II)Lclient!uc;")
	Class229 method2658(@OriginalArg(1) int arg0);

	@OriginalMember(owner = "com.jagex.client!ci", name = "a", descriptor = "(IZIIFI)[I")
	...
	@OriginalMember(owner = "com.jagex.client!ci", name = "a", descriptor = "(BZIIFI)[F")
