...
@OriginalClass("com.jagex.client!eb")
public class Class57_Sub1 extends Class57 {

	@OriginalMember(owner = "com.jagex.client!eb", name = "r", descriptor = "I")
	private int elevation;

	@OriginalMember(owner = "com.jagex.client!eb", name = "t", descriptor = "[B")
	private byte[] subData;

	@OriginalMember(owner = "com.jagex.client!eb", name = "u", descriptor = "I")
	private int writerIndex;

	@OriginalMember(owner = "com.jagex.client!eb", name = "n", descriptor = "[I")
	private final int[] pows = new int[this.factorsOfTwo];

	@OriginalMember(owner = "com.jagex.client!eb", name = "<init>", descriptor = "(IIIIIF)V")
	...
	@OriginalMember(owner = "com.jagex.client!eb", name = "a", descriptor = "(Z)V")
	@Override
