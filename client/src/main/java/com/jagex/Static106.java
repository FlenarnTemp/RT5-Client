...
public final class Static106 {
	...
	@OriginalMember(owner = "com.jagex.client!fu", name = "T", descriptor = "I")
	public static int anInt2218;

	@OriginalMember(owner = "com.jagex.client!fu", name = "U", descriptor = "[[B")
	public static byte[][] aByteArrayArray6;

	@OriginalMember(owner = "com.jagex.client!fu", name = "V", descriptor = "Z")
	public static boolean aBoolean164 = false;

	@OriginalMember(owner = "com.jagex.client!fu", name = "W", descriptor = "[I")
	public static final int[] anIntArray135 = new int[32];

	@OriginalMember(owner = "com.jagex.client!fu", name = "a", descriptor = "(IIII)I")
