...
@OriginalClass("com.jagex.client!wa")
public final class SkyboxType {

	@OriginalMember(owner = "com.jagex.client!wa", name = "i", descriptor = "[I")
	public int[] anIntArray484;

	@OriginalMember(owner = "com.jagex.client!wa", name = "a", descriptor = "I")
	public int anInt7072 = -1;

	@OriginalMember(owner = "com.jagex.client!wa", name = "h", descriptor = "I")
	public int anInt7078 = -1;

	@OriginalMember(owner = "com.jagex.client!wa", name = "a", descriptor = "(Lclient!bt;II)V")
	...
	@OriginalMember(owner = "com.jagex.client!wa", name = "a", descriptor = "(Lclient!bt;B)V")
