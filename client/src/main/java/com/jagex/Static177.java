...
public final class Static177 {
	...
	@OriginalMember(owner = "com.jagex.client!ke", name = "q", descriptor = "Lclient!r;")
	public static Js5 aClass197_48;

	@OriginalMember(owner = "com.jagex.client!ke", name = "E", descriptor = "I")
	public static int anInt3381 = 0;

	@OriginalMember(owner = "com.jagex.client!ke", name = "K", descriptor = "I")
	public static int anInt3385 = 0;

	@OriginalMember(owner = "com.jagex.client!ke", name = "a", descriptor = "(Lclient!bu;[[BI)V")
	...
	@OriginalMember(owner = "com.jagex.client!ke", name = "d", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!ke", name = "a", descriptor = "(III)I")
