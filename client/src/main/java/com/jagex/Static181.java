...
public final class Static181 {
	...
	@OriginalMember(owner = "com.jagex.client!ki", name = "m", descriptor = "[I")
	public static int[] anIntArray203;

	@OriginalMember(owner = "com.jagex.client!ki", name = "p", descriptor = "[I")
	public static int[] anIntArray204;

	@OriginalMember(owner = "com.jagex.client!ki", name = "a", descriptor = "(IIIIIIIB)V")
	...
	@OriginalMember(owner = "com.jagex.client!ki", name = "a", descriptor = "(ZI)V")
	...
	@OriginalMember(owner = "com.jagex.client!ki", name = "a", descriptor = "([Lclient!nk;II)V")
	...
	@OriginalMember(owner = "com.jagex.client!ki", name = "a", descriptor = "(IIII)I")
