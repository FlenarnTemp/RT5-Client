...
@OriginalClass("com.jagex.client!nn")
public final class Class2_Sub26_Sub1 extends Class2_Sub26 {

	@OriginalMember(owner = "com.jagex.client!nn", name = "D", descriptor = "I")
	private int anInt4375;

	@OriginalMember(owner = "com.jagex.client!nn", name = "E", descriptor = "Z")
	public final boolean aBoolean300;

	@OriginalMember(owner = "com.jagex.client!nn", name = "F", descriptor = "I")
	public final int anInt4376;

	@OriginalMember(owner = "com.jagex.client!nn", name = "G", descriptor = "I")
	private int anInt4377;

	@OriginalMember(owner = "com.jagex.client!nn", name = "J", descriptor = "I")
	public int anInt4380;

	@OriginalMember(owner = "com.jagex.client!nn", name = "L", descriptor = "Z")
	public final boolean aBoolean301;

	@OriginalMember(owner = "com.jagex.client!nn", name = "N", descriptor = "I")
	private int anInt4382;

	@OriginalMember(owner = "com.jagex.client!nn", name = "Q", descriptor = "[S")
	public final short[] aShortArray92;

	@OriginalMember(owner = "com.jagex.client!nn", name = "S", descriptor = "I")
	private final int anInt4385;

	@OriginalMember(owner = "com.jagex.client!nn", name = "T", descriptor = "I")
	private int anInt4386;

	@OriginalMember(owner = "com.jagex.client!nn", name = "<init>", descriptor = "(Lclient!bt;)V")
	...
	@OriginalMember(owner = "com.jagex.client!nn", name = "a", descriptor = "(IZZ)V")
	public void method4153(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1) {
		...
		if (arg1) {
			...
			if (local26 == 1) {
				local9 = (Renderer.anIntArray178[local23 << 3] >> 5) + 1024;
			} else if (local26 == 3) {
	...
	@OriginalMember(owner = "com.jagex.client!nn", name = "a", descriptor = "(IIIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!nn", name = "b", descriptor = "(B)V")
