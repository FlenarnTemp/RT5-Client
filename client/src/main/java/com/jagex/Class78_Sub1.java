...
@OriginalClass("com.jagex.client!gb")
public final class Class78_Sub1 extends Class78 {

	@OriginalMember(owner = "com.jagex.client!gb", name = "h", descriptor = "[I")
	public final int[] anIntArray139;

	@OriginalMember(owner = "com.jagex.client!gb", name = "k", descriptor = "[I")
	public final int[] anIntArray140;

	@OriginalMember(owner = "com.jagex.client!gb", name = "<init>", descriptor = "(II[I[I)V")
