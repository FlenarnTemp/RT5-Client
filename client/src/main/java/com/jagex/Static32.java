...
public final class Static32 {
	...
	@OriginalMember(owner = "com.jagex.client!br", name = "V", descriptor = "Lclient!cf;")
	public static Class2_Sub5 aClass2_Sub5_2;

	@OriginalMember(owner = "com.jagex.client!br", name = "T", descriptor = "Lclient!gd;")
	public static final LocalizedString aClass79_21 = new LocalizedString("Loading...", "Lade...", "Chargement en cours...", "Carregando...");

	@OriginalMember(owner = "com.jagex.client!br", name = "a", descriptor = "(Lclient!wm;Lclient!hp;III)V")
	public static void method990(@OriginalArg(0) Renderer arg0, @OriginalArg(1) BaseEntity arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
	...
	@OriginalMember(owner = "com.jagex.client!br", name = "c", descriptor = "(Z)I")
