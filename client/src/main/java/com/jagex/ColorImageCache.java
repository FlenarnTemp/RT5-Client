...
@OriginalClass("com.jagex.client!vs")
public final class ColorImageCache {

	@OriginalMember(owner = "com.jagex.client!km", name = "j", descriptor = "Lclient!wh;")
	public static final ColorImageCacheEntry VALID = new ColorImageCacheEntry(0, 0);
	@OriginalMember(owner = "com.jagex.client!vs", name = "e", descriptor = "I")
	private int singleRow = -1;

	@OriginalMember(owner = "com.jagex.client!vs", name = "r", descriptor = "I")
	private int size = 0;

	@OriginalMember(owner = "com.jagex.client!vs", name = "f", descriptor = "Lclient!ld;")
	private LinkedList recentlyUsed = new LinkedList();

	@OriginalMember(owner = "com.jagex.client!vs", name = "w", descriptor = "Z")
	public boolean invalid = false;

	@OriginalMember(owner = "com.jagex.client!vs", name = "s", descriptor = "I")
	private final int capacity;

	@OriginalMember(owner = "com.jagex.client!vs", name = "b", descriptor = "I")
	private final int height;

	@OriginalMember(owner = "com.jagex.client!vs", name = "d", descriptor = "[[[I")
	private int[][][] pixels;

	@OriginalMember(owner = "com.jagex.client!vs", name = "o", descriptor = "[Lclient!wh;")
	private ColorImageCacheEntry[] entries;

	@OriginalMember(owner = "com.jagex.client!vs", name = "<init>", descriptor = "(III)V")
	...
	@OriginalMember(owner = "com.jagex.client!vs", name = "a", descriptor = "(II)[[I")
	...
	@OriginalMember(owner = "com.jagex.client!vs", name = "a", descriptor = "(Z)[[[I")
	...
	@OriginalMember(owner = "com.jagex.client!vs", name = "a", descriptor = "(B)V")
	public void clear() {
