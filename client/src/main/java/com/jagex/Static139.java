...
public final class Static139 {
	...
	@OriginalMember(owner = "com.jagex.client!hs", name = "s", descriptor = "Lclient!gd;")
	...
	@OriginalMember(owner = "com.jagex.client!hs", name = "t", descriptor = "Lclient!gd;")
	public static final LocalizedString aClass79_61 = new LocalizedString("Discard", "Ablegen", "Jeter", "Descartar");

	@OriginalMember(owner = "com.jagex.client!hs", name = "u", descriptor = "I")
	public static int anInt2593 = -50;

	@OriginalMember(owner = "com.jagex.client!hs", name = "z", descriptor = "I")
	public static int topLevelInterface = -1;

	@OriginalMember(owner = "com.jagex.client!hs", name = "A", descriptor = "Lclient!hu;")
	public static final LruHashTable aClass98_18 = new LruHashTable(4);

	@OriginalMember(owner = "com.jagex.client!hs", name = "a", descriptor = "(ZIII)Ljava/lang/String;")
	...
	@OriginalMember(owner = "com.jagex.client!hs", name = "a", descriptor = "(BII)V")
