...
public final class Static200 {
	...
	@OriginalMember(owner = "com.jagex.client!lo", name = "m", descriptor = "Lclient!ur;")
	public static BitmapFont aClass130_3;

	@OriginalMember(owner = "com.jagex.client!lo", name = "p", descriptor = "I")
	public static int anInt3698;

	@OriginalMember(owner = "com.jagex.client!lo", name = "a", descriptor = "(ICLjava/lang/String;)[Ljava/lang/String;")
	...
	@OriginalMember(owner = "com.jagex.client!lo", name = "a", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!lo", name = "a", descriptor = "(IIBII)V")
	...
	@OriginalMember(owner = "com.jagex.client!lo", name = "a", descriptor = "(Ljava/lang/String;BLjava/lang/String;Ljava/lang/String;)Ljava/lang/String;")
	...
	@OriginalMember(owner = "com.jagex.client!lo", name = "a", descriptor = "(B)Ljava/lang/String;")
