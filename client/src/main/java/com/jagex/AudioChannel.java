...
@OriginalClass("com.jagex.client!tg")
public class AudioChannel {

	@OriginalMember(owner = "com.jagex.client!up", name = "T", descriptor = "I")
	public static int sampleRate;

	@OriginalMember(owner = "com.jagex.client!tg", name = "g", descriptor = "[I")
	public int[] samples;

	@OriginalMember(owner = "com.jagex.client!tg", name = "t", descriptor = "Lclient!ll;")
	private PcmStream aClass2_Sub12_8;

	@OriginalMember(owner = "com.jagex.client!tg", name = "v", descriptor = "I")
	public int sampleRate2;

	@OriginalMember(owner = "com.jagex.client!tg", name = "y", descriptor = "I")
	private int anInt7098;

	@OriginalMember(owner = "com.jagex.client!tg", name = "B", descriptor = "I")
	public int bufferCapacity;

	@OriginalMember(owner = "com.jagex.client!tg", name = "b", descriptor = "I")
	private final int anInt7081 = 32;

	@OriginalMember(owner = "com.jagex.client!tg", name = "s", descriptor = "Z")
	private boolean aBoolean480 = false;

	@OriginalMember(owner = "com.jagex.client!tg", name = "j", descriptor = "J")
	private long aLong224 = MonotonicClock.currentTimeMillis();

	@OriginalMember(owner = "com.jagex.client!tg", name = "A", descriptor = "Z")
	private boolean aBoolean481 = true;

	@OriginalMember(owner = "com.jagex.client!tg", name = "z", descriptor = "J")
	private long aLong225 = 0L;

	@OriginalMember(owner = "com.jagex.client!tg", name = "C", descriptor = "J")
	private long aLong226 = 0L;

	@OriginalMember(owner = "com.jagex.client!tg", name = "w", descriptor = "I")
	private int anInt7097 = 0;

	@OriginalMember(owner = "com.jagex.client!tg", name = "D", descriptor = "I")
	private int anInt7100 = 0;

	@OriginalMember(owner = "com.jagex.client!tg", name = "E", descriptor = "[Lclient!ll;")
	private final PcmStream[] aClass2_Sub12Array6 = new PcmStream[8];

	@OriginalMember(owner = "com.jagex.client!tg", name = "x", descriptor = "[Lclient!ll;")
	private final PcmStream[] aClass2_Sub12Array5 = new PcmStream[8];

	@OriginalMember(owner = "com.jagex.client!tg", name = "H", descriptor = "I")
	private int anInt7102 = 0;

	@OriginalMember(owner = "com.jagex.client!tg", name = "G", descriptor = "I")
	private int anInt7101 = 0;

	@OriginalMember(owner = "com.jagex.client!wd", name = "a", descriptor = "(BILclient!ml;Ljava/awt/com.jagex.Component;I)Lclient!tg;")
	public static AudioChannel create(@OriginalArg(1) int arg0, @OriginalArg(2) Signlink arg1, @OriginalArg(3) Component arg2, @OriginalArg(4) int arg3) {
		...
		try {
			@Pc(33) AudioChannel local33 = (AudioChannel) Class.forName("com.jagex.JavaAudioChannel").getDeclaredConstructor().newInstance();
	...
	@OriginalMember(owner = "com.jagex.client!eo", name = "a", descriptor = "(ZIIZ)V")
	...
	@OriginalMember(owner = "com.jagex.client!tg", name = "a", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!tg", name = "b", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!tg", name = "a", descriptor = "(Lclient!ll;BI)V")
	...
	@OriginalMember(owner = "com.jagex.client!tg", name = "a", descriptor = "()I")
	protected int method6321() throws Exception {
		return this.bufferCapacity;
	}

	@OriginalMember(owner = "com.jagex.client!tg", name = "b", descriptor = "()V")
	protected void method6322() throws Exception {
	}

	@OriginalMember(owner = "com.jagex.client!tg", name = "a", descriptor = "([II)V")
	...
	@OriginalMember(owner = "com.jagex.client!tg", name = "c", descriptor = "()V")
	protected void method6324() {
	}

	@OriginalMember(owner = "com.jagex.client!tg", name = "d", descriptor = "(I)V")
	public final void method6325() {
		this.aBoolean481 = true;
	}

	@OriginalMember(owner = "com.jagex.client!tg", name = "e", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!tg", name = "a", descriptor = "(Ljava/awt/com.jagex.Component;)V")
	public void init(@OriginalArg(0) Component arg0) throws Exception {
	}

	@OriginalMember(owner = "com.jagex.client!tg", name = "a", descriptor = "(BI)V")
	...
	@OriginalMember(owner = "com.jagex.client!tg", name = "d", descriptor = "()V")
	protected void method6329() throws Exception {
	}

	@OriginalMember(owner = "com.jagex.client!tg", name = "a", descriptor = "(ILclient!ll;)V")
	public final synchronized void setStream(@OriginalArg(1) PcmStream arg0) {
		this.aClass2_Sub12_8 = arg0;
	}

	@OriginalMember(owner = "com.jagex.client!tg", name = "g", descriptor = "(I)V")
