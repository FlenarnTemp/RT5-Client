...
public final class Static138 {
	...
	@OriginalMember(owner = "com.jagex.client!hr", name = "S", descriptor = "Lclient!jd;")
	public static Sprite aClass13_8;

	@OriginalMember(owner = "com.jagex.client!hr", name = "Y", descriptor = "Lclient!bc;")
	public static final Class16 aClass16_3 = new Class16("", 10);

	@OriginalMember(owner = "com.jagex.client!hr", name = "b", descriptor = "(IIB)I")
	...
	@OriginalMember(owner = "com.jagex.client!hr", name = "b", descriptor = "(II)V")
	public static void method2580(@OriginalArg(0) int arg0) {
		for (@Pc(16) Node local16 = Static327.properties.head(); local16 != null; local16 = Static327.properties.next()) {
			if ((long) arg0 == (local16.nodeId >> 48 & 0xFFFFL)) {
				local16.remove();
			}
		}
	}
