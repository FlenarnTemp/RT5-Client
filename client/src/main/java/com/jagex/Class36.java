...
@OriginalClass("com.jagex.client!cm")
public final class Class36 {

	@OriginalMember(owner = "com.jagex.client!cm", name = "m", descriptor = "Lclient!ss;")
	private ParticleNode aClass12_10;

	@OriginalMember(owner = "com.jagex.client!cm", name = "j", descriptor = "Lclient!ss;")
	private final ParticleNode aClass12_9 = new ParticleNode();

	@OriginalMember(owner = "com.jagex.client!cm", name = "<init>", descriptor = "()V")
	public Class36() {
		this.aClass12_9.next = this.aClass12_9;
		this.aClass12_9.prev = this.aClass12_9;
	}

	@OriginalMember(owner = "com.jagex.client!cm", name = "a", descriptor = "(I)Z")
	public boolean method1414() {
		return this.aClass12_9.next == this.aClass12_9;
	}

	@OriginalMember(owner = "com.jagex.client!cm", name = "a", descriptor = "(B)Lclient!ss;")
	...
	@OriginalMember(owner = "com.jagex.client!cm", name = "b", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!cm", name = "b", descriptor = "(B)Lclient!ss;")
	...
	@OriginalMember(owner = "com.jagex.client!cm", name = "a", descriptor = "(ILclient!ss;)V")
	...
	@OriginalMember(owner = "com.jagex.client!cm", name = "c", descriptor = "(B)I")
	...
	@OriginalMember(owner = "com.jagex.client!cm", name = "a", descriptor = "(Z)Lclient!ss;")
	...
	@OriginalMember(owner = "com.jagex.client!cm", name = "d", descriptor = "(B)Lclient!ss;")
