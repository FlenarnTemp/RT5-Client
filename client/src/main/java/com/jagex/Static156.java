...
public final class Static156 {
	...
	@OriginalMember(owner = "com.jagex.client!iu", name = "f", descriptor = "F")
	public static float aFloat35;

	@OriginalMember(owner = "com.jagex.client!iu", name = "g", descriptor = "[Lclient!rk;")
	public static final Class37[] aClass37Array1 = new Class37[128];

	@OriginalMember(owner = "com.jagex.client!iu", name = "a", descriptor = "(IBIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!iu", name = "a", descriptor = "(Lclient!hc;III)V")
