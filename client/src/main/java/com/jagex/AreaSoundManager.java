...
public class AreaSoundManager {
	...
	@OriginalMember(owner = "com.jagex.client!vf", name = "U", descriptor = "Lclient!ld;")
	public static final LinkedList npcSounds = new LinkedList();
	@OriginalMember(owner = "com.jagex.client!ng", name = "g", descriptor = "Lclient!ad;")
	public static final HashTable aClass4_86 = new HashTable(16);
	@OriginalMember(owner = "com.jagex.client!en", name = "c", descriptor = "Lclient!ld;")
	...
	public static void add(@OriginalArg(0) LocType arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Player arg3, @OriginalArg(4) Npc arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6) {
		...
		if (arg0 != null) {
			...
			aClass4_86.pushNode(local7, (long) arg3.anInt4619);
		}
	}
	...
	@OriginalMember(owner = "com.jagex.client!tk", name = "a", descriptor = "(IILclient!jc;III)V")
	...
	@OriginalMember(owner = "com.jagex.client!dd", name = "a", descriptor = "(IIIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!am", name = "a", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!nn", name = "a", descriptor = "(IZ)V")
