...
@OriginalClass("com.jagex.client!hr")
public final class TextureOpBrightness extends TextureOp {

	@OriginalMember(owner = "com.jagex.client!hr", name = "P", descriptor = "I")
	private int anInt2570 = 4096;

	@OriginalMember(owner = "com.jagex.client!hr", name = "O", descriptor = "I")
	private int anInt2569 = 4096;

	@OriginalMember(owner = "com.jagex.client!hr", name = "T", descriptor = "[I")
	private final int[] anIntArray165 = new int[3];

	@OriginalMember(owner = "com.jagex.client!hr", name = "Z", descriptor = "I")
	private int anInt2577 = 4096;

	@OriginalMember(owner = "com.jagex.client!hr", name = "X", descriptor = "I")
	private int anInt2576 = 409;

	@OriginalMember(owner = "com.jagex.client!hr", name = "<init>", descriptor = "()V")
	public TextureOpBrightness() {
		super(1, false);
	}

	@OriginalMember(owner = "com.jagex.client!hr", name = "a", descriptor = "(ILclient!bt;I)V")
	@Override
	public void decode(@OriginalArg(0) int code, @OriginalArg(1) Packet buf) {
		if (code == 0) {
			this.anInt2576 = buf.g2();
		} else if (code == 1) {
			this.anInt2570 = buf.g2();
		} else if (code == 2) {
			this.anInt2577 = buf.g2();
		} else if (code == 3) {
			this.anInt2569 = buf.g2();
		} else if (code == 4) {
			@Pc(62) int local62 = buf.g3();
	...
	@OriginalMember(owner = "com.jagex.client!hr", name = "b", descriptor = "(IB)[[I")
	@Override
