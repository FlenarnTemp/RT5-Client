...
@OriginalClass("com.jagex.client!oc")
public final class IntHashTable {

	@OriginalMember(owner = "com.jagex.client!oc", name = "f", descriptor = "[I")
	private final int[] anIntArray294;

	@OriginalMember(owner = "com.jagex.client!oc", name = "<init>", descriptor = "([I)V")
	...
	@OriginalMember(owner = "com.jagex.client!oc", name = "a", descriptor = "(II)I")
