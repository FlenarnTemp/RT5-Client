...
public final class Static99 {
	...
	@OriginalMember(owner = "com.jagex.client!fm", name = "V", descriptor = "I")
	public static int anInt2095;

	@OriginalMember(owner = "com.jagex.client!fm", name = "b", descriptor = "(III)Lclient!gq;")
	...
	@OriginalMember(owner = "com.jagex.client!fm", name = "j", descriptor = "(I)V")
