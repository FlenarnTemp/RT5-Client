...
public final class Static62 {
	...
	@OriginalMember(owner = "com.jagex.client!dm", name = "m", descriptor = "I")
	public static int anInt2395;

	@OriginalMember(owner = "com.jagex.client!dm", name = "n", descriptor = "[I")
	public static int[] underwaterLocGroupIds;

	@OriginalMember(owner = "com.jagex.client!dm", name = "o", descriptor = "Lclient!rc;")
	public static Class42 aClass42_5;

	@OriginalMember(owner = "com.jagex.client!dm", name = "r", descriptor = "[Lclient!jd;")
	public static Sprite[] aClass13Array9;

	@OriginalMember(owner = "com.jagex.client!dm", name = "a", descriptor = "(IBIIIZ)V")
	public static void method2391(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) boolean arg4) {
		...
		@Pc(20) Class2_Sub41 local20 = (Class2_Sub41) Static353.aClass4_136.getNode(local14);
		if (local20 == null) {
			local20 = new Class2_Sub41();
			Static353.aClass4_136.pushNode(local20, local14);
		}
