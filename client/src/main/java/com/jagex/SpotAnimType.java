...
@OriginalClass("com.jagex.client!hf")
public final class SpotAnimType {

	@OriginalMember(owner = "com.jagex.client!hf", name = "b", descriptor = "[S")
	private short[] aShortArray49;

	@OriginalMember(owner = "com.jagex.client!hf", name = "c", descriptor = "Lclient!sg;")
	public SpotAnimTypeList aClass211_1;

	@OriginalMember(owner = "com.jagex.client!hf", name = "g", descriptor = "[S")
	private short[] aShortArray50;

	@OriginalMember(owner = "com.jagex.client!hf", name = "l", descriptor = "[S")
	private short[] aShortArray51;

	@OriginalMember(owner = "com.jagex.client!hf", name = "p", descriptor = "I")
	private int anInt2452;

	@OriginalMember(owner = "com.jagex.client!hf", name = "r", descriptor = "[S")
	private short[] aShortArray52;

	@OriginalMember(owner = "com.jagex.client!hf", name = "s", descriptor = "I")
	public int anInt2453;

	@OriginalMember(owner = "com.jagex.client!hf", name = "e", descriptor = "I")
	private int anInt2445 = 0;

	@OriginalMember(owner = "com.jagex.client!hf", name = "j", descriptor = "I")
	private int anInt2447 = 128;

	@OriginalMember(owner = "com.jagex.client!hf", name = "h", descriptor = "I")
	private int anInt2446 = 0;

	@OriginalMember(owner = "com.jagex.client!hf", name = "f", descriptor = "Z")
	public boolean aBoolean177 = false;

	@OriginalMember(owner = "com.jagex.client!hf", name = "k", descriptor = "I")
	public int anInt2448 = -1;

	@OriginalMember(owner = "com.jagex.client!hf", name = "t", descriptor = "I")
	private int anInt2454 = 128;

	@OriginalMember(owner = "com.jagex.client!hf", name = "n", descriptor = "I")
	private int anInt2450 = 0;

	@OriginalMember(owner = "com.jagex.client!hf", name = "q", descriptor = "Z")
	public boolean aBoolean178 = false;

	@OriginalMember(owner = "com.jagex.client!hf", name = "a", descriptor = "(BLclient!bt;)V")
	...
	@OriginalMember(owner = "com.jagex.client!hf", name = "a", descriptor = "(ILclient!bt;I)V")
	private void method2431(@OriginalArg(1) Packet arg0, @OriginalArg(2) int arg1) {
		if (arg1 == 1) {
	...
	@OriginalMember(owner = "com.jagex.client!hf", name = "a", descriptor = "(IILclient!wm;BILclient!gp;I)Lclient!gn;")
	public Model method2433(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Renderer arg2, @OriginalArg(4) int arg3, @OriginalArg(5) SeqTypeList arg4, @OriginalArg(6) int arg5) {
		...
		@Pc(62) LruHashTable local62 = this.aClass211_1.aClass98_51;
		@Pc(82) Model local82;
		synchronized (this.aClass211_1.aClass98_51) {
			local82 = (Model) this.aClass211_1.aClass98_51.get((long) (this.anInt2453 |= arg2.anInt2836 << 29));
		}
		if (local82 == null || arg2.method2863(local82.method3827(), local7) != 0) {
			...
			@Pc(209) LruHashTable local209 = this.aClass211_1.aClass98_51;
			synchronized (this.aClass211_1.aClass98_51) {
				this.aClass211_1.aClass98_51.put((long) (this.anInt2453 |= arg2.anInt2836 << 29), local82);
			}
		}
		@Pc(253) Model local253 = local23 == null ? local82.method3800((byte) 2, local7, true) : local23.method3987(arg0, (byte) 2, arg5, 0, arg1, local7, local82);
