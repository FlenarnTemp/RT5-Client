...
@OriginalClass("com.jagex.client!pr")
public final class Class185 {

	@OriginalMember(owner = "com.jagex.client!pr", name = "a", descriptor = "[B")
	public byte[] aByteArray61;

	@OriginalMember(owner = "com.jagex.client!pr", name = "b", descriptor = "[I")
	public int[] anIntArray354;

	@OriginalMember(owner = "com.jagex.client!pr", name = "c", descriptor = "[S")
	public short[] aShortArray96;

	@OriginalMember(owner = "com.jagex.client!pr", name = "d", descriptor = "[I")
	public int[] anIntArray355;

	@OriginalMember(owner = "com.jagex.client!pr", name = "g", descriptor = "[S")
	public short[] aShortArray97;

	@OriginalMember(owner = "com.jagex.client!pr", name = "j", descriptor = "[S")
	public short[] aShortArray98;

	@OriginalMember(owner = "com.jagex.client!pr", name = "l", descriptor = "[B")
	public byte[] aByteArray62;

	@OriginalMember(owner = "com.jagex.client!pr", name = "q", descriptor = "[S")
	public short[] aShortArray99;

	@OriginalMember(owner = "com.jagex.client!pr", name = "r", descriptor = "[B")
	public byte[] aByteArray63;

	@OriginalMember(owner = "com.jagex.client!pr", name = "t", descriptor = "[I")
	public int[] anIntArray356;

	@OriginalMember(owner = "com.jagex.client!pr", name = "u", descriptor = "[S")
	public short[] aShortArray100;

	@OriginalMember(owner = "com.jagex.client!pr", name = "v", descriptor = "[B")
	public byte[] aByteArray64;

	@OriginalMember(owner = "com.jagex.client!pr", name = "w", descriptor = "[S")
	public short[] aShortArray101;

	@OriginalMember(owner = "com.jagex.client!pr", name = "x", descriptor = "[S")
	public short[] aShortArray102;

	@OriginalMember(owner = "com.jagex.client!pr", name = "y", descriptor = "[B")
	public byte[] aByteArray65;

	@OriginalMember(owner = "com.jagex.client!pr", name = "z", descriptor = "[B")
	public byte[] aByteArray66;

	@OriginalMember(owner = "com.jagex.client!pr", name = "C", descriptor = "[S")
	public short[] aShortArray103;

	@OriginalMember(owner = "com.jagex.client!pr", name = "F", descriptor = "[S")
	public short[] aShortArray104;

	@OriginalMember(owner = "com.jagex.client!pr", name = "I", descriptor = "[S")
	public short[] aShortArray105;

	@OriginalMember(owner = "com.jagex.client!pr", name = "K", descriptor = "[Lclient!nm;")
	public Class163[] aClass163Array3;

	@OriginalMember(owner = "com.jagex.client!pr", name = "M", descriptor = "[B")
	public byte[] aByteArray67;

	@OriginalMember(owner = "com.jagex.client!pr", name = "O", descriptor = "[Lclient!jf;")
	public Class114[] aClass114Array3;

	@OriginalMember(owner = "com.jagex.client!pr", name = "Q", descriptor = "[B")
	public byte[] aByteArray68;

	@OriginalMember(owner = "com.jagex.client!pr", name = "R", descriptor = "[S")
	public short[] aShortArray106;

	@OriginalMember(owner = "com.jagex.client!pr", name = "S", descriptor = "[B")
	public byte[] aByteArray69;

	@OriginalMember(owner = "com.jagex.client!pr", name = "T", descriptor = "[B")
	public byte[] aByteArray70;

	@OriginalMember(owner = "com.jagex.client!pr", name = "U", descriptor = "[I")
	public int[] anIntArray357;

	@OriginalMember(owner = "com.jagex.client!pr", name = "V", descriptor = "[S")
	public short[] aShortArray107;

	@OriginalMember(owner = "com.jagex.client!pr", name = "Y", descriptor = "[I")
	public int[] anIntArray358;

	@OriginalMember(owner = "com.jagex.client!pr", name = "Z", descriptor = "[S")
	public short[] aShortArray108;

	@OriginalMember(owner = "com.jagex.client!pr", name = "h", descriptor = "I")
	public int anInt5072 = 0;

	@OriginalMember(owner = "com.jagex.client!pr", name = "D", descriptor = "B")
	public byte aByte56 = 0;

	@OriginalMember(owner = "com.jagex.client!pr", name = "m", descriptor = "I")
	public int anInt5075 = 0;

	@OriginalMember(owner = "com.jagex.client!pr", name = "f", descriptor = "I")
	public int anInt5071 = 0;

	@OriginalMember(owner = "com.jagex.client!pr", name = "X", descriptor = "I")
	public int anInt5087 = 0;

	@OriginalMember(owner = "com.jagex.client!pr", name = "<init>", descriptor = "([B)V")
	...
	@OriginalMember(owner = "com.jagex.client!pr", name = "<init>", descriptor = "(III)V")
	...
	@OriginalMember(owner = "com.jagex.client!pr", name = "<init>", descriptor = "([Lclient!pr;I)V")
	...
	@OriginalMember(owner = "com.jagex.client!pr", name = "a", descriptor = "(B[B)V")
	private void method4652(@OriginalArg(1) byte[] arg0) {
		...
		@Pc(117) int local117 = local10.g2();
		@Pc(121) int local121 = local10.g2();
		@Pc(125) int local125 = local10.g2();
		@Pc(129) int local129 = local10.g2();
		@Pc(133) int local133 = local10.g2();
		...
		if (this.anInt5072 > 0) {
			...
			for (local155 = 0; local155 < this.anInt5072; local155++) {
				@Pc(166) byte local166 = this.aByteArray67[local155] = local10.g1b();
				if (local166 == 0) {
					local135++;
				}
				if (local166 == 2) {
		...
		local15.pos = local295;
		local20.pos = local301;
		local25.pos = local307;
		local30.pos = local242;
		...
		for (@Pc(545) int local545 = 0; local545 < this.anInt5075; local545++) {
			...
			if ((local551 & 0x1) != 0) {
				local553 = local15.gsmarts();
			}
			@Pc(563) int local563 = 0;
			if ((local551 & 0x2) != 0) {
				local563 = local20.gsmarts();
			}
			@Pc(573) int local573 = 0;
			if ((local551 & 0x4) != 0) {
				local573 = local25.gsmarts();
			}
		...
		local10.pos = local286;
		local15.pos = local204;
		local20.pos = local220;
		local25.pos = local252;
		local30.pos = local230;
		local35.pos = local268;
		local48.pos = local280;
		for (local551 = 0; local551 < this.anInt5071; local551++) {
			this.aShortArray108[local551] = (short) local10.g2();
			if (local82) {
				this.aByteArray64[local551] = local15.g1b();
			}
			if (local97 == 255) {
				this.aByteArray61[local551] = local20.g1b();
			}
			if (local101 == 1) {
				this.aByteArray63[local551] = local25.g1b();
			}
			if (local105 == 1) {
				this.anIntArray357[local551] = local30.g1();
			}
			if (local109 == 1) {
				this.aShortArray98[local551] = (short) (local35.g2() - 1);
			}
		...
		local10.pos = local262;
		this.anInt5087 = -1;
		local15.pos = local213;
		...
		for (@Pc(778) int local778 = 0; local778 < this.anInt5071; local778++) {
			local784 = local15.g1();
			if (local784 == 1) {
				local770 = (short) (local776 + local10.gsmarts());
				local772 = (short) (local10.gsmarts() + local770);
				local774 = (short) (local10.gsmarts() + local772);
				local776 = local774;
			...
			if (local784 == 2) {
				local772 = local774;
				local774 = (short) (local10.gsmarts() + local776);
				local776 = local774;
				this.aShortArray97[local778] = local770;
				this.aShortArray105[local778] = local772;
				this.aShortArray102[local778] = local774;
		...
		this.anInt5087++;
		local10.pos = local313;
		local15.pos = local321;
		local20.pos = local329;
		local25.pos = local337;
		local30.pos = local343;
		local35.pos = local349;
		@Pc(1014) int local1014;
		for (local784 = 0; local784 < this.anInt5072; local784++) {
			local1014 = this.aByteArray67[local784] & 0xFF;
			if (local1014 == 0) {
				this.aShortArray104[local784] = (short) local10.g2();
				this.aShortArray106[local784] = (short) local10.g2();
				this.aShortArray101[local784] = (short) local10.g2();
			}
			if (local1014 == 1) {
				this.aShortArray104[local784] = (short) local15.g2();
				this.aShortArray106[local784] = (short) local15.g2();
				this.aShortArray101[local784] = (short) local15.g2();
				this.aShortArray96[local784] = (short) local20.g2();
				this.aShortArray99[local784] = (short) local20.g2();
				this.aShortArray103[local784] = (short) local20.g2();
				this.aByteArray68[local784] = local25.g1b();
				this.aByteArray66[local784] = local30.g1b();
				this.aByteArray65[local784] = local35.g1b();
			}
			if (local1014 == 2) {
				this.aShortArray104[local784] = (short) local15.g2();
				this.aShortArray106[local784] = (short) local15.g2();
				...
				this.aByteArray66[local784] = local30.g1b();
				this.aByteArray65[local784] = local35.g1b();
				this.aByteArray69[local784] = local35.g1b();
				this.aByteArray62[local784] = local35.g1b();
			}
			if (local1014 == 3) {
				this.aShortArray104[local784] = (short) local15.g2();
				this.aShortArray106[local784] = (short) local15.g2();
		...
		if (local1014 > 0) {
			...
			for (local1304 = 0; local1304 < local1014; local1304++) {
				local1310 = local10.g2();
				@Pc(1314) int local1314 = local10.g2();
		...
		for (local1310 = 0; local1310 < local1304; local1310++) {
			this.aClass163Array3[local1310] = new Class163(local10.g2(), local10.g2());
		}
		return;
	}

	@OriginalMember(owner = "com.jagex.client!pr", name = "a", descriptor = "(Z)[[I")
	...
	@OriginalMember(owner = "com.jagex.client!pr", name = "a", descriptor = "(Z[B)V")
	private void method4654(@OriginalArg(1) byte[] arg0) {
		...
		@Pc(79) int local79 = local14.g2();
		@Pc(83) int local83 = local14.g2();
		@Pc(87) int local87 = local14.g2();
		@Pc(91) int local91 = local14.g2();
		...
		this.aShortArray97 = new short[this.anInt5071];
		this.aShortArray102 = new short[this.anInt5071];
		local19.pos = local187;
		local24.pos = local193;
		local29.pos = local100;
		local34.pos = local141;
		...
		for (@Pc(344) int local344 = 0; local344 < this.anInt5075; local344++) {
			...
			local352 = 0;
			if ((local350 & 0x1) != 0) {
				local352 = local19.gsmarts();
			}
			@Pc(365) int local365 = 0;
			if ((local350 & 0x2) != 0) {
				local365 = local24.gsmarts();
			}
			@Pc(378) int local378 = 0;
			if ((local350 & 0x4) != 0) {
				local378 = local29.gsmarts();
			}
		...
		local14.pos = local169;
		local19.pos = local129;
		local24.pos = local109;
		local29.pos = local151;
		local34.pos = local119;
		for (local350 = 0; local350 < this.anInt5071; local350++) {
			this.aShortArray108[local350] = (short) local14.g2();
			if (local59 == 1) {
				local352 = local19.g1();
				if ((local352 & 0x1) == 1) {
			...
			if (local63 == 255) {
				this.aByteArray61[local350] = local24.g1b();
			}
			if (local67 == 1) {
				this.aByteArray63[local350] = local29.g1b();
			}
			if (local71 == 1) {
		...
		this.anInt5087 = -1;
		local14.pos = local163;
		local19.pos = local102;
		...
		for (@Pc(602) int local602 = 0; local602 < this.anInt5071; local602++) {
			local608 = local19.g1();
			if (local608 == 1) {
				local594 = (short) (local600 + local14.gsmarts());
				local596 = (short) (local14.gsmarts() + local594);
				local598 = (short) (local596 + local14.gsmarts());
				local600 = local598;
			...
			if (local608 == 2) {
				local596 = local598;
				local598 = (short) (local14.gsmarts() + local600);
				local600 = local598;
				this.aShortArray97[local602] = local594;
				this.aShortArray105[local602] = local596;
				this.aShortArray102[local602] = local598;
			...
			if (local608 == 3) {
				local594 = local598;
				local598 = (short) (local600 + local14.gsmarts());
				local600 = local598;
				this.aShortArray97[local602] = local594;
				this.aShortArray105[local602] = local596;
				this.aShortArray102[local602] = local598;
		...
		local14.pos = local178;
		this.anInt5087++;
		for (local608 = 0; local608 < this.anInt5072; local608++) {
			this.aByteArray67[local608] = 0;
			this.aShortArray104[local608] = (short) local14.g2();
			this.aShortArray106[local608] = (short) local14.g2();
			this.aShortArray101[local608] = (short) local14.g2();
		}
		if (this.aByteArray70 != null) {
	...
	@OriginalMember(owner = "com.jagex.client!pr", name = "a", descriptor = "(IIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!pr", name = "a", descriptor = "(SILclient!pr;Z)I")
	...
	@OriginalMember(owner = "com.jagex.client!pr", name = "a", descriptor = "(ZSS)V")
	...
	@OriginalMember(owner = "com.jagex.client!pr", name = "a", descriptor = "(SIBIIBISB)I")
	...
	@OriginalMember(owner = "com.jagex.client!pr", name = "b", descriptor = "(Z)[[I")
	...
	@OriginalMember(owner = "com.jagex.client!pr", name = "a", descriptor = "(IBSBBSSSSS)B")
	...
	@OriginalMember(owner = "com.jagex.client!pr", name = "a", descriptor = "(SSZ)V")
	...
	@OriginalMember(owner = "com.jagex.client!pr", name = "b", descriptor = "(IIII)V")
	public void method4664(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		@Pc(32) int local32;
		if (arg1 != 0) {
			local7 = Renderer.anIntArray178[arg1];
			local11 = Renderer.anIntArray177[arg1];
		...
		if (arg2 != 0) {
			local7 = Renderer.anIntArray178[arg2];
			local11 = Renderer.anIntArray177[arg2];
			for (local13 = 0; local13 < this.anInt5075; local13++) {
		...
		local7 = Renderer.anIntArray178[arg0];
		local11 = Renderer.anIntArray177[arg0];
		for (local13 = 0; local13 < this.anInt5075; local13++) {
	...
	@OriginalMember(owner = "com.jagex.client!pr", name = "c", descriptor = "(IIII)I")
