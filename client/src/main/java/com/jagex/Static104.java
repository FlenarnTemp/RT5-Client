...
public final class Static104 {
	...
	@OriginalMember(owner = "com.jagex.client!fs", name = "a", descriptor = "Ljava/nio/ByteBuffer;")
	public static ByteBuffer aByteBuffer1;

	@OriginalMember(owner = "com.jagex.client!fs", name = "c", descriptor = "Ljava/nio/ByteBuffer;")
	public static ByteBuffer aByteBuffer2;

	@OriginalMember(owner = "com.jagex.client!fs", name = "a", descriptor = "()V")
