...
public final class Static266 {
	...
	@OriginalMember(owner = "com.jagex.client!pe", name = "Y", descriptor = "[I")
	public static final int[] anIntArray334 = new int[64];

	@OriginalMember(owner = "com.jagex.client!pe", name = "b", descriptor = "(II)I")
	public static int method4498(@OriginalArg(0) int arg0) {
		return arg0 >>> 8;
	}

	@OriginalMember(owner = "com.jagex.client!pe", name = "a", descriptor = "(III)Lclient!f;")
