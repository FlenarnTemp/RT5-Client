...
@OriginalClass("com.jagex.client!tf")
public abstract class Class6 {

	@OriginalMember(owner = "com.jagex.client!tf", name = "i", descriptor = "I")
	public final int anInt6320;

	@OriginalMember(owner = "com.jagex.client!tf", name = "h", descriptor = "I")
	public final int anInt6319;

	@OriginalMember(owner = "com.jagex.client!tf", name = "<init>", descriptor = "(II)V")
	protected Class6(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.anInt6320 = arg0;
		this.anInt6319 = arg1;
	}

	@OriginalMember(owner = "com.jagex.client!tf", name = "a", descriptor = "(II[I[I[I[I[I[I[I[I[I[I[IIIIZ)V")
	...
	@OriginalMember(owner = "com.jagex.client!tf", name = "a", descriptor = "()V")
	public abstract void method5718();

	@OriginalMember(owner = "com.jagex.client!tf", name = "a", descriptor = "(II)I")
	public abstract int method5719(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1);

	@OriginalMember(owner = "com.jagex.client!tf", name = "b", descriptor = "(II)V")
	public abstract void method5720(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1);

	@OriginalMember(owner = "com.jagex.client!tf", name = "a", descriptor = "(Lclient!of;[I)V")
	public abstract void method5721(@OriginalArg(0) Class2_Sub26 arg0, @OriginalArg(1) int[] arg1);

	@OriginalMember(owner = "com.jagex.client!tf", name = "a", descriptor = "(IIIIIII[[Z)V")
	...
	@OriginalMember(owner = "com.jagex.client!tf", name = "a", descriptor = "(III)V")
	public abstract void method5723(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2);

	@OriginalMember(owner = "com.jagex.client!tf", name = "a", descriptor = "(Lclient!kb;IIIIZ)V")
	...
	@OriginalMember(owner = "com.jagex.client!tf", name = "b", descriptor = "(Lclient!kb;IIIIZ)V")
	...
	@OriginalMember(owner = "com.jagex.client!tf", name = "a", descriptor = "(II[I[I[I[I[I[I[I[IIIIZ)V")
	...
	@OriginalMember(owner = "com.jagex.client!tf", name = "c", descriptor = "(II)I")
	public abstract int method5728(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1);

	@OriginalMember(owner = "com.jagex.client!tf", name = "a", descriptor = "(III[[ZZ)V")
	...
	@OriginalMember(owner = "com.jagex.client!tf", name = "a", descriptor = "(IILclient!kb;)Lclient!kb;")
	...
	@OriginalMember(owner = "com.jagex.client!tf", name = "c", descriptor = "(Lclient!kb;IIIIZ)Z")
