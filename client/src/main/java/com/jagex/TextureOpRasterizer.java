...
@OriginalClass("com.jagex.client!vm")
public final class TextureOpRasterizer extends TextureOp {

	@OriginalMember(owner = "com.jagex.client!vm", name = "X", descriptor = "[Lclient!pa;")
	private Class173[] aClass173Array1;

	@OriginalMember(owner = "com.jagex.client!vm", name = "<init>", descriptor = "()V")
	public TextureOpRasterizer() {
		super(0, true);
	}

	@OriginalMember(owner = "com.jagex.client!vm", name = "b", descriptor = "(IB)[[I")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!vm", name = "a", descriptor = "(ILclient!bt;I)V")
	@Override
	public void decode(@OriginalArg(0) int code, @OriginalArg(1) Packet buf) {
		if (code == 0) {
			this.aClass173Array1 = new Class173[buf.g1()];
			for (@Pc(33) int local33 = 0; local33 < this.aClass173Array1.length; local33++) {
				@Pc(39) int local39 = buf.g1();
				if (local39 == 0) {
					this.aClass173Array1[local33] = Static354.method1393(buf);
				} else if (local39 == 1) {
					this.aClass173Array1[local33] = Static174.method1508(buf);
				} else if (local39 == 2) {
					this.aClass173Array1[local33] = Static372.method6266(buf);
				} else if (local39 == 3) {
					this.aClass173Array1[local33] = Static217.method3799(buf);
				}
			}
		} else if (code == 1) {
	...
	@OriginalMember(owner = "com.jagex.client!vm", name = "a", descriptor = "([[II)V")
	...
	@OriginalMember(owner = "com.jagex.client!vm", name = "a", descriptor = "(BI)[I")
	@Override
