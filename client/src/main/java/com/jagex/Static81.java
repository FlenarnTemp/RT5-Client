...
public final class Static81 {
	...
	@OriginalMember(owner = "com.jagex.client!el", name = "j", descriptor = "[I")
	public static final int[] anIntArray219 = new int[14];

	@OriginalMember(owner = "com.jagex.client!el", name = "l", descriptor = "I")
	public static int anInt3709 = 0;

	@OriginalMember(owner = "com.jagex.client!el", name = "a", descriptor = "(Lclient!r;BLclient!r;)V")
	...
	@OriginalMember(owner = "com.jagex.client!el", name = "a", descriptor = "([[[Lclient!f;ZIIII)Z")
