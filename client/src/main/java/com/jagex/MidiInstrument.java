...
@OriginalClass("com.jagex.client!ne")
public final class MidiInstrument extends Node {

	@OriginalMember(owner = "com.jagex.client!ne", name = "s", descriptor = "[B")
	public final byte[] aByteArray45 = new byte[128];

	@OriginalMember(owner = "com.jagex.client!ne", name = "v", descriptor = "[Lclient!jn;")
	public final PcmSound[] aClass2_Sub21_Sub1Array1 = new PcmSound[128];

	@OriginalMember(owner = "com.jagex.client!ne", name = "x", descriptor = "[B")
	public final byte[] aByteArray46 = new byte[128];

	@OriginalMember(owner = "com.jagex.client!ne", name = "y", descriptor = "[Lclient!bd;")
	public final Class17[] aClass17Array1 = new Class17[128];

	@OriginalMember(owner = "com.jagex.client!ne", name = "C", descriptor = "[I")
	private int[] anIntArray264 = new int[128];

	@OriginalMember(owner = "com.jagex.client!ne", name = "D", descriptor = "I")
	public final int anInt4064;

	@OriginalMember(owner = "com.jagex.client!ne", name = "F", descriptor = "[S")
	public final short[] aShortArray90 = new short[128];

	@OriginalMember(owner = "com.jagex.client!ne", name = "I", descriptor = "[B")
	public final byte[] aByteArray47 = new byte[128];

	@OriginalMember(owner = "com.jagex.client!ne", name = "<init>", descriptor = "([B)V")
	...
	@OriginalMember(owner = "com.jagex.client!ne", name = "b", descriptor = "(I)V")
	public void release() {
		this.anIntArray264 = null;
	}

	@OriginalMember(owner = "com.jagex.client!ne", name = "a", descriptor = "([BLclient!bk;I[I)Z")
