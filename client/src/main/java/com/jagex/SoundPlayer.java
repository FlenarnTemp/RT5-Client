...
public class SoundPlayer {
	...
	@OriginalMember(owner = "com.jagex.client!om", name = "K", descriptor = "[I")
	public static final int[] ids = new int[50];
	@OriginalMember(owner = "com.jagex.client!tc", name = "T", descriptor = "[I")
	public static final int[] loops = new int[50];
	@OriginalMember(owner = "com.jagex.client!nl", name = "e", descriptor = "[I")
	public static final int[] delays = new int[50];
	@OriginalMember(owner = "com.jagex.client!lh", name = "d", descriptor = "[Lclient!wk;")
	public static final SynthSound[] sounds = new SynthSound[50];
	@OriginalMember(owner = "com.jagex.client!jh", name = "j", descriptor = "[I")
	public static final int[] positions = new int[50];
	@OriginalMember(owner = "com.jagex.client!mt", name = "c", descriptor = "[I")
	public static final int[] volumes = new int[50];
	@OriginalMember(owner = "com.jagex.client!nt", name = "Q", descriptor = "I")
	public static int size = 0;

	@OriginalMember(owner = "com.jagex.client!bm", name = "a", descriptor = "(IZIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!mm", name = "a", descriptor = "(I)V")
