...
public class ByteArrayPool {
    @OriginalMember(owner = "com.jagex.client!qk", name = "gb", descriptor = "[[B")
    public static final byte[][] allocatedMin = new byte[1000][];
    @OriginalMember(owner = "com.jagex.client!mh", name = "b", descriptor = "[[B")
    public static final byte[][] allocatedMid = new byte[250][];
    @OriginalMember(owner = "com.jagex.client!od", name = "bb", descriptor = "[[B")
    public static final byte[][] allocatedMax = new byte[50][];
    @OriginalMember(owner = "com.jagex.client!dd", name = "m", descriptor = "I")
    public static int allocatedMinCount = 0;
    @OriginalMember(owner = "com.jagex.client!pi", name = "g", descriptor = "I")
    public static int allocatedMidCount = 0;
    @OriginalMember(owner = "com.jagex.client!ut", name = "K", descriptor = "I")
    public static int allocatedMaxCount = 0;

    @OriginalMember(owner = "com.jagex.client!cq", name = "a", descriptor = "(II)[B")
