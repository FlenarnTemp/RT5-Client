...
public class IgnoreList {
	...
	@OriginalMember(owner = "com.jagex.client!lh", name = "g", descriptor = "[Z")
	public static final boolean[] temporary = new boolean[100];
	@OriginalMember(owner = "com.jagex.client!ri", name = "U", descriptor = "I")
	public static int size = 0;

	@OriginalMember(owner = "com.jagex.client!oo", name = "a", descriptor = "(Ljava/lang/String;Z)V")
	...
	@OriginalMember(owner = "com.jagex.client!rs", name = "a", descriptor = "(Ljava/lang/String;ZB)V")
	...
	@OriginalMember(owner = "com.jagex.client!ft", name = "a", descriptor = "(ILjava/lang/String;)Z")
