...
public final class Static282 {
	...
	@OriginalMember(owner = "com.jagex.client!qg", name = "Ub", descriptor = "I")
	public static int anInt5347;

	@OriginalMember(owner = "com.jagex.client!qg", name = "Kb", descriptor = "Lclient!gd;")
	...
	@OriginalMember(owner = "com.jagex.client!qg", name = "a", descriptor = "(IIILclient!wm;IIBII)V")
	public static void method4874(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Renderer arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7) {
		...
		@Pc(43) int local43;
		if (local11 != null) {
			local25 = client.LocTypes.get(local11.method6085());
			local33 = local11.method6084() & 0x3;
			local37 = local11.method6081();
			if (local25.mapsceneicon == -1) {
				local43 = arg1;
				if (local25.active > 0) {
					local43 = arg0;
				}
