...
public final class Static20 {
	...
	@OriginalMember(owner = "com.jagex.client!bd", name = "g", descriptor = "[Z")
	public static final boolean[] aBooleanArray6 = new boolean[100];

	@OriginalMember(owner = "com.jagex.client!bd", name = "m", descriptor = "Lclient!nk;")
	public static Component aClass161_1 = null;

	@OriginalMember(owner = "com.jagex.client!bd", name = "a", descriptor = "(I)V")
