...
@OriginalClass("com.jagex.client!rf")
public final class HslAdjust extends TextureOp {

	@OriginalMember(owner = "com.jagex.client!rf", name = "N", descriptor = "I")
	private int anInt5639;

	@OriginalMember(owner = "com.jagex.client!rf", name = "P", descriptor = "I")
	private int anInt5640;

	@OriginalMember(owner = "com.jagex.client!rf", name = "V", descriptor = "I")
	private int anInt5646;

	@OriginalMember(owner = "com.jagex.client!rf", name = "Y", descriptor = "I")
	private int anInt5649;

	@OriginalMember(owner = "com.jagex.client!rf", name = "Z", descriptor = "I")
	private int anInt5650;

	@OriginalMember(owner = "com.jagex.client!rf", name = "bb", descriptor = "I")
	private int anInt5652;

	@OriginalMember(owner = "com.jagex.client!rf", name = "X", descriptor = "I")
	private int anInt5648 = 0;

	@OriginalMember(owner = "com.jagex.client!rf", name = "W", descriptor = "I")
	private int anInt5647 = 0;

	@OriginalMember(owner = "com.jagex.client!rf", name = "Q", descriptor = "I")
	private int anInt5641 = 0;

	@OriginalMember(owner = "com.jagex.client!rf", name = "<init>", descriptor = "()V")
	public HslAdjust() {
		super(1, false);
	}

	@OriginalMember(owner = "com.jagex.client!rf", name = "b", descriptor = "(IB)[[I")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!rf", name = "a", descriptor = "(ILclient!bt;I)V")
	@Override
	public void decode(@OriginalArg(0) int code, @OriginalArg(1) Packet buf) {
		if (code == 0) {
			this.anInt5647 = buf.g2s();
		} else if (code == 1) {
			this.anInt5641 = (buf.g1b() << 12) / 100;
		} else if (code == 2) {
			this.anInt5648 = (buf.g1b() << 12) / 100;
		}
	}

	@OriginalMember(owner = "com.jagex.client!rf", name = "a", descriptor = "(IIIZ)V")
	...
	@OriginalMember(owner = "com.jagex.client!rf", name = "a", descriptor = "(IIII)V")
