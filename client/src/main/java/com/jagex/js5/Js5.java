...
@OriginalClass("com.jagex.client!r")
public final class Js5 {

	@OriginalMember(owner = "com.jagex.client!fk", name = "v", descriptor = "Z")
	public static final boolean RAISE_EXCEPTIONS = false;
	@OriginalMember(owner = "com.jagex.client!r", name = "c", descriptor = "[Ljava/lang/Object;")
	private Object[] packed;

	@OriginalMember(owner = "com.jagex.client!r", name = "S", descriptor = "[[Ljava/lang/Object;")
	private Object[][] unpacked;

	@OriginalMember(owner = "com.jagex.client!r", name = "h", descriptor = "Lclient!ra;")
	private Js5Index index = null;

	@OriginalMember(owner = "com.jagex.client!r", name = "g", descriptor = "Lclient!di;")
	private final Js5ResourceProvider provider;

	@OriginalMember(owner = "com.jagex.client!r", name = "x", descriptor = "Z")
	private final boolean discardPacked;

	@OriginalMember(owner = "com.jagex.client!r", name = "n", descriptor = "I")
	public int discardUnpacked;

	@OriginalMember(owner = "com.jagex.client!r", name = "<init>", descriptor = "(Lclient!di;ZI)V")
	...
	@OriginalMember(owner = "com.jagex.client!r", name = "a", descriptor = "(BI)I")
	...
	@OriginalMember(owner = "com.jagex.client!r", name = "a", descriptor = "(Z)V")
	...
	@OriginalMember(owner = "com.jagex.client!r", name = "a", descriptor = "(III)Z")
	private boolean isGroupValid(@OriginalArg(0) int file, @OriginalArg(2) int group) {
	...
	@OriginalMember(owner = "com.jagex.client!r", name = "a", descriptor = "(ZIZ)V")
	...
	@OriginalMember(owner = "com.jagex.client!r", name = "b", descriptor = "(BI)Z")
	...
	@OriginalMember(owner = "com.jagex.client!r", name = "a", descriptor = "(Ljava/lang/String;B)Z")
	...
	@OriginalMember(owner = "com.jagex.client!r", name = "a", descriptor = "(I)Z")
	...
	@OriginalMember(owner = "com.jagex.client!r", name = "a", descriptor = "(BII[I)Z")
	...
	@OriginalMember(owner = "com.jagex.client!r", name = "a", descriptor = "(BLjava/lang/String;)I")
	...
	@OriginalMember(owner = "com.jagex.client!r", name = "b", descriptor = "(Ljava/lang/String;B)V")
	...
	@OriginalMember(owner = "com.jagex.client!r", name = "a", descriptor = "(IZ)[I")
	...
	@OriginalMember(owner = "com.jagex.client!r", name = "a", descriptor = "(B)I")
	...
	@OriginalMember(owner = "com.jagex.client!r", name = "a", descriptor = "([IIII)[B")
	public byte[] getfile(@OriginalArg(3) int group, @OriginalArg(2) int file, @OriginalArg(0) int[] key) {
		if (!this.isGroupValid(file, group)) {
			return null;
		}
		if (this.unpacked[group] == null || this.unpacked[group][file] == null) {
			@Pc(32) boolean success = this.unpackGroup(file, group, key);
			if (!success) {
				this.fetchGroup(group);
				success = this.unpackGroup(file, group, key);
				if (!success) {
					return null;
				}
			}
		}
		@Pc(65) byte[] local65 = ByteArray.unwrap(false, this.unpacked[group][file]);
	...
	@OriginalMember(owner = "com.jagex.client!r", name = "a", descriptor = "(IB)I")
	public int getGroupCapacity(@OriginalArg(0) int arg0) {
		return this.isGroupValid(arg0) ? this.index.groupCapacities[arg0] : 0;
	}

	@OriginalMember(owner = "com.jagex.client!r", name = "a", descriptor = "(II)[B")
	...
	@OriginalMember(owner = "com.jagex.client!r", name = "b", descriptor = "(II)V")
	private void prefetchGroup(@OriginalArg(0) int arg0) {
		this.provider.prefetchGroup(arg0);
	}

	@OriginalMember(owner = "com.jagex.client!r", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;I)[B")
	public byte[] getfile(@OriginalArg(0) String arg0, @OriginalArg(1) String arg1) {
		if (!this.isIndexReady()) {
			return null;
		}
		...
		if (this.isGroupValid(local28)) {
			...
			return this.getfile(local46, local28);
		} else {
			return null;
		}
	}

	@OriginalMember(owner = "com.jagex.client!r", name = "c", descriptor = "(Ljava/lang/String;B)I")
	...
	@OriginalMember(owner = "com.jagex.client!r", name = "b", descriptor = "(B)Z")
	...
	@OriginalMember(owner = "com.jagex.client!r", name = "d", descriptor = "(BI)Z")
	public boolean requestDownload(@OriginalArg(1) int id) {
		if (!this.isIndexReady()) {
			return false;
		} else if (this.index.groupCapacities.length == 1) {
	...
	@OriginalMember(owner = "com.jagex.client!r", name = "b", descriptor = "(III)Z")
	public boolean requestDownload(@OriginalArg(2) int group, @OriginalArg(0) int file) {
		if (!this.isGroupValid(file, group)) {
			return false;
	...
	@OriginalMember(owner = "com.jagex.client!r", name = "a", descriptor = "(BII)[B")
	public byte[] getfile(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
		return this.getfile(arg1, arg0, null);
	}

	@OriginalMember(owner = "com.jagex.client!r", name = "c", descriptor = "(B)V")
	...
	@OriginalMember(owner = "com.jagex.client!r", name = "d", descriptor = "(B)I")
	public int getPercentageComplete() {
		...
		for (@Pc(25) int index = 0; index < this.packed.length; index++) {
	...
	@OriginalMember(owner = "com.jagex.client!r", name = "e", descriptor = "(B)I")
	public int capacity() {
		return this.isIndexReady() ? this.index.groupCapacities.length : -1;
	}

	@OriginalMember(owner = "com.jagex.client!r", name = "c", descriptor = "(II)V")
	...
	@OriginalMember(owner = "com.jagex.client!r", name = "b", descriptor = "(IZ)I")
	...
	@OriginalMember(owner = "com.jagex.client!r", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;Z)Z")
	public boolean requestDownload(@OriginalArg(0) String arg0, @OriginalArg(1) String arg1) {
		if (!this.isIndexReady()) {
			return false;
		}
		@Pc(12) String local12 = arg0.toLowerCase();
		...
		if (this.isGroupValid(local24)) {
			...
			return this.requestDownload(local24, local47);
		} else {
			return false;
		}
	}

	@OriginalMember(owner = "com.jagex.client!r", name = "a", descriptor = "(ILjava/lang/String;)Z")
	...
	@OriginalMember(owner = "com.jagex.client!r", name = "d", descriptor = "(II)Z")
