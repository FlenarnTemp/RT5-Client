...
public final class Static239 {
	...
	@OriginalMember(owner = "com.jagex.client!nn", name = "U", descriptor = "Lclient!gd;")
	public static final LocalizedString aClass79_95 = new LocalizedString("Drop", "Fallen lassen", "Poser", "Largar");

	@OriginalMember(owner = "com.jagex.client!nn", name = "a", descriptor = "(Lclient!wm;B)V")
	public static void method4156(@OriginalArg(0) Renderer arg0) {
