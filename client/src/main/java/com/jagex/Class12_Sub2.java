...
@OriginalClass("com.jagex.client!au")
public final class Class12_Sub2 extends ParticleNode {

	@OriginalMember(owner = "com.jagex.client!au", name = "i", descriptor = "I")
	public int anInt423;

	@OriginalMember(owner = "com.jagex.client!au", name = "j", descriptor = "I")
	public int anInt424;

	@OriginalMember(owner = "com.jagex.client!au", name = "k", descriptor = "I")
	public int anInt425;

	@OriginalMember(owner = "com.jagex.client!au", name = "l", descriptor = "I")
	public int anInt426;

	@OriginalMember(owner = "com.jagex.client!au", name = "n", descriptor = "I")
	public int anInt427;

	@OriginalMember(owner = "com.jagex.client!au", name = "m", descriptor = "Z")
	public boolean aBoolean29 = false;

	@OriginalMember(owner = "com.jagex.client!au", name = "a", descriptor = "(II)Z")
