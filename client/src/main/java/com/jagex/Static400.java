...
public final class Static400 {
	...
	@OriginalMember(owner = "com.jagex.client!ic", name = "a", descriptor = "(II[BIIII[BI)V")
	...
	@OriginalMember(owner = "com.jagex.client!ic", name = "a", descriptor = "([BBIIIII)Z")
	...
	@OriginalMember(owner = "com.jagex.client!ic", name = "a", descriptor = "([B[BIIIIIII)V")
