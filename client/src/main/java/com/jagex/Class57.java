...
@OriginalClass("com.jagex.client!os")
public abstract class Class57 {

	@OriginalMember(owner = "com.jagex.client!q", name = "n", descriptor = "[I")
	...
	@OriginalMember(owner = "com.jagex.client!os", name = "j", descriptor = "[S")
	private short[] powerOfTwo;

	@OriginalMember(owner = "com.jagex.client!os", name = "c", descriptor = "I")
	private int yFactor = 4;

	@OriginalMember(owner = "com.jagex.client!os", name = "e", descriptor = "I")
	private int zFactor = 4;

	@OriginalMember(owner = "com.jagex.client!os", name = "d", descriptor = "I")
	private int seed = 0;

	@OriginalMember(owner = "com.jagex.client!os", name = "g", descriptor = "I")
	private int xFactor = 4;

	@OriginalMember(owner = "com.jagex.client!os", name = "l", descriptor = "[S")
	private final short[] pImp = new short[512];

	@OriginalMember(owner = "com.jagex.client!os", name = "k", descriptor = "I")
	protected int factorsOfTwo = 4;

	@OriginalMember(owner = "com.jagex.client!os", name = "<init>", descriptor = "(IIIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!jr", name = "a", descriptor = "(IIIII)I")
	...
	@OriginalMember(owner = "com.jagex.client!pj", name = "b", descriptor = "(IB)I")
	...
	@OriginalMember(owner = "com.jagex.client!os", name = "a", descriptor = "(III)V")
	protected abstract void apply(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1);

	@OriginalMember(owner = "com.jagex.client!os", name = "a", descriptor = "(B)V")
	...
	@OriginalMember(owner = "com.jagex.client!os", name = "a", descriptor = "(IIBI)V")
	...
	@OriginalMember(owner = "com.jagex.client!os", name = "b", descriptor = "(B)V")
	...
	@OriginalMember(owner = "com.jagex.client!os", name = "a", descriptor = "(I)V")
	protected abstract void setup();

	@OriginalMember(owner = "com.jagex.client!os", name = "a", descriptor = "(Z)V")
