...
public final class Static228 {
	...
	@OriginalMember(owner = "com.jagex.client!nc", name = "m", descriptor = "I")
	public static int anInt4046;

	@OriginalMember(owner = "com.jagex.client!nc", name = "a", descriptor = "(IIIIIII)V")
		...
		for (@Pc(13) int local13 = 0; local13 < NPCList.size + local7; local13++) {
			...
			if (local33.anInt4638 >= 0 && (Static163.anInt3086 == local33.anInt4603 || PlayerList.self.plane == local33.plane)) {
				...
				if (Static216.anIntArray231[0] >= 0) {
					if (local33.aString50 != null && (local13 >= local7 || Chat.publicFilter == 0 || Chat.publicFilter == 3 || Chat.publicFilter == 1 && FriendsList.contains(((Player) local33).username)) && Static319.anInt5977 > Static45.anInt1196) {
					...
					if (!local33.aBoolean320 && client.cycle < local33.anInt4606) {
						...
						if (local217 != -1) {
							...
							if (local246 == null) {
								@Pc(253) SpriteData[] local253 = Static396.method1688(client.jsArchive8, local217);
								if (local253 != null) {
						...
						Rasteriser.instance.method2817(local310, local194, local322 + local310, local194 + local180.method6382());
						local209.method6385(local310, local194);
						Rasteriser.instance.method2895(arg0, arg3, arg0 + arg1, arg3 - -arg2);
					}
					local194 -= 2;
					if (!local33.aBoolean320) {
						if (client.cycle < local33.anInt4621) {
							...
							if (local310 != -1) {
								...
								if (local420 == null) {
									@Pc(427) SpriteData[] local427 = Static396.method1688(client.jsArchive8, local310);
									if (local427 != null) {
							...
							Rasteriser.instance.method2817(local546, local194, local261 + local546, local194 - -local435);
							local386.method6385(local546, local194);
							local194 -= 2;
							Rasteriser.instance.method2895(arg0, arg3, arg1 + arg0, arg3 - -arg2);
						}
						if (local13 < local7) {
		...
		for (@Pc(1030) int local1030 = 0; local1030 < Static45.anInt1196; local1030++) {
			...
			if (Static389.anInt4896 == 0) {
				...
				if (Static319.anIntArray400[local1030] == 4) {
					...
					Rasteriser.instance.method2817(local194 + arg0 - 50, arg3, arg0 + local194 + 50, arg3 - -arg2);
				...
				if (Static319.anIntArray400[local1030] == 5) {
					...
					Rasteriser.instance.method2817(arg0, arg3 + local663 - local1571 - 1, arg0 - -arg1, arg3 + local663 + 5);
	...
	@OriginalMember(owner = "com.jagex.client!nc", name = "a", descriptor = "(IIII)Lclient!mr;")
