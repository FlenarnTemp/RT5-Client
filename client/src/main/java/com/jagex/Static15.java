...
public final class Static15 {
	...
	@OriginalMember(owner = "com.jagex.client!ar", name = "N", descriptor = "I")
	public static int anInt366;

	@OriginalMember(owner = "com.jagex.client!ar", name = "U", descriptor = "[Lclient!jd;")
	public static Sprite[] aClass13Array3;

	@OriginalMember(owner = "com.jagex.client!ar", name = "a", descriptor = "(IJ)Ljava/lang/String;")
	...
	public static void method395(@OriginalArg(0) int arg0, @OriginalArg(1) LocType arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) Renderer arg4) {
		...
		@Pc(39) Sprite local39 = local9.method3711(arg1.mapsceneiconmirror, arg0, arg4);
		if (local39 == null) {
			return;
		}
		@Pc(45) int local45 = arg1.width;
