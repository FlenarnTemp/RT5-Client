...
public final class Static262 {
	...
	@OriginalMember(owner = "com.jagex.client!pa", name = "f", descriptor = "Lclient!gd;")
	public static final LocalizedString aClass79_145 = new LocalizedString("Continue", "Weiter", "Continuer", "Continuar");

	@OriginalMember(owner = "com.jagex.client!pa", name = "i", descriptor = "I")
	public static int anInt6999 = 2;

	@OriginalMember(owner = "com.jagex.client!pa", name = "a", descriptor = "(IIIIILclient!nk;Lclient!kf;IB)V")
	public static void method6249(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) Component arg5, @OriginalArg(6) Class78 arg6, @OriginalArg(7) int arg7) {
		...
		@Pc(77) int local77 = Renderer.anIntArray178[local66];
		@Pc(81) int local81 = Renderer.anIntArray177[local66];
		if (Camera.cameraType != 4) {
	...
	@OriginalMember(owner = "com.jagex.client!pa", name = "a", descriptor = "(Z)V")
