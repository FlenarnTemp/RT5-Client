...
public final class Static133 {
	...
	@OriginalMember(owner = "com.jagex.client!hl", name = "H", descriptor = "Lclient!hu;")
	public static final LruHashTable aClass98_17 = new LruHashTable(4);

	@OriginalMember(owner = "com.jagex.client!hl", name = "K", descriptor = "I")
	public static final int anInt2489 = 1406;

	@OriginalMember(owner = "com.jagex.client!hl", name = "a", descriptor = "(BJ)V")
