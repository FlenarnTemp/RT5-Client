...
@OriginalClass("com.jagex.client!rq")
public final class Cache {

	@OriginalMember(owner = "com.jagex.client!rq", name = "e", descriptor = "Lclient!rn;")
	private Class205 aClass205_3 = null;

	@OriginalMember(owner = "com.jagex.client!rq", name = "g", descriptor = "I")
	private int anInt5776 = 65000;

	@OriginalMember(owner = "com.jagex.client!rq", name = "k", descriptor = "Lclient!rn;")
	private Class205 aClass205_4 = null;

	@OriginalMember(owner = "com.jagex.client!rq", name = "b", descriptor = "I")
	private final int anInt5772;

	@OriginalMember(owner = "com.jagex.client!rq", name = "<init>", descriptor = "(ILclient!rn;Lclient!rn;I)V")
	...
	@OriginalMember(owner = "com.jagex.client!rq", name = "toString", descriptor = "()Ljava/lang/String;")
	@Override
	public String toString() {
		return "com.jagex.Cache:" + this.anInt5772;
	}

	@OriginalMember(owner = "com.jagex.client!rq", name = "a", descriptor = "(I[BBI)Z")
	...
	@OriginalMember(owner = "com.jagex.client!rq", name = "a", descriptor = "(ZIII[B)Z")
	...
	@OriginalMember(owner = "com.jagex.client!rq", name = "a", descriptor = "(II)[B")
