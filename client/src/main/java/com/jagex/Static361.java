...
public final class Static361 {
	...
	@OriginalMember(owner = "com.jagex.client!vc", name = "e", descriptor = "I")
	public static int anInt6770;

	@OriginalMember(owner = "com.jagex.client!vc", name = "g", descriptor = "[[I")
	...
	@OriginalMember(owner = "com.jagex.client!vc", name = "a", descriptor = "(Lclient!wm;I)V")
	public static void method6055(@OriginalArg(0) Renderer arg0) {
		...
		@Pc(72) int local72 = Mouse.instance.method3304();
		@Pc(76) int local76 = Mouse.instance.method3313();
		@Pc(78) int local78 = 0;
		for (@Pc(88) Class2_Sub5 local88 = (Class2_Sub5) Static129.aClass135_19.head(); local88 != null; local88 = (Class2_Sub5) Static129.aClass135_19.next()) {
			...
			if (Static298.method2425(local88.anInt1005)) {
				...
				if (local166 != null) {
					...
					if (local171.multinpc != null) {
						local171 = local171.getMultiNpc(VarpDomain.instance);
					}
					if (local171 != null) {
						local138 = local171.quests;
					}
				}
				...
				if (local207.multiloc != null) {
					local207 = local207.method1533(VarpDomain.instance);
				}
				if (local207 != null) {
					local138 = local207.quests;
				}
			}
