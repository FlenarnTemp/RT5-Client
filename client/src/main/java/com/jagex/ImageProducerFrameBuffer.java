...
@OriginalClass("com.jagex.client!ms")
public final class ImageProducerFrameBuffer extends FrameBuffer implements ImageProducer {

	@OriginalMember(owner = "com.jagex.client!ms", name = "p", descriptor = "Ljava/awt/Image;")
	private Image anImage2;

	@OriginalMember(owner = "com.jagex.client!ms", name = "r", descriptor = "Ljava/awt/Canvas;")
	private Canvas aCanvas4;

	@OriginalMember(owner = "com.jagex.client!ms", name = "s", descriptor = "Ljava/awt/image/ColorModel;")
	private ColorModel aColorModel1;

	@OriginalMember(owner = "com.jagex.client!ms", name = "z", descriptor = "Ljava/awt/image/ImageConsumer;")
	private ImageConsumer anImageConsumer1;

	@OriginalMember(owner = "com.jagex.client!ms", name = "addConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!ms", name = "isConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)Z")
	@Override
	public synchronized boolean isConsumer(@OriginalArg(0) ImageConsumer arg0) {
		return arg0 == this.anImageConsumer1;
	}

	@OriginalMember(owner = "com.jagex.client!ms", name = "requestTopDownLeftRightResend", descriptor = "(Ljava/awt/image/ImageConsumer;)V")
	@Override
	public void requestTopDownLeftRightResend(@OriginalArg(0) ImageConsumer arg0) {
	}

	@OriginalMember(owner = "com.jagex.client!ms", name = "a", descriptor = "(IIIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!ms", name = "a", descriptor = "(IIIILjava/awt/Graphics;I)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!ms", name = "removeConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!ms", name = "c", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!ms", name = "a", descriptor = "(Ljava/awt/Canvas;B)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!ms", name = "a", descriptor = "(Ljava/awt/Graphics;III)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!ms", name = "startProduction", descriptor = "(Ljava/awt/image/ImageConsumer;)V")
	@Override
