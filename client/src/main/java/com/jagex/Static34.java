...
public final class Static34 {
	...
	@OriginalMember(owner = "com.jagex.client!bt", name = "xb", descriptor = "Lclient!ih;")
	public static Class103 aClass103_3;

	@OriginalMember(owner = "com.jagex.client!bt", name = "Ab", descriptor = "Lclient!cm;")
	public static final Class36 aClass36_6 = new Class36();

	@OriginalMember(owner = "com.jagex.client!bt", name = "a", descriptor = "(ILclient!wm;)V")
	public static void method4810(@OriginalArg(1) Renderer arg0) {
	...
	@OriginalMember(owner = "com.jagex.client!bt", name = "a", descriptor = "(IIIIIIII)V")
