...
@OriginalClass("com.jagex.client!oh")
public final class ParticleSystem extends ParticleNode {

	@OriginalMember(owner = "com.jagex.client!oh", name = "t", descriptor = "I")
	public int anInt4675;

	@OriginalMember(owner = "com.jagex.client!oh", name = "u", descriptor = "I")
	public int anInt4676;

	@OriginalMember(owner = "com.jagex.client!oh", name = "v", descriptor = "I")
	public int anInt4677;

	@OriginalMember(owner = "com.jagex.client!oh", name = "z", descriptor = "I")
	public int anInt4679;

	@OriginalMember(owner = "com.jagex.client!oh", name = "A", descriptor = "I")
	public int anInt4680;

	@OriginalMember(owner = "com.jagex.client!oh", name = "i", descriptor = "Z")
	public boolean aBoolean322 = false;

	@OriginalMember(owner = "com.jagex.client!oh", name = "m", descriptor = "Z")
	private boolean aBoolean323 = false;

	@OriginalMember(owner = "com.jagex.client!oh", name = "o", descriptor = "I")
	public int anInt4673 = 0;

	@OriginalMember(owner = "com.jagex.client!oh", name = "l", descriptor = "Lclient!cm;")
	private Class36 aClass36_5 = new Class36();

	@OriginalMember(owner = "com.jagex.client!oh", name = "r", descriptor = "I")
	private int anInt4674 = 0;

	@OriginalMember(owner = "com.jagex.client!oh", name = "s", descriptor = "Lclient!ld;")
	public LinkedList aClass135_29 = new LinkedList();

	@OriginalMember(owner = "com.jagex.client!oh", name = "y", descriptor = "I")
	private int anInt4678 = 0;

	@OriginalMember(owner = "com.jagex.client!oh", name = "x", descriptor = "Z")
	private boolean aBoolean324 = false;

	@OriginalMember(owner = "com.jagex.client!oh", name = "w", descriptor = "Lclient!tp;")
	public final Class224 aClass224_2 = new Class224();

	@OriginalMember(owner = "com.jagex.client!oh", name = "n", descriptor = "[Lclient!ns;")
	public Class12_Sub1_Sub1_Sub1[] aClass12_Sub1_Sub1_Sub1Array2 = new Class12_Sub1_Sub1_Sub1[8192];

	@OriginalMember(owner = "com.jagex.client!oh", name = "p", descriptor = "J")
	private long aLong138;

	@OriginalMember(owner = "com.jagex.client!oh", name = "k", descriptor = "J")
	private long aLong137;

	@OriginalMember(owner = "com.jagex.client!oh", name = "<init>", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!oh", name = "a", descriptor = "()V")
	...
	@OriginalMember(owner = "com.jagex.client!oh", name = "b", descriptor = "()V")
	private void method4351() {
		this.aBoolean323 = false;
	}

	@OriginalMember(owner = "com.jagex.client!oh", name = "a", descriptor = "(Lclient!wm;J)Z")
	public boolean method4352(@OriginalArg(0) Renderer arg0, @OriginalArg(1) long arg1) {
	...
	@OriginalMember(owner = "com.jagex.client!oh", name = "a", descriptor = "(Lclient!wm;[Lclient!jf;Z)V")
	private void method4353(@OriginalArg(0) Renderer arg0, @OriginalArg(1) Class114[] arg1) {
	...
	@OriginalMember(owner = "com.jagex.client!oh", name = "c", descriptor = "()V")
	public void method4354() {
		this.aBoolean323 = true;
	}

	@OriginalMember(owner = "com.jagex.client!oh", name = "a", descriptor = "(J)V")
	public void method4355(@OriginalArg(0) long arg0) {
		this.aLong138 = arg0;
	}

	@OriginalMember(owner = "com.jagex.client!oh", name = "d", descriptor = "()V")
	...
	@OriginalMember(owner = "com.jagex.client!oh", name = "a", descriptor = "(Lclient!wm;J[Lclient!jf;[Lclient!nm;Z)V")
	public void method4357(@OriginalArg(0) Renderer arg0, @OriginalArg(1) long arg1, @OriginalArg(2) Class114[] arg2, @OriginalArg(3) Class163[] arg3) {
		if (!this.aBoolean322) {
	...
	@OriginalMember(owner = "com.jagex.client!oh", name = "e", descriptor = "()Lclient!tp;")
	public Class224 method4358() {
		return this.aClass224_2;
	}

	@OriginalMember(owner = "com.jagex.client!oh", name = "f", descriptor = "()V")
	public void method4359() {
		this.aBoolean324 = true;
	}

	@OriginalMember(owner = "com.jagex.client!oh", name = "a", descriptor = "(IIIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!oh", name = "a", descriptor = "([Lclient!nm;Z)V")
