...
@OriginalClass("com.jagex.client!u")
public final class Shadow {

	@OriginalMember(owner = "com.jagex.client!u", name = "b", descriptor = "Z")
	public boolean outputToSprite = true;

	@OriginalMember(owner = "com.jagex.client!u", name = "a", descriptor = "I")
	private int anInt6399 = -1;

	@OriginalMember(owner = "com.jagex.client!u", name = "e", descriptor = "I")
	private final int anInt6400;

	@OriginalMember(owner = "com.jagex.client!u", name = "h", descriptor = "Lclient!ic;")
	private final ShadowManager aClass100_2;

	@OriginalMember(owner = "com.jagex.client!u", name = "g", descriptor = "Lclient!bf;")
	private final Class19_Sub1 aClass19_Sub1_36;

	@OriginalMember(owner = "com.jagex.client!u", name = "i", descriptor = "I")
	private final int anInt6401;

	@OriginalMember(owner = "com.jagex.client!u", name = "j", descriptor = "I")
	private final int anInt6402;

	@OriginalMember(owner = "com.jagex.client!u", name = "d", descriptor = "Lclient!al;")
	private Class8_Sub1 aClass8_Sub1_5;

	@OriginalMember(owner = "com.jagex.client!u", name = "c", descriptor = "Lclient!fd;")
	private Interface4 anInterface4_5;

	@OriginalMember(owner = "com.jagex.client!u", name = "f", descriptor = "Lclient!ve;")
	private Class180_Sub2 aClass180_Sub2_2;

	@OriginalMember(owner = "com.jagex.client!u", name = "<init>", descriptor = "(Lclient!bf;Lclient!ic;Lclient!ah;IIIII)V")
			...
			if (this.aClass19_Sub1_36.aBoolean53) {
					...
					for (local117 = 0; local117 < local23; local117++) {
						...
						if (local126 != null) {
							for (local131 = 0; local131 < local126.length; local131++) {
								local91.p2(local126[local131] & 0xFFFF);
							}
						}
					}
				}
				...
				for (local48 = 0; local48 < local23; local48++) {
					...
					for (local117 = 0; local117 < local23; local117++) {
						...
						if (local126 != null) {
							for (local131 = 0; local131 < local126.length; local131++) {
								local91.ip2(local126[local131] & 0xFFFF);
							}
						}
					}
				}
			}
			this.anInterface4_5 = this.aClass19_Sub1_36.method839(local91.data, local91.pos, false);
			this.aClass180_Sub2_2 = new Class180_Sub2(this.aClass19_Sub1_36, 5123, null, 1);
		}
	}

	@OriginalMember(owner = "com.jagex.client!u", name = "a", descriptor = "(B)V")
	public void method5787() {
		this.method5788(this.anInterface4_5, this.anInt6402);
	}

	@OriginalMember(owner = "com.jagex.client!u", name = "a", descriptor = "(ILclient!fd;I)V")
	...
	@OriginalMember(owner = "com.jagex.client!u", name = "a", descriptor = "([BIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!u", name = "a", descriptor = "(I)V")
