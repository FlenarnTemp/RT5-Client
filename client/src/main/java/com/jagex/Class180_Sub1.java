...
@OriginalClass("com.jagex.client!pl")
public final class Class180_Sub1 extends Class180 implements Interface5 {

	@OriginalMember(owner = "com.jagex.client!pl", name = "c", descriptor = "I")
	private int anInt5024;

	@OriginalMember(owner = "com.jagex.client!pl", name = "<init>", descriptor = "(Lclient!bf;ILjava/nio/ByteBuffer;)V")
	public Class180_Sub1(@OriginalArg(0) Class19_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) ByteBuffer arg2) {
		super(arg0, arg2);
		this.anInt5024 = arg1;
	}

	@OriginalMember(owner = "com.jagex.client!pl", name = "<init>", descriptor = "(Lclient!bf;I[BI)V")
	...
	@OriginalMember(owner = "com.jagex.client!pl", name = "d", descriptor = "(Lclient!kj;)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!pl", name = "a", descriptor = "()I")
	@Override
	public int method6066() {
		return 0;
	}

	@OriginalMember(owner = "com.jagex.client!pl", name = "c", descriptor = "(Lclient!kj;)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!pl", name = "a", descriptor = "(Lclient!kj;)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!pl", name = "b", descriptor = "(Lclient!kj;)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!pl", name = "a", descriptor = "(I[BI)V")
	@Override
