...
@OriginalClass("com.jagex.client!fi")
public final class MixerPcmStream extends PcmStream {

	@OriginalMember(owner = "com.jagex.client!fi", name = "w", descriptor = "Lclient!ld;")
	private final LinkedList aClass135_16 = new LinkedList();

	@OriginalMember(owner = "com.jagex.client!fi", name = "x", descriptor = "Lclient!ld;")
	private final LinkedList aClass135_17 = new LinkedList();

	@OriginalMember(owner = "com.jagex.client!fi", name = "z", descriptor = "I")
	private int anInt2000 = 0;

	@OriginalMember(owner = "com.jagex.client!fi", name = "y", descriptor = "I")
	private int anInt1999 = -1;

	@OriginalMember(owner = "com.jagex.client!fi", name = "a", descriptor = "([III)V")
	@Override
		...
		do {
			...
			synchronized (local60) {
				...
				if (local68 < 0) {
					...
					this.method2080(local60.prev, local60);
				}
			}
		} while (arg2 != 0);
	}

	@OriginalMember(owner = "com.jagex.client!fi", name = "d", descriptor = "()Lclient!ll;")
	@Override
	public PcmStream method4978() {
		return (PcmStream) this.aClass135_16.head();
	}

	@OriginalMember(owner = "com.jagex.client!fi", name = "e", descriptor = "()V")
	...
	@OriginalMember(owner = "com.jagex.client!fi", name = "a", descriptor = "(Lclient!qa;)V")
	private void method2078(@OriginalArg(0) Class2_Sub30 arg0) {
		arg0.remove();
		arg0.method4695();
		@Pc(9) Node local9 = this.aClass135_17.aClass2_130.prev;
	...
	@OriginalMember(owner = "com.jagex.client!fi", name = "b", descriptor = "(I)V")
	@Override
		...
		do {
			...
			synchronized (local50) {
				...
				if (local58 < 0) {
					...
					this.method2080(local50.prev, local50);
				}
			}
		} while (arg0 != 0);
	}

	@OriginalMember(owner = "com.jagex.client!fi", name = "c", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!fi", name = "c", descriptor = "()I")
	@Override
	public int method4977() {
		return 0;
	}

	@OriginalMember(owner = "com.jagex.client!fi", name = "a", descriptor = "(Lclient!ag;Lclient!qa;)V")
	private void method2080(@OriginalArg(0) Node arg0, @OriginalArg(1) Class2_Sub30 arg1) {
		...
		this.anInt1999 = ((Class2_Sub30) this.aClass135_17.aClass2_130.prev).anInt5127;
	}

	@OriginalMember(owner = "com.jagex.client!fi", name = "a", descriptor = "(Lclient!ll;)V")
	public synchronized void removeSubStream(@OriginalArg(0) PcmStream arg0) {
		arg0.remove();
	}

	@OriginalMember(owner = "com.jagex.client!fi", name = "c", descriptor = "([III)V")
	...
	@OriginalMember(owner = "com.jagex.client!fi", name = "a", descriptor = "()Lclient!ll;")
	@Override
	public PcmStream nextSubStream() {
		return (PcmStream) this.aClass135_16.next();
	}

	@OriginalMember(owner = "com.jagex.client!fi", name = "b", descriptor = "(Lclient!ll;)V")
