...
public final class Static111 {
	...
	@OriginalMember(owner = "com.jagex.client!ge", name = "k", descriptor = "Lclient!r;")
	public static Js5 aClass197_25;

	@OriginalMember(owner = "com.jagex.client!ge", name = "c", descriptor = "I")
	public static final int anInt2254 = 12;

	@OriginalMember(owner = "com.jagex.client!ge", name = "l", descriptor = "Z")
	public static boolean aBoolean167 = false;

	@OriginalMember(owner = "com.jagex.client!ge", name = "c", descriptor = "(Z)V")
	...
	@OriginalMember(owner = "com.jagex.client!ge", name = "a", descriptor = "(IIILjava/lang/String;IIII)V")
