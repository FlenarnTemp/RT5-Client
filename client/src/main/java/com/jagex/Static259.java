...
public final class Static259 {
	...
	@OriginalMember(owner = "com.jagex.client!oq", name = "r", descriptor = "Lclient!gd;")
	public static final LocalizedString aClass79_105 = new LocalizedString("Cancel", "Abbrechen", "Annuler", "Cancelar");

	@OriginalMember(owner = "com.jagex.client!oq", name = "v", descriptor = "Lclient!gd;")
	public static final LocalizedString aClass79_106 = new LocalizedString("M", "M", "M", "M");

	@OriginalMember(owner = "com.jagex.client!oq", name = "x", descriptor = "[I")
	public static final int[] anIntArray323 = new int[13];

	@OriginalMember(owner = "com.jagex.client!oq", name = "c", descriptor = "(III)V")
