...
@OriginalClass("com.jagex.client!jo")
public final class PlayerAppearance {

	@OriginalMember(owner = "com.jagex.client!ad", name = "r", descriptor = "[I")
	public static final int[] MALE_FEATURES = new int[] { 0, 1, 2, 3, 4, 5, 6, 14 };
	@OriginalMember(owner = "com.jagex.client!uo", name = "J", descriptor = "[I")
	public static final int[] FEMALE_FEATURES = new int[] { 7, 8, 9, 10, 11, 12, 13, 15 };
	@OriginalMember(owner = "com.jagex.client!ui", name = "k", descriptor = "[[S")
	public static short[][] destinationBodyColors;
	@OriginalMember(owner = "com.jagex.client!jo", name = "d", descriptor = "Z")
	public boolean gender;

	@OriginalMember(owner = "com.jagex.client!jo", name = "e", descriptor = "[[I")
	private int[][] anIntArrayArray24;

	@OriginalMember(owner = "com.jagex.client!jo", name = "h", descriptor = "J")
	private long aLong106;

	@OriginalMember(owner = "com.jagex.client!jo", name = "k", descriptor = "[I")
	private int[] anIntArray193;

	@OriginalMember(owner = "com.jagex.client!jo", name = "q", descriptor = "I")
	private int anInt3190;

	@OriginalMember(owner = "com.jagex.client!jo", name = "s", descriptor = "[I")
	public int[] anIntArray194;

	@OriginalMember(owner = "com.jagex.client!jo", name = "v", descriptor = "J")
	private long aLong107;

	@OriginalMember(owner = "com.jagex.client!jo", name = "j", descriptor = "I")
	public int npcId = -1;

	@OriginalMember(owner = "com.jagex.client!jo", name = "a", descriptor = "([I[IZIIZ)V")
	...
	@OriginalMember(owner = "com.jagex.client!jo", name = "a", descriptor = "(Lclient!e;III)V")
	...
	@OriginalMember(owner = "com.jagex.client!jo", name = "a", descriptor = "(ZI)V")
		...
		if (local172 == null || arg7.method2863(local172.method3827(), local27) != 0) {
			...
			for (local46 = 0; local46 < 12; local46++) {
				...
				if ((local109 & 0x40000000) == 0) {
					if ((Integer.MIN_VALUE & local109) != 0 && !arg6.method1784(local109 & 0x3FFFFFFF).hasReadyHeads()) {
						local35 = true;
					}
	...
	public Model method3185(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) IDKTypeList arg2, @OriginalArg(4) Class157 arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) SeqTypeList arg6, @OriginalArg(9) Renderer arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9) {
		...
		if (local170 == null || arg7.method2863(local170.method3827(), local7) != 0) {
			...
			if (!arg2.method1784(arg5).hasReadyHeads() || !arg2.method1784(arg1).hasReadyHeads() || !arg2.method1784(arg0).hasReadyHeads()) {
				return null;
			}
	...
	@OriginalMember(owner = "com.jagex.client!jo", name = "a", descriptor = "(III)V")
	public void setColor(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
		this.anIntArray194[arg0] = arg1;
		this.method3189();
	}

	@OriginalMember(owner = "com.jagex.client!jo", name = "b", descriptor = "(Z)V")
	private void method3189() {
		@Pc(7) long[] local7 = Packet.CRC64_TABLE;
		this.aLong107 = -1L;
		...
		if (local589 == null || arg13.method2863(local589.method3827(), local33) != 0 || local597 != null && local597.equipmentTransforms != null && this.anIntArrayArray24 == null) {
			...
			while (true) {
								...
								if (local597.equipmentTransforms[local743] != null && local735[local743] != null) {
									...
									if (this.anIntArrayArray24[local743] == null) {
										...
										if (local844 == 0 && local853 == 0 && local862 == 0) {
											...
											@Pc(894) int local894 = Renderer.anIntArray177[local844];
											@Pc(898) int local898 = Renderer.anIntArray178[local844];
											@Pc(902) int local902 = Renderer.anIntArray177[local853];
											@Pc(906) int local906 = Renderer.anIntArray178[local853];
											@Pc(910) int local910 = Renderer.anIntArray177[local862];
											@Pc(914) int local914 = Renderer.anIntArray178[local862];
				...
				if ((local646 & 0x40000000) == 0) {
					if ((local646 & Integer.MIN_VALUE) != 0 && !arg3.method1784(local646 & 0x3FFFFFFF).hasReadyModels()) {
						local638 = true;
					}
