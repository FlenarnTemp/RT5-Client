...
public final class Static7 {
	...
	@OriginalMember(owner = "com.jagex.client!ag", name = "r", descriptor = "Lclient!bu;")
	public static SceneBuilder aClass29_Sub1_120;

	@OriginalMember(owner = "com.jagex.client!ag", name = "l", descriptor = "Lclient!ad;")
	public static final HashTable aClass4_151 = new HashTable(16);

	@OriginalMember(owner = "com.jagex.client!ag", name = "a", descriptor = "(Lclient!dg;IIIIIIIIII)Z")
	public static boolean method6463(@OriginalArg(0) CollisionMap arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8, @OriginalArg(10) int arg9) {
	...
	@OriginalMember(owner = "com.jagex.client!ag", name = "a", descriptor = "(Lclient!nk;B)Lclient!nk;")
	public static Component method6465(@OriginalArg(0) Component arg0) {
		...
		for (@Pc(35) SubInterface local35 = (SubInterface) local30.method3561(); local35 != null; local35 = (SubInterface) local30.method3560()) {
			if (local35.id == local25) {
				return InterfaceList.getComponent((int) local35.nodeId);
			}
		}
		return null;
	}

	@OriginalMember(owner = "com.jagex.client!ag", name = "a", descriptor = "(IZI)I")
	...
	@OriginalMember(owner = "com.jagex.client!ag", name = "a", descriptor = "(III)V")
	...
	@OriginalMember(owner = "com.jagex.client!ag", name = "a", descriptor = "(Lclient!bh;IZ)V")
	...
	@OriginalMember(owner = "com.jagex.client!ag", name = "a", descriptor = "(Lclient!nk;I)Z")
