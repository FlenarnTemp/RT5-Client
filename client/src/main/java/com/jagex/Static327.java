...
public final class Static327 {
	...
	@OriginalMember(owner = "com.jagex.client!ta", name = "b", descriptor = "Lclient!ad;")
	public static final HashTable properties = new HashTable(512);

	@OriginalMember(owner = "com.jagex.client!ta", name = "a", descriptor = "(Lclient!wm;III)V")
	public static void method5574(@OriginalArg(0) Renderer arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2) {
		...
		if (Scene.aClass6Array3 != null) {
			...
			while (local135 < 1.0F) {
				...
				if (local178 > 0 && local193 > 0 && Static373.buildAreaLimitX > local178 && local193 < Static242.buildAreaLimitZ) {
					@Pc(206) int local206 = PlayerList.self.plane;
					...
					if ((float) Scene.aClass6Array3[local206].method5728(local174, local189) < (float) local152 * local135 + (float) local112[1]) {
						local54 = local174 + (PlayerList.self.getSize() - 1) * 64 >> 7;
						local56 = local189 + (PlayerList.self.getSize() - 1) * 64 >> 7;
						break;
					}
				}
			...
			if (local54 != -1 && local56 != -1) {
				if (Static330.aBoolean419 && (Static115.anInt3837 & 0x40) != 0) {
					...
					if (client.GAME_SD == client.game) {
						Static1.method3(-1, true, local56, false, Static382.aClass79_147.getLocalized(client.language), local54, 59, "", -1, 0L);
					}
		...
		for (@Pc(354) Class12_Sub4 local354 = (Class12_Sub4) local349.method1415(); local354 != null; local354 = (Class12_Sub4) local349.method1420()) {
			if (PlayerList.self.plane == local354.anInt4073 && local354.method4025(arg1, arg2, arg0)) {
				@Pc(473) int local473;
				if (local354.aClass11_1 instanceof Player) {
					...
					if ((local67 & 0x1) == 0 && (local380.xFine & 0x7F) == 0 && (local380.zFine & 0x7F) == 0 || (local67 & 0x1) == 1 && (local380.xFine & 0x7F) == 64 && (local380.zFine & 0x7F) == 64) {
						...
						for (local88 = 0; local88 < NpcList.size; local88++) {
							...
							if (local451 != null && local451.anInt4632 != client.cycle && local451.aBoolean320) {
								...
								if (local76 <= local473 && local451.type.size <= local380.getSize() - (local473 - local76 >> 7) && local485 >= local79 && local451.type.size <= local380.getSize() - (local485 - local79 >> 7)) {
									Static241.method4191(local451, PlayerList.self.plane != local354.anInt4073);
						...
						for (local485 = 0; local485 < local97; local485++) {
							@Pc(564) Player local564 = PlayerList.players[local112[local485]];
							if (local564 != null && client.cycle != local564.anInt4632 && local380 != local564 && local564.aBoolean320) {
								...
								if (local144 >= local76 && local564.getSize() <= local380.getSize() - (local144 - local76 >> 7) && local152 >= local79 && local564.getSize() <= local380.getSize() - (local152 - local79 >> 7)) {
									Static184.method3397(PlayerList.self.plane != local354.anInt4073, local564);
					...
					Static184.method3397(local354.anInt4073 != PlayerList.self.plane, local380);
					...
					if (local692.type != null) {
						if ((local692.type.size & 0x1) == 0 && (local692.xFine & 0x7F) == 0 && (local692.zFine & 0x7F) == 0 || (local692.type.size & 0x1) == 1 && (local692.xFine & 0x7F) == 64 && (local692.zFine & 0x7F) == 64) {
							...
							for (local79 = 0; local79 < NpcList.size; local79++) {
								...
								if (local768 != null && local768.anInt4632 != client.cycle && local692 != local768 && local768.aBoolean320) {
									...
									if (local67 <= local97 && local692.type.size - (local97 - local67 >> 7) >= local768.type.size && local76 <= local473 && local768.type.size <= local692.type.size - (local473 - local76 >> 7)) {
										Static241.method4191(local768, PlayerList.self.plane != local354.anInt4073);
							...
							for (local473 = 0; local473 < local88; local473++) {
								@Pc(892) Player local892 = PlayerList.players[local882[local473]];
								if (local892 != null && local892.anInt4632 != client.cycle && local892.aBoolean320) {
									...
									if (local919 >= local67 && local892.getSize() <= local692.type.size - (local919 - local67 >> 7) && local144 >= local76 && local892.getSize() <= local692.type.size - (local144 - local76 >> 7)) {
										Static184.method3397(PlayerList.self.plane != local354.anInt4073, local892);
						...
						Static241.method4191(local692, local354.anInt4073 != PlayerList.self.plane);
					...
					if (local1038 != null) {
						for (@Pc(1046) ObjStack local1046 = (ObjStack) local1038.aClass135_34.tail(); local1046 != null; local1046 = (ObjStack) local1038.aClass135_34.method3547()) {
							...
							if (!Static330.aBoolean419) {
								if (local354.anInt4073 == PlayerList.self.plane) {
									...
									for (local88 = 4; local88 >= 0; local88--) {
										if (local1134 != null && local1134[local88] != null) {
											...
											Static1.method3(-1, true, local354.anInt4075, false, local1134[local88], local354.anInt4076, local1146, "<col=ff9040>" + local1054.name, local473, (long) local1046.type);
										}
									}
								}
								Static1.method3(-1, true, local354.anInt4075, local354.anInt4073 != PlayerList.self.plane, Static368.aClass79_143.getLocalized(client.language), local354.anInt4076, 1009, "<col=ff9040>" + local1054.name, Static135.anInt2523, (long) local1046.type);
							} else if (PlayerList.self.plane == local354.anInt4073) {
								@Pc(1071) ParamType local1071 = Static172.anInt3298 == -1 ? null : client.ParamTypes.get(Static172.anInt3298);
								if ((Static115.anInt3837 & 0x1) != 0 && (local1071 == null || local1054.getParam(local1071.defaultInt, Static172.anInt3298) != local1071.defaultInt)) {
									Static1.method3(-1, true, local354.anInt4075, false, Static91.aString18, local354.anInt4076, 13, Static371.aString68 + " -> <col=ff9040>" + local1054.name, Static41.anInt1044, (long) local1046.type);
								}
							}
						}
					}
				...
				if (local354.aClass11_1 instanceof Interface6) {
					...
					if (local1297.multiloc != null) {
						local1297 = local1297.method1533(VarpDomain.instance);
					}
					if (local1297 != null) {
						if (!Static330.aBoolean419) {
							if (PlayerList.self.plane == local354.anInt4073) {
								@Pc(1393) String[] local1393 = local1297.ops;
								if (local1393 != null) {
									for (local79 = 4; local79 >= 0; local79--) {
										if (local1393[local79] != null) {
											...
											Static1.method3(-1, true, local354.anInt4075, false, local1393[local79], local354.anInt4076, local1405, "<col=00ffff>" + local1297.name, local97, Static310.method5284(local354.anInt4075, local354.anInt4076, local1288));
										}
									}
								}
							}
							Static1.method3(-1, true, local354.anInt4075, local354.anInt4073 != PlayerList.self.plane, Static368.aClass79_143.getLocalized(client.language), local354.anInt4076, 1010, "<col=00ffff>" + local1297.name, Static135.anInt2523, (long) local1297.anInt1351);
						} else if (local354.anInt4073 == PlayerList.self.plane) {
							@Pc(1324) ParamType local1324 = Static172.anInt3298 == -1 ? null : client.ParamTypes.get(Static172.anInt3298);
							if ((Static115.anInt3837 & 0x4) != 0 && (local1324 == null || local1297.getParam(local1324.defaultInt, Static172.anInt3298) != local1324.defaultInt)) {
								Static1.method3(-1, true, local354.anInt4075, false, Static91.aString18, local354.anInt4076, 57, Static371.aString68 + " -> <col=00ffff>" + local1297.name, Static41.anInt1044, Static310.method5284(local354.anInt4075, local354.anInt4076, local1288));
							}
						}
					}
				}
	...
	@OriginalMember(owner = "com.jagex.client!ta", name = "a", descriptor = "(IIIIII)V")
