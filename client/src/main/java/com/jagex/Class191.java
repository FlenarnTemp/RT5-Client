...
@OriginalClass("com.jagex.client!qj")
public final class Class191 {

	@OriginalMember(owner = "com.jagex.client!qj", name = "l", descriptor = "Lclient!bs;")
	private Class12_Sub1 aClass12_Sub1_8;

	@OriginalMember(owner = "com.jagex.client!qj", name = "c", descriptor = "Lclient!bs;")
	public final Class12_Sub1 aClass12_Sub1_7 = new Class12_Sub1();

	@OriginalMember(owner = "com.jagex.client!qj", name = "<init>", descriptor = "()V")
	public Class191() {
		this.aClass12_Sub1_7.aClass12_Sub1_5 = this.aClass12_Sub1_7;
		this.aClass12_Sub1_7.aClass12_Sub1_6 = this.aClass12_Sub1_7;
	}

	@OriginalMember(owner = "com.jagex.client!qj", name = "a", descriptor = "(B)Lclient!bs;")
	...
	@OriginalMember(owner = "com.jagex.client!qj", name = "b", descriptor = "(I)Lclient!bs;")
	...
	@OriginalMember(owner = "com.jagex.client!qj", name = "a", descriptor = "(Lclient!bs;I)V")
	...
	@OriginalMember(owner = "com.jagex.client!qj", name = "c", descriptor = "(I)V")
