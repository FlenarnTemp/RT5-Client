...
public final class Static236 {
	...
	@OriginalMember(owner = "com.jagex.client!nk", name = "Ec", descriptor = "I")
	public static int anInt4309;

	@OriginalMember(owner = "com.jagex.client!nk", name = "pc", descriptor = "I")
	public static int anInt4301 = -1;

	@OriginalMember(owner = "com.jagex.client!nk", name = "a", descriptor = "(Lclient!r;Lclient!r;Lclient!wm;I)V")
	public static void method4102(@OriginalArg(0) Js5 arg0, @OriginalArg(1) Js5 arg1, @OriginalArg(2) Renderer arg2) {
	...
	@OriginalMember(owner = "com.jagex.client!nk", name = "a", descriptor = "(IIII)V")
