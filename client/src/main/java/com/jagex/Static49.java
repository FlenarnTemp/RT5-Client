...
public final class Static49 {
	...
	@OriginalMember(owner = "com.jagex.client!cr", name = "b", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!cr", name = "a", descriptor = "(BLclient!wm;I)Z")
	public static boolean method1472(@OriginalArg(1) Renderer arg0, @OriginalArg(2) int arg1) {
		...
		if (!Static46.aBoolean100) {
					...
					for (local220 = arg1; local220 <= arg1 + 1 && local220 <= 3; local220++) {
						if (Static142.method2661(local216, arg1, local220, local199)) {
							...
							if (local621 != null) {
								...
								if (!local662.members || LoginManager.mapMembers) {
									local284 = local662.mapelement;
									if (local662.multiloc != null) {
										for (local288 = 0; local288 < local662.multiloc.length; local288++) {
											if (local662.multiloc[local288] != -1) {
												@Pc(691) LocType local691 = client.LocTypes.get(local662.multiloc[local288]);
												if (local691.mapelement >= 0) {
													local284 = local691.mapelement;
												}
											}
										}
									}
									if (local284 >= 0) {
										...
										Static231.anIntArray265[Static387.anInt2831] = local662.id;
			...
			if (Static34.aClass103_3 != null) {
				...
				client.MelTypes.method3377(64, 128);
