...
public final class Static212 {
	...
	@OriginalMember(owner = "com.jagex.client!mi", name = "e", descriptor = "I")
	public static int inTutorialIsland = 0;

	@OriginalMember(owner = "com.jagex.client!mi", name = "a", descriptor = "(Lclient!nk;III)V")
	...
	@OriginalMember(owner = "com.jagex.client!mi", name = "a", descriptor = "(BI)Lclient!je;")
