...
public final class Static301 {
	...
	@OriginalMember(owner = "com.jagex.client!ri", name = "X", descriptor = "[[I")
	public static int[][] anIntArrayArray50;

	@OriginalMember(owner = "com.jagex.client!ri", name = "N", descriptor = "Lclient!nk;")
	public static Component aClass161_13 = null;

	@OriginalMember(owner = "com.jagex.client!ri", name = "P", descriptor = "[[I")
	public static final int[][] anIntArrayArray49 = new int[128][128];

	@OriginalMember(owner = "com.jagex.client!ri", name = "V", descriptor = "Z")
	public static boolean aBoolean403 = false;

	@OriginalMember(owner = "com.jagex.client!ri", name = "c", descriptor = "(Z)V")
