...
public final class Static385 {
	...
	@OriginalMember(owner = "com.jagex.client!wi", name = "y", descriptor = "Lclient!ha;")
	public static Class2_Sub16 aClass2_Sub16_2;

	@OriginalMember(owner = "com.jagex.client!wi", name = "A", descriptor = "[Lclient!nt;")
	public static final AnimFrameset[] aClass2_Sub2_Sub13Array4 = new AnimFrameset[14];

	@OriginalMember(owner = "com.jagex.client!wi", name = "b", descriptor = "(III)I")
	...
	@OriginalMember(owner = "com.jagex.client!wi", name = "a", descriptor = "(ZLclient!oo;)V")
	...
	@OriginalMember(owner = "com.jagex.client!wi", name = "a", descriptor = "(BI)V")
	public static void method6432(@OriginalArg(1) int arg0) {
		...
		Static349.method5833((local19 >> 3) * 3 + 600, Static288.anInt5463, arg0, Scene.getTileHeight(PlayerList.self.xFine, PlayerList.self.zFine, Static355.anInt6585) - 50, Static62.anInt2395, local53, local19);
