...
public final class Static169 {
	...
	@OriginalMember(owner = "com.jagex.client!jr", name = "o", descriptor = "[Ljava/lang/String;")
	public static final String[] MSG_SECONDARY = new String[100];

	@OriginalMember(owner = "com.jagex.client!jr", name = "a", descriptor = "(Lclient!wm;)V")
	public static void method3212(@OriginalArg(0) Renderer arg0) {
	...
	@OriginalMember(owner = "com.jagex.client!jr", name = "a", descriptor = "(IIIZIII)V")
