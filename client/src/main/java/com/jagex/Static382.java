...
public final class Static382 {
	...
	@OriginalMember(owner = "com.jagex.client!we", name = "I", descriptor = "I")
	public static int anInt7141;

	@OriginalMember(owner = "com.jagex.client!we", name = "y", descriptor = "[I")
	public static final int[] anIntArray490 = new int[13];

	@OriginalMember(owner = "com.jagex.client!we", name = "C", descriptor = "Lclient!gd;")
	...
	@OriginalMember(owner = "com.jagex.client!we", name = "a", descriptor = "(IILjava/util/Random;)I")
	...
	@OriginalMember(owner = "com.jagex.client!we", name = "a", descriptor = "(Lclient!r;I)V")
	...
	@OriginalMember(owner = "com.jagex.client!we", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Lclient!hk;")
	...
	@OriginalMember(owner = "com.jagex.client!we", name = "a", descriptor = "(IIIZI)Lclient!cu;")
	public static SubInterface method6365(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) boolean arg2, @OriginalArg(4) int arg3) {
		...
		InterfaceList.subInterfaces.pushNode(local7, (long) arg0);
	...
	@OriginalMember(owner = "com.jagex.client!we", name = "a", descriptor = "(IIII)I")
