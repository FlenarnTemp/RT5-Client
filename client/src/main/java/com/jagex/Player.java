...
@OriginalClass("com.jagex.client!nh")
public final class Player extends PathingEntity {

	@OriginalMember(owner = "com.jagex.client!tr", name = "d", descriptor = "[I")
	public static final int[] TITLES_PER_GAME = new int[] { 1, 4 };
	@OriginalMember(owner = "com.jagex.client!ch", name = "cb", descriptor = "I")
	public static int weight = 0;
	@OriginalMember(owner = "com.jagex.client!fj", name = "f", descriptor = "I")
	public static int energy = 0;
	@OriginalMember(owner = "com.jagex.client!gs", name = "i", descriptor = "I")
	public static int worldId = -1;
	@OriginalMember(owner = "com.jagex.client!im", name = "G", descriptor = "I")
	public static int rebootTimer = 0;
	@OriginalMember(owner = "com.jagex.client!un", name = "I", descriptor = "Lclient!cc;")
	public static PrivilegedRequest lastLogAddress;
	@OriginalMember(owner = "com.jagex.client!hg", name = "n", descriptor = "[Ljava/lang/String;")
	public static String[] playerNames;
	@OriginalMember(owner = "com.jagex.client!nt", name = "O", descriptor = "I")
	public static int level;
	@OriginalMember(owner = "com.jagex.client!nh", name = "pc", descriptor = "Ljava/lang/String;")
	public String username;

	@OriginalMember(owner = "com.jagex.client!nh", name = "tc", descriptor = "I")
	public int anInt4169;

	@OriginalMember(owner = "com.jagex.client!nh", name = "Gc", descriptor = "I")
	public int anInt4181;

	@OriginalMember(owner = "com.jagex.client!nh", name = "Rc", descriptor = "Ljava/lang/String;")
	public String username2;

	@OriginalMember(owner = "com.jagex.client!nh", name = "Wc", descriptor = "I")
	private int basId;

	@OriginalMember(owner = "com.jagex.client!nh", name = "ed", descriptor = "Lclient!jo;")
	public PlayerAppearance appearance;

	@OriginalMember(owner = "com.jagex.client!nh", name = "rc", descriptor = "I")
	public int crawlSound = -1;

	@OriginalMember(owner = "com.jagex.client!nh", name = "vc", descriptor = "I")
	public int anInt4171 = 0;

	@OriginalMember(owner = "com.jagex.client!nh", name = "Mc", descriptor = "I")
	public int idleSound = -1;

	@OriginalMember(owner = "com.jagex.client!nh", name = "yc", descriptor = "I")
	public int anInt4174 = -1;

	@OriginalMember(owner = "com.jagex.client!nh", name = "xc", descriptor = "I")
	public int totalLevel = 0;

	@OriginalMember(owner = "com.jagex.client!nh", name = "zc", descriptor = "B")
	private byte gender = 0;

	@OriginalMember(owner = "com.jagex.client!nh", name = "Sc", descriptor = "I")
	public int anInt4191 = -1;

	@OriginalMember(owner = "com.jagex.client!nh", name = "Oc", descriptor = "I")
	public int pkIcon = -1;

	@OriginalMember(owner = "com.jagex.client!nh", name = "sc", descriptor = "I")
	public int walkSound = -1;

	@OriginalMember(owner = "com.jagex.client!nh", name = "Uc", descriptor = "I")
	public int team = 0;

	@OriginalMember(owner = "com.jagex.client!nh", name = "mc", descriptor = "B")
	private byte aByte38 = 0;

	@OriginalMember(owner = "com.jagex.client!nh", name = "Ec", descriptor = "I")
	public int combatLevel = 0;

	@OriginalMember(owner = "com.jagex.client!nh", name = "Zc", descriptor = "I")
	public int prayerIcon = -1;

	@OriginalMember(owner = "com.jagex.client!nh", name = "dd", descriptor = "B")
	private byte title = 0;

	@OriginalMember(owner = "com.jagex.client!nh", name = "Nc", descriptor = "Z")
	public boolean aBoolean275 = false;

	@OriginalMember(owner = "com.jagex.client!nh", name = "Hc", descriptor = "I")
	public int soundRadius = 0;

	@OriginalMember(owner = "com.jagex.client!nh", name = "Xc", descriptor = "I")
	public int runSound = -1;

	@OriginalMember(owner = "com.jagex.client!nh", name = "gd", descriptor = "I")
	public int soundVolume = 255;

	@OriginalMember(owner = "com.jagex.client!nh", name = "cd", descriptor = "Z")
	...
	@OriginalMember(owner = "com.jagex.client!wh", name = "a", descriptor = "(ZLclient!nh;)I")
	...
	@OriginalMember(owner = "com.jagex.client!nh", name = "a", descriptor = "(Lclient!wm;B)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!nh", name = "a", descriptor = "(IIILclient!wm;ZLclient!hp;Z)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!nh", name = "a", descriptor = "(IIZ)V")
	...
	@OriginalMember(owner = "com.jagex.client!nh", name = "i", descriptor = "(I)Z")
	public boolean method4065() {
		return this.appearance != null;
	}

	@OriginalMember(owner = "com.jagex.client!nh", name = "a", descriptor = "(Z)I")
	@Override
	public int method4324() {
		return -1;
	}

	@OriginalMember(owner = "com.jagex.client!nh", name = "e", descriptor = "(I)V")
	@Override
	public void method6069() {
		throw new IllegalStateException();
	}

	@OriginalMember(owner = "com.jagex.client!nh", name = "g", descriptor = "(I)Z")
	@Override
	public boolean method6076() {
		return false;
	}

	@OriginalMember(owner = "com.jagex.client!nh", name = "e", descriptor = "(B)I")
	@Override
	protected int method4329() {
		return this.basId;
	}

	@OriginalMember(owner = "com.jagex.client!nh", name = "a", descriptor = "(Lclient!bt;I)V")
	...
	@OriginalMember(owner = "com.jagex.client!nh", name = "a", descriptor = "(ILclient!wm;I)Z")
	...
	@OriginalMember(owner = "com.jagex.client!nh", name = "a", descriptor = "(IIIB)V")
	...
	@OriginalMember(owner = "com.jagex.client!nh", name = "h", descriptor = "(I)I")
	@Override
	public int method6080() {
		return super.anInt4630;
	}

	@OriginalMember(owner = "com.jagex.client!nh", name = "b", descriptor = "(Lclient!wm;B)Lclient!nf;")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!nh", name = "a", descriptor = "(IIBLclient!wm;)Z")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!nh", name = "b", descriptor = "(Z)I")
	@Override
	public int getSize() {
		return this.appearance == null || this.appearance.npcId == -1 ? super.getSize() : client.NpcTypes.get(this.appearance.npcId).size;
	}

	@OriginalMember(owner = "com.jagex.client!nh", name = "d", descriptor = "(ZI)Ljava/lang/String;")
	public String method4070() {
		return this.username;
	}

	@OriginalMember(owner = "com.jagex.client!nh", name = "a", descriptor = "(BIBI)V")
	...
	@OriginalMember(owner = "com.jagex.client!nh", name = "a", descriptor = "(IZ)Ljava/lang/String;")
	...
	@OriginalMember(owner = "com.jagex.client!nh", name = "a", descriptor = "(ZIIIILclient!on;Lclient!gn;Lclient!wm;)V")
	private void method4073(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) Class14 arg4, @OriginalArg(6) Model arg5, @OriginalArg(7) Renderer arg6) {
