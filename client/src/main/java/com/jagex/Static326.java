...
public final class Static326 {
	...
	@OriginalMember(owner = "com.jagex.client!ss", name = "e", descriptor = "I")
	public static int anInt6235 = 0;

	@OriginalMember(owner = "com.jagex.client!ss", name = "g", descriptor = "[Ljava/lang/String;")
	public static final String[] aStringArray58 = new String[] { "Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat" };

	@OriginalMember(owner = "com.jagex.client!ss", name = "a", descriptor = "(IIIIII)V")
