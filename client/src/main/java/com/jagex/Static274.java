...
public final class Static274 {
	...
	@OriginalMember(owner = "com.jagex.client!pp", name = "h", descriptor = "Lclient!ci;")
	public static TextureProviderInterface anInterface2_7;

	@OriginalMember(owner = "com.jagex.client!pp", name = "s", descriptor = "[I")
	public static int[] anIntArray352;

	@OriginalMember(owner = "com.jagex.client!pp", name = "a", descriptor = "(ZLclient!nk;I)I")
	...
	@OriginalMember(owner = "com.jagex.client!pp", name = "a", descriptor = "(II)I")
