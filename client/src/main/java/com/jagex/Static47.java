...
public final class Static47 {
	...
	@OriginalMember(owner = "com.jagex.client!co", name = "f", descriptor = "Lclient!gd;")
	...
	@OriginalMember(owner = "com.jagex.client!co", name = "s", descriptor = "Z")
	public static boolean nonpcs = false;

	@OriginalMember(owner = "com.jagex.client!co", name = "u", descriptor = "[I")
	public static final int[] anIntArray90 = new int[4096];

	@OriginalMember(owner = "com.jagex.client!co", name = "a", descriptor = "(II)Ljava/lang/String;")
