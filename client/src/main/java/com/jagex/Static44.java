...
public final class Static44 {
	...
	@OriginalMember(owner = "com.jagex.client!cl", name = "u", descriptor = "Lclient!gd;")
	...
	@OriginalMember(owner = "com.jagex.client!cl", name = "B", descriptor = "I")
	public static int anInt1106 = 20;

	@OriginalMember(owner = "com.jagex.client!cl", name = "L", descriptor = "I")
	public static int anInt1115 = 0;

	@OriginalMember(owner = "com.jagex.client!cl", name = "M", descriptor = "[Z")
	public static final boolean[] secondaryOptions = new boolean[8];

	@OriginalMember(owner = "com.jagex.client!cl", name = "a", descriptor = "(Lclient!wm;BLclient!r;)V")
	public static void method1358(@OriginalArg(0) Renderer arg0, @OriginalArg(2) Js5 arg1) {
		@Pc(10) SpriteData[] local10 = Static396.method1688(arg1, Sprites.hitMarksId);
		Static15.aClass13Array3 = new Sprite[local10.length];
		for (@Pc(16) int local16 = 0; local16 < local10.length; local16++) {
			Static15.aClass13Array3[local16] = arg0.createSprite(local10[local16]);
		}
		...
		for (@Pc(43) int local43 = 0; local43 < local10.length; local43++) {
			Static62.aClass13Array9[local43] = arg0.createSprite(local10[local43]);
		}
		...
		for (@Pc(74) int local74 = 0; local74 < local10.length; local74++) {
			Static332.aClass13Array23[local74] = arg0.createSprite(local10[local74]);
		}
		...
		for (@Pc(105) int local105 = 0; local105 < local10.length; local105++) {
			Static232.aClass13Array17[local105] = arg0.createSprite(local10[local105]);
		}
		...
		for (@Pc(141) int local141 = 0; local141 < local10.length; local141++) {
			Static137.aClass13Array13[local141] = arg0.createSprite(local10[local141]);
		}
		...
		for (@Pc(168) int local168 = 0; local168 < local10.length; local168++) {
			Static230.aClass13Array16[local168] = arg0.createSprite(local10[local168]);
		}
		...
		for (@Pc(199) int local199 = 0; local199 < local10.length; local199++) {
			Static123.aClass13Array10[local199] = arg0.createSprite(local10[local199]);
		}
		...
		for (@Pc(226) int local226 = 0; local226 < local10.length; local226++) {
			Static352.aClass13Array25[local226] = arg0.createSprite(local10[local226]);
		}
		...
		for (@Pc(257) int local257 = 0; local257 < local10.length; local257++) {
			Static288.aClass13Array21[local257] = arg0.createSprite(local10[local257]);
		}
		...
		for (@Pc(288) int local288 = 0; local288 < local10.length; local288++) {
			Static76.aClass13Array5[local288] = arg0.createSprite(local10[local288]);
		}
		...
		for (@Pc(319) int local319 = 0; local319 < local10.length; local319++) {
			Static126.aClass13Array22[local319] = arg0.createSprite(local10[local319]);
		}
		...
		for (@Pc(346) int local346 = 0; local346 < local10.length; local346++) {
			Static124.aClass13Array27[local346] = arg0.createSprite(local10[local346]);
		}
		Static12.aClass13_2 = arg0.createSprite(Static396.method1682(arg1, Sprites.compassId, 0));
		Static119.aClass13_7 = arg0.createSprite(Static396.method1682(arg1, Sprites.otherLevelId, 0));
		...
		for (@Pc(393) int local393 = 0; local393 < local10.length; local393++) {
			Static116.aClass13Array8[local393] = arg0.createSprite(local10[local393]);
		}
	}

	@OriginalMember(owner = "com.jagex.client!cl", name = "a", descriptor = "(Lclient!r;I)V")
