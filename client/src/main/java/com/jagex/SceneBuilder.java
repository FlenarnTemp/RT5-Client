...
@OriginalClass("com.jagex.client!bu")
public final class SceneBuilder extends Class29 {

	@OriginalMember(owner = "com.jagex.client!bu", name = "M", descriptor = "I")
	public int anInt922 = 99;

	@OriginalMember(owner = "com.jagex.client!bu", name = "<init>", descriptor = "(IIIZ)V")
	...
	@OriginalMember(owner = "com.jagex.client!bu", name = "a", descriptor = "([IIILclient!wm;Lclient!bt;Z)V")
	public void method1100(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Renderer arg3, @OriginalArg(4) Packet arg4) {
		if (super.aBoolean73) {
			return;
		}
	...
	@OriginalMember(owner = "com.jagex.client!bu", name = "a", descriptor = "(Lclient!bt;IIIIILclient!wm;[IIII)V")
	public void method1101(@OriginalArg(0) Packet arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) Renderer arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9) {
		if (super.aBoolean73) {
			return;
		}
		if (arg7 != null) {
	...
	@OriginalMember(owner = "com.jagex.client!bu", name = "a", descriptor = "(ILclient!wm;)V")
	public void method1104(@OriginalArg(1) Renderer arg0) {
	...
	@OriginalMember(owner = "com.jagex.client!bu", name = "a", descriptor = "(IIIIIIILclient!wm;Lclient!dg;II)V")
	public void method1105(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) Renderer arg6, @OriginalArg(8) CollisionMap arg7, @OriginalArg(9) int arg8, @OriginalArg(10) int arg9) {
		...
		if (Static77.anInt1762 == 1 && local30.istexture) {
			return;
		}
		@Pc(48) int local48;
		@Pc(51) int local51;
		if (arg0 == 1 || arg0 == 3) {
			local51 = local30.width;
			local48 = local30.length;
		} else {
			local48 = local30.width;
			local51 = local30.length;
		}
		@Pc(93) int local93;
		@Pc(87) int local87;
		...
		@Pc(186) boolean local186 = Static263.aBoolean330 && !super.aBoolean73 && local30.sharelight;
		if (local30.method1522()) {
			AreaSoundManager.add(local30, arg2, arg0, null, null, arg1, arg5);
		}
		@Pc(220) boolean local220 = arg9 == -1 && local30.anim == -1 && local30.anIntArray95 == null && local30.multiloc == null && !local30.aBoolean107;
		if (Static160.showocc && local30.occlude != 1) {
			return;
		}
		if (arg8 != 22) {
			...
			if (arg8 == 10 || arg8 == 11) {
				...
				if (local419 || Static329.method5630(local373, false)) {
					...
					if (local30.shadow && Static263.aBoolean330) {
						if (local369 > 30) {
							local369 = 30;
						}
				...
				if (local30.blockwalk != 0 && arg7 != null) {
					arg7.method1639(local30.var1, local51, arg1, !local30.breakroutefinding, arg2, local48);
				}
			} else {
				...
				if (arg8 >= 12 && arg8 <= 17 || arg8 >= 18 && arg8 <= 21) {
					...
					if (Static263.aBoolean330 && !super.aBoolean73 && arg8 >= 12 && arg8 <= 17 && arg8 != 13 && arg5 > 0 && local30.occlude != 0) {
					...
					if (arg8 == 0) {
						@Pc(714) int local714 = local30.occlude;
						if (Static263.wallocc && local30.occlude == -1) {
							local714 = 1;
						}
						if (local220) {
						...
						if (local30.blockwalk != 0 && arg7 != null) {
							arg7.method1638(arg0, arg2, arg1, local30.var1, arg8, !local30.breakroutefinding);
						}
						if (local30.walloff != 16) {
							Static285.method4894(arg5, arg1, arg2, local30.walloff);
						}
					} else {
						...
						if (arg8 == 1) {
							...
							if (local30.occlude == 1 && Static263.aBoolean330 && !super.aBoolean73) {
								if (arg0 == 0) {
									super.levelOccludemap[arg5][arg1][arg2] = (byte) (super.levelOccludemap[arg5][arg1][arg2] | 0x1);
									super.levelOccludemap[arg5][arg1][arg2 + 1] = (byte) (super.levelOccludemap[arg5][arg1][arg2 + 1] | 0x2);
								} else if (arg0 == 1) {
							...
							if (arg8 == 4) {
								...
								if (arg8 == 5) {
									...
									if (local1899 != null) {
										local1893 = client.LocTypes.get(local1899.method6085()).walloff;
									}
									if (local220) {
									...
									local1899 = (Interface6) Static12.method283(arg5, arg1, arg2);
									if (local1899 != null) {
										local1893 = client.LocTypes.get(local1899.method6085()).walloff / 2;
									}
									if (local220) {
									...
									if (local2210 != null) {
										local2204 = client.LocTypes.get(local2210.method6085()).walloff / 2;
									}
		...
		} else if (client.preferences.groundDecoration || local30.active != 0 || local30.blockwalk == 1 || local30.forcedecor) {
			...
			if (local30.blockwalk == 1 && arg7 != null) {
				arg7.method1634(arg2, arg1);
			}
		}
	}

	@OriginalMember(owner = "com.jagex.client!bu", name = "a", descriptor = "(IIII[BBILclient!wm;[Lclient!dg;II)V")
	public void method1107(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) byte[] arg4, @OriginalArg(6) int arg5, @OriginalArg(7) Renderer arg6, @OriginalArg(8) CollisionMap[] arg7, @OriginalArg(9) int arg8, @OriginalArg(10) int arg9) {
		...
		while (true) {
			...
			while (true) {
				...
				if (arg1 == local54 && local50 >= arg3 && arg3 + 8 > local50 && arg9 <= local44 && arg9 + 8 > local44) {
					...
					@Pc(115) int local115 = arg5 + Static50.method1528(local50 & 0x7, arg0, local66, local98.width, local98.length, local44 & 0x7);
					@Pc(132) int local132 = arg8 + Static33.method4205(arg0, local66, local50 & 0x7, local98.width, local44 & 0x7, local98.length);
	...
	@OriginalMember(owner = "com.jagex.client!bu", name = "a", descriptor = "(IILclient!dg;IIILclient!wm;)V")
	public void method1108(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) CollisionMap arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) Renderer arg5) {
		...
		if (arg3 != 0) {
			...
			if (arg3 == 2) {
				...
				if (local70.blockwalk == 0 || super.anInt900 <= arg1 + local70.width || local70.width + arg4 >= super.anInt911 || super.anInt900 <= arg1 + local70.length || local70.length + arg4 >= super.anInt911) {
					return;
				}
				arg2.method1641(local78, local70.width, !local70.breakroutefinding, local70.var1, arg1, arg4, local70.length);
			} else if (arg3 == 3) {
		...
		if (local70.blockwalk != 0) {
			arg2.method1625(local70.var1, !local70.breakroutefinding, arg1, arg4, local78, local74);
			return;
		}
	}

	@OriginalMember(owner = "com.jagex.client!bu", name = "a", descriptor = "([Lclient!dg;II[BILclient!wm;)V")
	public void method1109(@OriginalArg(0) CollisionMap[] arg0, @OriginalArg(2) int arg1, @OriginalArg(3) byte[] arg2, @OriginalArg(4) int arg3, @OriginalArg(5) Renderer arg4) {
