...
@OriginalClass("com.jagex.client!ap")
public final class Class11_Sub1_Sub2 extends Class11_Sub1 implements Interface6 {

	@OriginalMember(owner = "com.jagex.client!ap", name = "F", descriptor = "Lclient!ql;")
	public final Class192 aClass192_1;

	@OriginalMember(owner = "com.jagex.client!ap", name = "q", descriptor = "Z")
	private final boolean aBoolean25;

	@OriginalMember(owner = "com.jagex.client!ap", name = "<init>", descriptor = "(Lclient!wm;Lclient!ct;IIIIIZIII)V")
	public Class11_Sub1_Sub2(@OriginalArg(0) Renderer arg0, @OriginalArg(1) LocType arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) boolean arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10) {
		...
		this.aBoolean25 = arg1.active != 0 && !arg7;
	}

	@OriginalMember(owner = "com.jagex.client!ap", name = "g", descriptor = "(I)Z")
	@Override
	public boolean method6076() {
		return false;
	}

	@OriginalMember(owner = "com.jagex.client!ap", name = "c", descriptor = "(I)I")
	@Override
	public int method6084() {
		return this.aClass192_1.anInt5429;
	}

	@OriginalMember(owner = "com.jagex.client!ap", name = "a", descriptor = "(I)I")
	@Override
	public int method6081() {
		return this.aClass192_1.anInt5433;
	}

	@OriginalMember(owner = "com.jagex.client!ap", name = "a", descriptor = "(ILclient!wm;I)Lclient!gn;")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!ap", name = "a", descriptor = "(BLclient!wm;)V")
	@Override
	public void method6087(@OriginalArg(1) Renderer arg0) {
		this.aClass192_1.method4930(arg0);
	}

	@OriginalMember(owner = "com.jagex.client!ap", name = "a", descriptor = "(Lclient!wm;I)V")
	@Override
	public void method6083(@OriginalArg(0) Renderer arg0) {
		this.aClass192_1.method4940(arg0);
	}

	@OriginalMember(owner = "com.jagex.client!ap", name = "a", descriptor = "(Z)Z")
	@Override
	public boolean method6086() {
		return this.aClass192_1.method4938();
	}

	@OriginalMember(owner = "com.jagex.client!ap", name = "d", descriptor = "(I)I")
	@Override
	public int method6085() {
		return this.aClass192_1.anInt5432;
	}

	@OriginalMember(owner = "com.jagex.client!ap", name = "a", descriptor = "(IIBLclient!wm;)Z")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!ap", name = "a", descriptor = "(IIILclient!wm;ZLclient!hp;Z)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!ap", name = "a", descriptor = "(Lclient!wm;B)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!ap", name = "e", descriptor = "(I)V")
	@Override
	public void method6069() {
		throw new IllegalStateException();
	}

	@OriginalMember(owner = "com.jagex.client!ap", name = "b", descriptor = "(I)V")
	@Override
	public void method6082() {
	}

	@OriginalMember(owner = "com.jagex.client!ap", name = "b", descriptor = "(Lclient!wm;B)Lclient!nf;")
	@Override
