...
public final class Static182 {
	...
	@OriginalMember(owner = "com.jagex.client!kk", name = "c", descriptor = "I")
	public static int anInt3422;

	@OriginalMember(owner = "com.jagex.client!kk", name = "i", descriptor = "[I")
	public static int[] anIntArray205;

	@OriginalMember(owner = "com.jagex.client!kk", name = "d", descriptor = "I")
	public static int anInt3423 = 0;

	@OriginalMember(owner = "com.jagex.client!kk", name = "j", descriptor = "Lclient!nk;")
	public static Component aClass161_7 = null;

	@OriginalMember(owner = "com.jagex.client!kk", name = "a", descriptor = "(IJ)V")
	...
	@OriginalMember(owner = "com.jagex.client!kk", name = "a", descriptor = "(B)V")
	...
	@OriginalMember(owner = "com.jagex.client!kk", name = "b", descriptor = "(B)V")
