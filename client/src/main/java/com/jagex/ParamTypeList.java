...
@OriginalClass("com.jagex.client!be")
public final class ParamTypeList {

	@OriginalMember(owner = "com.jagex.client!be", name = "i", descriptor = "Lclient!hu;")
	private final LruHashTable aClass98_2 = new LruHashTable(64);

	@OriginalMember(owner = "com.jagex.client!be", name = "h", descriptor = "Lclient!r;")
	private final Js5 aClass197_2;

	@OriginalMember(owner = "com.jagex.client!be", name = "<init>", descriptor = "(Lclient!dn;ILclient!r;)V")
	...
	@OriginalMember(owner = "com.jagex.client!be", name = "b", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!be", name = "c", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!be", name = "a", descriptor = "(II)Lclient!vp;")
	public ParamType get(@OriginalArg(1) int arg0) {
		...
		@Pc(38) byte[] local38 = this.aClass197_2.getfile(arg0, 11);
	...
	@OriginalMember(owner = "com.jagex.client!be", name = "b", descriptor = "(II)V")
