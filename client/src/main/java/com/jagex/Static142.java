...
public final class Static142 {
	...
	@OriginalMember(owner = "com.jagex.client!ia", name = "k", descriptor = "Lclient!r;")
	public static Js5 aClass197_37;

	@OriginalMember(owner = "com.jagex.client!ia", name = "o", descriptor = "Lclient!ld;")
	public static final LinkedList aClass135_21 = new LinkedList();

	@OriginalMember(owner = "com.jagex.client!ia", name = "a", descriptor = "(IIIII)Z")
