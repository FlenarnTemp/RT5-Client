...
public final class Static254 {
	...
	@OriginalMember(owner = "com.jagex.client!ok", name = "e", descriptor = "I")
	public static int anInt4698;

	@OriginalMember(owner = "com.jagex.client!ok", name = "i", descriptor = "Lclient!hu;")
	public static final LruHashTable aClass98_39 = new LruHashTable(8);

	@OriginalMember(owner = "com.jagex.client!ok", name = "a", descriptor = "(I[S)[S")
	...
	@OriginalMember(owner = "com.jagex.client!ok", name = "a", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!ok", name = "c", descriptor = "(I)I")
