...
public final class Static357 {
	...
	@OriginalMember(owner = "com.jagex.client!uq", name = "jb", descriptor = "[[I")
	public static int[][] anIntArrayArray58;

	@OriginalMember(owner = "com.jagex.client!uq", name = "db", descriptor = "Lclient!gd;")
	...
	@OriginalMember(owner = "com.jagex.client!uq", name = "fb", descriptor = "[Z")
	public static final boolean[] aBooleanArray59 = new boolean[100];

	@OriginalMember(owner = "com.jagex.client!uq", name = "gb", descriptor = "Lclient!gd;")
	...
	@OriginalMember(owner = "com.jagex.client!uq", name = "hb", descriptor = "[J")
	public static final long[] aLongArray12 = new long[32];

	@OriginalMember(owner = "com.jagex.client!uq", name = "ib", descriptor = "I")
	public static int anInt6683 = 0;

	@OriginalMember(owner = "com.jagex.client!uq", name = "b", descriptor = "(II)I")
