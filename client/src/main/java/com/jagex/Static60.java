...
public final class Static60 {
	...
	@OriginalMember(owner = "com.jagex.client!di", name = "c", descriptor = "I")
	public static int anInt666 = 0;

	@OriginalMember(owner = "com.jagex.client!di", name = "d", descriptor = "[I")
	public static final int[] anIntArray35 = new int[] { 0, 64, 128, 128, 128, 64, 0, 0, 32, 64, 32, 96, 64 };

	@OriginalMember(owner = "com.jagex.client!di", name = "e", descriptor = "I")
	public static final int anInt667 = 1405;

	@OriginalMember(owner = "com.jagex.client!di", name = "a", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!di", name = "a", descriptor = "()V")
	...
	@OriginalMember(owner = "com.jagex.client!di", name = "a", descriptor = "(ZZ)V")
	public static void method891(@OriginalArg(1) boolean arg0) {
		Static129.method2435(GameShell.canvasHeight, Static139.topLevelInterface, arg0, GameShell.canvasWidth);
	}
}
