...
@OriginalClass("com.jagex.client!bm")
public final class Class11_Sub2_Sub1 extends Class11_Sub2 implements Interface6 {

	@OriginalMember(owner = "com.jagex.client!bm", name = "T", descriptor = "B")
	private final byte aByte3;

	@OriginalMember(owner = "com.jagex.client!bm", name = "L", descriptor = "B")
	private final byte aByte2;

	@OriginalMember(owner = "com.jagex.client!bm", name = "v", descriptor = "Z")
	private final boolean aBoolean63;

	@OriginalMember(owner = "com.jagex.client!bm", name = "F", descriptor = "Z")
	private final boolean aBoolean65;

	@OriginalMember(owner = "com.jagex.client!bm", name = "y", descriptor = "Z")
	private boolean aBoolean64;

	@OriginalMember(owner = "com.jagex.client!bm", name = "J", descriptor = "S")
	private final short aShort1;

	@OriginalMember(owner = "com.jagex.client!bm", name = "P", descriptor = "Z")
	private final boolean aBoolean66;

	@OriginalMember(owner = "com.jagex.client!bm", name = "O", descriptor = "Lclient!gn;")
	private Model aClass31_1;

	@OriginalMember(owner = "com.jagex.client!bm", name = "Q", descriptor = "Lclient!kb;")
	private Class2_Sub2_Sub4 aClass2_Sub2_Sub4_1;

	@OriginalMember(owner = "com.jagex.client!bm", name = "<init>", descriptor = "(Lclient!wm;Lclient!ct;IIIIZIZ)V")
	public Class11_Sub2_Sub1(@OriginalArg(0) Renderer arg0, @OriginalArg(1) LocType arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) boolean arg6, @OriginalArg(7) int arg7, @OriginalArg(8) boolean arg8) {
		super(arg3, arg4, arg5, arg1.aBoolean109, arg1.aBoolean108);
		this.aByte3 = (byte) arg7;
		this.aByte2 = (byte) arg2;
		this.aBoolean63 = arg1.active != 0 && !arg6;
		super.anInt3710 = (short) arg3;
		super.anInt3708 = (short) arg5;
		this.aBoolean65 = arg6;
		this.aBoolean64 = arg8;
		this.aShort1 = (short) arg1.id;
		this.aBoolean66 = arg0.method2878() && arg1.hardshadow && !this.aBoolean65 && client.preferences.shadows != 0;
	...
	@OriginalMember(owner = "com.jagex.client!bm", name = "e", descriptor = "(I)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!bm", name = "g", descriptor = "(I)Z")
	@Override
	public boolean method6076() {
		return this.aBoolean64;
	}

	@OriginalMember(owner = "com.jagex.client!bm", name = "d", descriptor = "(I)I")
	@Override
	public int method6085() {
		return this.aShort1 & 0xFFFF;
	}

	@OriginalMember(owner = "com.jagex.client!bm", name = "a", descriptor = "(IILclient!wm;)Lclient!gn;")
	private Model method936(@OriginalArg(0) int arg0, @OriginalArg(2) Renderer arg1) {
	...
	@OriginalMember(owner = "com.jagex.client!bm", name = "b", descriptor = "(Lclient!wm;B)Lclient!nf;")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!bm", name = "a", descriptor = "(IIILclient!wm;ZLclient!hp;Z)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!bm", name = "a", descriptor = "(BLclient!wm;)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!bm", name = "b", descriptor = "(I)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!bm", name = "a", descriptor = "(ILclient!wm;I)Lclient!gn;")
	@Override
	public Model method6088(@OriginalArg(0) int arg0, @OriginalArg(1) Renderer arg1) {
		return this.method936(arg0, arg1);
	}

	@OriginalMember(owner = "com.jagex.client!bm", name = "c", descriptor = "(I)I")
	@Override
	public int method6084() {
		return this.aByte3;
	}

	@OriginalMember(owner = "com.jagex.client!bm", name = "a", descriptor = "(I)I")
	@Override
	public int method6081() {
		return 22;
	}

	@OriginalMember(owner = "com.jagex.client!bm", name = "a", descriptor = "(Lclient!wm;I)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!bm", name = "a", descriptor = "(IZLclient!wm;I)Lclient!ij;")
	private Class105 method940(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) Renderer arg2) {
	...
	@OriginalMember(owner = "com.jagex.client!bm", name = "a", descriptor = "(Lclient!wm;B)V")
	@Override
	public void method6070(@OriginalArg(0) Renderer arg0) {
	}

	@OriginalMember(owner = "com.jagex.client!bm", name = "a", descriptor = "(IIBLclient!wm;)Z")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!bm", name = "a", descriptor = "(Z)Z")
	@Override
