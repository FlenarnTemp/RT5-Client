...
@OriginalClass("com.jagex.client!tb")
public final class QuickChatPhraseType extends SecondaryNode {

	@OriginalMember(owner = "com.jagex.client!tb", name = "F", descriptor = "[Ljava/lang/String;")
	private String[] aStringArray56;

	@OriginalMember(owner = "com.jagex.client!tb", name = "G", descriptor = "[I")
	private int[] anIntArray417;

	@OriginalMember(owner = "com.jagex.client!tb", name = "S", descriptor = "[[I")
	private int[][] anIntArrayArray52;

	@OriginalMember(owner = "com.jagex.client!tb", name = "T", descriptor = "[I")
	public int[] automaticResponses;

	@OriginalMember(owner = "com.jagex.client!tb", name = "K", descriptor = "Z")
	public boolean aBoolean413 = true;

	@OriginalMember(owner = "com.jagex.client!tb", name = "a", descriptor = "(ILclient!bt;I)V")
	...
	@OriginalMember(owner = "com.jagex.client!tb", name = "a", descriptor = "(II)I")
	...
	@OriginalMember(owner = "com.jagex.client!tb", name = "a", descriptor = "(Lclient!bt;I[I)V")
	...
	@OriginalMember(owner = "com.jagex.client!tb", name = "a", descriptor = "(BLclient!bt;)V")
	...
	@OriginalMember(owner = "com.jagex.client!tb", name = "a", descriptor = "(IIB)I")
	...
	@OriginalMember(owner = "com.jagex.client!tb", name = "e", descriptor = "(B)Ljava/lang/String;")
	...
	@OriginalMember(owner = "com.jagex.client!tb", name = "a", descriptor = "(Lclient!bt;B)Ljava/lang/String;")
	...
	@OriginalMember(owner = "com.jagex.client!tb", name = "f", descriptor = "(B)I")
	public int getDynamicCommandCount() {
		return this.anIntArray417 == null ? 0 : this.anIntArray417.length;
	}

	@OriginalMember(owner = "com.jagex.client!tb", name = "g", descriptor = "(B)V")
