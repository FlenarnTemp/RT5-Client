...
public final class Static12 {
	...
	@OriginalMember(owner = "com.jagex.client!am", name = "f", descriptor = "Lclient!jd;")
	public static Sprite aClass13_2;

	@OriginalMember(owner = "com.jagex.client!am", name = "g", descriptor = "[C")
	public static final char[] aCharArray1 = new char[] { '[', ']', '#' };

	@OriginalMember(owner = "com.jagex.client!am", name = "a", descriptor = "(BII)V")
	public static void method280(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
		...
		for (@Pc(170) Class2_Sub15 local170 = (Class2_Sub15) Static197.aClass135_24.head(); local170 != null; local170 = (Class2_Sub15) Static197.aClass135_24.next()) {
			@Pc(179) MapElementType local179 = MapList.aClass125_4.get(local170.aClass2_Sub20_1.id);
	...
	@OriginalMember(owner = "com.jagex.client!am", name = "a", descriptor = "(III)Lclient!gq;")
