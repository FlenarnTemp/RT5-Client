...
public class Protocol {
	...
	@OriginalMember(owner = "com.jagex.client!on", name = "g", descriptor = "Lclient!qg;")
	public static final PacketBit outboundBuffer = new PacketBit(5000);
	@OriginalMember(owner = "com.jagex.client!ld", name = "n", descriptor = "Ljava/math/BigInteger;")
	...
	@OriginalMember(owner = "com.jagex.client!sm", name = "w", descriptor = "Ljava/math/BigInteger;")
	...
	@OriginalMember(owner = "com.jagex.client!mi", name = "m", descriptor = "Lclient!qg;")
	public static final PacketBit inboundBuffer = new PacketBit(5000);
	@OriginalMember(owner = "com.jagex.client!at", name = "J", descriptor = "[I")
	public static final int[] removedIds = new int[1000];
	@OriginalMember(owner = "com.jagex.client!q", name = "o", descriptor = "[I")
	public static final int[] extendedIds = new int[250];
	@OriginalMember(owner = "com.jagex.client!et", name = "d", descriptor = "Lclient!bt;")
	public static final Packet playerAppearanceBuffer = new Packet(new byte[5000]);

	@OriginalMember(owner = "com.jagex.client!jc", name = "S", descriptor = "Lclient!cc;")
	public static PrivilegedRequest socketRequest = null;

	@OriginalMember(owner = "com.jagex.client!ad", name = "x", descriptor = "Lclient!cc;")
	public static PrivilegedRequest socketRequest2;

	@OriginalMember(owner = "com.jagex.client!ti", name = "A", descriptor = "Lclient!iu;")
	public static BufferedSocket socket;

	@OriginalMember(owner = "com.jagex.client!qr", name = "n", descriptor = "I")
	public static int verifyId = 0;

	@OriginalMember(owner = "com.jagex.client!nf", name = "t", descriptor = "Lclient!h;")
	public static ServerProt packet = null;

	@OriginalMember(owner = "com.jagex.client!em", name = "i", descriptor = "I")
	public static int packetSize = 0;
	@OriginalMember(owner = "com.jagex.client!ri", name = "R", descriptor = "I")
	public static int totalRead;
	@OriginalMember(owner = "com.jagex.client!du", name = "b", descriptor = "Z")
	public static boolean aBoolean129 = true;
	@OriginalMember(owner = "com.jagex.client!dr", name = "O", descriptor = "Lclient!h;")
	public static ServerProt packet2;
	@OriginalMember(owner = "com.jagex.client!th", name = "F", descriptor = "Lclient!h;")
	public static ServerProt packet1;
	@OriginalMember(owner = "com.jagex.client!cf", name = "x", descriptor = "Lclient!h;")
	public static ServerProt packet3;
	@OriginalMember(owner = "com.jagex.client!nr", name = "h", descriptor = "I")
	public static int removedCount = 0;
	@OriginalMember(owner = "com.jagex.client!ts", name = "f", descriptor = "I")
	public static int extendedCount = 0;
	@OriginalMember(owner = "com.jagex.client!oc", name = "a", descriptor = "Lclient!iu;")
	public static BufferedSocket aClass111_2;
	@OriginalMember(owner = "com.jagex.client!eq", name = "G", descriptor = "I")
	public static int anInt1870 = 0;
	@OriginalMember(owner = "com.jagex.client!ds", name = "u", descriptor = "I")
	public static int zoneX;
	@OriginalMember(owner = "com.jagex.client!ag", name = "q", descriptor = "I")
	public static int zoneZ;
    @OriginalMember(owner = "com.jagex.client!a", name = "f", descriptor = "Z")
    public static boolean verifyIdChanged = false;

    @OriginalMember(owner = "com.jagex.client!ed", name = "b", descriptor = "(I)Z")
		...
		if (ServerProt.REFLECTION_CHEAT_CHECK == packet) {
			...
			if (packet == ServerProt.IF_OPENTOP) {
				...
				if (setVerifyId(local228)) {
					...
					for (worldId = 0; worldId < 100; worldId++) {
						Static357.aBooleanArray59[worldId] = true;
					}
				}
				packet = null;
				return true;
			...
			if (packet == ServerProt.PACKET_48) {
				local272 = inboundBuffer.g1b_alt1();
				local74 = inboundBuffer.g2_alt2();
				local228 = inboundBuffer.g2_alt3();
				if (setVerifyId(local74)) {
				...
				if (packet == ServerProt.PACKET_66) {
					local220 = inboundBuffer.g4_alt3();
					...
					if (setVerifyId(local228)) {
						...
						if (local335 != null) {
							local335.remove();
							InterfaceList.subInterfaces.pushNode(local335, (long) local74);
						}
					...
					if (Static139.topLevelInterface != -1) {
						Static392.method6460(Static139.topLevelInterface, 0);
					}
					packet = null;
					return true;
					...
					if (ServerProt.PACKET_0 == packet) {
						local220 = inboundBuffer.g2_alt2();
						local74 = inboundBuffer.g2_alt2();
						...
						if (local228 >> 30 == 0) {
							...
							if (local506 >= 0 && local512 >= 0 && Static373.buildAreaLimitX > local506 && Static242.buildAreaLimitZ > local512) {
								...
								@Pc(563) SpotAnim local563 = new SpotAnim(local220, 0, client.cycle, local497, local536, Scene.getTileHeight(local536, local542, local497) - worldId, local542, local506, local506, local512, local512);
						...
						local220 = inboundBuffer.g2_alt3();
						local74 = inboundBuffer.g4_alt2();
						...
						if (packet == ServerProt.WIDGETSTRUCT_SETTING) {
							local220 = inboundBuffer.g2();
							if (local220 == 65535) {
								local220 = -1;
							}
							...
							local497 = inboundBuffer.g4_alt2();
							if (setVerifyId(worldId)) {
								for (local506 = local220; local506 <= local228; local506++) {
									...
									if (local1109 != null) {
										...
										local1118 = new ServerActiveProperties(InterfaceList.getComponent(local497).properties.events, local74);
									} else {
										local1118 = new ServerActiveProperties(0, local74);
									}
									Static327.properties.pushNode(local1118, local1101);
								}
							}
							packet = null;
							return true;
						} else if (packet == ServerProt.PACKET_89) {
							local220 = inboundBuffer.g4_alt1();
							local74 = inboundBuffer.g2_alt3();
							if (setVerifyId(local74)) {
							...
							if (setVerifyId(local220)) {
								...
								Static382.method6365(local228, local74, false, worldId);
							}
							packet = null;
							return true;
						} else if (ServerProt.UPDATE_STAT == packet) {
							local220 = inboundBuffer.g4();
							local74 = inboundBuffer.g1_alt2();
							local228 = inboundBuffer.g1_alt3();
							...
							worldId = Static287.anIntArray369[local74] - 1;
							for (local497 = 0; local497 < worldId; local497++) {
							...
							packet = null;
							return true;
						} else if (packet == ServerProt.CAM_LOOKAT) {
							local220 = inboundBuffer.g2();
							...
							if (setVerifyId(local220)) {
								Camera.moveto(local228, local497, local506, true, worldId, local74);
							}
							packet = null;
							return true;
						} else {
							...
							if (ServerProt.UPDATE_FRIENDLIST == packet) {
								while (inboundBuffer.pos < packetSize) {
									...
									for (local536 = 0; local536 < FriendsList.size; local536++) {
										if (local1371) {
											...
											if (FriendsList.worlds[local536] != worldId) {
												FriendsList.worlds[local536] = worldId;
												if (worldId > 0) {
								...
								while (local74 > 0) {
									...
									for (local228 = 0; local228 < local74; local228++) {
										if (FriendsList.worlds[local228] != Player.worldId && Player.worldId == FriendsList.worlds[local228 + 1] || FriendsList.worlds[local228] == 0 && FriendsList.worlds[local228 + 1] != 0) {
											worldId = FriendsList.worlds[local228];
											FriendsList.worlds[local228] = FriendsList.worlds[local228 + 1];
											FriendsList.worlds[local228 + 1] = worldId;
								...
								packet = null;
								return true;
							} else if (packet == ServerProt.UPDATE_RUNWEIGHT) {
								...
								if (packet == ServerProt.PACKET_55) {
									...
									while (true) {
										...
										if (local1796 == Static358.recentMessages[local1800]) {
											local1798 = true;
											break;
										}
										local1800++;
									...
									if (!local1798 && Static212.inTutorialIsland == 0) {
										Static358.recentMessages[Static193.messageCounter] = local1796;
										Static193.messageCounter = (Static193.messageCounter + 1) % 100;
									...
									local506 = inboundBuffer.g1();
									if (setVerifyId(local220)) {
										Camera.lookAt(local497, worldId, local228, local506, local74);
									}
									packet = null;
									return true;
								} else if (ServerProt.PACKET_17 == packet) {
									local220 = inboundBuffer.g1_alt2();
									local74 = inboundBuffer.g1_alt3();
									if (local220 == 255) {
										local74 = -1;
										local220 = -1;
									...
									worldId = inboundBuffer.g1();
									SoundPlayer.play(local74, worldId, local228, local220);
									packet = null;
									return true;
									...
									local74 = inboundBuffer.g4_alt2();
									local228 = inboundBuffer.g2();
									worldId = inboundBuffer.g2_alt3();
									if (setVerifyId(local228)) {
										Static375.method6282(local220 + (worldId << 16), local74);
									}
									packet = null;
									return true;
									...
									worldId = inboundBuffer.g2_alt1();
									if (setVerifyId(local228)) {
										Static190.method3501(worldId, local74, 5, local220);
									}
									packet = null;
									return true;
								} else {
									...
									if (packet == ServerProt.PACKET_35) {
										...
										local228 = inboundBuffer.g2();
										worldId = inboundBuffer.g2();
										if (setVerifyId(local220) && Static26.components[local74] != null) {
											for (local497 = local228; local497 < worldId; local497++) {
												local506 = inboundBuffer.g3();
												if (local497 < Static26.components[local74].length && Static26.components[local74][local497] != null) {
													Static26.components[local74][local497].anInt4246 = local506;
												}
											}
										}
										packet = null;
										...
										if (setVerifyId(local220)) {
											...
											Static105.anIntArray134[local74] = worldId;
										...
										local452 = Cp1252.decodeString(0, local2782, packetSize);
										...
										zoneZ = inboundBuffer.g1_alt2();
										Player.level = inboundBuffer.g1_alt1();
										for (@Pc(2839) Class2_Sub32 local2839 = (Class2_Sub32) Static120.objStacks.head(); local2839 != null; local2839 = (Class2_Sub32) Static120.objStacks.next()) {
											local74 = (int) (local2839.nodeId & 0x3FFFL);
											local228 = (int) (local2839.nodeId >> 14 & 0x3FFFL);
											worldId = (int) (local2839.nodeId >> 28 & 0x3L);
											if (Player.level == worldId && zoneX <= local74 && zoneX + 8 > local74 && local228 >= zoneZ && local228 < zoneZ + 8) {
												local2839.remove();
										...
										while (true) {
											...
											if (local3014 == Static358.recentMessages[local3018]) {
												local3016 = true;
												break;
											}
											local3018++;
										...
										if (!local3016 && Static212.inTutorialIsland == 0) {
											Static358.recentMessages[Static193.messageCounter] = local3014;
											Static193.messageCounter = (Static193.messageCounter + 1) % 100;
										...
										packet = null;
										return true;
									} else if (ServerProt.SET_INTERFACE_SETTINGS == packet) {
										local220 = inboundBuffer.g4_alt2();
										local74 = inboundBuffer.g2_alt1();
										if (local74 == 65535) {
											local74 = -1;
										}
										local228 = inboundBuffer.g4_alt3();
										worldId = inboundBuffer.g2_alt2();
										if (worldId == 65535) {
											worldId = -1;
										}
										local497 = inboundBuffer.g2_alt1();
										if (setVerifyId(local497)) {
											for (local506 = local74; local506 <= worldId; local506++) {
												...
												if (local1109 != null) {
													...
													local1118 = new ServerActiveProperties(local228, InterfaceList.getComponent(local220).properties.targetParam);
												} else {
										...
										Static53.anInt3971 = InterfaceList.transmitTimer;
										return true;
									} else if (packet == ServerProt.SET_INTERACTION) {
										local444 = inboundBuffer.gjstr();
										local74 = inboundBuffer.g2_alt2();
										if (local74 == 65535) {
											local74 = -1;
										...
										local228 = inboundBuffer.g1_alt3();
										worldId = inboundBuffer.g1_alt3();
										if (local228 >= 1 && local228 <= 8) {
											if (local444.equalsIgnoreCase("null")) {
												local444 = null;
											}
											Static243.options[local228 - 1] = local444;
											Static207.cursors[local228 - 1] = local74;
											Static44.secondaryOptions[local228 - 1] = worldId == 0;
										}
										packet = null;
										return true;
										...
										local228 = inboundBuffer.g4_alt3();
										worldId = inboundBuffer.g4_alt2();
										if (setVerifyId(local220)) {
											Static216.method3774(local74, worldId, local228);
											@Pc(3499) ObjType local3499 = client.ObjTypes.get(local74);
											Static277.method4680(local3499.yAngle2d, local3499.xAngle2d, worldId, local3499.zoom2d);
											Static376.method6287(worldId, local3499.yOffset2d, local3499.xOffset2d, local3499.zOffset2d);
										}
										packet = null;
										return true;
										...
										if (packet == ServerProt.PACKET_67) {
											...
											if (local3571) {
												...
												for (local512 = 0; local512 < ClanChat.size && (!ClanChat.members[local512].username.equals(local452) || ClanChat.members[local512].world != worldId); local512++) {
												}
												...
												for (local542 = ClanChat.size - 1; local542 >= 0; local542--) {
													...
													if (local638 == 0) {
														ClanChat.members[local542].world = worldId;
										...
										if (ServerProt.MESSAGE_GAME == packet) {
											...
											packet = null;
											return true;
										} else if (packet == ServerProt.LAST_LOGIN_INFO) {
											local220 = inboundBuffer.g4();
											Player.lastLogAddress = GameShell.signlink.getReverseDns(local220);
											packet = null;
											return true;
										} else if (ServerProt.CHAT_FILTER_SETTINGS == packet) {
											Chat.publicFilter = inboundBuffer.g1_alt1();
											Chat.tradeFilter = inboundBuffer.g1_alt3();
											packet = null;
											return true;
											...
											packet = null;
											return true;
										} else if (ServerProt.UPDATE_RUNENERGY == packet) {
											...
											packet = null;
											return true;
										} else if (packet == ServerProt.MIDI_SONG) {
											local220 = inboundBuffer.g1_alt3();
											local74 = inboundBuffer.g2_alt1();
											if (local74 == 65535) {
												local74 = -1;
											}
											...
											packet = null;
											return true;
										} else if (packet == ServerProt.MIDI_JINGLE) {
											local220 = inboundBuffer.g1_alt1();
											local74 = inboundBuffer.g3();
											local228 = inboundBuffer.g2();
											if (local228 == 65535) {
												local228 = -1;
											}
											...
											if (ServerProt.PACKET_84 == packet) {
												...
												while (true) {
													...
													if (Static358.recentMessages[local4314] == local4310) {
														local4312 = true;
														break;
													}
													local4314++;
												...
												if (!local4312 && Static212.inTutorialIsland == 0) {
													Static358.recentMessages[Static193.messageCounter] = local4310;
													Static193.messageCounter = (Static193.messageCounter + 1) % 100;
												...
												while (packetSize > inboundBuffer.pos) {
													...
													Static62.method2391(worldId, local506, local220, local497 - 1, local3551);
												}
												...
												local444 = inboundBuffer.gjstr();
												local74 = inboundBuffer.g2_alt1();
												local228 = inboundBuffer.g4_alt2();
												if (setVerifyId(local74)) {
												...
												local220 = inboundBuffer.g4_alt1();
												local74 = inboundBuffer.g2_alt1();
												local228 = inboundBuffer.g2s_alt1();
												worldId = inboundBuffer.g2s_alt2();
												if (setVerifyId(local74)) {
													Static129.method2438(worldId, local228, local220);
												}
												packet = null;
												return true;
												...
												local272 = inboundBuffer.g1b_alt2();
												local74 = inboundBuffer.g2();
												...
												local228 = inboundBuffer.g2();
												worldId = inboundBuffer.g2_alt3();
												local497 = inboundBuffer.g4_alt1();
												if (setVerifyId(local74)) {
													Static190.method3501(local228 | worldId << 16, local220, 7, local497);
												}
												packet = null;
												return true;
												...
												while (true) {
													...
													if (Static358.recentMessages[local4902] == local4898) {
														local4900 = true;
														break;
													}
													local4902++;
												...
												if (!local4900 && Static212.inTutorialIsland == 0) {
													Static358.recentMessages[Static193.messageCounter] = local4898;
													Static193.messageCounter = (Static193.messageCounter + 1) % 100;
												...
												worldId = inboundBuffer.g2();
												for (local497 = 0; local497 < worldId; local497++) {
													local506 = inboundBuffer.g2_alt1();
													local512 = inboundBuffer.g1();
													if (local512 == 255) {
														local512 = inboundBuffer.g4_alt3();
													}
												...
												local228 = inboundBuffer.g2_alt2();
												worldId = inboundBuffer.g2_alt2();
												local497 = inboundBuffer.g2_alt2();
												if (setVerifyId(local74)) {
													Static277.method4680(local497, worldId, local220, local228);
												}
												packet = null;
												return true;
												...
												worldId = Static150.LAYERS[local74];
												local497 = inboundBuffer.g4_alt3();
												local506 = local497 >> 28 & 0x3;
												local512 = local497 >> 14 & 0x3FFF;
												local536 = local497 & 0x3FFF;
												local542 = inboundBuffer.g2_alt3();
												@Pc(5371) int local5371 = local536 - Camera.originZ;
												if (local542 == 65535) {
													local542 = -1;
												}
												local512 -= Camera.originX;
												Static391.method6452(local74, local542, local5371, worldId, local228, local512, local506);
												packet = null;
												return true;
												...
												for (worldId = local452.length() - 1; worldId >= 0; worldId--) {
													if (local452.charAt(worldId) == 's') {
														local5648[worldId + 1] = inboundBuffer.gjstr();
													} else {
														local5648[worldId + 1] = Integer.valueOf(inboundBuffer.g4());
													}
												}
												...
												local220 = inboundBuffer.g4();
												local74 = inboundBuffer.g2_alt1();
												local228 = inboundBuffer.g2s_alt3();
												if (setVerifyId(local74)) {
	...
	@OriginalMember(owner = "com.jagex.client!nj", name = "a", descriptor = "(B)Z")
	...
	@OriginalMember(owner = "com.jagex.client!se", name = "b", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!du", name = "a", descriptor = "(IZ)V")
	...
	@OriginalMember(owner = "com.jagex.client!at", name = "a", descriptor = "(ZZ)V")
	...
	@OriginalMember(owner = "com.jagex.client!nk", name = "a", descriptor = "(I)V")
	public static void readExtendedNpcInfo() {
		for (@Pc(7) int local7 = 0; local7 < extendedCount; local7++) {
			...
			@Pc(55) int local55;
			if ((local29 & 0x400) != 0) {
				local55 = inboundBuffer.g2_alt2();
				local25.anInt4578 = inboundBuffer.g1_alt3();
				local25.anInt4591 = inboundBuffer.g1_alt3();
			...
			if ((local29 & 0x2) != 0) {
				...
				local107 = inboundBuffer.g1_alt2();
			...
			if ((local29 & 0x8) != 0) {
				...
				local107 = inboundBuffer.g1_alt3();
			...
			@Pc(224) int local224;
			if ((local29 & 0x4) != 0) {
				local55 = inboundBuffer.g2_alt3();
				local107 = inboundBuffer.g4_alt1();
				if (local55 == 65535) {
					local55 = -1;
				}
			...
			if ((local29 & 0x100) != 0) {
				...
				for (@Pc(419) int local419 = 0; local419 < local55; local419++) {
					local224 = inboundBuffer.g2_alt2();
					if (local224 == 65535) {
						local224 = -1;
					}
					local411[local419] = local224;
					local414[local419] = inboundBuffer.g1_alt2();
			...
			if ((local29 & 0x200) != 0) {
				...
				local25.anInt4657 = inboundBuffer.g2_alt1();
			}
			if ((local29 & 0x10) != 0) {
	...
	@OriginalMember(owner = "com.jagex.client!vc", name = "a", descriptor = "(Lclient!qg;BI)V")
	public static void readPlayerInfo(@OriginalArg(0) PacketBit buf, @OriginalArg(2) int size) {
		Static112.debugGpi = false;
		Static325.anInt6079 = 0;
		readPlayerGpi(buf);
		readPlayerUpdateMasks(buf);
		if (Static112.debugGpi) {
			System.out.println("---endgpp---");
		}
		if (buf.pos != size) {
			throw new RuntimeException("gpi1 pos:" + buf.pos + " psize:" + size);
		}
	}

	@OriginalMember(owner = "com.jagex.client!a", name = "a", descriptor = "(Lclient!qg;I)V")
	public static void readPlayerGpi(@OriginalArg(0) PacketBit buf) {
		// active players:
		...
		for (@Pc(14) int local14 = 0; local14 < PlayerList.anInt751; local14++) {
			...
			if ((PlayerList.aByteArray7[local20] & 0x1) == 0) {
				if (local7 > 0) {
					...
					local48 = buf.gBit(1);
					if (local48 == 0) {
						local7 = method2161(buf);
						PlayerList.aByteArray7[local20] = (byte) (PlayerList.aByteArray7[local20] | 0x2);
					} else {
						method6464(buf, local20);
					}
				}
			}
		}
			...
			if ((PlayerList.aByteArray7[local126] & 0x1) != 0) {
				if (local7 > 0) {
					...
					if (local210 == 0) {
						local7 = method2161(buf);
						PlayerList.aByteArray7[local126] = (byte) (PlayerList.aByteArray7[local126] | 0x2);
					} else if (method6033(buf, local126)) {
						PlayerList.aByteArray7[local126] = (byte) (PlayerList.aByteArray7[local126] | 0x2);
					}
				}
			}
		...
		for (local126 = 0; local126 < PlayerList.anInt3547; local126++) {
			...
			if ((PlayerList.aByteArray7[local210] & 0x1) == 0) {
				if (local7 > 0) {
					...
					@Pc(301) int local301 = buf.gBit(1);
					if (local301 == 0) {
						local7 = method2161(buf);
						PlayerList.aByteArray7[local210] = (byte) (PlayerList.aByteArray7[local210] | 0x2);
					} else if (method6033(buf, local210)) {
						PlayerList.aByteArray7[local210] = (byte) (PlayerList.aByteArray7[local210] | 0x2);
					}
				}
			}
	...
	@OriginalMember(owner = "com.jagex.client!pa", name = "a", descriptor = "(ILclient!qg;)V")
	public static void readPlayerUpdateMasks(@OriginalArg(1) PacketBit buffer) {
	...
	@OriginalMember(owner = "com.jagex.client!rm", name = "a", descriptor = "(Lclient!qg;BILclient!nh;I)V")
	public static void readPlayerUpdateMask(@OriginalArg(0) PacketBit buffer, @OriginalArg(2) int arg1, @OriginalArg(3) Player arg2, @OriginalArg(4) int arg3) {
		@Pc(11) byte local11 = -1;
		if ((arg3 & 0x20) != 0) {
			Static335.aByteArray92[arg1] = buffer.g1b_alt1();
		}
		@Pc(32) int local32;
		@Pc(36) int local36;
		@Pc(40) int local40;
		@Pc(43) int local43;
		if ((arg3 & 0x8) != 0) {
			local32 = buffer.g2_alt2();
			local36 = buffer.g1_alt2();
			local40 = buffer.g1();
			local43 = buffer.pos;
			...
			if (arg2.username != null && arg2.appearance != null) {
				...
				if (!local59 && Static212.inTutorialIsland == 0) {
					...
					buffer.gdata_alt3(playerAppearanceBuffer.data, local40);
					playerAppearanceBuffer.pos = 0;
		...
		if ((arg3 & 0x400) != 0) {
			...
			for (local283 = 0; local283 < local32; local283++) {
				local289 = buffer.g2_alt1();
				if (local289 == 65535) {
					local289 = -1;
				}
				local275[local283] = local289;
				local278[local283] = buffer.g1_alt2();
				local281[local283] = buffer.g2_alt1();
			}
		...
		if ((arg3 & 0x1) != 0) {
			...
			@Pc(342) Packet local342 = new Packet(local337);
			buffer.pdata_alt1(local337, local32);
		...
		if ((arg3 & 0x4) != 0) {
			local32 = buffer.g2_alt3();
			if (local32 == 65535) {
				local32 = -1;
			}
			local36 = buffer.g1_alt1();
			Player.animate(arg2, local36, local32);
		}
		if ((arg3 & 0x100) != 0) {
			arg2.anInt4615 = buffer.g1b_alt1();
			arg2.anInt4588 = buffer.g1b_alt1();
			arg2.anInt4577 = buffer.g1b_alt3();
			arg2.anInt4599 = buffer.g1b();
			arg2.anInt4622 = buffer.g2_alt2() + client.cycle;
			arg2.anInt4584 = buffer.g2_alt2() + client.cycle;
			arg2.anInt4614 = buffer.g1_alt2();
			arg2.anInt4642 = 0;
			if (arg2.aBoolean276) {
		...
		if ((arg3 & 0x1000) != 0) {
			local32 = buffer.g2();
			arg2.anInt4578 = buffer.g1_alt1();
			arg2.anInt4591 = buffer.g1_alt3();
	...
	@OriginalMember(owner = "com.jagex.client!fn", name = "a", descriptor = "(Lclient!qg;B)I")
	public static int method2161(@OriginalArg(0) PacketBit arg0) {
	...
	@OriginalMember(owner = "com.jagex.client!ag", name = "a", descriptor = "(Lclient!qg;II)V")
	public static void method6464(@OriginalArg(0) PacketBit arg0, @OriginalArg(2) int arg1) {
	...
	@OriginalMember(owner = "com.jagex.client!wj", name = "a", descriptor = "(Lclient!qg;ZI)Z")
	public static boolean method6033(@OriginalArg(0) PacketBit arg0, @OriginalArg(2) int arg1) {
	...
	@OriginalMember(owner = "com.jagex.client!f", name = "a", descriptor = "(Lclient!mc;I)V")
	public static void writeOpcode(@OriginalArg(0) ClientProt packet) {
		outboundBuffer.p1isaac(packet.getId());
	}

	@OriginalMember(owner = "com.jagex.client!fe", name = "a", descriptor = "(B)V")
	...
	@OriginalMember(owner = "com.jagex.client!ff", name = "b", descriptor = "(III)V")
	public static void method2045(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		...
		outboundBuffer.p2_alt3(arg1);
	}

	@OriginalMember(owner = "com.jagex.client!tq", name = "a", descriptor = "(IBLjava/lang/String;)V")
		...
		for (@Pc(13) int local13 = 0; local13 < local7; local13++) {
			...
			if (local21 != null && PlayerList.self != local21 && local21.username != null && local21.username.equalsIgnoreCase(arg1)) {
				if (arg0 == 1) {
					...
					outboundBuffer.p1(0);
					outboundBuffer.p2_alt3(local9[local13]);
				} else if (arg0 == 4) {
					writeOpcode(ClientProt.PACKET_69);
					outboundBuffer.p1_alt2(0);
					outboundBuffer.p2_alt1(local9[local13]);
				} else if (arg0 == 5) {
					writeOpcode(ClientProt.PACKET_36);
					outboundBuffer.p2_alt1(local9[local13]);
					outboundBuffer.p1_alt3(0);
				} else if (arg0 == 6) {
					writeOpcode(ClientProt.PACKET_45);
					outboundBuffer.p2_alt1(local9[local13]);
					outboundBuffer.p1_alt1(0);
				} else if (arg0 == 7) {
	...
	@OriginalMember(owner = "com.jagex.client!q", name = "a", descriptor = "(IIILjava/lang/String;I)V")
	public static void method4681(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) String arg2, @OriginalArg(4) int arg3) {
		...
		if (!local35 || !InterfaceList.getServerActiveProperties(local8).isButtonEnabled(arg1 - 1)) {
			return;
		}
		if (arg1 == 1) {
	...
	@OriginalMember(owner = "com.jagex.client!oq", name = "a", descriptor = "(Lclient!cf;IZI)V")
	public static void method4427(@OriginalArg(0) Class2_Sub5 arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2) {
		...
		if (local21 == 21) {
			...
			outboundBuffer.p2_alt3(Camera.originZ + local18);
			outboundBuffer.p2(local15 + Camera.originX);
			outboundBuffer.p1_alt3(Keyboard.instance.isPressed(82) ? 1 : 0);
			outboundBuffer.p2_alt1(local25);
		...
		if (local21 == 51) {
			...
			outboundBuffer.p2_alt1(Static196.anInt3317);
			outboundBuffer.p4(Static337.anInt6317);
			outboundBuffer.p2_alt3(local18 + Camera.originZ);
			outboundBuffer.p2_alt1(Static214.anInt3792);
			outboundBuffer.p2_alt3(Camera.originX + local15);
		...
		if (local21 == 12) {
			...
			outboundBuffer.p2_alt3((int) (local28 >>> 32) & Integer.MAX_VALUE);
			outboundBuffer.p2_alt3(Camera.originZ + local18);
			outboundBuffer.p2(local15 + Camera.originX);
		...
		if (local21 == 1004) {
			...
			outboundBuffer.p2_alt1((int) (local28 >>> 32) & Integer.MAX_VALUE);
			outboundBuffer.p2_alt2(Camera.originX + local15);
			outboundBuffer.p1_alt2(Keyboard.instance.isPressed(82) ? 1 : 0);
			Static172.method3285(local18, local28, local15);
		}
		...
		if (local21 == 2) {
			...
			if (local275 != null) {
				...
				writeOpcode(ClientProt.PACKET_27);
				outboundBuffer.p1_alt3(Keyboard.instance.isPressed(82) ? 1 : 0);
				outboundBuffer.p2_alt3(local25);
		...
		if (local21 == 46) {
			...
			outboundBuffer.p2_alt1(Camera.originZ + local18);
			outboundBuffer.p2(local25);
			outboundBuffer.p1_alt3(Keyboard.instance.isPressed(82) ? 1 : 0);
			outboundBuffer.p2_alt2(Camera.originX + local15);
			Static151.method2756(local18, local15);
		...
		if (local21 == 15) {
			...
			outboundBuffer.p2_alt3(local25);
			outboundBuffer.p2_alt2(Camera.originZ + local18);
			outboundBuffer.p2_alt3(Camera.originX + local15);
			outboundBuffer.p1_alt3(Keyboard.instance.isPressed(82) ? 1 : 0);
			Static151.method2756(local18, local15);
		}
		if (local21 == 10) {
			...
			if (local485 != null) {
				...
				outboundBuffer.p4(Static337.anInt6317);
				outboundBuffer.p1_alt3(Keyboard.instance.isPressed(82) ? 1 : 0);
				outboundBuffer.p2_alt3(Static196.anInt3317);
				outboundBuffer.p2_alt1(Static214.anInt3792);
				outboundBuffer.p2(local25);
				Static322.method5482(true, -2, local485.movementQueueZ[0], 0, local485.getSize(), local485.movementQueueX[0], local485.getSize(), 0);
			}
		...
		if (local21 == 17) {
			...
			outboundBuffer.p2_alt3(Integer.MAX_VALUE & (int) (local28 >>> 32));
			outboundBuffer.p1(Keyboard.instance.isPressed(82) ? 1 : 0);
			outboundBuffer.p2(local15 + Camera.originX);
			outboundBuffer.p2_alt1(Camera.originZ + local18);
			Static172.method3285(local18, local28, local15);
		...
		if (local21 == 60) {
			...
			if (local275 != null) {
				...
				outboundBuffer.p4_alt1(Static337.anInt6317);
				outboundBuffer.p1_alt3(Keyboard.instance.isPressed(82) ? 1 : 0);
				outboundBuffer.p2_alt1(Static214.anInt3792);
				outboundBuffer.p2_alt3(Static196.anInt3317);
				outboundBuffer.p2_alt1(local25);
		...
		if (local21 == 20) {
			...
			outboundBuffer.p2_alt3(Camera.originZ + local18);
			outboundBuffer.p2_alt2(Integer.MAX_VALUE & (int) (local28 >>> 32));
		...
		if (local21 == 58) {
			...
			outboundBuffer.p2_alt3(local25);
			outboundBuffer.p1_alt1(Keyboard.instance.isPressed(82) ? 1 : 0);
			outboundBuffer.p2(Camera.originZ + local18);
			outboundBuffer.p2_alt1(Camera.originX + local15);
			Static151.method2756(local18, local15);
		}
		if (local21 == 13) {
			Cross.ms = 0;
			...
			outboundBuffer.p2_alt1(Camera.originX + local15);
			outboundBuffer.p1_alt2(Keyboard.instance.isPressed(82) ? 1 : 0);
			outboundBuffer.p2_alt3(Static214.anInt3792);
			outboundBuffer.p4_alt3(Static337.anInt6317);
			outboundBuffer.p2_alt3(Camera.originZ + local18);
			Static151.method2756(local18, local15);
		}
		if (local21 == 23) {
		...
		if (local21 == 6) {
			...
			outboundBuffer.p2(local25);
			outboundBuffer.p1_alt1(Keyboard.instance.isPressed(82) ? 1 : 0);
			outboundBuffer.p2_alt2(local15 + Camera.originX);
			outboundBuffer.p2(Camera.originZ + local18);
			Static151.method2756(local18, local15);
		}
		if (local21 == 22) {
		...
		if (local21 == 50) {
			...
			outboundBuffer.p2_alt1((int) (local28 >>> 32) & Integer.MAX_VALUE);
			outboundBuffer.p2_alt1(local15 + Camera.originX);
			outboundBuffer.p2_alt1(Camera.originZ + local18);
			outboundBuffer.p1(Keyboard.instance.isPressed(82) ? 1 : 0);
			Static172.method3285(local18, local28, local15);
		}
		...
		if (local21 == 57) {
			...
			outboundBuffer.p2_alt1(Integer.MAX_VALUE & (int) (local28 >>> 32));
			outboundBuffer.p4_alt2(Static337.anInt6317);
			outboundBuffer.p2(Static196.anInt3317);
			outboundBuffer.p1(Keyboard.instance.isPressed(82) ? 1 : 0);
			outboundBuffer.p2_alt3(Static214.anInt3792);
			outboundBuffer.p2(Camera.originX + local15);
		...
		if (local21 == 49) {
			...
			if (local1723 != null) {
				...
				Static185.method3400(local1723.anInt4238, local1730.getTargetMask(), local18, local15, local1723.anInt4286, local1730.targetParam);
	...
	@OriginalMember(owner = "com.jagex.client!jg", name = "a", descriptor = "(BZ)V")
	...
	@OriginalMember(owner = "com.jagex.client!hf", name = "b", descriptor = "(I)V")
	public static void method2432() {
		writeOpcode(ClientProt.TRANSMITVAR_VERIFYID);
		outboundBuffer.p2(verifyId);
	}

	@OriginalMember(owner = "com.jagex.client!r", name = "a", descriptor = "(Lclient!nk;ZLclient!nk;)V")
	public static void method5096(@OriginalArg(0) Component arg0, @OriginalArg(2) Component arg1) {
		...
		outboundBuffer.p2_alt3(arg1.objId);
		outboundBuffer.p2_alt2(arg1.activeComponentId);
		outboundBuffer.p4_alt3(arg0.id);
		outboundBuffer.p2_alt3(arg0.objId);
		outboundBuffer.p2_alt1(arg0.activeComponentId);
	}

	@OriginalMember(owner = "com.jagex.client!vi", name = "a", descriptor = "(Lclient!nk;I)V")
	public static void method6129(@OriginalArg(0) Component arg0) {
		...
		outboundBuffer.p2_alt2(arg0.activeComponentId);
		outboundBuffer.p2_alt2(Static214.anInt3792);
		outboundBuffer.p2(Static196.anInt3317);
		outboundBuffer.p4_alt3(Static337.anInt6317);
		outboundBuffer.p2(arg0.objId);
	}

	@OriginalMember(owner = "com.jagex.client!dq", name = "b", descriptor = "(IIII)V")
	public static void method1736(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
		...
		outboundBuffer.p2_alt1(arg1 + Camera.originZ);
	...
	@OriginalMember(owner = "com.jagex.client!hq", name = "b", descriptor = "(I)V")
	public static void mainLogic() {
		...
		ReflectionCheck.mainLogic(outboundBuffer, ClientProt.REFLECTION_CHECK.getId());
		...
		if (Mouse.clickButton != null) {
			...
			outboundBuffer.p4_alt1(local135 | local410 << 16);
		}
		@Pc(483) int local483;
		...
		if (Camera.aBoolean156 && Camera.anInt7153 <= 0) {
			...
			outboundBuffer.p2_alt1((int) Camera.pitch >> 3);
		}
		...
		if (!Preferences.sentToServer) {
			...
			@Pc(672) Packet local672 = client.preferences.encode();
		...
		if (Static332.aBoolean427) {
			...
			outboundBuffer.p4_alt1(Static283.anInt5351 << 28 | Static282.anInt5347 << 14 | Static4.anInt89);
	...
	@OriginalMember(owner = "com.jagex.client!mh", name = "b", descriptor = "(B)V")
	...
	@OriginalMember(owner = "com.jagex.client!td", name = "a", descriptor = "(Lclient!s;I)V")
	public static void readZonePacket(@OriginalArg(0) ZoneProt packet) {
		if (packet == ZoneProt.MAP_PROJANIM_HALFSQ) {
				...
				if (sourceEntity != 0) {
					...
					if (local491 != null) {
						...
						if (bas.equipmentTransforms != null && bas.equipmentTransforms[local483] != null) {
							...
							@Pc(556) int local556 = Renderer.anIntArray178[local552];
							@Pc(560) int local560 = Renderer.anIntArray177[local552];
			...
			int count = inboundBuffer.g2_alt1();
			int receiver = inboundBuffer.g2_alt3();

			int pos = inboundBuffer.g1_alt3();
			int x = (pos >> 4 & 0x7) + zoneX;
			int z = zoneZ + (pos & 0x7);
			...
			int info = inboundBuffer.g1_alt2();
			int shape = info >> 2;
			int rotation = info & 0x3;
			int layer = Static150.LAYERS[shape];

			int type = inboundBuffer.g2_alt2();
			...
			@Pc(916) byte local916 = inboundBuffer.g1b_alt2();

			int pos = inboundBuffer.g1();
			int x = (pos >> 4 & 0x7) + zoneX;
			int z = (pos & 0x7) + zoneZ;

			int local49 = inboundBuffer.g2s_alt1();
			@Pc(942) byte local942 = inboundBuffer.g1b_alt3();
			int local57 = inboundBuffer.g2_alt3();
			int local63 = inboundBuffer.g2_alt3();
			@Pc(954) byte local954 = inboundBuffer.g1b_alt2();
			@Pc(958) byte local958 = inboundBuffer.g1b_alt2();
			int info = inboundBuffer.g1_alt1();
			int shape = info >> 2;
			int rotation = info & 0x3;
			...
			int info = inboundBuffer.g1_alt3();
			int shape = info >> 2;
			int rotation = info & 0x3;
			int layer = Static150.LAYERS[shape];
			...
			int type = inboundBuffer.g2();
			int count = inboundBuffer.g2_alt2();
	...
	@OriginalMember(owner = "com.jagex.client!wa", name = "a", descriptor = "(BI)Z")
