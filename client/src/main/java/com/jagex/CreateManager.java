...
public class CreateManager {
	...
	@OriginalMember(owner = "com.jagex.client!i", name = "W", descriptor = "I")
	public static int step = 0;
	@OriginalMember(owner = "com.jagex.client!dr", name = "V", descriptor = "I")
	public static int errors = 0;
	@OriginalMember(owner = "com.jagex.client!sj", name = "i", descriptor = "I")
	public static int reply = -2;
	@OriginalMember(owner = "com.jagex.client!ta", name = "s", descriptor = "I")
	public static int loops = 0;
	@OriginalMember(owner = "com.jagex.client!jj", name = "S", descriptor = "[Ljava/lang/String;")
	public static String[] suggestedNames;

	@OriginalMember(owner = "com.jagex.client!ia", name = "a", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!wo", name = "a", descriptor = "(Ljava/lang/String;IIIZJIIZZLjava/lang/String;)V")
	...
	@OriginalMember(owner = "com.jagex.client!uh", name = "a", descriptor = "(IIIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!ec", name = "a", descriptor = "(JB)V")
