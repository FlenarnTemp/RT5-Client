...
public final class Static371 {
	...
	@OriginalMember(owner = "com.jagex.client!vo", name = "y", descriptor = "Lclient!jd;")
	public static Sprite aClass13_20;

	@OriginalMember(owner = "com.jagex.client!vo", name = "F", descriptor = "J")
	public static long aLong220;

	@OriginalMember(owner = "com.jagex.client!vo", name = "m", descriptor = "Ljava/lang/String;")
	public static String aString68 = null;

	@OriginalMember(owner = "com.jagex.client!vo", name = "C", descriptor = "Z")
	public static volatile boolean aBoolean475 = true;

	@OriginalMember(owner = "com.jagex.client!vo", name = "D", descriptor = "[Ljava/lang/String;")
	public static final String[] aStringArray66 = new String[100];

	@OriginalMember(owner = "com.jagex.client!vo", name = "a", descriptor = "(IIIZLclient!nk;)V")
	...
	@OriginalMember(owner = "com.jagex.client!vo", name = "a", descriptor = "(JILclient!wm;)V")
	public static void method6257(@OriginalArg(0) long arg0, @OriginalArg(2) Renderer arg1) {
	...
	@OriginalMember(owner = "com.jagex.client!vo", name = "a", descriptor = "([BI)[B")
