...
public final class Static285 {
	...
	@OriginalMember(owner = "com.jagex.client!qj", name = "g", descriptor = "I")
	public static final int anInt5368 = 52;

	@OriginalMember(owner = "com.jagex.client!qj", name = "i", descriptor = "I")
	public static int anInt5370 = 0;

	@OriginalMember(owner = "com.jagex.client!qj", name = "o", descriptor = "I")
	public static int anInt5374 = 0;

	@OriginalMember(owner = "com.jagex.client!qj", name = "p", descriptor = "I")
	public static int anInt5375 = 0;

	@OriginalMember(owner = "com.jagex.client!qj", name = "q", descriptor = "[[I")
	...
	@OriginalMember(owner = "com.jagex.client!qj", name = "a", descriptor = "(BLclient!nk;)V")
	public static void method4886(@OriginalArg(1) Component arg0) {
	...
	@OriginalMember(owner = "com.jagex.client!qj", name = "a", descriptor = "(Z)V")
	...
	@OriginalMember(owner = "com.jagex.client!qj", name = "a", descriptor = "(II)V")
	...
	@OriginalMember(owner = "com.jagex.client!qj", name = "a", descriptor = "(IIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!qj", name = "a", descriptor = "(ILclient!r;)V")
