...
@OriginalClass("com.jagex.client!nl")
public final class Class162 implements Runnable {

	@OriginalMember(owner = "com.jagex.client!nl", name = "f", descriptor = "Lclient!ld;")
	private final LinkedList aClass135_28 = new LinkedList();

	@OriginalMember(owner = "com.jagex.client!nl", name = "k", descriptor = "Ljava/lang/Thread;")
	private Thread aThread2 = new Thread(this);

	@OriginalMember(owner = "com.jagex.client!nl", name = "<init>", descriptor = "()V")
	public Class162() {
		this.aThread2.setDaemon(true);
		this.aThread2.start();
	}

	@OriginalMember(owner = "com.jagex.client!nl", name = "a", descriptor = "(Ljava/lang/String;B)Lclient!ha;")
	...
	@OriginalMember(owner = "com.jagex.client!nl", name = "a", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!nl", name = "run", descriptor = "()V")
	@Override
	public void run() {
		while (true) {
	...
	@OriginalMember(owner = "com.jagex.client!nl", name = "a", descriptor = "(ILclient!ag;)V")
