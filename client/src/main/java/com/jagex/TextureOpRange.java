...
@OriginalClass("com.jagex.client!tc")
public final class TextureOpRange extends TextureOp {

	@OriginalMember(owner = "com.jagex.client!tc", name = "O", descriptor = "I")
	private int anInt6163 = 3072;

	@OriginalMember(owner = "com.jagex.client!tc", name = "R", descriptor = "I")
	private int anInt6165 = 1024;

	@OriginalMember(owner = "com.jagex.client!tc", name = "S", descriptor = "I")
	private int anInt6166 = 2048;

	@OriginalMember(owner = "com.jagex.client!tc", name = "<init>", descriptor = "()V")
	public TextureOpRange() {
		super(1, false);
	}

	@OriginalMember(owner = "com.jagex.client!tc", name = "b", descriptor = "(IB)[[I")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!tc", name = "a", descriptor = "(ILclient!bt;I)V")
	@Override
	public void decode(@OriginalArg(0) int code, @OriginalArg(1) Packet buf) {
		if (code == 0) {
			this.anInt6165 = buf.g2();
		} else if (code == 1) {
			this.anInt6163 = buf.g2();
		} else if (code == 2) {
			super.monochrome = buf.g1() == 1;
		}
	}

	@OriginalMember(owner = "com.jagex.client!tc", name = "d", descriptor = "(I)V")
	@Override
	public void postDecode() {
		this.anInt6166 = this.anInt6163 - this.anInt6165;
	}

	@OriginalMember(owner = "com.jagex.client!tc", name = "a", descriptor = "(BI)[I")
	@Override
