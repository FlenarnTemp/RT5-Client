...
public final class Static322 {
	...
	@OriginalMember(owner = "com.jagex.client!so", name = "m", descriptor = "[I")
	public static int[] anIntArray404;

	@OriginalMember(owner = "com.jagex.client!so", name = "k", descriptor = "Lclient!gd;")
	...
	@OriginalMember(owner = "com.jagex.client!so", name = "a", descriptor = "(III)V")
	...
	@OriginalMember(owner = "com.jagex.client!so", name = "a", descriptor = "(ZIIIIIIII)Z")
