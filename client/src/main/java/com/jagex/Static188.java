...
public final class Static188 {
	...
	@OriginalMember(owner = "com.jagex.client!kr", name = "F", descriptor = "Lclient!r;")
	public static Js5 aClass197_52;

	@OriginalMember(owner = "com.jagex.client!kr", name = "H", descriptor = "[I")
	public static final int[] anIntArray206 = new int[] { 160, 192, 80, 96, 0, 144, 80, 48, 160 };

	@OriginalMember(owner = "com.jagex.client!kr", name = "a", descriptor = "(IIILjava/lang/Class;)V")
	...
	@OriginalMember(owner = "com.jagex.client!kr", name = "a", descriptor = "([SZII[Ljava/lang/String;)V")
