...
@OriginalClass("com.jagex.client!uj")
public final class Class130_Sub4 extends BitmapFont {

	@OriginalMember(owner = "com.jagex.client!uj", name = "z", descriptor = "Lclient!j;")
	private final Class19_Sub2 aClass19_Sub2_10;

	@OriginalMember(owner = "com.jagex.client!uj", name = "v", descriptor = "[I")
	private final int[] anIntArray452;

	@OriginalMember(owner = "com.jagex.client!uj", name = "u", descriptor = "[I")
	private final int[] anIntArray451;

	@OriginalMember(owner = "com.jagex.client!uj", name = "w", descriptor = "[[B")
	private final byte[][] aByteArrayArray21;

	@OriginalMember(owner = "com.jagex.client!uj", name = "x", descriptor = "[I")
	private final int[] anIntArray453;

	@OriginalMember(owner = "com.jagex.client!uj", name = "y", descriptor = "[I")
	private final int[] anIntArray454;

	@OriginalMember(owner = "com.jagex.client!uj", name = "<init>", descriptor = "(Lclient!j;Lclient!vi;[Lclient!dk;[I[I)V")
	public Class130_Sub4(@OriginalArg(0) Class19_Sub2 arg0, @OriginalArg(1) Class239 arg1, @OriginalArg(2) SpriteData[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int[] arg4) {
		super(arg0, arg1);
	...
	@OriginalMember(owner = "com.jagex.client!uj", name = "a", descriptor = "(CIIIZ)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!uj", name = "a", descriptor = "([B[IIIIIIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!uj", name = "a", descriptor = "([B[IIIIIIIIIIILclient!kf;II)V")
	...
	@OriginalMember(owner = "com.jagex.client!uj", name = "b", descriptor = "([B[IIIIIIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!uj", name = "b", descriptor = "([B[IIIIIIIIIIILclient!kf;II)V")
	...
	@OriginalMember(owner = "com.jagex.client!uj", name = "a", descriptor = "(CIIIZLclient!kf;II)V")
	@Override
