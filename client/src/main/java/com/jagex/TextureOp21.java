...
@OriginalClass("com.jagex.client!il")
public final class TextureOp21 extends TextureOp {

	@OriginalMember(owner = "com.jagex.client!il", name = "<init>", descriptor = "()V")
	public TextureOp21() {
		super(3, false);
	}

	@OriginalMember(owner = "com.jagex.client!il", name = "a", descriptor = "(ILclient!bt;I)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!il", name = "a", descriptor = "(BI)[I")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!il", name = "b", descriptor = "(IB)[[I")
	@Override
