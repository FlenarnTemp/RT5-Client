...
public final class Static226 {
	...
	@OriginalMember(owner = "com.jagex.client!na", name = "X", descriptor = "Lclient!gd;")
	...
	@OriginalMember(owner = "com.jagex.client!na", name = "Z", descriptor = "[Ljava/lang/String;")
	public static final String[] aStringArray35 = new String[100];

	@OriginalMember(owner = "com.jagex.client!na", name = "f", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!na", name = "b", descriptor = "(II)V")
	public static void method3983(@OriginalArg(0) int arg0) {
		@Pc(10) DelayedStateChange local10 = Static316.method5413(1, arg0);
		local10.method2312();
	}

	@OriginalMember(owner = "com.jagex.client!na", name = "a", descriptor = "([Ljava/lang/Object;[II)V")
