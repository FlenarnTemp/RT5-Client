...
@OriginalClass("com.jagex.client!ib")
public final class AnimBase extends Node {

	@OriginalMember(owner = "com.jagex.client!ib", name = "v", descriptor = "I")
	public final int id;

	@OriginalMember(owner = "com.jagex.client!ib", name = "A", descriptor = "I")
	public final int transforms;

	@OriginalMember(owner = "com.jagex.client!ib", name = "x", descriptor = "[I")
	public final int[] parts;

	@OriginalMember(owner = "com.jagex.client!ib", name = "s", descriptor = "[Z")
	public final boolean[] shadow;

	@OriginalMember(owner = "com.jagex.client!ib", name = "w", descriptor = "[[I")
	public final int[][] bones;

	@OriginalMember(owner = "com.jagex.client!ib", name = "t", descriptor = "[I")
	public final int[] types;

	@OriginalMember(owner = "com.jagex.client!ib", name = "<init>", descriptor = "(I[B)V")
