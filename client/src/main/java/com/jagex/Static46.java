...
public final class Static46 {
	...
	@OriginalMember(owner = "com.jagex.client!cm", name = "i", descriptor = "Z")
	public static boolean aBoolean100 = false;

	@OriginalMember(owner = "com.jagex.client!cm", name = "c", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!cm", name = "a", descriptor = "(ILclient!wm;Lclient!nk;)V")
	public static void method1422(@OriginalArg(1) Renderer arg0, @OriginalArg(2) Component arg1) {
	...
	@OriginalMember(owner = "com.jagex.client!cm", name = "a", descriptor = "(III)Z")
