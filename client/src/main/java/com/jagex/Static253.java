...
public final class Static253 {
	...
	@OriginalMember(owner = "com.jagex.client!oj", name = "c", descriptor = "I")
	public static int anInt4689;

	@OriginalMember(owner = "com.jagex.client!oj", name = "a", descriptor = "()V")
	...
	@OriginalMember(owner = "com.jagex.client!oj", name = "a", descriptor = "(IIB)I")
	...
	@OriginalMember(owner = "com.jagex.client!oj", name = "b", descriptor = "(I)V")
