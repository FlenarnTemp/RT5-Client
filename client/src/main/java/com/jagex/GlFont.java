...
@OriginalClass("com.jagex.client!ko")
public final class GlFont extends BitmapFont {

	@OriginalMember(owner = "com.jagex.client!ko", name = "w", descriptor = "Lclient!bf;")
	private final Class19_Sub1 aClass19_Sub1_19;

	@OriginalMember(owner = "com.jagex.client!ko", name = "v", descriptor = "Lclient!ln;")
	private final Class8_Sub1_Sub1 aClass8_Sub1_Sub1_3;

	@OriginalMember(owner = "com.jagex.client!ko", name = "u", descriptor = "Z")
	private final boolean aBoolean228;

	@OriginalMember(owner = "com.jagex.client!ko", name = "x", descriptor = "Lclient!rj;")
	private final Class203 aClass203_3;

	@OriginalMember(owner = "com.jagex.client!ko", name = "<init>", descriptor = "(Lclient!bf;Lclient!vi;[Lclient!dk;Z)V")
	public GlFont(@OriginalArg(0) Class19_Sub1 arg0, @OriginalArg(1) Class239 arg1, @OriginalArg(2) SpriteData[] arg2, @OriginalArg(3) boolean arg3) {
		super(arg0, arg1);
		...
		for (local13 = 0; local13 < 256; local13++) {
			@Pc(20) SpriteData local20 = arg2[local13];
		...
		for (@Pc(49) int local49 = 0; local49 < 256; local49++) {
			@Pc(56) SpriteData local56 = arg2[local49];
		...
		for (@Pc(303) int local303 = 0; local303 < 256; local303++) {
			@Pc(310) SpriteData local310 = arg2[local303];
	...
	@OriginalMember(owner = "com.jagex.client!ko", name = "a", descriptor = "(CIIIZLclient!kf;II)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!ko", name = "a", descriptor = "(CIIIZ)V")
	@Override
