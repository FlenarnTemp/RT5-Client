...
public final class Static386 {
	...
	@OriginalMember(owner = "com.jagex.client!wj", name = "b", descriptor = "[[S")
	...
	@OriginalMember(owner = "com.jagex.client!wj", name = "c", descriptor = "I")
	public static int anInt6737 = 0;

	@OriginalMember(owner = "com.jagex.client!wj", name = "a", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!wj", name = "a", descriptor = "(Z)V")
