...
@OriginalClass("com.jagex.client!ub")
public final class TextureOpTexture extends TextureOp {

	@OriginalMember(owner = "com.jagex.client!ub", name = "O", descriptor = "I")
	private int anInt6433;

	@OriginalMember(owner = "com.jagex.client!ub", name = "Q", descriptor = "I")
	private int anInt6435;

	@OriginalMember(owner = "com.jagex.client!ub", name = "T", descriptor = "[I")
	private int[] anIntArray435;

	@OriginalMember(owner = "com.jagex.client!ub", name = "R", descriptor = "I")
	private int anInt6436 = -1;

	@OriginalMember(owner = "com.jagex.client!ub", name = "<init>", descriptor = "()V")
	public TextureOpTexture() {
		super(0, false);
	}

	@OriginalMember(owner = "com.jagex.client!ub", name = "a", descriptor = "(IIB)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!ub", name = "b", descriptor = "(Z)I")
	@Override
	public int method6482() {
		return this.anInt6436;
	}

	@OriginalMember(owner = "com.jagex.client!ub", name = "b", descriptor = "(I)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!ub", name = "b", descriptor = "(IB)[[I")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!ub", name = "a", descriptor = "(ILclient!bt;I)V")
	@Override
	public void decode(@OriginalArg(0) int code, @OriginalArg(1) Packet buf) {
		if (code == 0) {
			this.anInt6436 = buf.g2();
		}
	}
}
