...
@OriginalClass("com.jagex.client!no")
public final class Class130_Sub2 extends BitmapFont {

	@OriginalMember(owner = "com.jagex.client!no", name = "z", descriptor = "Lclient!j;")
	private Class19_Sub2 aClass19_Sub2_7;

	@OriginalMember(owner = "com.jagex.client!no", name = "u", descriptor = "[I")
	private int[] anIntArray286;

	@OriginalMember(owner = "com.jagex.client!no", name = "v", descriptor = "[I")
	private int[] anIntArray287;

	@OriginalMember(owner = "com.jagex.client!no", name = "w", descriptor = "[[B")
	private byte[][] aByteArrayArray10;

	@OriginalMember(owner = "com.jagex.client!no", name = "y", descriptor = "[I")
	private int[] anIntArray289;

	@OriginalMember(owner = "com.jagex.client!no", name = "x", descriptor = "[I")
	private int[] anIntArray288;

	protected Class130_Sub2(Renderer arg0, Class239 arg1) {
		super(arg0, arg1);
	}

	@OriginalMember(owner = "com.jagex.client!no", name = "a", descriptor = "(CIIIZ)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!no", name = "a", descriptor = "(CIIIZLclient!kf;II)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!no", name = "a", descriptor = "([B[IIIIIIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!no", name = "a", descriptor = "([B[IIIIIIIIIIILclient!kf;II)V")
