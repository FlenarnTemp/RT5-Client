...
public final class Static216 {
	...
	@OriginalMember(owner = "com.jagex.client!mm", name = "c", descriptor = "[I")
	public static final int[] anIntArray231 = new int[3];

	@OriginalMember(owner = "com.jagex.client!mm", name = "f", descriptor = "I")
	public static int anInt3798 = 0;

	@OriginalMember(owner = "com.jagex.client!mm", name = "a", descriptor = "(IIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!mm", name = "a", descriptor = "(ILclient!nk;ILclient!wm;IILclient!kf;II)V")
	public static void method3776(@OriginalArg(0) int arg0, @OriginalArg(1) Component arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Renderer arg3, @OriginalArg(4) int arg4, @OriginalArg(6) Class78 arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7) {
		@Pc(14) MapElementType local14 = client.MelTypes.get(arg2);
		...
		if (local14.anIntArray290 != null) {
			...
			for (local34 = 0; local34 < local32.length / 2; local34++) {
				if (Camera.cameraType == 4) {
					local44 = (int) Camera.yaw & 0x3FFF;
				} else {
					local44 = (int) Camera.yaw + Static6.anInt158 & 0x3FFF;
				}
				@Pc(58) int local58 = Renderer.anIntArray178[local44];
				@Pc(62) int local62 = Renderer.anIntArray177[local44];
				if (Camera.cameraType != 4) {
		...
		if (local14.textSize == 1) {
			local303 = Static165.aClass239_3;
			local301 = Static276.aClass130_4;
		}
		if (local14.textSize == 2) {
			local301 = Static52.aClass130_1;
			local303 = Static113.aClass239_2;
		}
		Static164.method3147(arg0, arg4, arg7, local14.anInt4431, arg6, local34, local301, local303, arg5, local14.text, arg1);
		return;
	}
