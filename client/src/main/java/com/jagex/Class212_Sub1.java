...
@OriginalClass("com.jagex.client!st")
public final class Class212_Sub1 extends Class212 {

	@OriginalMember(owner = "com.jagex.client!st", name = "g", descriptor = "Ljava/nio/ByteBuffer;")
	private ByteBuffer aByteBuffer5;

	@OriginalMember(owner = "com.jagex.client!st", name = "a", descriptor = "([BZ)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!st", name = "a", descriptor = "(B)[B")
	@Override
