...
@OriginalClass("com.jagex.client!wf")
public final class ReflectionCheck extends Node {

	@OriginalMember(owner = "com.jagex.client!tk", name = "b", descriptor = "Lclient!ld;")
	public static LinkedList queue = new LinkedList();
	@OriginalMember(owner = "com.jagex.client!wf", name = "t", descriptor = "I")
	public int size;

	@OriginalMember(owner = "com.jagex.client!wf", name = "v", descriptor = "[Lclient!cc;")
	public PrivilegedRequest[] fieldRequests;

	@OriginalMember(owner = "com.jagex.client!wf", name = "w", descriptor = "[I")
	public int[] errors;

	@OriginalMember(owner = "com.jagex.client!wf", name = "x", descriptor = "[Lclient!cc;")
	public PrivilegedRequest[] methodRequests;

	@OriginalMember(owner = "com.jagex.client!wf", name = "y", descriptor = "[I")
	public int[] fieldValues;

	@OriginalMember(owner = "com.jagex.client!wf", name = "z", descriptor = "[I")
	public int[] types;

	@OriginalMember(owner = "com.jagex.client!wf", name = "A", descriptor = "I")
	public int id;

	@OriginalMember(owner = "com.jagex.client!wf", name = "C", descriptor = "[[[B")
	public byte[][][] methodArguments;

	@OriginalMember(owner = "com.jagex.client!ad", name = "a", descriptor = "(ILclient!qg;I)V")
	...
	@OriginalMember(owner = "com.jagex.client!nj", name = "a", descriptor = "(Lclient!ml;IILclient!bt;)V")
