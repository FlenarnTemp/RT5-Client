...
@OriginalClass("com.jagex.client!br")
public final class TextureOpColorEdgeDetector extends TextureOp {

	@OriginalMember(owner = "com.jagex.client!br", name = "O", descriptor = "Z")
	private boolean aBoolean71 = true;

	@OriginalMember(owner = "com.jagex.client!br", name = "N", descriptor = "I")
	private int anInt796 = 4096;

	@OriginalMember(owner = "com.jagex.client!br", name = "<init>", descriptor = "()V")
	public TextureOpColorEdgeDetector() {
		super(1, false);
	}

	@OriginalMember(owner = "com.jagex.client!br", name = "a", descriptor = "(ILclient!bt;I)V")
	@Override
	public void decode(@OriginalArg(0) int code, @OriginalArg(1) Packet buf) {
		if (code == 0) {
			this.anInt796 = buf.g2();
		} else if (code == 1) {
			this.aBoolean71 = buf.g1() == 1;
		}
	}

	@OriginalMember(owner = "com.jagex.client!br", name = "b", descriptor = "(IB)[[I")
	@Override
