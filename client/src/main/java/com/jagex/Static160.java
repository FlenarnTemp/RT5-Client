...
public final class Static160 {
	...
	@OriginalMember(owner = "com.jagex.client!jf", name = "q", descriptor = "[I")
	public static int[] anIntArray185;

	@OriginalMember(owner = "com.jagex.client!jf", name = "f", descriptor = "Z")
	public static boolean showocc = false;

	@OriginalMember(owner = "com.jagex.client!jf", name = "r", descriptor = "[I")
	public static final int[] anIntArray186 = new int[500];

	@OriginalMember(owner = "com.jagex.client!jf", name = "a", descriptor = "(Z)Z")
	...
	@OriginalMember(owner = "com.jagex.client!jf", name = "a", descriptor = "(CB)Z")
	...
	@OriginalMember(owner = "com.jagex.client!jf", name = "a", descriptor = "(Ljava/awt/Canvas;Lclient!ml;ILclient!ci;II)Lclient!wm;")
	public static Renderer method2955(@OriginalArg(0) Canvas arg0, @OriginalArg(1) Signlink arg1, @OriginalArg(3) TextureProviderInterface arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4) {
		try {
			@Pc(6) Class local6 = Class.forName("com.jagex.Class19_Sub1");
			...
			return (Renderer) local58.newInstance(arg0, arg2, Integer.valueOf(arg4), new Integer(arg3), arg1);
		} catch (@Pc(91) Exception local91) {
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "com.jagex.client!jf", name = "b", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!jf", name = "a", descriptor = "(II)V")
