...
public final class Static250 {
	...
	@OriginalMember(owner = "com.jagex.client!og", name = "b", descriptor = "Lclient!bc;")
	public static final Class16 aClass16_6 = new Class16("", 12);

	@OriginalMember(owner = "com.jagex.client!og", name = "a", descriptor = "(IZLclient!mr;IIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!og", name = "b", descriptor = "(IB)V")
