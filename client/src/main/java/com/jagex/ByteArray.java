...
public class ByteArray {
	...
	@OriginalMember(owner = "com.jagex.client!it", name = "a", descriptor = "(BZLjava/lang/Object;)[B")
	...
	@OriginalMember(owner = "com.jagex.client!ae", name = "a", descriptor = "(IZ[B)Ljava/lang/Object;")
	public static Object wrap(@OriginalArg(2) byte[] arg0) {
		...
		if (arg0.length > 136 && !Static141.aBoolean189) {
			try {
				@Pc(18) Class212 local18 = (Class212) Class.forName("com.jagex.Class212_Sub1").getDeclaredConstructor().newInstance();
