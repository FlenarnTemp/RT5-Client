...
@OriginalClass("com.jagex.client!pq")
public final class Class184 implements Interface1 {

	@OriginalMember(owner = "com.jagex.client!pq", name = "h", descriptor = "I")
	private int anInt5069 = -1;

	@OriginalMember(owner = "com.jagex.client!pq", name = "c", descriptor = "Lclient!bf;")
	private final Class19_Sub1 aClass19_Sub1_30;

	@OriginalMember(owner = "com.jagex.client!pq", name = "e", descriptor = "I")
	public final int anInt5067;

	@OriginalMember(owner = "com.jagex.client!pq", name = "b", descriptor = "I")
	public final int anInt5065;

	@OriginalMember(owner = "com.jagex.client!pq", name = "d", descriptor = "I")
	private final int anInt5066;

	@OriginalMember(owner = "com.jagex.client!pq", name = "f", descriptor = "I")
	private int anInt5068;

	@OriginalMember(owner = "com.jagex.client!pq", name = "a", descriptor = "I")
	private final int anInt5064;

	@OriginalMember(owner = "com.jagex.client!pq", name = "<init>", descriptor = "(Lclient!bf;III)V")
	...
	@OriginalMember(owner = "com.jagex.client!pq", name = "finalize", descriptor = "()V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!pq", name = "a", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!pq", name = "a", descriptor = "()V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!pq", name = "b", descriptor = "()V")
