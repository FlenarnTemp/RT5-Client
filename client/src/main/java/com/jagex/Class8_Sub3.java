...
@OriginalClass("com.jagex.client!qd")
public final class Class8_Sub3 extends Class8 {

	@OriginalMember(owner = "com.jagex.client!qd", name = "j", descriptor = "I")
	private int anInt5168;

	@OriginalMember(owner = "com.jagex.client!qd", name = "i", descriptor = "I")
	public final int anInt5167;

	@OriginalMember(owner = "com.jagex.client!qd", name = "<init>", descriptor = "(Lclient!bf;II)V")
	...
	@OriginalMember(owner = "com.jagex.client!qd", name = "<init>", descriptor = "(Lclient!bf;IIZ[[BI)V")
	...
	@OriginalMember(owner = "com.jagex.client!qd", name = "<init>", descriptor = "(Lclient!bf;IIZ[[I)V")
	...
	@OriginalMember(owner = "com.jagex.client!qd", name = "a", descriptor = "()V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!qd", name = "a", descriptor = "(III)V")
