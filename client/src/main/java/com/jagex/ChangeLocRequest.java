...
@OriginalClass("com.jagex.client!ug")
public final class ChangeLocRequest extends Node {

	@OriginalMember(owner = "com.jagex.client!ug", name = "s", descriptor = "I")
	public int anInt6479;

	@OriginalMember(owner = "com.jagex.client!ug", name = "t", descriptor = "I")
	public int anInt6480;

	@OriginalMember(owner = "com.jagex.client!ug", name = "u", descriptor = "I")
	public int anInt6481;

	@OriginalMember(owner = "com.jagex.client!ug", name = "v", descriptor = "I")
	public int anInt6482;

	@OriginalMember(owner = "com.jagex.client!ug", name = "y", descriptor = "I")
	public int anInt6484;

	@OriginalMember(owner = "com.jagex.client!ug", name = "A", descriptor = "I")
	public int anInt6486;

	@OriginalMember(owner = "com.jagex.client!ug", name = "F", descriptor = "I")
	public int anInt6491;

	@OriginalMember(owner = "com.jagex.client!ug", name = "G", descriptor = "I")
	public int anInt6492;

	@OriginalMember(owner = "com.jagex.client!ug", name = "H", descriptor = "I")
	public int anInt6493;

	@OriginalMember(owner = "com.jagex.client!ug", name = "I", descriptor = "I")
	public int anInt6494;

	@OriginalMember(owner = "com.jagex.client!ug", name = "C", descriptor = "I")
	public int anInt6488 = 0;

	@OriginalMember(owner = "com.jagex.client!ug", name = "z", descriptor = "I")
	...
	@OriginalMember(owner = "com.jagex.client!rr", name = "b", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!bl", name = "a", descriptor = "(IIIIIIIIII)V")
