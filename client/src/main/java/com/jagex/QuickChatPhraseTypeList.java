...
public class QuickChatPhraseTypeList {
	...
	@OriginalMember(owner = "com.jagex.client!hq", name = "C", descriptor = "Lclient!r;")
	public static Js5 aClass197_33;
	@OriginalMember(owner = "com.jagex.client!sr", name = "a", descriptor = "Lclient!o;")
	public static Interface9 anInterface9_1 = null;
	@OriginalMember(owner = "com.jagex.client!rr", name = "x", descriptor = "Lclient!r;")
	public static Js5 aClass197_80;
	@OriginalMember(owner = "com.jagex.client!be", name = "k", descriptor = "I")
	public static int anInt554 = 0;
	@OriginalMember(owner = "com.jagex.client!vc", name = "d", descriptor = "I")
	public static int anInt6769 = 0;

	@OriginalMember(owner = "com.jagex.client!sr", name = "a", descriptor = "(Lclient!o;Lclient!r;Lclient!r;B)V")
	...
	@OriginalMember(owner = "com.jagex.client!ih", name = "a", descriptor = "(BI)Lclient!tb;")
	public static QuickChatPhraseType get(@OriginalArg(1) int arg0) {
		...
		@Pc(28) byte[] local28;
		if (arg0 < 32768) {
			local28 = aClass197_33.getfile(arg0, 1);
		} else {
			local28 = aClass197_80.getfile(arg0 & 0x7FFF, 1);
		}
	...
	@OriginalMember(owner = "com.jagex.client!tq", name = "a", descriptor = "(I[IIJ)Ljava/lang/String;")
