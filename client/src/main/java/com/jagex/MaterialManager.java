...
@OriginalClass("com.jagex.client!hm")
public final class MaterialManager {

	@OriginalMember(owner = "com.jagex.client!hm", name = "c", descriptor = "I")
	private int anInt2490 = 0;

	@OriginalMember(owner = "com.jagex.client!hm", name = "d", descriptor = "I")
	private int anInt2491 = 0;

	@OriginalMember(owner = "com.jagex.client!hm", name = "f", descriptor = "Lclient!kq;")
	private Class8 aClass8_1 = null;

	@OriginalMember(owner = "com.jagex.client!hm", name = "b", descriptor = "Lclient!bf;")
	private final Class19_Sub1 aClass19_Sub1_14;

	@OriginalMember(owner = "com.jagex.client!hm", name = "e", descriptor = "Lclient!fs;")
	private final Class76 aClass76_3;

	@OriginalMember(owner = "com.jagex.client!hm", name = "a", descriptor = "[Lclient!cd;")
	private final MaterialRenderer[] renderers;

	@OriginalMember(owner = "com.jagex.client!hm", name = "<init>", descriptor = "(Lclient!bf;)V")
	...
	@OriginalMember(owner = "com.jagex.client!hm", name = "a", descriptor = "(IZI)V")
	...
	@OriginalMember(owner = "com.jagex.client!hm", name = "a", descriptor = "(ZIZI)V")
	...
	@OriginalMember(owner = "com.jagex.client!hm", name = "a", descriptor = "(IZ)Z")
	public boolean method2506() {
		return this.renderers[3].method5711();
	}

	@OriginalMember(owner = "com.jagex.client!hm", name = "a", descriptor = "(Lclient!kq;I)Z")
