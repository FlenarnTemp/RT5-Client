...
public final class Static389 {
	...
	@OriginalMember(owner = "com.jagex.client!wo", name = "J", descriptor = "I")
	public static int anInt4896 = 0;

	@OriginalMember(owner = "com.jagex.client!wo", name = "a", descriptor = "(IIIIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!wo", name = "b", descriptor = "(I)V")
