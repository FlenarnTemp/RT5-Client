...
@OriginalClass("com.jagex.client!mq")
public final class Js5MasterIndex {

	@OriginalMember(owner = "com.jagex.client!mq", name = "h", descriptor = "Lclient!bt;")
	private Packet buffer;

	@OriginalMember(owner = "com.jagex.client!mq", name = "j", descriptor = "[Lclient!bl;")
	private Js5CachedResourceProvider[] resourceProviders;

	@OriginalMember(owner = "com.jagex.client!mq", name = "f", descriptor = "Lclient!ro;")
	private final Js5CacheQueue cacheQueue;

	@OriginalMember(owner = "com.jagex.client!mq", name = "b", descriptor = "Lclient!pp;")
	private final Js5NetQueue netQueue;

	@OriginalMember(owner = "com.jagex.client!mq", name = "a", descriptor = "Lclient!jj;")
	private Js5NetRequest request;

	@OriginalMember(owner = "com.jagex.client!mq", name = "<init>", descriptor = "(Lclient!pp;Lclient!ro;)V")
	...
	@OriginalMember(owner = "com.jagex.client!mq", name = "a", descriptor = "(ILclient!rq;ILclient!rq;)Lclient!bl;")
	...
	@OriginalMember(owner = "com.jagex.client!mq", name = "a", descriptor = "(B)Z")
	...
	@OriginalMember(owner = "com.jagex.client!mq", name = "a", descriptor = "(IZLclient!rq;Lclient!rq;I)Lclient!bl;")
	...
	@OriginalMember(owner = "com.jagex.client!mq", name = "c", descriptor = "(B)V")
