...
public final class Static193 {
	...
	@OriginalMember(owner = "com.jagex.client!la", name = "k", descriptor = "I")
	public static int anInt3556;

	@OriginalMember(owner = "com.jagex.client!la", name = "f", descriptor = "Lclient!gd;")
	...
	@OriginalMember(owner = "com.jagex.client!la", name = "j", descriptor = "I")
	public static int messageCounter = 0;

	@OriginalMember(owner = "com.jagex.client!la", name = "l", descriptor = "I")
	public static int anInt3557 = 0;

	@OriginalMember(owner = "com.jagex.client!la", name = "a", descriptor = "(II[BIII)Z")
			...
			while (true) {
				...
				while (!local33) {
					...
					if (local82 > 0 && local86 > 0 && local82 < arg4 - 1 && arg3 - 1 > local86) {
						...
						if (local78 != 22 || client.preferences.groundDecoration || local112.active != 0 || local112.blockwalk == 1 || local112.forcedecor) {
	...
	@OriginalMember(owner = "com.jagex.client!la", name = "a", descriptor = "(ILclient!wm;Lclient!ur;ZIII)V")
	public static void method3512(@OriginalArg(0) int arg0, @OriginalArg(1) Renderer arg1, @OriginalArg(2) BitmapFont arg2, @OriginalArg(3) boolean arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
		if (arg3) {
