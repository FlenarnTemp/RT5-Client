...
@OriginalClass("com.jagex.client!t")
public final class Class2_Sub36 extends Node {

	@OriginalMember(owner = "com.jagex.client!t", name = "t", descriptor = "Lclient!kj;")
	private Class126 aClass126_14;

	@OriginalMember(owner = "com.jagex.client!t", name = "B", descriptor = "Ljava/nio/ByteBuffer;")
	private ByteBuffer aByteBuffer6;

	@OriginalMember(owner = "com.jagex.client!t", name = "z", descriptor = "Lclient!ah;")
	private final Class6_Sub1 aClass6_Sub1_3;

	@OriginalMember(owner = "com.jagex.client!t", name = "v", descriptor = "I")
	public final int anInt6097;

	@OriginalMember(owner = "com.jagex.client!t", name = "A", descriptor = "I")
	public final int anInt6098;

	@OriginalMember(owner = "com.jagex.client!t", name = "s", descriptor = "I")
	public final int anInt6095;

	@OriginalMember(owner = "com.jagex.client!t", name = "u", descriptor = "I")
	public final int anInt6096;

	@OriginalMember(owner = "com.jagex.client!t", name = "w", descriptor = "F")
	public final float aFloat75;

	@OriginalMember(owner = "com.jagex.client!t", name = "C", descriptor = "Lclient!bf;")
	private final Class19_Sub1 aClass19_Sub1_34;

	@OriginalMember(owner = "com.jagex.client!t", name = "x", descriptor = "[I")
	private final int[] anIntArray415;

	@OriginalMember(owner = "com.jagex.client!t", name = "y", descriptor = "Lclient!ve;")
	private final Class180_Sub2 aClass180_Sub2_1;

	@OriginalMember(owner = "com.jagex.client!t", name = "<init>", descriptor = "(Lclient!ah;IIIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!t", name = "a", descriptor = "(FIIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!t", name = "b", descriptor = "(IB)V")
	public void method5565(@OriginalArg(0) int arg0) {
		this.aByteBuffer6 = ByteBuffer.allocateDirect(arg0 * 4);
	}

	@OriginalMember(owner = "com.jagex.client!t", name = "a", descriptor = "(II)V")
	...
	@OriginalMember(owner = "com.jagex.client!t", name = "a", descriptor = "(IIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!t", name = "a", descriptor = "(IZ)V")
	public void method5568(@OriginalArg(0) int arg0) {
		this.aByteBuffer6.position(arg0 * 4 + 3);
		this.aByteBuffer6.put((byte) -1);
	}

	@OriginalMember(owner = "com.jagex.client!t", name = "a", descriptor = "([IZI)V")
