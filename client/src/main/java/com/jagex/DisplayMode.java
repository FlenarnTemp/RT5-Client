...
@OriginalClass("com.jagex.client!oi")
public final class DisplayMode {

	@OriginalMember(owner = "com.jagex.client!oi", name = "b", descriptor = "I")
	public int anInt4682;

	@OriginalMember(owner = "com.jagex.client!oi", name = "d", descriptor = "I")
	public int height;

	@OriginalMember(owner = "com.jagex.client!oi", name = "e", descriptor = "I")
	public int width;

	@OriginalMember(owner = "com.jagex.client!oi", name = "g", descriptor = "I")
	public int anInt4687;

	@OriginalMember(owner = "com.jagex.client!ib", name = "a", descriptor = "(IIBZI)V")
	...
	@OriginalMember(owner = "com.jagex.client!dn", name = "a", descriptor = "(B)[Lclient!oi;")
	...
	@OriginalMember(owner = "com.jagex.client!ie", name = "a", descriptor = "(B)I")
