...
public final class Static337 {
	...
	@OriginalMember(owner = "com.jagex.client!tk", name = "e", descriptor = "Lclient!jd;")
	public static Sprite aClass13_17;

	@OriginalMember(owner = "com.jagex.client!tk", name = "g", descriptor = "I")
	public static int anInt6317;

	@OriginalMember(owner = "com.jagex.client!tk", name = "b", descriptor = "(I)V")
