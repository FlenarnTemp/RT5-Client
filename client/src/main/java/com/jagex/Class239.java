...
@OriginalClass("com.jagex.client!vi")
public final class Class239 {

	@OriginalMember(owner = "com.jagex.client!vi", name = "a", descriptor = "[B")
	private final byte[] aByteArray98;

	@OriginalMember(owner = "com.jagex.client!vi", name = "n", descriptor = "[[B")
	private byte[][] aByteArrayArray22;

	@OriginalMember(owner = "com.jagex.client!vi", name = "h", descriptor = "I")
	public final int anInt6841;

	@OriginalMember(owner = "com.jagex.client!vi", name = "c", descriptor = "I")
	public final int anInt6836;

	@OriginalMember(owner = "com.jagex.client!vi", name = "m", descriptor = "I")
	...
	@OriginalMember(owner = "com.jagex.client!vi", name = "<init>", descriptor = "([B)V")
	...
	@OriginalMember(owner = "com.jagex.client!vi", name = "a", descriptor = "(I[Ljava/lang/String;Ljava/lang/String;[I[Lclient!jd;)I")
			...
			if (local48 == 60) {
				...
				if (local29 == -1) {
					...
					if (local77.equals("lt")) {
						...
						try {
							@Pc(286) int local286 = StringUtils.parseInt(local77.substring(4));
							local31 = -1;
	...
	@OriginalMember(owner = "com.jagex.client!vi", name = "a", descriptor = "(ILjava/lang/String;B[Lclient!jd;I)I")
	...
	@OriginalMember(owner = "com.jagex.client!vi", name = "a", descriptor = "(II)I")
	public int method6122(@OriginalArg(1) int arg0) {
		return this.aByteArray98[arg0] & 0xFF;
	}

	@OriginalMember(owner = "com.jagex.client!vi", name = "a", descriptor = "(BLjava/lang/String;I[Lclient!jd;)I")
	...
	@OriginalMember(owner = "com.jagex.client!vi", name = "a", descriptor = "([Lclient!jd;Ljava/lang/String;BI)I")
	...
	@OriginalMember(owner = "com.jagex.client!vi", name = "a", descriptor = "(IIC)I")
	...
	@OriginalMember(owner = "com.jagex.client!vi", name = "a", descriptor = "(Ljava/lang/String;I)I")
	public int method6126(@OriginalArg(0) String arg0) {
		return this.method6127(null, arg0);
	}

	@OriginalMember(owner = "com.jagex.client!vi", name = "a", descriptor = "([Lclient!jd;ZLjava/lang/String;)I")
					...
					if (local58.equals("lt")) {
						...
						if (!local58.equals("reg")) {
							if (local58.startsWith("img=") && arg0 != null) {
								try {
									@Pc(118) int local118 = StringUtils.parseInt(local58.substring(4));
