...
@OriginalClass("com.jagex.client!od")
public final class MidiPcmStream extends PcmStream {

	@OriginalMember(owner = "com.jagex.client!od", name = "Lb", descriptor = "I")
	private int anInt4565;

	@OriginalMember(owner = "com.jagex.client!od", name = "Mb", descriptor = "I")
	private int anInt4566;

	@OriginalMember(owner = "com.jagex.client!od", name = "Nb", descriptor = "J")
	private long aLong135;

	@OriginalMember(owner = "com.jagex.client!od", name = "Ob", descriptor = "Z")
	private boolean aBoolean314;

	@OriginalMember(owner = "com.jagex.client!od", name = "Pb", descriptor = "J")
	private long aLong136;

	@OriginalMember(owner = "com.jagex.client!od", name = "Qb", descriptor = "Lclient!sl;")
	private Song aClass2_Sub34_2;

	@OriginalMember(owner = "com.jagex.client!od", name = "Rb", descriptor = "I")
	private int anInt4567;

	@OriginalMember(owner = "com.jagex.client!od", name = "Sb", descriptor = "Z")
	private boolean aBoolean315;

	@OriginalMember(owner = "com.jagex.client!od", name = "w", descriptor = "[I")
	private final int[] anIntArray295 = new int[16];

	@OriginalMember(owner = "com.jagex.client!od", name = "x", descriptor = "[I")
	private final int[] anIntArray296 = new int[16];

	@OriginalMember(owner = "com.jagex.client!od", name = "C", descriptor = "[I")
	public final int[] anIntArray297 = new int[16];

	@OriginalMember(owner = "com.jagex.client!od", name = "I", descriptor = "[[Lclient!ej;")
	private final MidiNote[][] aClass2_Sub11ArrayArray2 = new MidiNote[16][128];

	@OriginalMember(owner = "com.jagex.client!od", name = "S", descriptor = "[I")
	public final int[] anIntArray300 = new int[16];

	@OriginalMember(owner = "com.jagex.client!od", name = "A", descriptor = "[[Lclient!ej;")
	private final MidiNote[][] aClass2_Sub11ArrayArray1 = new MidiNote[16][128];

	@OriginalMember(owner = "com.jagex.client!od", name = "kb", descriptor = "I")
	private int anInt4548 = 256;

	@OriginalMember(owner = "com.jagex.client!od", name = "F", descriptor = "[I")
	private final int[] anIntArray298 = new int[16];

	@OriginalMember(owner = "com.jagex.client!od", name = "qb", descriptor = "[I")
	private final int[] anIntArray305 = new int[16];

	@OriginalMember(owner = "com.jagex.client!od", name = "hb", descriptor = "[I")
	private final int[] anIntArray303 = new int[16];

	@OriginalMember(owner = "com.jagex.client!od", name = "Q", descriptor = "[I")
	private final int[] anIntArray299 = new int[16];

	@OriginalMember(owner = "com.jagex.client!od", name = "pb", descriptor = "[I")
	private final int[] anIntArray304 = new int[16];

	@OriginalMember(owner = "com.jagex.client!od", name = "gb", descriptor = "[I")
	private final int[] anIntArray302 = new int[16];

	@OriginalMember(owner = "com.jagex.client!od", name = "Y", descriptor = "I")
	private final int anInt4540 = 1000000;

	@OriginalMember(owner = "com.jagex.client!od", name = "U", descriptor = "[I")
	private final int[] anIntArray301 = new int[16];

	@OriginalMember(owner = "com.jagex.client!od", name = "yb", descriptor = "[I")
	private final int[] anIntArray307 = new int[16];

	@OriginalMember(owner = "com.jagex.client!od", name = "zb", descriptor = "[I")
	public final int[] anIntArray308 = new int[16];

	@OriginalMember(owner = "com.jagex.client!od", name = "Db", descriptor = "[I")
	private final int[] anIntArray309 = new int[16];

	@OriginalMember(owner = "com.jagex.client!od", name = "tb", descriptor = "[I")
	private final int[] anIntArray306 = new int[16];

	@OriginalMember(owner = "com.jagex.client!od", name = "Jb", descriptor = "[I")
	private final int[] anIntArray310 = new int[16];

	@OriginalMember(owner = "com.jagex.client!od", name = "vb", descriptor = "Lclient!jp;")
	private final Class118 aClass118_1 = new Class118();

	@OriginalMember(owner = "com.jagex.client!od", name = "Kb", descriptor = "Lclient!ff;")
	private final MidiNoteStream nodeStream = new MidiNoteStream(this);

	@OriginalMember(owner = "com.jagex.client!od", name = "cb", descriptor = "Lclient!ad;")
	private final HashTable instruments = new HashTable(128);

	@OriginalMember(owner = "com.jagex.client!od", name = "<init>", descriptor = "()V")
	public MidiPcmStream() {
		this.method4301();
		this.reset(true);
	}

	@OriginalMember(owner = "com.jagex.client!od", name = "b", descriptor = "(B)Z")
	public synchronized boolean isValid() {
		return this.aClass118_1.method3199();
	}

	@OriginalMember(owner = "com.jagex.client!od", name = "c", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!od", name = "a", descriptor = "()Lclient!ll;")
	@Override
	public synchronized PcmStream nextSubStream() {
		return null;
	}

	@OriginalMember(owner = "com.jagex.client!od", name = "a", descriptor = "(IZLclient!ej;)V")
	...
	@OriginalMember(owner = "com.jagex.client!od", name = "a", descriptor = "(Lclient!sl;ZI)V")
	public synchronized void method4273(@OriginalArg(0) Song arg0, @OriginalArg(1) boolean arg1) {
		this.method4283(true, arg1, arg0);
	}

	@OriginalMember(owner = "com.jagex.client!od", name = "c", descriptor = "(B)V")
	public synchronized void method4274() {
		this.method4293(true);
	}

	@OriginalMember(owner = "com.jagex.client!od", name = "a", descriptor = "(BLclient!ej;)Z")
	...
	@OriginalMember(owner = "com.jagex.client!od", name = "d", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!od", name = "a", descriptor = "(IZI[ILclient!ej;)Z")
	...
	@OriginalMember(owner = "com.jagex.client!od", name = "a", descriptor = "(II)V")
	public synchronized void setVolume(@OriginalArg(0) int arg0) {
		this.anInt4548 = arg0;
	}

	@OriginalMember(owner = "com.jagex.client!od", name = "a", descriptor = "(ZIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!od", name = "a", descriptor = "(Lclient!bk;Lclient!sl;Lclient!r;II)Z")
	public synchronized boolean method4281(@OriginalArg(0) SoundBank arg0, @OriginalArg(1) Song arg1, @OriginalArg(2) Js5 arg2) {
		...
		for (@Pc(34) ByteArrayNode local34 = (ByteArrayNode) arg1.programs.head(); local34 != null; local34 = (ByteArrayNode) arg1.programs.next()) {
			...
			if (local48 == null) {
				...
				this.instruments.pushNode(local48, (long) local40);
			}
	...
	@OriginalMember(owner = "com.jagex.client!od", name = "a", descriptor = "(IBI)V")
	private void method4282(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		this.anIntArray299[arg1] = arg0;
	}

	@OriginalMember(owner = "com.jagex.client!od", name = "b", descriptor = "(I)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!od", name = "a", descriptor = "([III)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!od", name = "a", descriptor = "(BZZLclient!sl;)V")
	...
	@OriginalMember(owner = "com.jagex.client!od", name = "a", descriptor = "(IZII)V")
	private void method4284(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
	}

	@OriginalMember(owner = "com.jagex.client!od", name = "b", descriptor = "(III)V")
	private void method4285(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	}

	@OriginalMember(owner = "com.jagex.client!od", name = "b", descriptor = "(IB)V")
	...
	@OriginalMember(owner = "com.jagex.client!od", name = "a", descriptor = "(IZ)V")
	...
	@OriginalMember(owner = "com.jagex.client!od", name = "a", descriptor = "(ZI)V")
	...
	@OriginalMember(owner = "com.jagex.client!od", name = "e", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!od", name = "b", descriptor = "(II)V")
	...
	@OriginalMember(owner = "com.jagex.client!od", name = "a", descriptor = "(IIB)V")
	...
	@OriginalMember(owner = "com.jagex.client!od", name = "a", descriptor = "(Lclient!ej;I)I")
	...
	@OriginalMember(owner = "com.jagex.client!od", name = "a", descriptor = "(BZ)V")
	...
	@OriginalMember(owner = "com.jagex.client!od", name = "b", descriptor = "(Lclient!ej;I)I")
	...
	@OriginalMember(owner = "com.jagex.client!od", name = "c", descriptor = "(IB)V")
	...
	@OriginalMember(owner = "com.jagex.client!od", name = "b", descriptor = "(IIB)V")
	public synchronized void init() {
		this.method4304();
	}

	@OriginalMember(owner = "com.jagex.client!od", name = "b", descriptor = "(IZ)V")
	...
	@OriginalMember(owner = "com.jagex.client!od", name = "d", descriptor = "()Lclient!ll;")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!od", name = "a", descriptor = "(ILclient!ej;)I")
	...
	@OriginalMember(owner = "com.jagex.client!od", name = "a", descriptor = "(IBII)V")
	...
	@OriginalMember(owner = "com.jagex.client!od", name = "c", descriptor = "(III)V")
	...
	@OriginalMember(owner = "com.jagex.client!od", name = "g", descriptor = "(I)I")
	public int getVolume() {
		return this.anInt4548;
	}

	@OriginalMember(owner = "com.jagex.client!od", name = "a", descriptor = "(BII)V")
	...
	@OriginalMember(owner = "com.jagex.client!od", name = "a", descriptor = "(BI)V")
	...
	@OriginalMember(owner = "com.jagex.client!od", name = "d", descriptor = "(III)V")
