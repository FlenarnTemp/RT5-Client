...
public final class Static342 {
	...
	@OriginalMember(owner = "com.jagex.client!tr", name = "f", descriptor = "I")
	public static int anInt5657;

	@OriginalMember(owner = "com.jagex.client!tr", name = "b", descriptor = "I")
	public static int anInt5655 = 0;

	@OriginalMember(owner = "com.jagex.client!tr", name = "g", descriptor = "[[I")
	...
	@OriginalMember(owner = "com.jagex.client!tr", name = "a", descriptor = "(ILjava/lang/String;)V")
