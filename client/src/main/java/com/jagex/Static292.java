...
public final class Static292 {
	...
	@OriginalMember(owner = "com.jagex.client!qr", name = "q", descriptor = "Lclient!jd;")
	public static Sprite aClass13_15;

	@OriginalMember(owner = "com.jagex.client!qr", name = "r", descriptor = "I")
	public static int anInt5512;

	@OriginalMember(owner = "com.jagex.client!qr", name = "m", descriptor = "[J")
	public static final long[] aLongArray9 = new long[32];

	@OriginalMember(owner = "com.jagex.client!qr", name = "p", descriptor = "[S")
	public static final short[] aShortArray115 = new short[] { 44, 19, 48, 47, 9, 23, 2, 18 };

	@OriginalMember(owner = "com.jagex.client!qr", name = "a", descriptor = "(IIIBII)V")
	...
	@OriginalMember(owner = "com.jagex.client!qr", name = "a", descriptor = "(Lclient!ci;BLclient!r;)V")
