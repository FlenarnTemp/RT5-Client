...
public class WordPack {
	...
	@OriginalMember(owner = "com.jagex.client!th", name = "a", descriptor = "(ILclient!lo;)V")
	public static void init(@OriginalArg(1) HuffmanCodec arg0) {
		Static370.aClass140_1 = arg0;
	}

	@OriginalMember(owner = "com.jagex.client!gs", name = "a", descriptor = "(Ljava/lang/String;ILclient!bt;)I")
