...
public final class Static131 {
	...
	@OriginalMember(owner = "com.jagex.client!hi", name = "d", descriptor = "Lclient!cm;")
	public static Class36 aClass36_4;

	@OriginalMember(owner = "com.jagex.client!hi", name = "a", descriptor = "Lclient!gd;")
	public static final LocalizedString aClass79_82 = new LocalizedString("Please wait...", "Bitte warte...", "Veuillez patienter...", "Aguarde...");

	@OriginalMember(owner = "com.jagex.client!hi", name = "c", descriptor = "[S")
