...
public final class Static148 {
	...
	@OriginalMember(owner = "com.jagex.client!ij", name = "a", descriptor = "[I")
	public static final int[] anIntArray172 = new int[] { 0, -1, 0, 1 };

	@OriginalMember(owner = "com.jagex.client!ij", name = "j", descriptor = "Z")
	public static boolean shiftClickMod = false;

	@OriginalMember(owner = "com.jagex.client!ij", name = "a", descriptor = "(B)V")
	...
	@OriginalMember(owner = "com.jagex.client!ij", name = "a", descriptor = "(IIIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!ij", name = "a", descriptor = "(IIII)I")
