...
@OriginalClass("com.jagex.client!sq")
public final class IsaacRandom {

	@OriginalMember(owner = "com.jagex.client!sq", name = "a", descriptor = "[I")
	private final int[] mem = new int[256];

	@OriginalMember(owner = "com.jagex.client!sq", name = "e", descriptor = "I")
	private int a;

	@OriginalMember(owner = "com.jagex.client!sq", name = "l", descriptor = "I")
	private int b;

	@OriginalMember(owner = "com.jagex.client!sq", name = "m", descriptor = "[I")
	private final int[] rsl = new int[256];

	@OriginalMember(owner = "com.jagex.client!sq", name = "o", descriptor = "I")
	private int c;

	@OriginalMember(owner = "com.jagex.client!sq", name = "p", descriptor = "I")
	private int count;

	@OriginalMember(owner = "com.jagex.client!sq", name = "<init>", descriptor = "([I)V")
	...
	@OriginalMember(owner = "com.jagex.client!sq", name = "a", descriptor = "(I)I")
	public int peekNext() {
		if (this.count == 0) {
			this.isaac();
			this.count = 256;
	...
	@OriginalMember(owner = "com.jagex.client!sq", name = "a", descriptor = "(B)I")
	public int getNext() {
		if (this.count == 0) {
			this.isaac();
			this.count = 256;
...
//		this.count--;
	...
	@OriginalMember(owner = "com.jagex.client!sq", name = "b", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!sq", name = "c", descriptor = "(I)V")
	private void isaac() {
		this.b += ++this.c;
