...
public final class Static295 {
	...
	@OriginalMember(owner = "com.jagex.client!r", name = "H", descriptor = "Lclient!ld;")
	public static final LinkedList aClass135_32 = new LinkedList();

	@OriginalMember(owner = "com.jagex.client!r", name = "O", descriptor = "[I")
	public static final int[] anIntArray375 = new int[] { 1, 2, 4, 8 };

	@OriginalMember(owner = "com.jagex.client!r", name = "g", descriptor = "(B)V")
	...
	@OriginalMember(owner = "com.jagex.client!r", name = "c", descriptor = "(III)I")
	...
	@OriginalMember(owner = "com.jagex.client!r", name = "b", descriptor = "(IB)Lclient!js;")
	public static Class2_Sub2_Sub11 method5100(@OriginalArg(0) int arg0) {
		...
		@Pc(25) byte[] local25 = client.jsArchive12.getfile(0, arg0);
