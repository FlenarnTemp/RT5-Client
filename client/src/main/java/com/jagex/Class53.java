...
@OriginalClass("com.jagex.client!dt")
public final class Class53 implements Interface7 {

	@OriginalMember(owner = "com.jagex.client!dt", name = "b", descriptor = "I")
	public int anInt1639;

	@OriginalMember(owner = "com.jagex.client!dt", name = "c", descriptor = "I")
	public int anInt1640;

	@OriginalMember(owner = "com.jagex.client!dt", name = "d", descriptor = "I")
	public int anInt1641;

	@OriginalMember(owner = "com.jagex.client!dt", name = "e", descriptor = "I")
	public int anInt1642;

	@OriginalMember(owner = "com.jagex.client!dt", name = "g", descriptor = "Z")
	public boolean aBoolean128;

	@OriginalMember(owner = "com.jagex.client!dt", name = "h", descriptor = "I")
	public int anInt1644;

	@OriginalMember(owner = "com.jagex.client!dt", name = "i", descriptor = "I")
	public int anInt1645;

	@OriginalMember(owner = "com.jagex.client!dt", name = "a", descriptor = "(BLclient!iq;)Z")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!dt", name = "a", descriptor = "(I)J")
	@Override
	public long method1779() {
		@Pc(5) long[] local5 = Packet.CRC64_TABLE;
		@Pc(7) long local7 = -1L;
