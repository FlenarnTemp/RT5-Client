...
@OriginalClass("com.jagex.client!pd")
public final class Class173_Sub2 extends Class173 {

	@OriginalMember(owner = "com.jagex.client!pd", name = "r", descriptor = "I")
	private final int anInt4853;

	@OriginalMember(owner = "com.jagex.client!pd", name = "t", descriptor = "I")
	private final int anInt4855;

	@OriginalMember(owner = "com.jagex.client!pd", name = "l", descriptor = "I")
	private final int anInt4849;

	@OriginalMember(owner = "com.jagex.client!pd", name = "n", descriptor = "I")
	private final int anInt4850;

	@OriginalMember(owner = "com.jagex.client!pd", name = "<init>", descriptor = "(IIIIIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!pd", name = "a", descriptor = "(III)V")
	@Override
	public void method6250(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
	}

	@OriginalMember(owner = "com.jagex.client!pd", name = "b", descriptor = "(III)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!pd", name = "a", descriptor = "(IBI)V")
	@Override
