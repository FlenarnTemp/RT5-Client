...
public final class Static97 {
	...
	@OriginalMember(owner = "com.jagex.client!fk", name = "Z", descriptor = "I")
	public static int anInt2034;

	@OriginalMember(owner = "com.jagex.client!fk", name = "Ab", descriptor = "I")
	public static int anInt2052;

	@OriginalMember(owner = "com.jagex.client!fk", name = "c", descriptor = "I")
	public static int anInt2005 = 0;

	@OriginalMember(owner = "com.jagex.client!fk", name = "lb", descriptor = "I")
	public static int anInt2040 = -50;

	@OriginalMember(owner = "com.jagex.client!fk", name = "a", descriptor = "(I[Ljava/lang/String;)[Ljava/lang/String;")
	...
	@OriginalMember(owner = "com.jagex.client!fk", name = "a", descriptor = "(IIIIIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!fk", name = "a", descriptor = "(Lclient!ag;BLclient!ag;)V")
