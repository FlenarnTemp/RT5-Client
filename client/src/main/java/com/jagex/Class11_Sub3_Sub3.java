...
@OriginalClass("com.jagex.client!to")
public final class Class11_Sub3_Sub3 extends Class11_Sub3 implements Interface6 {

	@OriginalMember(owner = "com.jagex.client!to", name = "t", descriptor = "Lclient!ql;")
	public final Class192 aClass192_3;

	@OriginalMember(owner = "com.jagex.client!to", name = "A", descriptor = "Z")
	private final boolean aBoolean428;

	@OriginalMember(owner = "com.jagex.client!to", name = "<init>", descriptor = "(Lclient!wm;Lclient!ct;IIIIIZIIIIII)V")
	public Class11_Sub3_Sub3(@OriginalArg(0) Renderer arg0, @OriginalArg(1) LocType arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) boolean arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) int arg12, @OriginalArg(13) int arg13) {
		...
		this.aBoolean428 = arg1.active != 0 && !arg7;
	}

	@OriginalMember(owner = "com.jagex.client!to", name = "a", descriptor = "(IIBLclient!wm;)Z")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!to", name = "a", descriptor = "(Z)Z")
	@Override
	public boolean method6086() {
		return this.aClass192_3.method4938();
	}

	@OriginalMember(owner = "com.jagex.client!to", name = "a", descriptor = "(I)I")
	@Override
	public int method6081() {
		return this.aClass192_3.anInt5433;
	}

	@OriginalMember(owner = "com.jagex.client!to", name = "b", descriptor = "(I)V")
	@Override
	public void method6082() {
	}

	@OriginalMember(owner = "com.jagex.client!to", name = "d", descriptor = "(I)I")
	@Override
	public int method6085() {
		return this.aClass192_3.anInt5432;
	}

	@OriginalMember(owner = "com.jagex.client!to", name = "h", descriptor = "(I)I")
	@Override
	public int method5748() {
		return this.aClass192_3.method4936();
	}

	@OriginalMember(owner = "com.jagex.client!to", name = "a", descriptor = "(ILclient!wm;I)Lclient!gn;")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!to", name = "a", descriptor = "(Lclient!wm;I)V")
	@Override
	public void method6083(@OriginalArg(0) Renderer arg0) {
		this.aClass192_3.method4940(arg0);
	}

	@OriginalMember(owner = "com.jagex.client!to", name = "b", descriptor = "(Lclient!wm;B)Lclient!nf;")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!to", name = "c", descriptor = "(I)I")
	@Override
	public int method6084() {
		return this.aClass192_3.anInt5429;
	}

	@OriginalMember(owner = "com.jagex.client!to", name = "a", descriptor = "(BLclient!wm;)V")
	@Override
	public void method6087(@OriginalArg(1) Renderer arg0) {
		this.aClass192_3.method4930(arg0);
	}

	@OriginalMember(owner = "com.jagex.client!to", name = "a", descriptor = "(Lclient!wm;B)V")
	@Override
