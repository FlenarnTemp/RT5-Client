...
public final class Static57 {
	...
	@OriginalMember(owner = "com.jagex.client!df", name = "b", descriptor = "I")
	public static int anInt1464;

	@OriginalMember(owner = "com.jagex.client!df", name = "g", descriptor = "[Lclient!nk;")
	public static Component[] aClass161Array1;

	@OriginalMember(owner = "com.jagex.client!df", name = "e", descriptor = "[I")
	public static final int[] anIntArray104 = new int[] { 1, -1, -1, 1 };

	@OriginalMember(owner = "com.jagex.client!df", name = "f", descriptor = "Z")
	public static boolean aBoolean124 = false;

	@OriginalMember(owner = "com.jagex.client!df", name = "a", descriptor = "(Lclient!kb;III[Z)Z")
	...
	@OriginalMember(owner = "com.jagex.client!df", name = "a", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!df", name = "a", descriptor = "(IIIIII)V")
