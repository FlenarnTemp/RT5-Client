...
@OriginalClass("com.jagex.client!qm")
public final class Texture extends SecondaryNode {

	@OriginalMember(owner = "com.jagex.client!gg", name = "B", descriptor = "[I")
	public static final int[] brightnessMap = new int[256];
	@OriginalMember(owner = "com.jagex.client!oq", name = "w", descriptor = "Lclient!ci;")
	public static TextureProviderInterface provider;
	@OriginalMember(owner = "com.jagex.client!ge", name = "e", descriptor = "Lclient!r;")
	public static Js5 spritesArchive;
	@OriginalMember(owner = "com.jagex.client!nb", name = "F", descriptor = "I")
	public static int width;
	@OriginalMember(owner = "com.jagex.client!th", name = "t", descriptor = "[I")
	public static int[] widthFractions;
	@OriginalMember(owner = "com.jagex.client!ed", name = "x", descriptor = "I")
	public static int anInt1721;
	@OriginalMember(owner = "com.jagex.client!rf", name = "db", descriptor = "I")
	public static int anInt5653;
	@OriginalMember(owner = "com.jagex.client!bh", name = "o", descriptor = "I")
	public static int height;
	@OriginalMember(owner = "com.jagex.client!as", name = "a", descriptor = "[I")
	public static int[] heightFractions;
	@OriginalMember(owner = "com.jagex.client!ij", name = "b", descriptor = "I")
	public static int heightMask;
	@OriginalMember(owner = "com.jagex.client!qm", name = "I", descriptor = "[I")
	private final int[] anIntArray370;

	@OriginalMember(owner = "com.jagex.client!qm", name = "L", descriptor = "[I")
	private final int[] anIntArray371;

	@OriginalMember(owner = "com.jagex.client!qm", name = "D", descriptor = "Lclient!jq;")
	private final TextureOp textureOp3;

	@OriginalMember(owner = "com.jagex.client!qm", name = "K", descriptor = "Lclient!jq;")
	private final TextureOp textureOp1;

	@OriginalMember(owner = "com.jagex.client!qm", name = "C", descriptor = "Lclient!jq;")
	private final TextureOp textureOp2;

	@OriginalMember(owner = "com.jagex.client!qm", name = "F", descriptor = "[Lclient!jq;")
	private final TextureOp[] textureOps;

	@OriginalMember(owner = "com.jagex.client!qm", name = "<init>", descriptor = "(Lclient!bt;)V")
	...
	@OriginalMember(owner = "com.jagex.client!it", name = "a", descriptor = "(IIB)V")
	...
	@OriginalMember(owner = "com.jagex.client!ad", name = "a", descriptor = "(DI)V")
	...
	@OriginalMember(owner = "com.jagex.client!qm", name = "a", descriptor = "(ZLclient!r;Lclient!ci;ZII)[F")
	...
	@OriginalMember(owner = "com.jagex.client!qm", name = "a", descriptor = "(ILclient!ci;Lclient!r;)Z")
	public boolean method4957(@OriginalArg(1) TextureProviderInterface arg0, @OriginalArg(2) Js5 arg1) {
		...
		if (Static123.anInt2421 >= 0) {
			for (local9 = 0; local9 < this.anIntArray371.length; local9++) {
				if (!arg1.requestDownload(Static123.anInt2421, this.anIntArray371[local9])) {
					return false;
				}
			}
		} else {
			for (local9 = 0; local9 < this.anIntArray371.length; local9++) {
				if (!arg1.requestDownload(this.anIntArray371[local9])) {
					return false;
				}
			}
		}
	...
	@OriginalMember(owner = "com.jagex.client!qm", name = "a", descriptor = "(ZDIILclient!r;ZILclient!ci;)[I")
	...
	@OriginalMember(owner = "com.jagex.client!qm", name = "a", descriptor = "(Lclient!ci;Lclient!r;DIZII)[I")
