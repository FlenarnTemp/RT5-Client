...
@OriginalClass("com.jagex.client!kt")
public final class TextureOpColorGradient extends TextureOp {

	@OriginalMember(owner = "com.jagex.client!kt", name = "ab", descriptor = "[[I")
	private int[][] anIntArrayArray26;

	@OriginalMember(owner = "com.jagex.client!kt", name = "P", descriptor = "[I")
	private final int[] anIntArray207 = new int[257];

	@OriginalMember(owner = "com.jagex.client!kt", name = "<init>", descriptor = "()V")
	public TextureOpColorGradient() {
		super(1, false);
	}

	@OriginalMember(owner = "com.jagex.client!kt", name = "d", descriptor = "(I)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!kt", name = "b", descriptor = "(IB)[[I")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!kt", name = "a", descriptor = "(ILclient!bt;I)V")
	@Override
	public void decode(@OriginalArg(0) int code, @OriginalArg(1) Packet buf) {
		if (code != 0) {
			return;
		}
		@Pc(10) int local10 = buf.g1();
		if (local10 != 0) {
			this.method3503(local10);
			return;
		}
		this.anIntArrayArray26 = new int[buf.g1()][4];
		for (@Pc(21) int local21 = 0; local21 < this.anIntArrayArray26.length; local21++) {
			this.anIntArrayArray26[local21][0] = buf.g2();
			this.anIntArrayArray26[local21][1] = buf.g1() << 4;
			this.anIntArrayArray26[local21][2] = buf.g1() << 4;
			this.anIntArrayArray26[local21][3] = buf.g1() << 4;
		}
	}

	@OriginalMember(owner = "com.jagex.client!kt", name = "c", descriptor = "(IB)V")
	...
	@OriginalMember(owner = "com.jagex.client!kt", name = "c", descriptor = "(Z)V")
