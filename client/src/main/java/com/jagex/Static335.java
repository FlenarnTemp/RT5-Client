...
public final class Static335 {
	...
	@OriginalMember(owner = "com.jagex.client!ti", name = "r", descriptor = "Lclient!hu;")
	public static final LruHashTable aClass98_57 = new LruHashTable(200);

	@OriginalMember(owner = "com.jagex.client!ti", name = "L", descriptor = "[B")
	public static final byte[] aByteArray92 = new byte[2048];

	@OriginalMember(owner = "com.jagex.client!ti", name = "a", descriptor = "(B)V")
