...
public final class Static297 {
	...
	@OriginalMember(owner = "com.jagex.client!rb", name = "k", descriptor = "Lclient!hu;")
	public static final LruHashTable aClass98_44 = new LruHashTable(8);

	@OriginalMember(owner = "com.jagex.client!rb", name = "o", descriptor = "[I")
	public static final int[] anIntArray383 = new int[] { 2, 1, 1, 1, 2, 2, 2, 1, 3, 3, 3, 2, 0, 4, 0 };

	@OriginalMember(owner = "com.jagex.client!rb", name = "a", descriptor = "(IIIIIII)Lclient!rc;")
	...
	@OriginalMember(owner = "com.jagex.client!rb", name = "a", descriptor = "(II)Z")
	...
	@OriginalMember(owner = "com.jagex.client!rb", name = "a", descriptor = "(BLclient!mr;)V")
