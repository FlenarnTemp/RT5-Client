...
@OriginalClass("com.jagex.client!ir")
public final class MillisTimer extends Timer {

	@OriginalMember(owner = "com.jagex.client!ir", name = "h", descriptor = "I")
	private int anInt2798 = 1;

	@OriginalMember(owner = "com.jagex.client!ir", name = "k", descriptor = "[J")
	private final long[] aLongArray3 = new long[10];

	@OriginalMember(owner = "com.jagex.client!ir", name = "i", descriptor = "J")
	private long aLong87 = 0L;

	@OriginalMember(owner = "com.jagex.client!ir", name = "j", descriptor = "J")
	private long aLong88 = 0L;

	@OriginalMember(owner = "com.jagex.client!ir", name = "l", descriptor = "I")
	private int anInt2799 = 0;

	@OriginalMember(owner = "com.jagex.client!ir", name = "g", descriptor = "J")
	private long aLong86 = 0L;

	@OriginalMember(owner = "com.jagex.client!ir", name = "a", descriptor = "(I)J")
	@Override
	public long method4405() {
		return this.aLong87;
	}

	@OriginalMember(owner = "com.jagex.client!ir", name = "c", descriptor = "(I)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!ir", name = "a", descriptor = "(ZI)I")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!ir", name = "a", descriptor = "(Z)J")
