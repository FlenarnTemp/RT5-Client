...
public final class Static119 {
	...
	@OriginalMember(owner = "com.jagex.client!gr", name = "e", descriptor = "Lclient!jd;")
	public static Sprite aClass13_7;

	@OriginalMember(owner = "com.jagex.client!gr", name = "f", descriptor = "Lclient!bh;")
	public static Environment aClass21_1;

	@OriginalMember(owner = "com.jagex.client!gr", name = "h", descriptor = "Lclient!hu;")
	public static final LruHashTable aClass98_16 = new LruHashTable(64);

	@OriginalMember(owner = "com.jagex.client!gr", name = "j", descriptor = "[I")
	public static final int[] anIntArray152 = new int[] { 16, 32, 64, 128 };

	@OriginalMember(owner = "com.jagex.client!gr", name = "a", descriptor = "(IIIIIII)V")
