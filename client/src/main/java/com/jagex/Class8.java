...
@OriginalClass("com.jagex.client!kq")
public abstract class Class8 implements Interface1 {

	@OriginalMember(owner = "com.jagex.client!kq", name = "f", descriptor = "Z")
	private boolean aBoolean468 = false;

	@OriginalMember(owner = "com.jagex.client!kq", name = "g", descriptor = "Lclient!bf;")
	protected final Class19_Sub1 aClass19_Sub1_40;

	@OriginalMember(owner = "com.jagex.client!kq", name = "c", descriptor = "I")
	public final int anInt6882;

	@OriginalMember(owner = "com.jagex.client!kq", name = "d", descriptor = "I")
	protected final int anInt6883;

	@OriginalMember(owner = "com.jagex.client!kq", name = "a", descriptor = "Z")
	private boolean aBoolean467;

	@OriginalMember(owner = "com.jagex.client!kq", name = "h", descriptor = "I")
	private final int anInt6884;

	@OriginalMember(owner = "com.jagex.client!kq", name = "b", descriptor = "I")
	protected int anInt6881;

	@OriginalMember(owner = "com.jagex.client!kq", name = "<init>", descriptor = "(Lclient!bf;IIIZ)V")
	...
	@OriginalMember(owner = "com.jagex.client!kq", name = "a", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!kq", name = "b", descriptor = "()V")
	...
	@OriginalMember(owner = "com.jagex.client!kq", name = "d", descriptor = "()Z")
	...
	@OriginalMember(owner = "com.jagex.client!kq", name = "a", descriptor = "(Z)V")
	...
	@OriginalMember(owner = "com.jagex.client!kq", name = "e", descriptor = "()V")
	...
	@OriginalMember(owner = "com.jagex.client!kq", name = "f", descriptor = "()I")
	...
	@OriginalMember(owner = "com.jagex.client!kq", name = "finalize", descriptor = "()V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!kq", name = "b", descriptor = "(Z)V")
