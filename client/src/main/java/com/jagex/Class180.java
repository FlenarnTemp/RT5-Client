...
@OriginalClass("com.jagex.client!ul")
public class Class180 {

	@OriginalMember(owner = "com.jagex.client!ul", name = "a", descriptor = "Lclient!bf;")
	protected final Class19_Sub1 aClass19_Sub1_39;

	@OriginalMember(owner = "com.jagex.client!ul", name = "b", descriptor = "Ljava/nio/ByteBuffer;")
	protected ByteBuffer aByteBuffer7;

	@OriginalMember(owner = "com.jagex.client!ul", name = "<init>", descriptor = "(Lclient!bf;[BI)V")
	...
	@OriginalMember(owner = "com.jagex.client!ul", name = "<init>", descriptor = "(Lclient!bf;Ljava/nio/ByteBuffer;)V")
	protected Class180(@OriginalArg(0) Class19_Sub1 arg0, @OriginalArg(1) ByteBuffer arg1) {
		this.aClass19_Sub1_39 = arg0;
		this.aByteBuffer7 = arg1;
	}

	@OriginalMember(owner = "com.jagex.client!ul", name = "a", descriptor = "([BI)V")
