...
public final class Static33 {
	...
	@OriginalMember(owner = "com.jagex.client!bs", name = "u", descriptor = "I")
	public static int anInt4463;

	@OriginalMember(owner = "com.jagex.client!bs", name = "q", descriptor = "Lclient!gd;")
	public static final LocalizedString aClass79_96 = new LocalizedString("level: ", "Stufe: ", "niveau ", "nível: ");

	@OriginalMember(owner = "com.jagex.client!bs", name = "t", descriptor = "I")
	public static int anInt4462 = -1;

	@OriginalMember(owner = "com.jagex.client!bs", name = "a", descriptor = "(ILjava/lang/String;ILjava/lang/String;ILjava/lang/String;)V")
	...
	@OriginalMember(owner = "com.jagex.client!bs", name = "b", descriptor = "(I)I")
		...
		if (Cs1ScriptRunner.aClass161_14 == null) {
			if (!Static375.aBoolean477 && Static268.anInt4959 > 0) {
				if (Static148.shiftClickMod && Keyboard.instance.isPressed(81) && Static268.anInt4959 > 2) {
					return ((Class2_Sub5) Static129.aClass135_19.aClass2_130.next.next).anInt1007;
				}
				return ((Class2_Sub5) Static129.aClass135_19.aClass2_130.next).anInt1007;
			}
	...
	@OriginalMember(owner = "com.jagex.client!bs", name = "a", descriptor = "(BI)V")
	...
	@OriginalMember(owner = "com.jagex.client!bs", name = "a", descriptor = "(IIIIIII)I")
	...
	@OriginalMember(owner = "com.jagex.client!bs", name = "d", descriptor = "(I)V")
