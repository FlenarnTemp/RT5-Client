...
@OriginalClass("com.jagex.client!jm")
public final class Class116 {

	@OriginalMember(owner = "com.jagex.client!jm", name = "f", descriptor = "Lclient!tl;")
	private SecondaryNode aClass2_Sub2_32 = new SecondaryNode();

	@OriginalMember(owner = "com.jagex.client!jm", name = "q", descriptor = "Lclient!wc;")
	private final SecondaryLinkedList aClass246_3 = new SecondaryLinkedList();

	@OriginalMember(owner = "com.jagex.client!jm", name = "m", descriptor = "I")
	private final int anInt3150;

	@OriginalMember(owner = "com.jagex.client!jm", name = "o", descriptor = "I")
	private int anInt3151;

	@OriginalMember(owner = "com.jagex.client!jm", name = "n", descriptor = "Lclient!ad;")
	private final HashTable aClass4_69;

	@OriginalMember(owner = "com.jagex.client!jm", name = "<init>", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!jm", name = "b", descriptor = "(B)V")
	...
	@OriginalMember(owner = "com.jagex.client!jm", name = "a", descriptor = "(BLclient!tl;J)V")
	public void method3155(@OriginalArg(1) SecondaryNode arg0, @OriginalArg(2) long arg1) {
		...
		this.aClass4_69.pushNode(arg0, arg1);
