...
@OriginalClass("com.jagex.client!w")
public final class Class2_Sub38_Sub1 extends Class2_Sub38 {

	@OriginalMember(owner = "com.jagex.client!w", name = "u", descriptor = "Lclient!oa;")
	private Class166 aClass166_1;

	@OriginalMember(owner = "com.jagex.client!w", name = "x", descriptor = "Lclient!ua;")
	private Class228 aClass228_3;

	@OriginalMember(owner = "com.jagex.client!w", name = "y", descriptor = "Lclient!ua;")
	private Class228 aClass228_4;

	@OriginalMember(owner = "com.jagex.client!w", name = "z", descriptor = "Lclient!oa;")
	private Class166 aClass166_2;

	@OriginalMember(owner = "com.jagex.client!w", name = "A", descriptor = "I")
	private int anInt7068;

	@OriginalMember(owner = "com.jagex.client!w", name = "B", descriptor = "Lclient!al;")
	private Class8_Sub1 aClass8_Sub1_6;

	@OriginalMember(owner = "com.jagex.client!w", name = "C", descriptor = "Lclient!oa;")
	private Class166 aClass166_3;

	@OriginalMember(owner = "com.jagex.client!w", name = "D", descriptor = "I")
	private int anInt7069;

	@OriginalMember(owner = "com.jagex.client!w", name = "E", descriptor = "Lclient!oa;")
	private Class166 aClass166_4;

	@OriginalMember(owner = "com.jagex.client!w", name = "F", descriptor = "I")
	private int anInt7070;

	@OriginalMember(owner = "com.jagex.client!w", name = "G", descriptor = "[Lclient!al;")
	private Class8_Sub1[] aClass8_Sub1Array4;

	@OriginalMember(owner = "com.jagex.client!w", name = "H", descriptor = "Lclient!al;")
	private Class8_Sub1 aClass8_Sub1_7;

	@OriginalMember(owner = "com.jagex.client!w", name = "I", descriptor = "I")
	private int anInt7071;

	@OriginalMember(owner = "com.jagex.client!w", name = "<init>", descriptor = "(Lclient!bf;)V")
	public Class2_Sub38_Sub1(@OriginalArg(0) Class19_Sub1 arg0) {
		super(arg0);
	}

	@OriginalMember(owner = "com.jagex.client!w", name = "d", descriptor = "()Z")
	@Override
	public boolean method6308() {
		return this.aClass228_4 != null;
	}

	@OriginalMember(owner = "com.jagex.client!w", name = "a", descriptor = "(II)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!w", name = "b", descriptor = "()I")
	@Override
	public int method6301() {
		return 1;
	}

	@OriginalMember(owner = "com.jagex.client!w", name = "a", descriptor = "()Z")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!w", name = "c", descriptor = "()V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!w", name = "e", descriptor = "()Z")
	...
	@OriginalMember(owner = "com.jagex.client!w", name = "c", descriptor = "(I)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!w", name = "a", descriptor = "(ILclient!al;Lclient!al;)V")
	@Override
