...
public final class Static25 {
	...
	@OriginalMember(owner = "com.jagex.client!bi", name = "i", descriptor = "I")
	public static int anInt648;

	@OriginalMember(owner = "com.jagex.client!bi", name = "a", descriptor = "I")
	public static int anInt643 = -1;

	@OriginalMember(owner = "com.jagex.client!bi", name = "d", descriptor = "Ljava/lang/String;")
	public static String aString9 = "";

	@OriginalMember(owner = "com.jagex.client!bi", name = "f", descriptor = "[S")
	public static final short[] aShortArray4 = new short[] { 960, 957, -21568, -21571, 22464 };

	@OriginalMember(owner = "com.jagex.client!bi", name = "j", descriptor = "[I")
	public static final int[] anIntArray33 = new int[] { 2, 2, 4, 2, 1, 8, 4, 1, 4, 4, 2, 1, 1, 1, 4, 1 };

	@OriginalMember(owner = "com.jagex.client!bi", name = "k", descriptor = "[[S")
	...
	@OriginalMember(owner = "com.jagex.client!bi", name = "a", descriptor = "(ILclient!tf;)V")
	public static void method858(@OriginalArg(0) int arg0, @OriginalArg(1) Class6 arg1) {
		Scene.aClass6Array4[arg0] = arg1;
	}

	@OriginalMember(owner = "com.jagex.client!bi", name = "a", descriptor = "(Ljava/lang/String;I)I")
	...
	@OriginalMember(owner = "com.jagex.client!bi", name = "a", descriptor = "(IIII)I")
