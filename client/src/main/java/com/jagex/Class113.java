...
@OriginalClass("com.jagex.client!je")
public final class Class113 {

	@OriginalMember(owner = "com.jagex.client!je", name = "g", descriptor = "[I")
	private static final int[] anIntArray184 = new int[256];

	@OriginalMember(owner = "com.jagex.client!je", name = "a", descriptor = "I")
	private int anInt2912;

	@OriginalMember(owner = "com.jagex.client!je", name = "f", descriptor = "I")
	private int anInt2914;

	@OriginalMember(owner = "com.jagex.client!je", name = "b", descriptor = "[I")
	private final int[] anIntArray182 = new int[4];

	@OriginalMember(owner = "com.jagex.client!je", name = "h", descriptor = "Z")
	private boolean aBoolean205 = false;

	@OriginalMember(owner = "com.jagex.client!je", name = "c", descriptor = "[Lclient!jd;")
	private final Sprite[] aClass13Array14;

	@OriginalMember(owner = "com.jagex.client!je", name = "d", descriptor = "[I")
	...
	@OriginalMember(owner = "com.jagex.client!je", name = "<init>", descriptor = "(Lclient!wm;IZLjava/awt/com.jagex.Component;)V")
	public Class113(@OriginalArg(0) Renderer arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) Component arg3) {
	...
	@OriginalMember(owner = "com.jagex.client!je", name = "a", descriptor = "(Lclient!wm;Ljava/lang/String;[IIIIZ)V")
	private void method2946(@OriginalArg(0) Renderer arg0, @OriginalArg(1) String arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) boolean arg6) {
		if (arg5 == 0) {
			arg6 = false;
		}
	...
	@OriginalMember(owner = "com.jagex.client!je", name = "c", descriptor = "()I")
	public int method2948() {
		return this.anInt2912 - 1;
	}

	@OriginalMember(owner = "com.jagex.client!je", name = "a", descriptor = "(Lclient!wm;Ljava/awt/Font;Ljava/awt/FontMetrics;CIZ)V")
	private void method2949(@OriginalArg(0) Renderer arg0, @OriginalArg(1) Font arg1, @OriginalArg(2) FontMetrics arg2, @OriginalArg(3) char arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5) {
	...
	@OriginalMember(owner = "com.jagex.client!je", name = "a", descriptor = "(Ljava/lang/String;)I")
	...
	@OriginalMember(owner = "com.jagex.client!je", name = "a", descriptor = "(Lclient!wm;Ljava/lang/String;IIIZ)V")
	public void method2951(@OriginalArg(0) Renderer arg0, @OriginalArg(1) String arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
