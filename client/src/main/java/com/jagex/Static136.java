...
public final class Static136 {
	...
	@OriginalMember(owner = "com.jagex.client!hp", name = "e", descriptor = "I")
	public static int anInt6778;

	@OriginalMember(owner = "com.jagex.client!hp", name = "a", descriptor = "(III)I")
	...
	@OriginalMember(owner = "com.jagex.client!hp", name = "a", descriptor = "(I[B)[B")
	...
	@OriginalMember(owner = "com.jagex.client!hp", name = "a", descriptor = "(ZI)V")
