...
@OriginalClass("com.jagex.client!wp")
public final class PcmResampler {

	@OriginalMember(owner = "com.jagex.client!wp", name = "d", descriptor = "I")
	private int anInt7209;

	@OriginalMember(owner = "com.jagex.client!wp", name = "e", descriptor = "I")
	private int anInt7210;

	@OriginalMember(owner = "com.jagex.client!wp", name = "f", descriptor = "[[I")
	private int[][] anIntArrayArray61;

	@OriginalMember(owner = "com.jagex.client!wp", name = "<init>", descriptor = "(II)V")
	...
	@OriginalMember(owner = "com.jagex.client!wp", name = "a", descriptor = "(II)I")
	...
	@OriginalMember(owner = "com.jagex.client!wp", name = "a", descriptor = "(B[B)[B")
	...
	@OriginalMember(owner = "com.jagex.client!wp", name = "a", descriptor = "(ZI)I")
