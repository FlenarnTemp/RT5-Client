...
public final class Static358 {
	...
	@OriginalMember(owner = "com.jagex.client!ur", name = "d", descriptor = "[J")
	public static final long[] recentMessages = new long[100];

	@OriginalMember(owner = "com.jagex.client!ur", name = "t", descriptor = "I")
	public static int anInt6550 = -1;

	@OriginalMember(owner = "com.jagex.client!ur", name = "a", descriptor = "(I)V")
