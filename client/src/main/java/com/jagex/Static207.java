...
public final class Static207 {
	...
	@OriginalMember(owner = "com.jagex.client!mc", name = "o", descriptor = "I")
	public static int anInt3746;

	@OriginalMember(owner = "com.jagex.client!mc", name = "l", descriptor = "Lclient!ld;")
	public static LinkedList aClass135_26 = new LinkedList();

	@OriginalMember(owner = "com.jagex.client!mc", name = "m", descriptor = "[[Z")
	...
	@OriginalMember(owner = "com.jagex.client!mc", name = "n", descriptor = "[I")
	public static final int[] cursors = new int[8];

	@OriginalMember(owner = "com.jagex.client!mc", name = "a", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!mc", name = "a", descriptor = "(Lclient!nk;B)Lclient!nk;")
