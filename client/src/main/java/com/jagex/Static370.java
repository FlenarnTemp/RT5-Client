...
public final class Static370 {
	...
	@OriginalMember(owner = "com.jagex.client!vn", name = "N", descriptor = "Lclient!lo;")
	public static HuffmanCodec aClass140_1;

	@OriginalMember(owner = "com.jagex.client!vn", name = "O", descriptor = "Z")
	public static boolean aBoolean473 = false;

	@OriginalMember(owner = "com.jagex.client!vn", name = "R", descriptor = "Z")
	public static boolean aBoolean474 = true;

	@OriginalMember(owner = "com.jagex.client!vn", name = "b", descriptor = "(III)V")
