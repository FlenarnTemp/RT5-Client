...
public final class Static396 {
	...
	@OriginalMember(owner = "com.jagex.client!dk", name = "a", descriptor = "(Lclient!r;I)Lclient!dk;")
	public static SpriteData method1676(@OriginalArg(0) Js5 arg0, @OriginalArg(1) int arg1) {
		@Pc(4) byte[] local4 = arg0.method5082(arg1);
		return local4 == null ? null : method1679(local4)[0];
	}

	@OriginalMember(owner = "com.jagex.client!dk", name = "b", descriptor = "(Lclient!r;I)[Lclient!dk;")
	public static SpriteData[] method1678(@OriginalArg(0) Js5 arg0, @OriginalArg(1) int arg1) {
		@Pc(4) byte[] local4 = arg0.method5082(arg1);
		return local4 == null ? null : method1679(local4);
	}

	@OriginalMember(owner = "com.jagex.client!dk", name = "a", descriptor = "([B)[Lclient!dk;")
	private static SpriteData[] method1679(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Packet local4 = new Packet(arg0);
		local4.pos = arg0.length - 2;
		@Pc(14) int local14 = local4.g2();
		@Pc(17) SpriteData[] local17 = new SpriteData[local14];
		for (@Pc(19) int local19 = 0; local19 < local14; local19++) {
			local17[local19] = new SpriteData();
		}
		...
		for (@Pc(114) int local114 = 0; local114 < local14; local114++) {
			@Pc(119) SpriteData local119 = local17[local114];
		...
		for (@Pc(198) int local198 = 0; local198 < local14; local198++) {
			@Pc(203) SpriteData local203 = local17[local198];
	...
	@OriginalMember(owner = "com.jagex.client!dk", name = "a", descriptor = "(Lclient!r;II)Lclient!dk;")
	public static SpriteData method1682(@OriginalArg(0) Js5 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(5) byte[] local5 = arg0.getfile(arg2, arg1);
		return local5 == null ? null : method1679(local5)[0];
	}

	@OriginalMember(owner = "com.jagex.client!dk", name = "b", descriptor = "(Lclient!r;II)[Lclient!dk;")
	public static SpriteData[] method1688(@OriginalArg(0) Js5 arg0, @OriginalArg(1) int arg1) {
