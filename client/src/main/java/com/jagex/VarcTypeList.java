...
@OriginalClass("com.jagex.client!df")
public final class VarcTypeList {

	@OriginalMember(owner = "com.jagex.client!df", name = "h", descriptor = "Lclient!hu;")
	private final LruHashTable aClass98_4 = new LruHashTable(64);

	@OriginalMember(owner = "com.jagex.client!df", name = "j", descriptor = "Lclient!r;")
	private final Js5 aClass197_10;

	@OriginalMember(owner = "com.jagex.client!df", name = "d", descriptor = "I")
	public final int anInt1466;

	@OriginalMember(owner = "com.jagex.client!df", name = "<init>", descriptor = "(Lclient!dn;ILclient!r;)V")
	...
	@OriginalMember(owner = "com.jagex.client!df", name = "a", descriptor = "(ZI)Lclient!cr;")
	public VarcType get(@OriginalArg(1) int arg0) {
		...
		@Pc(33) byte[] local33 = this.aClass197_10.getfile(arg0, 19);
