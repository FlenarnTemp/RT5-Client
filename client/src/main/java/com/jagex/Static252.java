...
public final class Static252 {
	...
	@OriginalMember(owner = "com.jagex.client!oi", name = "i", descriptor = "Lclient!jd;")
	public static Sprite aClass13_14;

	@OriginalMember(owner = "com.jagex.client!oi", name = "h", descriptor = "Lclient!gd;")
	...
	@OriginalMember(owner = "com.jagex.client!oi", name = "a", descriptor = "(B)V")
	...
	@OriginalMember(owner = "com.jagex.client!oi", name = "a", descriptor = "(ZII)V")
