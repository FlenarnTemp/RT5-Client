...
public final class Static284 {
	...
	@OriginalMember(owner = "com.jagex.client!qi", name = "i", descriptor = "I")
	public static int anInt5359;

	@OriginalMember(owner = "com.jagex.client!qi", name = "b", descriptor = "[I")
	public static final int[] anIntArray367 = new int[] { 1, 2, 4, 8 };

	@OriginalMember(owner = "com.jagex.client!qi", name = "f", descriptor = "Lclient!cm;")
	public static final Class36 aClass36_7 = new Class36();

	@OriginalMember(owner = "com.jagex.client!qi", name = "m", descriptor = "I")
	public static int anInt5362 = 0;

	@OriginalMember(owner = "com.jagex.client!qi", name = "a", descriptor = "(ILclient!ci;IIIILclient!wm;)V")
	public static void method4881(@OriginalArg(1) TextureProviderInterface arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) Renderer arg5) {
	...
	@OriginalMember(owner = "com.jagex.client!qi", name = "a", descriptor = "(ZI)Z")
	...
	@OriginalMember(owner = "com.jagex.client!qi", name = "a", descriptor = "(Lclient!nk;ZI)Ljava/lang/String;")
