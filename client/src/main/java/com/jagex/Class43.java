...
@OriginalClass("com.jagex.client!dd")
public final class Class43 {

	@OriginalMember(owner = "com.jagex.client!dd", name = "d", descriptor = "Lclient!jd;")
	private Sprite aClass13_4;

	@OriginalMember(owner = "com.jagex.client!dd", name = "g", descriptor = "I")
	private int anInt1451;

	@OriginalMember(owner = "com.jagex.client!dd", name = "w", descriptor = "I")
	private int anInt1461;

	@OriginalMember(owner = "com.jagex.client!dd", name = "b", descriptor = "Z")
	private boolean aBoolean122 = true;

	@OriginalMember(owner = "com.jagex.client!dd", name = "u", descriptor = "I")
	private int anInt1459 = -1;

	@OriginalMember(owner = "com.jagex.client!dd", name = "c", descriptor = "I")
	private final int anInt1448;

	@OriginalMember(owner = "com.jagex.client!dd", name = "p", descriptor = "I")
	private final int anInt1457;

	@OriginalMember(owner = "com.jagex.client!dd", name = "o", descriptor = "I")
	private final int anInt1456;

	@OriginalMember(owner = "com.jagex.client!dd", name = "h", descriptor = "I")
	private final int anInt1452;

	@OriginalMember(owner = "com.jagex.client!dd", name = "i", descriptor = "[Lclient!ja;")
	private final Class112[] aClass112Array1;

	@OriginalMember(owner = "com.jagex.client!dd", name = "l", descriptor = "Lclient!ja;")
	private final Class112 aClass112_1;

	@OriginalMember(owner = "com.jagex.client!dd", name = "k", descriptor = "[Lclient!ja;")
	private final Class112[] aClass112Array2;

	@OriginalMember(owner = "com.jagex.client!dd", name = "<init>", descriptor = "(I[Lclient!ja;IIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!dd", name = "a", descriptor = "(IILclient!wm;IIIIIII)V")
	public void method1612(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Renderer arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8) {
	...
	@OriginalMember(owner = "com.jagex.client!dd", name = "a", descriptor = "(BILclient!wm;)Z")
	public boolean method1617(@OriginalArg(1) int arg0, @OriginalArg(2) Renderer arg1) {
		if (arg0 != this.anInt1459) {
			this.anInt1459 = arg0;
			@Pc(20) int local20 = Static162.bitCeil(arg0);
			if (arg0 < local20) {
	...
	@OriginalMember(owner = "com.jagex.client!dd", name = "b", descriptor = "(Z)V")
