...
@OriginalClass("com.jagex.client!ke")
public final class Keyboard extends KeyboardBase implements KeyListener, FocusListener {

	@OriginalMember(owner = "com.jagex.client!nn", name = "W", descriptor = "[I")
	...
	@OriginalMember(owner = "com.jagex.client!kb", name = "I", descriptor = "Lclient!nj;")
	public static KeyboardBase instance;

	@OriginalMember(owner = "com.jagex.client!ke", name = "m", descriptor = "Lclient!co;")
	private Class37_Sub1 aClass37_Sub1_2;

	@OriginalMember(owner = "com.jagex.client!ke", name = "p", descriptor = "Lclient!co;")
	private Class37_Sub1 aClass37_Sub1_3;

	@OriginalMember(owner = "com.jagex.client!ke", name = "x", descriptor = "Ljava/awt/com.jagex.Component;")
	private Component component;

	@OriginalMember(owner = "com.jagex.client!ke", name = "G", descriptor = "Lclient!co;")
	private Class37_Sub1 aClass37_Sub1_4;

	@OriginalMember(owner = "com.jagex.client!ke", name = "o", descriptor = "[Z")
	private final boolean[] pressedKeys = new boolean[112];

	@OriginalMember(owner = "com.jagex.client!ke", name = "<init>", descriptor = "(Ljava/awt/com.jagex.Component;)V")
	public Keyboard(@OriginalArg(0) Component arg0) {
		method2378();
		this.method3350(arg0);
	}

	@OriginalMember(owner = "com.jagex.client!gr", name = "a", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!ke", name = "keyTyped", descriptor = "(Ljava/awt/event/KeyEvent;)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!ke", name = "a", descriptor = "(BCII)V")
	...
	@OriginalMember(owner = "com.jagex.client!ke", name = "keyPressed", descriptor = "(Ljava/awt/event/KeyEvent;)V")
	@Override
	public synchronized void keyPressed(@OriginalArg(0) KeyEvent arg0) {
		this.method3348(arg0, 0);
	}

	@OriginalMember(owner = "com.jagex.client!ke", name = "a", descriptor = "(Ljava/awt/event/KeyEvent;II)V")
	...
	@OriginalMember(owner = "com.jagex.client!ke", name = "c", descriptor = "(I)V")
	@Override
	public void method3338() {
		this.method3351();
	}

	@OriginalMember(owner = "com.jagex.client!ke", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V")
	@Override
	public void focusGained(@OriginalArg(0) FocusEvent arg0) {
	}

	@OriginalMember(owner = "com.jagex.client!ke", name = "a", descriptor = "(Ljava/awt/com.jagex.Component;B)V")
	...
	@OriginalMember(owner = "com.jagex.client!ke", name = "b", descriptor = "(I)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!ke", name = "keyReleased", descriptor = "(Ljava/awt/event/KeyEvent;)V")
	@Override
	public synchronized void keyReleased(@OriginalArg(0) KeyEvent arg0) {
		this.method3348(arg0, 1);
	}

	@OriginalMember(owner = "com.jagex.client!ke", name = "e", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!ke", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V")
	@Override
	public synchronized void focusLost(@OriginalArg(0) FocusEvent arg0) {
		this.method3345('\u0000', 0, -1);
	}

	@OriginalMember(owner = "com.jagex.client!ke", name = "a", descriptor = "(BI)Z")
	@Override
	public boolean isPressed(@OriginalArg(1) int arg0) {
		return arg0 >= 0 && arg0 < 112 ? this.pressedKeys[arg0] : false;
	}

	@OriginalMember(owner = "com.jagex.client!ke", name = "a", descriptor = "(Z)Lclient!rk;")
	@Override
