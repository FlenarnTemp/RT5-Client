...
@OriginalClass("com.jagex.client!vr")
public final class LoginProt {

	@OriginalMember(owner = "com.jagex.client!ck", name = "I", descriptor = "Lclient!vr;")
	public static final LoginProt LOGIN = new LoginProt(14, 1);
	@OriginalMember(owner = "com.jagex.client!ck", name = "K", descriptor = "Lclient!vr;")
	public static final LoginProt JS5 = new LoginProt(15, 4);
	@OriginalMember(owner = "com.jagex.client!ck", name = "L", descriptor = "Lclient!vr;")
	public static final LoginProt WORLD_CONNECT = new LoginProt(16, -2);
	@OriginalMember(owner = "com.jagex.client!ck", name = "M", descriptor = "Lclient!vr;")
	public static final LoginProt aClass242_4 = new LoginProt(17, 0);
	@OriginalMember(owner = "com.jagex.client!ck", name = "N", descriptor = "Lclient!vr;")
	public static final LoginProt WORLD_RECONNECT = new LoginProt(18, -2);
	@OriginalMember(owner = "com.jagex.client!ck", name = "O", descriptor = "Lclient!vr;")
	public static final LoginProt REGISTER_STEP1 = new LoginProt(20, 6);
	@OriginalMember(owner = "com.jagex.client!ck", name = "P", descriptor = "Lclient!vr;")
	public static final LoginProt VALIDATE_USERNAME = new LoginProt(21, 8);
	@OriginalMember(owner = "com.jagex.client!ck", name = "Q", descriptor = "Lclient!vr;")
	public static final LoginProt REGISTER_STEP2 = new LoginProt(22, -2);
	@OriginalMember(owner = "com.jagex.client!ck", name = "R", descriptor = "Lclient!vr;")
	public static final LoginProt GET_WORLDLIST = new LoginProt(23, 4);
	@OriginalMember(owner = "com.jagex.client!ck", name = "S", descriptor = "Lclient!vr;")
	public static final LoginProt aClass242_10 = new LoginProt(24, -1);
	@OriginalMember(owner = "com.jagex.client!ck", name = "T", descriptor = "[Lclient!vr;")
	static final LoginProt[] aClass242Array1;
	@OriginalMember(owner = "com.jagex.client!vr", name = "g", descriptor = "I")
	...
	@OriginalMember(owner = "com.jagex.client!vr", name = "<init>", descriptor = "(II)V")
	public LoginProt(@OriginalArg(0) int opcode, @OriginalArg(1) int length) {
		this.opcode = opcode;
	}

	@OriginalMember(owner = "com.jagex.client!kh", name = "b", descriptor = "(B)[Lclient!vr;")
	...
	@OriginalMember(owner = "com.jagex.client!vr", name = "toString", descriptor = "()Ljava/lang/String;")
	@Override
