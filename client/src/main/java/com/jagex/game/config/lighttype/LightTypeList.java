...
@OriginalClass("com.jagex.client!qi")
public final class LightTypeList {

	@OriginalMember(owner = "com.jagex.client!qi", name = "l", descriptor = "Lclient!hu;")
	private final LruHashTable aClass98_41 = new LruHashTable(64);

	@OriginalMember(owner = "com.jagex.client!qi", name = "h", descriptor = "Lclient!r;")
	private final Js5 aClass197_69;

	@OriginalMember(owner = "com.jagex.client!qi", name = "<init>", descriptor = "(Lclient!dn;ILclient!r;)V")
	...
	public LightType get(@OriginalArg(0) int arg0) {
		...
		@Pc(38) byte[] local38 = this.aClass197_69.getfile(arg0, 31);
	...
	@OriginalMember(owner = "com.jagex.client!qi", name = "a", descriptor = "(IB)V")
	...
	@OriginalMember(owner = "com.jagex.client!qi", name = "a", descriptor = "(Z)V")
	...
	@OriginalMember(owner = "com.jagex.client!qi", name = "b", descriptor = "(I)V")
