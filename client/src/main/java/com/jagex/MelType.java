...
public final class MelType {
	...
	public Sprite method4183(@OriginalArg(1) Renderer arg0) {
		...
		this.aClass125_2.aClass197_50.requestDownload(this.anInt4413);
		@Pc(48) SpriteData local48 = Static396.method1682(this.aClass125_2.aClass197_50, this.anInt4413, 0);
		if (local48 != null) {
	...
	public String method4185(@OriginalArg(1) int arg0, @OriginalArg(2) String arg1) {
		if (this.aClass4_89 == null) {
			...
			@Pc(22) StringWrapper local22 = (StringWrapper) this.aClass4_89.get((long) arg0);
		...
		if (arg0 == 1) {
			...
			if (arg0 == 7) {
				...
				if (arg0 == 15) {
					...
					local57 = arg1.g1();
					if (this.aClass4_89 == null) {
						local196 = Static162.bitCeil(local57);
					...
					for (local196 = 0; local196 < local57; local196++) {
						...
						if (local215) {
							local228 = new StringWrapper(arg1.gjstr());
						} else {
							local228 = new IntWrapper(arg1.g4());
						}
						this.aClass4_89.pushNode(local228, (long) local219);
					}
				}
			}
		}
	...
	public int method4188(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (this.aClass4_89 == null) {
			...
			@Pc(25) IntWrapper local25 = (IntWrapper) this.aClass4_89.get((long) arg1);
	...
	public Sprite method4189(@OriginalArg(0) Renderer arg0, @OriginalArg(2) boolean arg1) {
		...
		if (local33 != null) {
			return local33;
		} else if (this.aClass125_2.aClass197_50.requestDownload(local17)) {
			@Pc(53) SpriteData local53 = Static396.method1682(this.aClass125_2.aClass197_50, local17, 0);
			if (local53 != null) {
