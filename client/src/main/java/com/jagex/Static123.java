...
public final class Static123 {
	...
	@OriginalMember(owner = "com.jagex.client!ha", name = "w", descriptor = "[Lclient!jd;")
	public static Sprite[] aClass13Array10;

	@OriginalMember(owner = "com.jagex.client!ha", name = "x", descriptor = "I")
	public static int anInt2420;

	@OriginalMember(owner = "com.jagex.client!ha", name = "y", descriptor = "Lclient!r;")
	public static Js5 aClass197_30;

	@OriginalMember(owner = "com.jagex.client!ha", name = "z", descriptor = "I")
	public static final int anInt2421 = -1;

	@OriginalMember(owner = "com.jagex.client!ha", name = "a", descriptor = "(ZIIIIIII)V")
