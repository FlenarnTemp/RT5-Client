...
public final class Static40 {
	...
	@OriginalMember(owner = "com.jagex.client!cg", name = "c", descriptor = "[I")
	private static final int[] anIntArray84 = new int[2];

	@OriginalMember(owner = "com.jagex.client!cg", name = "a", descriptor = "(Lclient!bf;ILjava/lang/String;)Lclient!cg;")
