...
@OriginalClass("com.jagex.client!fh")
public final class MaterialRenderer2 extends MaterialRenderer {

	@OriginalMember(owner = "com.jagex.client!fh", name = "e", descriptor = "I")
	private int anInt1986;

	@OriginalMember(owner = "com.jagex.client!fh", name = "f", descriptor = "Lclient!rj;")
	private Class203 aClass203_1;

	@OriginalMember(owner = "com.jagex.client!fh", name = "b", descriptor = "Lclient!fs;")
	private final Class76 aClass76_1;

	@OriginalMember(owner = "com.jagex.client!fh", name = "c", descriptor = "Lclient!kd;")
	private Class122 aClass122_1;

	@OriginalMember(owner = "com.jagex.client!fh", name = "g", descriptor = "Ljava/nio/FloatBuffer;")
	private FloatBuffer aFloatBuffer1;

	@OriginalMember(owner = "com.jagex.client!fh", name = "<init>", descriptor = "(Lclient!bf;Lclient!fs;)V")
	...
	@OriginalMember(owner = "com.jagex.client!fh", name = "a", descriptor = "(I)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!fh", name = "b", descriptor = "()V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!fh", name = "a", descriptor = "(Z)V")
	@Override
	public void method5713(@OriginalArg(0) boolean arg0) {
	}

	@OriginalMember(owner = "com.jagex.client!fh", name = "a", descriptor = "()Z")
	@Override
	public boolean method5711() {
		return true;
	}

	@OriginalMember(owner = "com.jagex.client!fh", name = "c", descriptor = "()V")
	...
	@OriginalMember(owner = "com.jagex.client!fh", name = "b", descriptor = "(Z)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!fh", name = "a", descriptor = "(Lclient!kq;)V")
	@Override
