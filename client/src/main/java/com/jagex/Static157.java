...
public final class Static157 {
	...
	@OriginalMember(owner = "com.jagex.client!ja", name = "f", descriptor = "Lclient!jd;")
	public static Sprite aClass13_9;

	@OriginalMember(owner = "com.jagex.client!ja", name = "h", descriptor = "Lclient!jd;")
	public static Sprite aClass13_10;

	@OriginalMember(owner = "com.jagex.client!ja", name = "o", descriptor = "Lclient!gn;")
	public static Model aClass31_4;

	@OriginalMember(owner = "com.jagex.client!ja", name = "g", descriptor = "[I")
	public static final int[] anIntArray180 = new int[4];

	@OriginalMember(owner = "com.jagex.client!ja", name = "a", descriptor = "()V")
	public static void method2917() {
		aClass31_4 = null;
		aClass13_9 = null;
	}

	@OriginalMember(owner = "com.jagex.client!ja", name = "a", descriptor = "(Lclient!wm;)V")
	public static void method2923(@OriginalArg(0) Renderer arg0) {
		if (aClass31_4 != null) {
			return;
		}
		...
		for (@Pc(37) int local37 = 0; local37 <= 24; local37++) {
			...
			@Pc(48) int local48 = Renderer.anIntArray178[local44];
			@Pc(52) int local52 = Renderer.anIntArray177[local44];
			@Pc(61) int local61;
			@Pc(67) int local67;
			@Pc(75) int local75;
			@Pc(83) int local83;
			for (@Pc(54) int local54 = 1; local54 < 24; local54++) {
				...
				local67 = Renderer.anIntArray177[local61] >> 8;
				local75 = Renderer.anIntArray178[local61] * local48 >> 23;
				local83 = Renderer.anIntArray178[local61] * local52 >> 23;
	...
	@OriginalMember(owner = "com.jagex.client!ja", name = "b", descriptor = "(Lclient!wm;)V")
	public static void method2925(@OriginalArg(0) Renderer arg0) {
		if (aClass13_9 != null) {
			return;
		}
