...
@OriginalClass("com.jagex.client!an")
public final class Class10_Sub1 extends Class10 implements Interface4 {

	@OriginalMember(owner = "com.jagex.client!an", name = "h", descriptor = "I")
	private int anInt278;

	@OriginalMember(owner = "com.jagex.client!an", name = "g", descriptor = "I")
	private int anInt277;

	@OriginalMember(owner = "com.jagex.client!an", name = "<init>", descriptor = "(Lclient!bf;I[BIZ)V")
	...
	@OriginalMember(owner = "com.jagex.client!an", name = "b", descriptor = "()V")
	@Override
	protected void method2315() {
		this.aClass19_Sub1_11.method801(this);
	}

	@OriginalMember(owner = "com.jagex.client!an", name = "a", descriptor = "()I")
	@Override
	public int method6066() {
		return super.method6066();
	}

	@OriginalMember(owner = "com.jagex.client!an", name = "a", descriptor = "(III)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!an", name = "a", descriptor = "(I[BI)V")
	@Override
