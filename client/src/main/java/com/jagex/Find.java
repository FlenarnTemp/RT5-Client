...
public class Find {
	...
	@OriginalMember(owner = "com.jagex.client!tb", name = "H", descriptor = "I")
	public static int index;
	@OriginalMember(owner = "com.jagex.client!ke", name = "F", descriptor = "[S")
	public static short[] results;
	@OriginalMember(owner = "com.jagex.client!am", name = "b", descriptor = "I")
	public static int size;

	@OriginalMember(owner = "com.jagex.client!hi", name = "a", descriptor = "(Ljava/lang/String;BZ)V")
	...
	@OriginalMember(owner = "com.jagex.client!pk", name = "a", descriptor = "(ZLjava/lang/String;I)V")
