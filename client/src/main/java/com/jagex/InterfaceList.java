...
public class InterfaceList {
	...
	@OriginalMember(owner = "com.jagex.client!wa", name = "c", descriptor = "Lclient!ld;")
	public static final LinkedList highPriorityRequests = new LinkedList();
	@OriginalMember(owner = "com.jagex.client!mc", name = "h", descriptor = "Lclient!ld;")
	public static final LinkedList mediumPriorityRequests = new LinkedList();
	@OriginalMember(owner = "com.jagex.client!pp", name = "w", descriptor = "Lclient!ld;")
	public static final LinkedList lowPriorityRequests = new LinkedList();
	@OriginalMember(owner = "com.jagex.client!pi", name = "e", descriptor = "Z")
	public static boolean aBoolean371 = false;
	@OriginalMember(owner = "com.jagex.client!fe", name = "f", descriptor = "I")
	public static int miscTransmitAt = 0;
	@OriginalMember(owner = "com.jagex.client!es", name = "d", descriptor = "I")
	public static int transmitTimer = 1;
	@OriginalMember(owner = "com.jagex.client!uc", name = "p", descriptor = "I")
	public static int anInt6449 = 0;
	@OriginalMember(owner = "com.jagex.client!tc", name = "Y", descriptor = "Lclient!ad;")
	public static HashTable subInterfaces = new HashTable(8);

	@OriginalMember(owner = "com.jagex.client!hd", name = "a", descriptor = "(Lclient!r;BLclient!r;Lclient!r;Lclient!r;)V")
	...
	@OriginalMember(owner = "com.jagex.client!ae", name = "b", descriptor = "(BI)Lclient!nk;")
	...
	@OriginalMember(owner = "com.jagex.client!lo", name = "a", descriptor = "(Lclient!nk;B)V")
	...
	@OriginalMember(owner = "com.jagex.client!dg", name = "a", descriptor = "(Lclient!nk;B)V")
	...
	@OriginalMember(owner = "com.jagex.client!mc", name = "a", descriptor = "(IIB)Lclient!nk;")
	...
	@OriginalMember(owner = "com.jagex.client!em", name = "a", descriptor = "(IZ)V")
