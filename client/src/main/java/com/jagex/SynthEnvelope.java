...
@OriginalClass("com.jagex.client!uf")
public final class SynthEnvelope {

	@OriginalMember(owner = "com.jagex.client!uf", name = "b", descriptor = "I")
	public int anInt6459;

	@OriginalMember(owner = "com.jagex.client!uf", name = "c", descriptor = "I")
	public int anInt6460;

	@OriginalMember(owner = "com.jagex.client!uf", name = "e", descriptor = "I")
	public int anInt6462;

	@OriginalMember(owner = "com.jagex.client!uf", name = "g", descriptor = "I")
	private int anInt6463;

	@OriginalMember(owner = "com.jagex.client!uf", name = "h", descriptor = "I")
	private int anInt6464;

	@OriginalMember(owner = "com.jagex.client!uf", name = "i", descriptor = "I")
	private int anInt6465;

	@OriginalMember(owner = "com.jagex.client!uf", name = "j", descriptor = "I")
	private int anInt6466;

	@OriginalMember(owner = "com.jagex.client!uf", name = "k", descriptor = "I")
	private int anInt6467;

	@OriginalMember(owner = "com.jagex.client!uf", name = "d", descriptor = "I")
	private int anInt6461 = 2;

	@OriginalMember(owner = "com.jagex.client!uf", name = "a", descriptor = "[I")
	private int[] anIntArray445 = new int[2];

	@OriginalMember(owner = "com.jagex.client!uf", name = "f", descriptor = "[I")
	private int[] anIntArray446 = new int[2];

	@OriginalMember(owner = "com.jagex.client!uf", name = "<init>", descriptor = "()V")
	...
	@OriginalMember(owner = "com.jagex.client!uf", name = "a", descriptor = "(I)I")
	...
	@OriginalMember(owner = "com.jagex.client!uf", name = "a", descriptor = "(Lclient!bt;)V")
	...
	@OriginalMember(owner = "com.jagex.client!uf", name = "a", descriptor = "()V")
	...
	@OriginalMember(owner = "com.jagex.client!uf", name = "b", descriptor = "(Lclient!bt;)V")
