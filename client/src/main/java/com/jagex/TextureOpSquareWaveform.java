...
@OriginalClass("com.jagex.client!sd")
public final class TextureOpSquareWaveform extends TextureOp {

	@OriginalMember(owner = "com.jagex.client!sd", name = "P", descriptor = "[I")
	private int[] anIntArray389;

	@OriginalMember(owner = "com.jagex.client!sd", name = "Y", descriptor = "[I")
	private int[] anIntArray390;

	@OriginalMember(owner = "com.jagex.client!sd", name = "X", descriptor = "I")
	private int anInt5917 = 0;

	@OriginalMember(owner = "com.jagex.client!sd", name = "W", descriptor = "I")
	private int anInt5916 = 2048;

	@OriginalMember(owner = "com.jagex.client!sd", name = "Q", descriptor = "I")
	private int anInt5910 = 10;

	@OriginalMember(owner = "com.jagex.client!sd", name = "<init>", descriptor = "()V")
	public TextureOpSquareWaveform() {
		super(0, true);
	}

	@OriginalMember(owner = "com.jagex.client!sd", name = "d", descriptor = "(I)V")
	@Override
	public void postDecode() {
		this.method5369();
	}

	@OriginalMember(owner = "com.jagex.client!sd", name = "a", descriptor = "(ILclient!bt;I)V")
	@Override
	public void decode(@OriginalArg(0) int code, @OriginalArg(1) Packet buf) {
		if (code == 0) {
			this.anInt5910 = buf.g1();
		} else if (code == 1) {
			this.anInt5916 = buf.g2();
		} else if (code == 2) {
			this.anInt5917 = buf.g1();
		}
	}

	@OriginalMember(owner = "com.jagex.client!sd", name = "g", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!sd", name = "a", descriptor = "(BI)[I")
	@Override
	public int[] getMonochromeOutput(@OriginalArg(1) int arg0) {
		...
		if (super.monochromeImageCache.invalid) {
			...
			if (this.anInt5917 == 0) {
				...
				ArrayUtil.method4610(local17, 0, Texture.width, local138);
			} else {
