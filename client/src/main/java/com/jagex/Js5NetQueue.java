...
@OriginalClass("com.jagex.client!pp")
public final class Js5NetQueue {

	@OriginalMember(owner = "com.jagex.client!pp", name = "x", descriptor = "Lclient!iu;")
	private BufferedSocket socket;

	@OriginalMember(owner = "com.jagex.client!pp", name = "y", descriptor = "I")
	private int latency;

	@OriginalMember(owner = "com.jagex.client!pp", name = "z", descriptor = "J")
	private long previousLoop;

	@OriginalMember(owner = "com.jagex.client!pp", name = "G", descriptor = "Lclient!jj;")
	private Js5NetRequest current;

	@OriginalMember(owner = "com.jagex.client!pp", name = "o", descriptor = "Lclient!wc;")
	private final SecondaryLinkedList pendingUrgentRequests = new SecondaryLinkedList();

	@OriginalMember(owner = "com.jagex.client!pp", name = "r", descriptor = "Lclient!wc;")
	private final SecondaryLinkedList inFlightUrgentRequests = new SecondaryLinkedList();

	@OriginalMember(owner = "com.jagex.client!pp", name = "u", descriptor = "Lclient!wc;")
	private final SecondaryLinkedList pendingPrefetchRequests = new SecondaryLinkedList();

	@OriginalMember(owner = "com.jagex.client!pp", name = "v", descriptor = "Lclient!wc;")
	private final SecondaryLinkedList inFlightPrefetchRequests = new SecondaryLinkedList();

	@OriginalMember(owner = "com.jagex.client!pp", name = "B", descriptor = "Lclient!bt;")
	private final Packet outBuffer = new Packet(4);

	@OriginalMember(owner = "com.jagex.client!pp", name = "E", descriptor = "B")
	private byte encryptionKey = 0;

	@OriginalMember(owner = "com.jagex.client!pp", name = "F", descriptor = "I")
	public volatile int errors = 0;

	@OriginalMember(owner = "com.jagex.client!pp", name = "D", descriptor = "I")
	public volatile int response = 0;

	@OriginalMember(owner = "com.jagex.client!pp", name = "C", descriptor = "Lclient!bt;")
	private final Packet inBuffer = new Packet(8);

	@OriginalMember(owner = "com.jagex.client!pp", name = "a", descriptor = "(B)V")
	...
	@OriginalMember(owner = "com.jagex.client!pp", name = "a", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!pp", name = "b", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!pp", name = "a", descriptor = "(Z)Z")
	public boolean isPrefetchRequestQueueFull() {
		return this.getPrefetchRequestCount() >= 20;
	}

	@OriginalMember(owner = "com.jagex.client!pp", name = "c", descriptor = "(I)I")
	public int getUrgentRequestCount() {
		return this.pendingUrgentRequests.method6338() + this.inFlightUrgentRequests.method6338();
	}

	@OriginalMember(owner = "com.jagex.client!pp", name = "a", descriptor = "(Lclient!iu;ZI)V")
	...
	@OriginalMember(owner = "com.jagex.client!pp", name = "b", descriptor = "(Z)Z")
	public boolean loop() {
		@Pc(18) int local18;
		if (this.socket != null) {
	...
	@OriginalMember(owner = "com.jagex.client!pp", name = "a", descriptor = "(ZIBBI)Lclient!jj;")
	...
	@OriginalMember(owner = "com.jagex.client!pp", name = "c", descriptor = "(B)V")
	public void rekey() {
		try {
			this.socket.close();
	...
	@OriginalMember(owner = "com.jagex.client!pp", name = "d", descriptor = "(I)Z")
	public boolean isUrgentRequestQueueFull() {
		return this.getUrgentRequestCount() >= 20;
	}

	@OriginalMember(owner = "com.jagex.client!pp", name = "e", descriptor = "(I)V")
	public void quit() {
		if (this.socket != null) {
			this.socket.close();
		}
	...
	@OriginalMember(owner = "com.jagex.client!pp", name = "c", descriptor = "(Z)I")
	...
	@OriginalMember(owner = "com.jagex.client!pp", name = "a", descriptor = "(ZI)V")
