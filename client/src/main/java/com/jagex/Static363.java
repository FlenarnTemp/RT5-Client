...
public final class Static363 {
	...
	@OriginalMember(owner = "com.jagex.client!vf", name = "P", descriptor = "I")
	public static int anInt6801;

	@OriginalMember(owner = "com.jagex.client!vf", name = "N", descriptor = "Z")
	public static boolean aBoolean464 = true;

	@OriginalMember(owner = "com.jagex.client!vf", name = "a", descriptor = "(IIIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!vf", name = "i", descriptor = "(I)V")
