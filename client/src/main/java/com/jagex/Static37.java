...
public final class Static37 {
	...
	@OriginalMember(owner = "com.jagex.client!ca", name = "D", descriptor = "I")
	public static int anInt949 = 1;

	@OriginalMember(owner = "com.jagex.client!ca", name = "a", descriptor = "([[II)V")
	public static void method1133(@OriginalArg(0) int[][] arg0) {
		Static357.anIntArrayArray58 = arg0;
	}

	@OriginalMember(owner = "com.jagex.client!ca", name = "a", descriptor = "(IIIIIII)V")
