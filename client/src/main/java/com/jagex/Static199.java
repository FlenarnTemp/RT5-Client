...
public final class Static199 {
	...
	@OriginalMember(owner = "com.jagex.client!lm", name = "u", descriptor = "I")
	public static int anInt5756;

	@OriginalMember(owner = "com.jagex.client!lm", name = "t", descriptor = "I")
	public static final int anInt5755 = 1337;

	@OriginalMember(owner = "com.jagex.client!lm", name = "a", descriptor = "(IIIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!lm", name = "a", descriptor = "([JII[Ljava/lang/Object;I)V")
	...
	@OriginalMember(owner = "com.jagex.client!lm", name = "a", descriptor = "(IIIIIIIII)V")
	public static void method5246(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7) {
		if (Static222.load(arg3)) {
			if (Static113.aClass161ArrayArray2[arg3] == null) {
				Static201.method3653(arg1, -1, Static26.components[arg3], arg0, arg5, arg6, arg2, arg4, arg7);
			} else {
	...
	@OriginalMember(owner = "com.jagex.client!lm", name = "d", descriptor = "(B)V")
