...
@OriginalClass("com.jagex.client!ln")
public final class Class8_Sub1_Sub1 extends Class8_Sub1 {

	@OriginalMember(owner = "com.jagex.client!ln", name = "n", descriptor = "I")
	public final int anInt3688;

	@OriginalMember(owner = "com.jagex.client!ln", name = "m", descriptor = "I")
	public final int anInt3687;

	@OriginalMember(owner = "com.jagex.client!ln", name = "p", descriptor = "F")
	public final float aFloat43;

	@OriginalMember(owner = "com.jagex.client!ln", name = "o", descriptor = "F")
	public final float aFloat42;

	@OriginalMember(owner = "com.jagex.client!ln", name = "l", descriptor = "Z")
	public final boolean aBoolean237;

	@OriginalMember(owner = "com.jagex.client!ln", name = "<init>", descriptor = "(Lclient!bf;IIII[I)V")
	...
	@OriginalMember(owner = "com.jagex.client!ln", name = "<init>", descriptor = "(Lclient!bf;IIIIIIZ)V")
	...
	@OriginalMember(owner = "com.jagex.client!ln", name = "<init>", descriptor = "(Lclient!bf;IIIZ[I)V")
	...
	@OriginalMember(owner = "com.jagex.client!ln", name = "<init>", descriptor = "(Lclient!bf;IIIIIZ)V")
	...
	@OriginalMember(owner = "com.jagex.client!ln", name = "<init>", descriptor = "(Lclient!bf;IIIIZ[BI)V")
	...
	@OriginalMember(owner = "com.jagex.client!ln", name = "<init>", descriptor = "(Lclient!bf;IIIII[BI)V")
