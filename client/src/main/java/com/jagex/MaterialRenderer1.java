...
@OriginalClass("com.jagex.client!tm")
public final class MaterialRenderer1 extends MaterialRenderer {

	@OriginalMember(owner = "com.jagex.client!tm", name = "e", descriptor = "Lclient!rj;")
	private Class203 aClass203_6;

	@OriginalMember(owner = "com.jagex.client!tm", name = "d", descriptor = "Z")
	private boolean aBoolean426 = false;

	@OriginalMember(owner = "com.jagex.client!tm", name = "b", descriptor = "Z")
	private boolean aBoolean425;

	@OriginalMember(owner = "com.jagex.client!tm", name = "c", descriptor = "[Lclient!qd;")
	private Class8_Sub3[] aClass8_Sub3Array1;

	@OriginalMember(owner = "com.jagex.client!tm", name = "<init>", descriptor = "(Lclient!bf;)V")
	public MaterialRenderer1(@OriginalArg(0) Class19_Sub1 arg0) {
		super(arg0);
	...
	@OriginalMember(owner = "com.jagex.client!tm", name = "a", descriptor = "(Z)V")
	@Override
	public void method5713(@OriginalArg(0) boolean arg0) {
		this.aClass19_Sub1_35.method794(8448, 7681);
	}

	@OriginalMember(owner = "com.jagex.client!tm", name = "a", descriptor = "(Lclient!kq;)V")
	@Override
	public void method5710(@OriginalArg(0) Class8 arg0) {
		this.aClass19_Sub1_35.method848(arg0);
	}

	@OriginalMember(owner = "com.jagex.client!tm", name = "a", descriptor = "(I)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!tm", name = "b", descriptor = "()V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!tm", name = "c", descriptor = "()V")
	...
	@OriginalMember(owner = "com.jagex.client!tm", name = "a", descriptor = "()Z")
	@Override
	public boolean method5711() {
		return true;
	}

	@OriginalMember(owner = "com.jagex.client!tm", name = "b", descriptor = "(Z)V")
	@Override
