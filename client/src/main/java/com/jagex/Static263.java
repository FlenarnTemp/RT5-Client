...
public final class Static263 {
	...
	@OriginalMember(owner = "com.jagex.client!pb", name = "T", descriptor = "Z")
	public static boolean aBoolean330;

	@OriginalMember(owner = "com.jagex.client!pb", name = "Q", descriptor = "Z")
	public static boolean wallocc = false;

	@OriginalMember(owner = "com.jagex.client!pb", name = "a", descriptor = "(IIII)I")
