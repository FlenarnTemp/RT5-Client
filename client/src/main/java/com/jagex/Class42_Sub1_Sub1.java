...
@OriginalClass("com.jagex.client!dc")
public final class Class42_Sub1_Sub1 extends Class42_Sub1 {

	@OriginalMember(owner = "com.jagex.client!dc", name = "k", descriptor = "Lclient!bf;")
	private final Class19_Sub1 aClass19_Sub1_8;

	@OriginalMember(owner = "com.jagex.client!dc", name = "i", descriptor = "Lclient!qd;")
	private final Class8_Sub3 aClass8_Sub3_1;

	@OriginalMember(owner = "com.jagex.client!dc", name = "<init>", descriptor = "(Lclient!bf;I)V")
	...
	@OriginalMember(owner = "com.jagex.client!dc", name = "c", descriptor = "(I)I")
	public int method1609() {
		return this.aClass8_Sub3_1.anInt5167;
	}

	@OriginalMember(owner = "com.jagex.client!dc", name = "b", descriptor = "(I)Lclient!qd;")
	@Override
	public Class8_Sub3 method2428() {
		return this.aClass8_Sub3_1;
	}

	@OriginalMember(owner = "com.jagex.client!dc", name = "a", descriptor = "(FLclient!qd;BLclient!qd;)V")
