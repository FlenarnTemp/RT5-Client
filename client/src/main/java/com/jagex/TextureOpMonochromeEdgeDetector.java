...
@OriginalClass("com.jagex.client!aj")
public final class TextureOpMonochromeEdgeDetector extends TextureOp {

	@OriginalMember(owner = "com.jagex.client!aj", name = "S", descriptor = "I")
	private int anInt246 = 4096;

	@OriginalMember(owner = "com.jagex.client!aj", name = "<init>", descriptor = "()V")
	public TextureOpMonochromeEdgeDetector() {
		super(1, true);
	}

	@OriginalMember(owner = "com.jagex.client!aj", name = "a", descriptor = "(BI)[I")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!aj", name = "a", descriptor = "(ILclient!bt;I)V")
	@Override
	public void decode(@OriginalArg(0) int code, @OriginalArg(1) Packet buf) {
		if (code == 0) {
			this.anInt246 = buf.g2();
		}
	}
}
