...
@OriginalClass("com.jagex.client!com.jagex.client")
public final class client extends GameShell {

	@OriginalMember(owner = "com.jagex.client!ng", name = "m", descriptor = "Lclient!rt;")
	public static final ModeEnvironment MODE_ENV_LIVE = new ModeEnvironment("LIVE", 0);
	@OriginalMember(owner = "com.jagex.client!kc", name = "i", descriptor = "Lclient!rt;")
	public static final ModeEnvironment MODE_ENV_RC = new ModeEnvironment("RC", 1);
	@OriginalMember(owner = "com.jagex.client!us", name = "T", descriptor = "Lclient!rt;")
	public static final ModeEnvironment MODE_ENV_WIP = new ModeEnvironment("WIP", 2);
	@OriginalMember(owner = "com.jagex.client!of", name = "u", descriptor = "Lclient!dn;")
	public static final Class50 GAME_RS = new Class50("runescape", 0);
	@OriginalMember(owner = "com.jagex.client!fu", name = "P", descriptor = "Lclient!dn;")
	public static final Class50 GAME_SD = new Class50("stellardawn", 1);
	@OriginalMember(owner = "com.jagex.client!dj", name = "bb", descriptor = "Ljava/util/Random;")
	public static final Random random = new Random();
	@OriginalMember(owner = "com.jagex.client!vr", name = "e", descriptor = "[Lclient!bl;")
	public static final Js5CachedResourceProvider[] aClass25_Sub1Array2 = new Js5CachedResourceProvider[29];
	@OriginalMember(owner = "com.jagex.client!kn", name = "g", descriptor = "[Lclient!rn;")
	public static final Class205[] aClass205Array1 = new Class205[29];
	@OriginalMember(owner = "com.jagex.client!ke", name = "t", descriptor = "I")
	public static int worldListWorldId = 1;
	@OriginalMember(owner = "com.jagex.client!lq", name = "I", descriptor = "Lclient!rt;")
	public static ModeEnvironment modeWhat;
	@OriginalMember(owner = "com.jagex.client!r", name = "M", descriptor = "I")
	public static int language = 0;
	@OriginalMember(owner = "com.jagex.client!ts", name = "r", descriptor = "Lclient!dn;")
	public static Class50 game = null;
	@OriginalMember(owner = "com.jagex.client!ie", name = "q", descriptor = "Lclient!com.jagex.client;")
	public static client instance;
	@OriginalMember(owner = "com.jagex.client!jm", name = "l", descriptor = "I")
	public static int affiliate = 0;
	@OriginalMember(owner = "com.jagex.client!mm", name = "d", descriptor = "Ljava/lang/String;")
	public static String hostname;
	@OriginalMember(owner = "com.jagex.client!gu", name = "y", descriptor = "Lclient!kk;")
	public static ModeWhere modeWhere;
	@OriginalMember(owner = "com.jagex.client!as", name = "d", descriptor = "I")
	public static int alternatePort;
	@OriginalMember(owner = "com.jagex.client!td", name = "O", descriptor = "I")
	public static int defaultPort;
	@OriginalMember(owner = "com.jagex.client!ep", name = "b", descriptor = "I")
	public static int port;
	@OriginalMember(owner = "com.jagex.client!dj", name = "cb", descriptor = "Ljava/lang/String;")
	public static String worldListHostname;
	@OriginalMember(owner = "com.jagex.client!qb", name = "P", descriptor = "I")
	public static int worldListPort;
	@OriginalMember(owner = "com.jagex.client!rm", name = "n", descriptor = "Lclient!tg;")
	public static AudioChannel musicChannel;
	@OriginalMember(owner = "com.jagex.client!kt", name = "Z", descriptor = "Lclient!tg;")
	public static AudioChannel soundChannel;
	@OriginalMember(owner = "com.jagex.client!wr", name = "a", descriptor = "I")
	public static int worldListDefaultPort;
	@OriginalMember(owner = "com.jagex.client!bu", name = "J", descriptor = "I")
	public static int worldListAlternatePort;
	@OriginalMember(owner = "com.jagex.client!tr", name = "h", descriptor = "Lclient!r;")
	public static Js5 jsArchive0;
	@OriginalMember(owner = "com.jagex.client!bt", name = "F", descriptor = "Lclient!r;")
	public static Js5 jsArchive1;
	@OriginalMember(owner = "com.jagex.client!qo", name = "b", descriptor = "Lclient!r;")
	public static Js5 jsArchive2;
	@OriginalMember(owner = "com.jagex.client!un", name = "H", descriptor = "Lclient!r;")
	public static Js5 jsArchive3;
	@OriginalMember(owner = "com.jagex.client!ep", name = "e", descriptor = "Lclient!r;")
	public static Js5 jsArchive4;
	@OriginalMember(owner = "com.jagex.client!qm", name = "Q", descriptor = "Lclient!r;")
	public static Js5 jsArchive5;
	@OriginalMember(owner = "com.jagex.client!fo", name = "h", descriptor = "Lclient!r;")
	public static Js5 jsArchive6;
	@OriginalMember(owner = "com.jagex.client!nl", name = "i", descriptor = "Lclient!r;")
	public static Js5 jsArchive7;
	@OriginalMember(owner = "com.jagex.client!bo", name = "e", descriptor = "Lclient!r;")
	public static Js5 jsArchive8;
	@OriginalMember(owner = "com.jagex.client!sq", name = "r", descriptor = "Lclient!r;")
	public static Js5 jsArchive9;
	@OriginalMember(owner = "com.jagex.client!ef", name = "A", descriptor = "Lclient!r;")
	public static Js5 jsArchive10;
	@OriginalMember(owner = "com.jagex.client!mm", name = "j", descriptor = "Lclient!r;")
	public static Js5 jsArchive11;
	@OriginalMember(owner = "com.jagex.client!lg", name = "c", descriptor = "Lclient!r;")
	public static Js5 jsArchive12;
	@OriginalMember(owner = "com.jagex.client!ol", name = "e", descriptor = "Lclient!r;")
	public static Js5 jsArchive13;
	@OriginalMember(owner = "com.jagex.client!hl", name = "D", descriptor = "Lclient!r;")
	public static Js5 jsArchive14;
	@OriginalMember(owner = "com.jagex.client!gs", name = "n", descriptor = "Lclient!r;")
	public static Js5 jsArchive15;
	@OriginalMember(owner = "com.jagex.client!wq", name = "m", descriptor = "Lclient!r;")
	public static Js5 jsArchive16;
	@OriginalMember(owner = "com.jagex.client!na", name = "U", descriptor = "Lclient!r;")
	public static Js5 jsArchive17;
	@OriginalMember(owner = "com.jagex.client!mm", name = "b", descriptor = "Lclient!r;")
	public static Js5 jsArchive18;
	@OriginalMember(owner = "com.jagex.client!dj", name = "eb", descriptor = "Lclient!r;")
	public static Js5 jsArchive19;
	@OriginalMember(owner = "com.jagex.client!hs", name = "y", descriptor = "Lclient!r;")
	public static Js5 jsArchive20;
	@OriginalMember(owner = "com.jagex.client!k", name = "G", descriptor = "Lclient!r;")
	public static Js5 jsArchive21;
	@OriginalMember(owner = "com.jagex.client!qt", name = "v", descriptor = "Lclient!r;")
	public static Js5 jsArchive22;
	@OriginalMember(owner = "com.jagex.client!wo", name = "M", descriptor = "Lclient!r;")
	public static Js5 jsArchive23;
	@OriginalMember(owner = "com.jagex.client!wi", name = "z", descriptor = "Lclient!r;")
	public static Js5 jsArchive24;
	@OriginalMember(owner = "com.jagex.client!hs", name = "w", descriptor = "Lclient!r;")
	public static Js5 jsArchive25;
	@OriginalMember(owner = "com.jagex.client!nj", name = "i", descriptor = "Lclient!r;")
	public static Js5 jsArchive26;
	@OriginalMember(owner = "com.jagex.client!dj", name = "db", descriptor = "Lclient!r;")
	public static Js5 jsArchive27;
	@OriginalMember(owner = "com.jagex.client!ep", name = "c", descriptor = "Lclient!r;")
	public static Js5 jsArchive28;
	@OriginalMember(owner = "com.jagex.client!ee", name = "c", descriptor = "Ljava/lang/String;")
	public static String settings = null;
	@OriginalMember(owner = "com.jagex.client!mo", name = "c", descriptor = "Lclient!pe;")
	public static Preferences preferences;
	@OriginalMember(owner = "com.jagex.client!gm", name = "f", descriptor = "I")
	public static int cycle = 0;
	@OriginalMember(owner = "com.jagex.client!ub", name = "bb", descriptor = "I")
	public static int gameState = 0;
	@OriginalMember(owner = "com.jagex.client!db", name = "s", descriptor = "Lclient!mq;")
	public static Js5MasterIndex js5MasterIndex;
	@OriginalMember(owner = "com.jagex.client!rs", name = "g", descriptor = "I")
	public static int mainLoadState = 0;
	@OriginalMember(owner = "com.jagex.client!i", name = "T", descriptor = "I")
	public static int mainLoadPercentage = 10;
	@OriginalMember(owner = "com.jagex.client!a", name = "g", descriptor = "Lclient!ro;")
	public static Js5CacheQueue js5CacheQueue;
	@OriginalMember(owner = "com.jagex.client!ql", name = "z", descriptor = "Lclient!pp;")
	public static Js5NetQueue js5NetQueue;
	@OriginalMember(owner = "com.jagex.client!rh", name = "r", descriptor = "Lclient!wp;")
	public static PcmResampler resampler;
	@OriginalMember(owner = "com.jagex.client!nb", name = "E", descriptor = "Lclient!fi;")
	public static MixerPcmStream soundStream;
	@OriginalMember(owner = "com.jagex.client!wi", name = "s", descriptor = "Lclient!od;")
	public static MidiPcmStream musicStream;
	@OriginalMember(owner = "com.jagex.client!dd", name = "t", descriptor = "Ljava/lang/String;")
	public static String mainLoadSecondaryText = "";
	@OriginalMember(owner = "com.jagex.client!hu", name = "t", descriptor = "Lclient!is;")
	public static EnumTypeList EnumTypes;
	@OriginalMember(owner = "com.jagex.client!vf", name = "M", descriptor = "Lclient!be;")
	public static ParamTypeList ParamTypes;
	@OriginalMember(owner = "com.jagex.client!dh", name = "a", descriptor = "Lclient!ak;")
	public static BASTypeList BasTypes;
	@OriginalMember(owner = "com.jagex.client!mr", name = "fb", descriptor = "Lclient!mi;")
	public static CursorTypeList CursorTypes;
	@OriginalMember(owner = "com.jagex.client!cf", name = "F", descriptor = "Lclient!fl;")
	public static FloorOverlayTypeList FloTypes;
	@OriginalMember(owner = "com.jagex.client!tj", name = "t", descriptor = "Lclient!vq;")
	public static FloorUnderlayTypeList FluTypes;
	@OriginalMember(owner = "com.jagex.client!be", name = "a", descriptor = "Lclient!e;")
	public static IDKTypeList IdkTypes;
	@OriginalMember(owner = "com.jagex.client!kf", name = "e", descriptor = "Lclient!dp;")
	public static InvTypeList InvTypes;
	@OriginalMember(owner = "com.jagex.client!eu", name = "H", descriptor = "Lclient!qi;")
	...
	@OriginalMember(owner = "com.jagex.client!cf", name = "B", descriptor = "Lclient!gp;")
	public static SeqTypeList SeqTypes;
	@OriginalMember(owner = "com.jagex.client!ai", name = "R", descriptor = "Lclient!sj;")
	public static SkyboxTypeList SkyboxTypes;
	@OriginalMember(owner = "com.jagex.client!qb", name = "W", descriptor = "Lclient!ng;")
	public static SkyboxSphereTypeList SkyboxSphereTypes;
	@OriginalMember(owner = "com.jagex.client!so", name = "l", descriptor = "Lclient!sg;")
	public static SpotAnimTypeList SpotAnimTypes;
	@OriginalMember(owner = "com.jagex.client!vj", name = "V", descriptor = "Lclient!ks;")
	public static StructTypeList StructTypes;
	@OriginalMember(owner = "com.jagex.client!kl", name = "m", descriptor = "Lclient!qo;")
	public static Class193 aClass193_2;
	@OriginalMember(owner = "com.jagex.client!jh", name = "l", descriptor = "Lclient!df;")
	public static VarcTypeList VarcTypes;
	@OriginalMember(owner = "com.jagex.client!so", name = "c", descriptor = "Lclient!km;")
	public static VarbitTypeList VarbitTypes;
	@OriginalMember(owner = "com.jagex.client!dd", name = "x", descriptor = "Lclient!rb;")
	public static VarpTypeList VarpTypes;
	@OriginalMember(owner = "com.jagex.client!sm", name = "D", descriptor = "I")
	public static int country;
	@OriginalMember(owner = "com.jagex.client!on", name = "i", descriptor = "[S")
	public static short[] aShortArray79;
	@OriginalMember(owner = "com.jagex.client!pr", name = "G", descriptor = "Z")
	public static boolean javaScript = false;
	@OriginalMember(owner = "com.jagex.client!nl", name = "d", descriptor = "Z")
	public static boolean objectTag = false;
	@OriginalMember(owner = "com.jagex.client!dp", name = "d", descriptor = "I")
	public static int gameId = 0;
	@OriginalMember(owner = "com.jagex.client!bp", name = "y", descriptor = "Z")
	public static boolean siteSettingsMember = false;
	@OriginalMember(owner = "com.jagex.client!pb", name = "R", descriptor = "I")
	public static int gameHeight = 503;
	@OriginalMember(owner = "com.jagex.client!ok", name = "j", descriptor = "I")
	public static int gameWidth = 765;
	@OriginalMember(owner = "com.jagex.client!rq", name = "m", descriptor = "Ljava/lang/String;")
	public static String quitUrl;
	@OriginalMember(owner = "com.jagex.client!hk", name = "h", descriptor = "Z")
	public static boolean showAdvert = false;
	@OriginalMember(owner = "com.jagex.client!jm", name = "k", descriptor = "I")
	public static int sceneDelta = 0;
	@OriginalMember(owner = "com.jagex.client!mh", name = "g", descriptor = "Lclient!cc;")
	public static PrivilegedRequest js5SocketRequest;
	@OriginalMember(owner = "com.jagex.client!fr", name = "e", descriptor = "Lclient!iu;")
	public static BufferedSocket js5Socket;
	@OriginalMember(owner = "com.jagex.client!rs", name = "f", descriptor = "I")
	public static int js5ConnectState = 0;
	@OriginalMember(owner = "com.jagex.client!gd", name = "i", descriptor = "Lclient!rn;")
	public static Class205 aClass205_1;

	@OriginalMember(owner = "com.jagex.client!com.jagex.client", name = "main", descriptor = "([Ljava/lang/String;)V")
	...
	@OriginalMember(owner = "com.jagex.client!kr", name = "a", descriptor = "(Ljava/lang/String;B)V")
	...
	@OriginalMember(owner = "com.jagex.client!bk", name = "a", descriptor = "(Lclient!bt;B)V")
	...
	@OriginalMember(owner = "com.jagex.client!wp", name = "a", descriptor = "(I)V")
	public static void reset() {
		...
		for (@Pc(4552) SubInterface local4552 = (SubInterface) InterfaceList.subInterfaces.head(); local4552 != null; local4552 = (SubInterface) InterfaceList.subInterfaces.next()) {
			if (!local4552.hasNext()) {
				local4552 = (SubInterface) InterfaceList.subInterfaces.head();
				if (local4552 == null) {
					break;
				}
			}
	...
	@OriginalMember(owner = "com.jagex.client!jj", name = "a", descriptor = "(IZBIZ)Lclient!r;")
	...
	@OriginalMember(owner = "com.jagex.client!aa", name = "c", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!ej", name = "c", descriptor = "(I)Z")
	...
	@OriginalMember(owner = "com.jagex.client!te", name = "a", descriptor = "(Z)Z")
	...
	@OriginalMember(owner = "com.jagex.client!ca", name = "i", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!tj", name = "c", descriptor = "(IB)V")
	...
	@OriginalMember(owner = "com.jagex.client!so", name = "b", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!com.jagex.client", name = "a", descriptor = "(IB)V")
	...
	@OriginalMember(owner = "com.jagex.client!com.jagex.client", name = "c", descriptor = "(I)V")
	@Override
	protected void mainLoop() {
		...
		if (GameShell.fullScreenFrame != null && !GameShell.focus && (gameState == 30 || gameState == 10)) {
			DisplayMode.setWindowMode(-1, preferences.windowMode, false, -1);
		}
		...
		if (preferences.cpuUsage == 0) {
			ThreadUtils.sleep(15L);
		} else if (preferences.cpuUsage == 1) {
			ThreadUtils.sleep(10L);
		} else if (preferences.cpuUsage == 2) {
			ThreadUtils.sleep(5L);
		} else if (preferences.cpuUsage == 3) {
	...
	@OriginalMember(owner = "com.jagex.client!com.jagex.client", name = "init", descriptor = "()V")
	@Override
	public void init() {
	...
	@OriginalMember(owner = "com.jagex.client!com.jagex.client", name = "a", descriptor = "(Z)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!com.jagex.client", name = "c", descriptor = "(B)V")
	@Override
	protected void method1389() {
	}

	@OriginalMember(owner = "com.jagex.client!com.jagex.client", name = "i", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!com.jagex.client", name = "j", descriptor = "(I)V")
							...
							if (local298 == null) {
								while (true) {
									do {
										...
										local311 = InterfaceList.getComponent(local303.layer);
	...
	@OriginalMember(owner = "com.jagex.client!com.jagex.client", name = "a", descriptor = "(B[B)V")
	...
	@OriginalMember(owner = "com.jagex.client!com.jagex.client", name = "b", descriptor = "(B)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!com.jagex.client", name = "m", descriptor = "(I)V")
	private void mainLoad() {
		...
		if (mainLoadState == 0) {
			...
			if (preferences.safeMode) {
				...
				preferences.antiAliasingModeDefault = 0;
			}
			preferences.safeMode = true;
			preferences.write(GameShell.signlink);
			...
			if (local6 < 1100) {
				...
				FloTypes = new FloorOverlayTypeList(game, language, jsArchive2);
				FluTypes = new FloorUnderlayTypeList(game, language, jsArchive2);
			...
			if (jsArchive10.requestDownload("huffman", "")) {
				@Pc(1242) HuffmanCodec local1242 = new HuffmanCodec(jsArchive10.getfile("huffman", ""));
	...
	@OriginalMember(owner = "com.jagex.client!com.jagex.client", name = "d", descriptor = "(B)V")
	...
	@OriginalMember(owner = "com.jagex.client!com.jagex.client", name = "d", descriptor = "(I)V")
	@Override
