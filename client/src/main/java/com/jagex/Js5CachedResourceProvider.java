...
@OriginalClass("com.jagex.client!bl")
public final class Js5CachedResourceProvider extends Js5ResourceProvider {

	@OriginalMember(owner = "com.jagex.client!ib", name = "y", descriptor = "Ljava/util/zip/CRC32;")
	public static final CRC32 crc32 = new CRC32();
	@OriginalMember(owner = "com.jagex.client!bl", name = "v", descriptor = "[B")
	private byte[] groupStatus;

	@OriginalMember(owner = "com.jagex.client!bl", name = "A", descriptor = "Lclient!ra;")
	private Js5Index index;

	@OriginalMember(owner = "com.jagex.client!bl", name = "L", descriptor = "Z")
	private boolean prefetchAll;

	@OriginalMember(owner = "com.jagex.client!bl", name = "E", descriptor = "I")
	private int verifiedGroups = 0;

	@OriginalMember(owner = "com.jagex.client!bl", name = "r", descriptor = "Lclient!ad;")
	private final HashTable requests = new HashTable(16);

	@OriginalMember(owner = "com.jagex.client!bl", name = "I", descriptor = "I")
	private int group = 0;

	@OriginalMember(owner = "com.jagex.client!bl", name = "K", descriptor = "Lclient!ld;")
	private final LinkedList prefetchQueue = new LinkedList();

	@OriginalMember(owner = "com.jagex.client!bl", name = "P", descriptor = "J")
	private long orphanCheckTime = 0L;

	@OriginalMember(owner = "com.jagex.client!bl", name = "G", descriptor = "Lclient!rq;")
	private final Cache cache;

	@OriginalMember(owner = "com.jagex.client!bl", name = "g", descriptor = "I")
	private final int archive;

	@OriginalMember(owner = "com.jagex.client!bl", name = "M", descriptor = "Z")
	private boolean verifyAll;

	@OriginalMember(owner = "com.jagex.client!bl", name = "J", descriptor = "Lclient!ld;")
	private LinkedList groupQueue;

	@OriginalMember(owner = "com.jagex.client!bl", name = "C", descriptor = "I")
	private final int expectedVersion;

	@OriginalMember(owner = "com.jagex.client!bl", name = "N", descriptor = "Z")
	private final boolean aBoolean58;

	@OriginalMember(owner = "com.jagex.client!bl", name = "w", descriptor = "Lclient!rq;")
	private final Cache masterCache;

	@OriginalMember(owner = "com.jagex.client!bl", name = "y", descriptor = "Lclient!pp;")
	private final Js5NetQueue netQueue;

	@OriginalMember(owner = "com.jagex.client!bl", name = "n", descriptor = "Lclient!ro;")
	private final Js5CacheQueue cacheQueue;

	@OriginalMember(owner = "com.jagex.client!bl", name = "i", descriptor = "I")
	private final int expectedChecksum;

	@OriginalMember(owner = "com.jagex.client!bl", name = "q", descriptor = "Lclient!ut;")
	private Js5Request indexRequest;

	@OriginalMember(owner = "com.jagex.client!bl", name = "<init>", descriptor = "(ILclient!rq;Lclient!rq;Lclient!pp;Lclient!ro;IIZ)V")
	...
	@OriginalMember(owner = "com.jagex.client!bl", name = "a", descriptor = "(B)V")
	public void method892() {
		...
		for (@Pc(24) Node local24 = this.prefetchQueue.head(); local24 != null; local24 = this.prefetchQueue.next()) {
			@Pc(30) int local30 = (int) local24.nodeId;
	...
	@OriginalMember(owner = "com.jagex.client!bl", name = "b", descriptor = "(B)V")
	...
	@OriginalMember(owner = "com.jagex.client!bl", name = "c", descriptor = "(B)I")
	public int method895() {
		return this.index == null ? 0 : this.index.size;
	}

	@OriginalMember(owner = "com.jagex.client!bl", name = "b", descriptor = "(Z)I")
	...
	@OriginalMember(owner = "com.jagex.client!bl", name = "b", descriptor = "(II)[B")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!bl", name = "c", descriptor = "(Z)I")
	public int method897() {
		if (this.index == null) {
			return 0;
		} else if (this.verifyAll) {
			@Pc(20) Node local20 = this.groupQueue.head();
			return local20 == null ? 0 : (int) local20.nodeId;
		} else {
			return this.index.size;
		}
	}

	@OriginalMember(owner = "com.jagex.client!bl", name = "c", descriptor = "(I)I")
	public int method898() {
		return this.verifiedGroups;
	}

	@OriginalMember(owner = "com.jagex.client!bl", name = "d", descriptor = "(I)V")
	...
	private Js5Request fetchGroupInner(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
		...
		if (local13 == null) {
			...
			this.requests.pushNode(local13, (long) arg0);
		}
		...
		if (!(local13 instanceof Js5CacheRequest)) {
			try {
				...
				if (local13.urgent && !this.netQueue.isUrgentRequestQueueFull()) {
					...
					this.requests.pushNode(local292, (long) arg0);
				}
				return null;
			}
	...
	@OriginalMember(owner = "com.jagex.client!bl", name = "a", descriptor = "(II)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!bl", name = "a", descriptor = "(Z)Lclient!ra;")
	@Override
