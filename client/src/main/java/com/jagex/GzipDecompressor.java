...
@OriginalClass("com.jagex.client!hg")
public final class GzipDecompressor {

	@OriginalMember(owner = "com.jagex.client!hg", name = "c", descriptor = "Ljava/util/zip/Inflater;")
	private Inflater anInflater1;

	@OriginalMember(owner = "com.jagex.client!hg", name = "<init>", descriptor = "()V")
	public GzipDecompressor() {
		this(-1, 1000000, 1000000);
	}

	@OriginalMember(owner = "com.jagex.client!hg", name = "<init>", descriptor = "(III)V")
	private GzipDecompressor(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
	}

	@OriginalMember(owner = "com.jagex.client!hg", name = "a", descriptor = "([BILclient!bt;)V")
