...
@OriginalClass("com.jagex.client!b")
public final class Class13_Sub1_Sub1 extends SoftwareSprite {

	@OriginalMember(owner = "com.jagex.client!b", name = "H", descriptor = "[I")
	private final int[] anIntArray22;

	@OriginalMember(owner = "com.jagex.client!b", name = "<init>", descriptor = "(Lclient!j;[IIIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!b", name = "<init>", descriptor = "(Lclient!j;[III)V")
	...
	@OriginalMember(owner = "com.jagex.client!b", name = "a", descriptor = "(III)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!b", name = "b", descriptor = "(II)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!b", name = "a", descriptor = "([I[III)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!b", name = "a", descriptor = "(IIIIIII)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!b", name = "a", descriptor = "(IIIII)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!b", name = "a", descriptor = "(IIIIII)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!b", name = "a", descriptor = "(IILclient!kf;II)V")
	@Override
