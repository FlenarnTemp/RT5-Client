...
@OriginalClass("com.jagex.client!sj")
public final class SkyboxTypeList {

	@OriginalMember(owner = "com.jagex.client!sj", name = "c", descriptor = "Lclient!hu;")
	private final LruHashTable aClass98_52 = new LruHashTable(16);

	@OriginalMember(owner = "com.jagex.client!sj", name = "e", descriptor = "Lclient!r;")
	private final Js5 aClass197_83;

	@OriginalMember(owner = "com.jagex.client!sj", name = "<init>", descriptor = "(Lclient!dn;ILclient!r;)V")
	...
	@OriginalMember(owner = "com.jagex.client!sj", name = "a", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!sj", name = "a", descriptor = "(II)V")
	...
	@OriginalMember(owner = "com.jagex.client!sj", name = "a", descriptor = "(IIILclient!ng;IB)Lclient!dd;")
	...
	@OriginalMember(owner = "com.jagex.client!sj", name = "a", descriptor = "(B)V")
	...
	@OriginalMember(owner = "com.jagex.client!sj", name = "b", descriptor = "(II)Lclient!wa;")
	private SkyboxType method5427(@OriginalArg(0) int arg0) {
		...
		@Pc(41) byte[] local41 = this.aClass197_83.getfile(arg0, 29);
