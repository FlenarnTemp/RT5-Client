...
@OriginalClass("com.jagex.client!er")
public abstract class Class10 {

	@OriginalMember(owner = "com.jagex.client!er", name = "a", descriptor = "Lclient!bf;")
	protected final Class19_Sub1 aClass19_Sub1_11;

	@OriginalMember(owner = "com.jagex.client!er", name = "d", descriptor = "I")
	private final int anInt2295;

	@OriginalMember(owner = "com.jagex.client!er", name = "e", descriptor = "I")
	private int anInt2296;

	@OriginalMember(owner = "com.jagex.client!er", name = "b", descriptor = "Z")
	private final boolean aBoolean174;

	@OriginalMember(owner = "com.jagex.client!er", name = "f", descriptor = "I")
	private final int anInt2297;

	@OriginalMember(owner = "com.jagex.client!er", name = "<init>", descriptor = "(Lclient!bf;I[BIZ)V")
	...
	@OriginalMember(owner = "com.jagex.client!er", name = "<init>", descriptor = "(Lclient!bf;ILjava/nio/ByteBuffer;Z)V")
	...
	@OriginalMember(owner = "com.jagex.client!er", name = "finalize", descriptor = "()V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!er", name = "a", descriptor = "()I")
	public int method6066() {
		return this.anInt2297;
	}

	@OriginalMember(owner = "com.jagex.client!er", name = "a", descriptor = "([BI)V")
	...
	@OriginalMember(owner = "com.jagex.client!er", name = "b", descriptor = "()V")
