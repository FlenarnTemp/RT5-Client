...
@OriginalClass("com.jagex.client!gh")
public final class Class10_Sub2 extends Class10 implements Interface5 {

	@OriginalMember(owner = "com.jagex.client!gh", name = "g", descriptor = "I")
	private int anInt2298;

	@OriginalMember(owner = "com.jagex.client!gh", name = "<init>", descriptor = "(Lclient!bf;I[BIZ)V")
	...
	@OriginalMember(owner = "com.jagex.client!gh", name = "<init>", descriptor = "(Lclient!bf;ILjava/nio/ByteBuffer;Z)V")
	...
	@OriginalMember(owner = "com.jagex.client!gh", name = "a", descriptor = "()I")
	@Override
	public int method6066() {
		return super.method6066();
	}

	@OriginalMember(owner = "com.jagex.client!gh", name = "b", descriptor = "()V")
	@Override
	protected void method2315() {
		this.aClass19_Sub1_11.method783(this);
	}

	@OriginalMember(owner = "com.jagex.client!gh", name = "a", descriptor = "(Lclient!kj;)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!gh", name = "c", descriptor = "(Lclient!kj;)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!gh", name = "d", descriptor = "(Lclient!kj;)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!gh", name = "a", descriptor = "(I[BI)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!gh", name = "b", descriptor = "(Lclient!kj;)V")
	@Override
