...
public final class Static244 {
	...
	@OriginalMember(owner = "com.jagex.client!oa", name = "a", descriptor = "[I")
	private static final int[] anIntArray293 = new int[2];

	@OriginalMember(owner = "com.jagex.client!oa", name = "a", descriptor = "(Lclient!bf;[Lclient!cg;)Lclient!oa;")
