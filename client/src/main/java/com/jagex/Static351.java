...
public final class Static351 {
	...
	@OriginalMember(owner = "com.jagex.client!ug", name = "b", descriptor = "(IB)I")
	...
	@OriginalMember(owner = "com.jagex.client!ug", name = "a", descriptor = "(Lclient!ur;ZLjava/lang/String;B)V")
