...
@OriginalClass("com.jagex.client!vl")
public final class TextureOpIrregularBricks extends TextureOp {

	@OriginalMember(owner = "com.jagex.client!vl", name = "db", descriptor = "I")
	private int anInt6927;

	@OriginalMember(owner = "com.jagex.client!vl", name = "P", descriptor = "I")
	private int anInt6916 = 409;

	@OriginalMember(owner = "com.jagex.client!vl", name = "S", descriptor = "I")
	private int anInt6918 = 2048;

	@OriginalMember(owner = "com.jagex.client!vl", name = "T", descriptor = "I")
	private int anInt6919 = 0;

	@OriginalMember(owner = "com.jagex.client!vl", name = "U", descriptor = "I")
	private int anInt6920 = 1024;

	@OriginalMember(owner = "com.jagex.client!vl", name = "W", descriptor = "I")
	private int anInt6922 = 1024;

	@OriginalMember(owner = "com.jagex.client!vl", name = "O", descriptor = "I")
	private int anInt6915 = 1024;

	@OriginalMember(owner = "com.jagex.client!vl", name = "V", descriptor = "I")
	private int anInt6921 = 819;

	@OriginalMember(owner = "com.jagex.client!vl", name = "Z", descriptor = "I")
	private int anInt6924 = 0;

	@OriginalMember(owner = "com.jagex.client!vl", name = "eb", descriptor = "I")
	private int anInt6928 = 1024;

	@OriginalMember(owner = "com.jagex.client!vl", name = "<init>", descriptor = "()V")
	public TextureOpIrregularBricks() {
		super(0, true);
	}

	@OriginalMember(owner = "com.jagex.client!vl", name = "d", descriptor = "(I)V")
	@Override
	public void postDecode() {
	}

	@OriginalMember(owner = "com.jagex.client!vl", name = "a", descriptor = "(BI)[I")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!vl", name = "a", descriptor = "(IIILjava/util/Random;II[[I)V")
		...
		if (local50 <= 0) {
			if (Texture.width >= arg3 + arg1) {
				for (local77 = 0; local77 < arg4; local77++) {
					ArrayUtil.method4610(arg5[arg0 + local77], arg3, arg1, local21);
				}
			} else {
				local77 = Texture.width - arg3;
				for (local104 = 0; local104 < arg4; local104++) {
					@Pc(112) int[] local112 = arg5[local104 + arg0];
					ArrayUtil.method4610(local112, arg3, local77, local21);
					ArrayUtil.method4610(local112, 0, arg1 - local77, local21);
				}
			}
			...
			for (@Pc(184) int local184 = 0; local184 < arg4; local184++) {
				...
				if (local184 < local171) {
					...
					if (local175 + local182 > Texture.width) {
						...
						ArrayUtil.method4610(local192, local175, local213, local205);
						ArrayUtil.method4610(local192, 0, local182 - local213, local205);
					} else {
						ArrayUtil.method4610(local192, local175, local182, local205);
					}
				} else {
					...
					if (local205 < local171) {
						...
						if (Texture.width < local182 + local175) {
							...
							ArrayUtil.method4610(local192, local175, local221, local213);
							ArrayUtil.method4610(local192, 0, local182 - local221, local213);
						} else {
							ArrayUtil.method4610(local192, local175, local182, local213);
						}
					} else {
						for (local213 = 0; local213 < local160; local213++) {
						...
						if (Texture.width < local182 + local175) {
							local221 = Texture.width - local175;
							ArrayUtil.method4610(local192, local175, local221, local21);
							ArrayUtil.method4610(local192, 0, local182 - local221, local21);
						} else {
							ArrayUtil.method4610(local192, local175, local182, local21);
						}
					}
				}
			}
	...
	@OriginalMember(owner = "com.jagex.client!vl", name = "a", descriptor = "(ILclient!bt;I)V")
	@Override
	public void decode(@OriginalArg(0) int code, @OriginalArg(1) Packet buf) {
		if (code == 0) {
			this.anInt6919 = buf.g1();
		} else if (code == 1) {
			this.anInt6915 = buf.g2();
		} else if (code == 2) {
			this.anInt6918 = buf.g2();
		} else if (code == 3) {
			this.anInt6916 = buf.g2();
		} else if (code == 4) {
			this.anInt6921 = buf.g2();
		} else if (code == 5) {
			this.anInt6922 = buf.g2();
		} else if (code == 6) {
			this.anInt6924 = buf.g1();
		} else if (code == 7) {
			this.anInt6928 = buf.g2();
		} else if (code == 8) {
			this.anInt6920 = buf.g2();
		}
	}
}
