...
public class Chat {
	...
	@OriginalMember(owner = "com.jagex.client!cj", name = "k", descriptor = "[Ljava/lang/String;")
	public static final String[] names = new String[100];
	@OriginalMember(owner = "com.jagex.client!qq", name = "e", descriptor = "[I")
	public static final int[] types = new int[100];
	@OriginalMember(owner = "com.jagex.client!es", name = "b", descriptor = "[Ljava/lang/String;")
	public static final String[] messages = new String[100];
	@OriginalMember(owner = "com.jagex.client!ho", name = "R", descriptor = "[Ljava/lang/String;")
	public static final String[] clans = new String[100];
	@OriginalMember(owner = "com.jagex.client!hk", name = "i", descriptor = "[I")
	public static final int[] phraseIds = new int[100];
	@OriginalMember(owner = "com.jagex.client!is", name = "j", descriptor = "Lclient!oj;")
	public static FilterSetting privateFilter;
	@OriginalMember(owner = "com.jagex.client!bd", name = "i", descriptor = "I")
	public static int publicFilter = 0;
	@OriginalMember(owner = "com.jagex.client!te", name = "i", descriptor = "I")
	public static int tradeFilter = 0;
	@OriginalMember(owner = "com.jagex.client!na", name = "S", descriptor = "I")
	public static int size = 0;

	@OriginalMember(owner = "com.jagex.client!mc", name = "a", descriptor = "(ILjava/lang/String;)V")
	public static void add(@OriginalArg(1) String arg0) {
		Static33.method4200("", 0, arg0, 0, "");
	}

	@OriginalMember(owner = "com.jagex.client!lk", name = "a", descriptor = "(Ljava/lang/String;I)V")
