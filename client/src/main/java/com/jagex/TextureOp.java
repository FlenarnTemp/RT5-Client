...
@OriginalClass("com.jagex.client!jq")
public abstract class TextureOp extends Node {

	@OriginalMember(owner = "com.jagex.client!jq", name = "x", descriptor = "Lclient!vs;")
	protected ColorImageCache colorImageCache;

	@OriginalMember(owner = "com.jagex.client!jq", name = "y", descriptor = "Lclient!nc;")
	protected MonochromeImageCache monochromeImageCache;

	@OriginalMember(owner = "com.jagex.client!jq", name = "G", descriptor = "I")
	public int anInt7251;

	@OriginalMember(owner = "com.jagex.client!jq", name = "u", descriptor = "[Lclient!jq;")
	public final TextureOp[] ops;

	@OriginalMember(owner = "com.jagex.client!jq", name = "M", descriptor = "Z")
	public boolean monochrome;

	@OriginalMember(owner = "com.jagex.client!jq", name = "<init>", descriptor = "(IZ)V")
	protected TextureOp(@OriginalArg(0) int size, @OriginalArg(1) boolean monochrome) {
		this.ops = new TextureOp[size];
		this.monochrome = monochrome;
	}

	@OriginalMember(owner = "com.jagex.client!jq", name = "b", descriptor = "(IZI)[I")
	...
	@OriginalMember(owner = "com.jagex.client!jq", name = "a", descriptor = "(IIB)V")
	...
	@OriginalMember(owner = "com.jagex.client!jq", name = "b", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!jq", name = "c", descriptor = "(I)I")
	public int method6478() {
		return -1;
	}

	@OriginalMember(owner = "com.jagex.client!jq", name = "b", descriptor = "(IB)[[I")
	public int[][] getColorOutput(@OriginalArg(0) int arg0) {
		throw new IllegalStateException("This operation does not have a colour output");
	}

	@OriginalMember(owner = "com.jagex.client!jq", name = "d", descriptor = "(I)V")
	public void postDecode() {
	}

	@OriginalMember(owner = "com.jagex.client!jq", name = "b", descriptor = "(Z)I")
	public int method6482() {
		return -1;
	}

	@OriginalMember(owner = "com.jagex.client!jq", name = "c", descriptor = "(IZI)[[I")
	...
	@OriginalMember(owner = "com.jagex.client!jq", name = "a", descriptor = "(ILclient!bt;I)V")
	public void decode(@OriginalArg(0) int arg0, @OriginalArg(1) Packet arg1) {
	}

	@OriginalMember(owner = "com.jagex.client!jq", name = "a", descriptor = "(BI)[I")
