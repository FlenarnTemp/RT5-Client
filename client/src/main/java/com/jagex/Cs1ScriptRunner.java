...
public class Cs1ScriptRunner {
	...
	@OriginalMember(owner = "com.jagex.client!vs", name = "a", descriptor = "Lclient!nk;")
	public static Component aClass161_14 = null;

	@OriginalMember(owner = "com.jagex.client!wc", name = "a", descriptor = "(ZIILclient!nk;)V")
	...
	@OriginalMember(owner = "com.jagex.client!h", name = "a", descriptor = "(B)V")
