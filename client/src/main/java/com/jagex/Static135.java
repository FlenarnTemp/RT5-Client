...
public final class Static135 {
	...
	@OriginalMember(owner = "com.jagex.client!ho", name = "Q", descriptor = "I")
	public static final int anInt2521 = 1338;

	@OriginalMember(owner = "com.jagex.client!ho", name = "S", descriptor = "Lclient!bc;")
	public static final Class16 aClass16_2 = new Class16("", 14);

	@OriginalMember(owner = "com.jagex.client!ho", name = "U", descriptor = "I")
	public static int anInt2523 = -1;

	@OriginalMember(owner = "com.jagex.client!ho", name = "a", descriptor = "([Ljava/lang/String;I[S)V")
	...
	@OriginalMember(owner = "com.jagex.client!ho", name = "a", descriptor = "(BIC)C")
	...
	@OriginalMember(owner = "com.jagex.client!ho", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;")
