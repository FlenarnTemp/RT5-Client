...
public final class Static384 {
	...
	@OriginalMember(owner = "com.jagex.client!wh", name = "w", descriptor = "Z")
	public static boolean aBoolean485;

	@OriginalMember(owner = "com.jagex.client!wh", name = "s", descriptor = "I")
	public static int anInt7174 = 0;

	@OriginalMember(owner = "com.jagex.client!wh", name = "a", descriptor = "(IIIIIB)V")
