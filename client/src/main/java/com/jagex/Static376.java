...
public final class Static376 {
	...
	@OriginalMember(owner = "com.jagex.client!vt", name = "a", descriptor = "Ljava/util/Calendar;")
	public static final Calendar aCalendar2 = Calendar.getInstance(TimeZone.getTimeZone("GMT"));

	@OriginalMember(owner = "com.jagex.client!vt", name = "d", descriptor = "I")
	public static int anInt7054 = 0;

	@OriginalMember(owner = "com.jagex.client!vt", name = "a", descriptor = "(Lclient!nh;IIIB)V")
	...
	@OriginalMember(owner = "com.jagex.client!vt", name = "a", descriptor = "(IIIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!vt", name = "a", descriptor = "(Lclient!kf;IIILclient!jd;ILclient!nk;B)V")
	public static void method6288(@OriginalArg(0) Class78 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) Sprite arg4, @OriginalArg(5) int arg5, @OriginalArg(6) Component arg6) {
		...
		@Pc(63) int local63 = Renderer.anIntArray178[local16];
		@Pc(67) int local67 = Renderer.anIntArray177[local16];
		if (Camera.cameraType != 4) {
