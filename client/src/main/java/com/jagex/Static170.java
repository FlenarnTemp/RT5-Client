...
public final class Static170 {
	...
	@OriginalMember(owner = "com.jagex.client!js", name = "O", descriptor = "I")
	public static int anInt3229;

	@OriginalMember(owner = "com.jagex.client!js", name = "Q", descriptor = "[B")
	public static final byte[] aByteArray33 = new byte[] { 2, 0, 0, 2, 0, 0, 0, 4, 4 };

	@OriginalMember(owner = "com.jagex.client!js", name = "a", descriptor = "(JB)Ljava/lang/String;")
	...
	@OriginalMember(owner = "com.jagex.client!js", name = "a", descriptor = "(ILclient!bu;[[B)V")
	public static void method3231(@OriginalArg(1) SceneBuilder arg0, @OriginalArg(2) byte[][] arg1) {
		...
		for (@Pc(18) int local18 = 0; local18 < local8; local18++) {
			...
			if (local24 != null) {
				...
				client.audioLogic();
				arg0.method1109(Static171.collisionMaps, local48, local24, local37, Rasteriser.instance);
			}
		}
	}
}
