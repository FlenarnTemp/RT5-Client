...
@OriginalClass("com.jagex.client!nt")
public final class AnimFrameset extends SecondaryNode {

	@OriginalMember(owner = "com.jagex.client!nt", name = "D", descriptor = "[[B")
	private byte[][] aByteArrayArray11;

	@OriginalMember(owner = "com.jagex.client!nt", name = "N", descriptor = "[Lclient!nd;")
	public AnimFrame[] frames;

	@OriginalMember(owner = "com.jagex.client!nt", name = "K", descriptor = "I")
	private final int anInt4499;

	@OriginalMember(owner = "com.jagex.client!nt", name = "<init>", descriptor = "(I)V")
	public AnimFrameset(@OriginalArg(0) int arg0) {
		this.anInt4499 = arg0;
	}

	@OriginalMember(owner = "com.jagex.client!nt", name = "b", descriptor = "(IB)Z")
	public boolean method4235(@OriginalArg(0) int arg0) {
		return this.frames[arg0].transformsAlpha;
	}

	@OriginalMember(owner = "com.jagex.client!nt", name = "a", descriptor = "(II)Z")
	public boolean method4237(@OriginalArg(1) int arg0) {
		return this.frames[arg0].transformsColor;
	}

	@OriginalMember(owner = "com.jagex.client!nt", name = "c", descriptor = "(I)Z")
	public boolean method4240() {
		...
		if (this.aByteArrayArray11 == null) {
			...
			for (local34 = 0; local34 < local27.length; local34++) {
				this.aByteArrayArray11[local34] = Static392.aClass197_97.getfile(local27[local34], this.anInt4499);
			}
		}
		...
		for (local34 = 0; local34 < this.aByteArrayArray11.length; local34++) {
			...
			local55 &= Static78.aClass197_89.requestDownload(local78);
		}
		if (!local55) {
			return false;
		}
