...
@OriginalClass("com.jagex.client!om")
public final class ProjAnim extends Entity {

	@OriginalMember(owner = "com.jagex.client!om", name = "w", descriptor = "Lclient!oh;")
	private ParticleSystem aClass12_Sub5_4;

	@OriginalMember(owner = "com.jagex.client!om", name = "y", descriptor = "D")
	private double aDouble2;

	@OriginalMember(owner = "com.jagex.client!om", name = "C", descriptor = "D")
	private double aDouble3;

	@OriginalMember(owner = "com.jagex.client!om", name = "H", descriptor = "D")
	private double aDouble4;

	@OriginalMember(owner = "com.jagex.client!om", name = "L", descriptor = "D")
	private double aDouble5;

	@OriginalMember(owner = "com.jagex.client!om", name = "M", descriptor = "I")
	private int anInt4724;

	@OriginalMember(owner = "com.jagex.client!om", name = "O", descriptor = "D")
	private double aDouble6;

	@OriginalMember(owner = "com.jagex.client!om", name = "R", descriptor = "I")
	private int anInt4727;

	@OriginalMember(owner = "com.jagex.client!om", name = "T", descriptor = "D")
	private double aDouble7;

	@OriginalMember(owner = "com.jagex.client!om", name = "Y", descriptor = "D")
	private double aDouble8;

	@OriginalMember(owner = "com.jagex.client!om", name = "db", descriptor = "D")
	private double aDouble9;

	@OriginalMember(owner = "com.jagex.client!om", name = "D", descriptor = "I")
	private int anInt4718 = -1;

	@OriginalMember(owner = "com.jagex.client!om", name = "ab", descriptor = "Z")
	private boolean aBoolean326 = false;

	@OriginalMember(owner = "com.jagex.client!om", name = "hb", descriptor = "I")
	private int anInt4738 = -32768;

	@OriginalMember(owner = "com.jagex.client!om", name = "S", descriptor = "I")
	private int anInt4728 = 0;

	@OriginalMember(owner = "com.jagex.client!om", name = "lb", descriptor = "I")
	private int anInt4742 = 0;

	@OriginalMember(owner = "com.jagex.client!om", name = "x", descriptor = "I")
	public final int anInt4714;

	@OriginalMember(owner = "com.jagex.client!om", name = "I", descriptor = "I")
	public final int anInt4722;

	@OriginalMember(owner = "com.jagex.client!om", name = "kb", descriptor = "I")
	private final int anInt4741;

	@OriginalMember(owner = "com.jagex.client!om", name = "X", descriptor = "I")
	private final int anInt4732;

	@OriginalMember(owner = "com.jagex.client!om", name = "eb", descriptor = "I")
	public final int anInt4736;

	@OriginalMember(owner = "com.jagex.client!om", name = "cb", descriptor = "I")
	private final int anInt4735;

	@OriginalMember(owner = "com.jagex.client!om", name = "P", descriptor = "I")
	public final int anInt4725;

	@OriginalMember(owner = "com.jagex.client!om", name = "N", descriptor = "Lclient!nb;")
	private final SeqType aSeqType_1;

	@OriginalMember(owner = "com.jagex.client!om", name = "<init>", descriptor = "(IIIIIIIIIII)V")
	public ProjAnim(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10) {
		...
		if (local65 == -1) {
			...
			this.aSeqType_1 = client.SeqTypes.method2371(local65);
		}
	}

	@OriginalMember(owner = "com.jagex.client!om", name = "b", descriptor = "(Lclient!wm;B)Lclient!nf;")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!om", name = "c", descriptor = "(B)V")
	...
	@OriginalMember(owner = "com.jagex.client!om", name = "e", descriptor = "(I)V")
	@Override
	public void method6069() {
		throw new IllegalStateException();
	}

	@OriginalMember(owner = "com.jagex.client!om", name = "a", descriptor = "(IZ)V")
	public void method4392(@OriginalArg(0) int arg0) {
		...
		while (true) {
			do {
				do {
					if (this.anInt4742 <= this.aSeqType_1.frames[this.anInt4728]) {
						return;
					}
					this.anInt4742 -= this.aSeqType_1.frames[this.anInt4728];
					this.anInt4728++;
					if (this.anInt4728 >= this.aSeqType_1.anIntArray262.length) {
						this.anInt4728 -= this.aSeqType_1.replayoff;
						if (this.anInt4728 < 0 || this.aSeqType_1.anIntArray262.length <= this.anInt4728) {
							this.anInt4728 = 0;
						}
					}
					this.anInt4718 = this.anInt4728 + 1;
				} while (this.aSeqType_1.anIntArray262.length > this.anInt4718);
				this.anInt4718 -= this.aSeqType_1.replayoff;
			} while (this.anInt4718 >= 0 && this.anInt4718 < this.aSeqType_1.anIntArray262.length);
			this.anInt4718 = -1;
		}
	}

	@OriginalMember(owner = "com.jagex.client!om", name = "a", descriptor = "(BLclient!wm;Lclient!gn;)V")
	private void method4393(@OriginalArg(1) Renderer arg0, @OriginalArg(2) Model arg1) {
	...
	@OriginalMember(owner = "com.jagex.client!om", name = "a", descriptor = "(IIILclient!wm;ZLclient!hp;Z)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!om", name = "a", descriptor = "(IIBLclient!wm;)Z")
	@Override
	public boolean method6068(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) Renderer arg2) {
		return false;
	}

	@OriginalMember(owner = "com.jagex.client!om", name = "h", descriptor = "(I)I")
	@Override
	public int method6080() {
		return this.anInt4738;
	}

	@OriginalMember(owner = "com.jagex.client!om", name = "g", descriptor = "(I)Z")
	@Override
	public boolean method6076() {
		return false;
	}

	@OriginalMember(owner = "com.jagex.client!om", name = "a", descriptor = "(IBLclient!wm;)Lclient!gn;")
	private Model method4396(@OriginalArg(0) int arg0, @OriginalArg(2) Renderer arg1) {
	...
	@OriginalMember(owner = "com.jagex.client!om", name = "a", descriptor = "(Lclient!wm;B)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!om", name = "a", descriptor = "(B)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!om", name = "finalize", descriptor = "()V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!om", name = "a", descriptor = "(IIIZI)V")
