...
@OriginalClass("com.jagex.client!ns")
public final class Class12_Sub1_Sub1_Sub1 extends Class12_Sub1_Sub1 {

	@OriginalMember(owner = "com.jagex.client!ns", name = "V", descriptor = "I")
	private int anInt4478;

	@OriginalMember(owner = "com.jagex.client!ns", name = "Z", descriptor = "S")
	private short aShort68;

	@OriginalMember(owner = "com.jagex.client!ns", name = "W", descriptor = "Lclient!th;")
	private Class12_Sub8 aClass12_Sub8_1;

	@OriginalMember(owner = "com.jagex.client!ns", name = "X", descriptor = "S")
	private short aShort66;

	@OriginalMember(owner = "com.jagex.client!ns", name = "Y", descriptor = "S")
	private short aShort67;

	@OriginalMember(owner = "com.jagex.client!ns", name = "T", descriptor = "S")
	private short aShort64;

	@OriginalMember(owner = "com.jagex.client!ns", name = "R", descriptor = "S")
	private short aShort63;

	@OriginalMember(owner = "com.jagex.client!ns", name = "U", descriptor = "S")
	private short aShort65;

	@OriginalMember(owner = "com.jagex.client!ns", name = "S", descriptor = "I")
	private int anInt4477;

	@OriginalMember(owner = "com.jagex.client!ns", name = "<init>", descriptor = "(Lclient!th;IIIIIIIIIIIZZ)V")
	...
	@OriginalMember(owner = "com.jagex.client!ns", name = "a", descriptor = "(J)V")
	...
	@OriginalMember(owner = "com.jagex.client!ns", name = "a", descriptor = "()V")
	...
	@OriginalMember(owner = "com.jagex.client!ns", name = "a", descriptor = "(Lclient!th;IIIIIIIIIIIZZ)V")
	...
	@OriginalMember(owner = "com.jagex.client!ns", name = "a", descriptor = "(JI)V")
	public void method4219(@OriginalArg(0) long arg0, @OriginalArg(1) int arg1) {
		...
		if (local35.anIntArray456 != null) {
			...
			for (@Pc(429) Node local429 = local426.prev; local429 != local426; local429 = local429.prev) {
	...
	@OriginalMember(owner = "com.jagex.client!ns", name = "b", descriptor = "()V")
