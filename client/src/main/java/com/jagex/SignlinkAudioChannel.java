...
@OriginalClass("com.jagex.client!wb")
public final class SignlinkAudioChannel extends AudioChannel {

	@OriginalMember(owner = "com.jagex.client!wb", name = "M", descriptor = "Lclient!fc;")
	public static AudioSource audioSource;
	@OriginalMember(owner = "com.jagex.client!wb", name = "L", descriptor = "I")
	private final int channel;

	@OriginalMember(owner = "com.jagex.client!wb", name = "<init>", descriptor = "(Lclient!ml;I)V")
	public SignlinkAudioChannel(@OriginalArg(0) Signlink arg0, @OriginalArg(1) int arg1) {
		audioSource = arg0.getAudioSource();
		this.channel = arg1;
	}

	@OriginalMember(owner = "com.jagex.client!wb", name = "a", descriptor = "(Ljava/awt/com.jagex.Component;)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!wb", name = "c", descriptor = "()V")
	@Override
	protected void method6324() {
		audioSource.method1996(this.channel);
	}

	@OriginalMember(owner = "com.jagex.client!wb", name = "d", descriptor = "()V")
	@Override
	protected void method6329() {
		audioSource.method1994(this.channel, super.samples);
	}

	@OriginalMember(owner = "com.jagex.client!wb", name = "g", descriptor = "(I)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!wb", name = "a", descriptor = "()I")
	@Override
	protected int method6321() {
		return audioSource.method1995(this.channel);
	}

	@OriginalMember(owner = "com.jagex.client!wb", name = "b", descriptor = "()V")
	@Override
