...
@OriginalClass("com.jagex.client!gg")
public final class DelayedStateChange extends SecondaryNode {

	@OriginalMember(owner = "com.jagex.client!gg", name = "D", descriptor = "Ljava/lang/String;")
	public String stringArg;

	@OriginalMember(owner = "com.jagex.client!gg", name = "E", descriptor = "I")
	public int intArg2;

	@OriginalMember(owner = "com.jagex.client!gg", name = "J", descriptor = "I")
	public int intArg1;

	@OriginalMember(owner = "com.jagex.client!gg", name = "K", descriptor = "I")
	public int intArg3;

	@OriginalMember(owner = "com.jagex.client!gg", name = "<init>", descriptor = "(II)V")
	public DelayedStateChange(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		super.nodeId = (long) arg1 | (long) arg0 << 32;
	}

	@OriginalMember(owner = "com.jagex.client!hs", name = "a", descriptor = "(II)V")
	...
	@OriginalMember(owner = "com.jagex.client!mm", name = "a", descriptor = "(II)V")
	...
	@OriginalMember(owner = "com.jagex.client!vm", name = "c", descriptor = "(IB)V")
	...
	@OriginalMember(owner = "com.jagex.client!qb", name = "b", descriptor = "(II)V")
	...
	@OriginalMember(owner = "com.jagex.client!hq", name = "a", descriptor = "(IZ)V")
	public static void method2552(@OriginalArg(0) int arg0) {
		@Pc(8) DelayedStateChange local8 = Static316.method5413(14, arg0);
		local8.method2312();
	}

	@OriginalMember(owner = "com.jagex.client!at", name = "a", descriptor = "(II)V")
	...
	@OriginalMember(owner = "com.jagex.client!k", name = "a", descriptor = "(II)V")
	...
	@OriginalMember(owner = "com.jagex.client!eq", name = "b", descriptor = "(ZI)V")
	...
	@OriginalMember(owner = "com.jagex.client!og", name = "a", descriptor = "(IB)V")
	public static void method4343(@OriginalArg(0) int arg0) {
		@Pc(8) DelayedStateChange local8 = Static316.method5413(5, arg0);
		local8.method2312();
	}

	@OriginalMember(owner = "com.jagex.client!kg", name = "a", descriptor = "(BI)V")
	...
	@OriginalMember(owner = "com.jagex.client!hg", name = "a", descriptor = "(BI)V")
	public static void method2439(@OriginalArg(1) int arg0) {
		@Pc(17) DelayedStateChange local17 = Static316.method5413(16, arg0);
		local17.method2312();
	}

	@OriginalMember(owner = "com.jagex.client!ep", name = "a", descriptor = "(ZLclient!nk;B)V")
	...
	@OriginalMember(owner = "com.jagex.client!sj", name = "c", descriptor = "(II)V")
	...
	@OriginalMember(owner = "com.jagex.client!il", name = "b", descriptor = "(IIB)V")
	...
	@OriginalMember(owner = "com.jagex.client!gg", name = "b", descriptor = "(I)I")
	public int getType() {
		return (int) (super.nodeId >>> 32 & 0xFFL);
	}

	@OriginalMember(owner = "com.jagex.client!gg", name = "c", descriptor = "(Z)J")
	public long method2308() {
		return super.secondaryKey & Long.MAX_VALUE;
	}

	@OriginalMember(owner = "com.jagex.client!gg", name = "d", descriptor = "(B)I")
	public int getId() {
		return (int) super.nodeId;
	}

	@OriginalMember(owner = "com.jagex.client!gg", name = "c", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!gg", name = "d", descriptor = "(I)V")
