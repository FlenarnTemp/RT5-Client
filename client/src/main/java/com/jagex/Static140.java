...
public final class Static140 {
	...
	@OriginalMember(owner = "com.jagex.client!hu", name = "v", descriptor = "Z")
	public static boolean aBoolean187 = false;

	@OriginalMember(owner = "com.jagex.client!hu", name = "f", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!hu", name = "g", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!hu", name = "h", descriptor = "(I)V")
