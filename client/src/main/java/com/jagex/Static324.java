...
public final class Static324 {
	...
	@OriginalMember(owner = "com.jagex.client!sq", name = "q", descriptor = "[I")
	public static int[] anIntArray412;

	@OriginalMember(owner = "com.jagex.client!sq", name = "c", descriptor = "[I")
	public static int[] anIntArray409 = new int[2];

	@OriginalMember(owner = "com.jagex.client!sq", name = "h", descriptor = "[I")
	public static final int[] anIntArray410 = new int[2048];

	@OriginalMember(owner = "com.jagex.client!sq", name = "a", descriptor = "(Lclient!hc;IIIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!sq", name = "a", descriptor = "(II)I")
	public static int method5540(@OriginalArg(1) int arg0) {
		return arg0 >>> 8;
	}

	@OriginalMember(owner = "com.jagex.client!sq", name = "a", descriptor = "(IIIIIIIIBI)V")
