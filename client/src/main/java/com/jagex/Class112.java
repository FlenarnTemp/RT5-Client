...
@OriginalClass("com.jagex.client!ja")
public final class Class112 {

	@OriginalMember(owner = "com.jagex.client!ja", name = "a", descriptor = "I")
	private int anInt2871;

	@OriginalMember(owner = "com.jagex.client!ja", name = "b", descriptor = "I")
	private int anInt2872;

	@OriginalMember(owner = "com.jagex.client!ja", name = "d", descriptor = "I")
	private int anInt2874;

	@OriginalMember(owner = "com.jagex.client!ja", name = "e", descriptor = "I")
	private int anInt2875;

	@OriginalMember(owner = "com.jagex.client!ja", name = "l", descriptor = "Lclient!jd;")
	private Sprite aClass13_11;

	@OriginalMember(owner = "com.jagex.client!ja", name = "p", descriptor = "I")
	public int anInt2880;

	@OriginalMember(owner = "com.jagex.client!ja", name = "m", descriptor = "I")
	private final int anInt2878;

	@OriginalMember(owner = "com.jagex.client!ja", name = "c", descriptor = "I")
	private final int anInt2873;

	@OriginalMember(owner = "com.jagex.client!ja", name = "q", descriptor = "I")
	private final int anInt2881;

	@OriginalMember(owner = "com.jagex.client!ja", name = "i", descriptor = "Z")
	private final boolean aBoolean203;

	@OriginalMember(owner = "com.jagex.client!ja", name = "j", descriptor = "I")
	private final int anInt2876;

	@OriginalMember(owner = "com.jagex.client!ja", name = "r", descriptor = "I")
	private final int anInt2882;

	@OriginalMember(owner = "com.jagex.client!ja", name = "n", descriptor = "I")
	private final int anInt2879;

	@OriginalMember(owner = "com.jagex.client!ja", name = "k", descriptor = "I")
	private final int anInt2877;

	@OriginalMember(owner = "com.jagex.client!ja", name = "<init>", descriptor = "(IIIIIIIZ)V")
	...
	@OriginalMember(owner = "com.jagex.client!ja", name = "a", descriptor = "(Lclient!wm;IIIIII)V")
	public void method2916(@OriginalArg(0) Renderer arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
	...
	@OriginalMember(owner = "com.jagex.client!ja", name = "a", descriptor = "(Lclient!wm;Lclient!ja;)V")
	private void method2918(@OriginalArg(0) Renderer arg0, @OriginalArg(1) Class112 arg1) {
		...
		@Pc(94) int local94;
		if (this.anInt2875 != 0) {
			local79 = Renderer.anIntArray178[this.anInt2875];
			local84 = Renderer.anIntArray177[this.anInt2875];
			local94 = local33 * local84 - local35 * local79 >> 15;
			local35 = local33 * local79 + local35 * local84 >> 15;
			local33 = local94;
		}
		if (this.anInt2871 != 0) {
			local79 = Renderer.anIntArray178[this.anInt2871];
			local84 = Renderer.anIntArray177[this.anInt2871];
	...
	@OriginalMember(owner = "com.jagex.client!ja", name = "b", descriptor = "(Lclient!wm;Lclient!ja;)V")
	private void method2919(@OriginalArg(0) Renderer arg0, @OriginalArg(1) Class112 arg1) {
		...
		if (this.anInt2875 != 0) {
			...
			local85 = Renderer.anIntArray178[local81];
			local89 = Renderer.anIntArray177[local81];
	...
	@OriginalMember(owner = "com.jagex.client!ja", name = "c", descriptor = "()V")
	public void method2921() {
		this.aClass13_11 = null;
	}

	@OriginalMember(owner = "com.jagex.client!ja", name = "c", descriptor = "(Lclient!wm;Lclient!ja;)Z")
	private boolean method2922(@OriginalArg(0) Renderer arg0, @OriginalArg(1) Class112 arg1) {
		if (this.aClass13_11 == null) {
			if (this.anInt2877 == 0) {
	...
	@OriginalMember(owner = "com.jagex.client!ja", name = "d", descriptor = "(Lclient!wm;Lclient!ja;)Z")
	public boolean method2924(@OriginalArg(0) Renderer arg0, @OriginalArg(1) Class112 arg1) {
		return this.aClass13_11 != null || this.method2922(arg0, arg1);
	}

	@OriginalMember(owner = "com.jagex.client!ja", name = "a", descriptor = "(IIII)Z")
	public boolean method2926(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		@Pc(143) int local143 = Static162.bitCeil(this.anInt2872);
		if (local143 > arg3) {
