...
public final class Static158 {
	...
	@OriginalMember(owner = "com.jagex.client!jc", name = "u", descriptor = "I")
	public static final int anInt2895 = 1;

	@OriginalMember(owner = "com.jagex.client!jc", name = "C", descriptor = "[[I")
	...
	@OriginalMember(owner = "com.jagex.client!jc", name = "T", descriptor = "Lclient!ij;")
	public static final Class105 aClass105_1 = new Class105();

	@OriginalMember(owner = "com.jagex.client!jc", name = "U", descriptor = "I")
	public static int anInt2911 = -1;

	@OriginalMember(owner = "com.jagex.client!jc", name = "a", descriptor = "(B[I)Ljava/lang/String;")
	public static String method2939(@OriginalArg(1) int[] arg0) {
		...
		for (@Pc(13) int local13 = 0; local13 < arg0.length; local13++) {
			...
			if (local27.anInt6454 != -1) {
				...
				if (local39 == null) {
					@Pc(47) SpriteData local47 = Static396.method1682(client.jsArchive8, local27.anInt6454, 0);
					if (local47 != null) {
						local39 = Rasteriser.instance.createSprite(local47);
	...
	@OriginalMember(owner = "com.jagex.client!jc", name = "a", descriptor = "(II)V")
