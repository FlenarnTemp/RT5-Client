...
public final class Static312 {
	...
	@OriginalMember(owner = "com.jagex.client!sa", name = "P", descriptor = "Lclient!gd;")
	...
	@OriginalMember(owner = "com.jagex.client!sa", name = "U", descriptor = "Lclient!gd;")
	public static final LocalizedString aClass79_124 = new LocalizedString("K", "T", "K", "K");

	@OriginalMember(owner = "com.jagex.client!sa", name = "W", descriptor = "I")
	public static int anInt5844 = -1;

	@OriginalMember(owner = "com.jagex.client!sa", name = "a", descriptor = "(IIIIIIII)V")
