...
@OriginalClass("com.jagex.client!pg")
public final class TextureOp24 extends TextureOp {

	@OriginalMember(owner = "com.jagex.client!pg", name = "<init>", descriptor = "()V")
	public TextureOp24() {
		super(1, true);
	}

	@OriginalMember(owner = "com.jagex.client!pg", name = "a", descriptor = "(BI)[I")
	@Override
