...
public final class Static317 {
	...
	@OriginalMember(owner = "com.jagex.client!sh", name = "a", descriptor = "F")
	public static float aFloat74;

	@OriginalMember(owner = "com.jagex.client!sh", name = "d", descriptor = "Lclient!rn;")
	public static Class205 aClass205_6;

	@OriginalMember(owner = "com.jagex.client!sh", name = "a", descriptor = "(Lclient!mr;BZ)V")
	...
	@OriginalMember(owner = "com.jagex.client!sh", name = "a", descriptor = "(BI)V")
	...
	@OriginalMember(owner = "com.jagex.client!sh", name = "a", descriptor = "(Lclient!r;Ljava/lang/String;ZI)Lclient!ih;")
	public static Class103 method5552(@OriginalArg(0) Js5 arg0, @OriginalArg(1) String arg1, @OriginalArg(2) boolean arg2) {
		...
		while (true) {
			while (local36 < local34.anInt2702) {
				@Pc(52) Packet local52 = new Packet(arg0.getfile(local28[local38++], local10));
