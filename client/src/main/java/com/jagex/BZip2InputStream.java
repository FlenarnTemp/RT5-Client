...
public final class BZip2InputStream {
	...
	@OriginalMember(owner = "com.jagex.client!mj", name = "a", descriptor = "Lclient!ot;")
	private static final BZip2InputState aClass174_1 = new BZip2InputState();

	@OriginalMember(owner = "com.jagex.client!mj", name = "a", descriptor = "(Lclient!ot;)V")
	...
	@OriginalMember(owner = "com.jagex.client!mj", name = "a", descriptor = "([I[I[I[BIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!mj", name = "b", descriptor = "(Lclient!ot;)V")
	...
	@OriginalMember(owner = "com.jagex.client!mj", name = "c", descriptor = "(Lclient!ot;)B")
	private static byte method3738(@OriginalArg(0) BZip2InputState arg0) {
		return (byte) method3740(1, arg0);
	}

	@OriginalMember(owner = "com.jagex.client!mj", name = "d", descriptor = "(Lclient!ot;)B")
	private static byte method3739(@OriginalArg(0) BZip2InputState arg0) {
		return (byte) method3740(8, arg0);
	}

	@OriginalMember(owner = "com.jagex.client!mj", name = "a", descriptor = "(ILclient!ot;)I")
	...
	@OriginalMember(owner = "com.jagex.client!mj", name = "a", descriptor = "([BI[BII)I")
	...
	@OriginalMember(owner = "com.jagex.client!mj", name = "e", descriptor = "(Lclient!ot;)V")
