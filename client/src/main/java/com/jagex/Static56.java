...
public final class Static56 {
	...
	@OriginalMember(owner = "com.jagex.client!dd", name = "r", descriptor = "Lclient!ld;")
	public static final LinkedList aClass135_13 = new LinkedList();

	@OriginalMember(owner = "com.jagex.client!dd", name = "y", descriptor = "I")
	public static final int anInt1462 = 1401;

	@OriginalMember(owner = "com.jagex.client!dd", name = "a", descriptor = "(B)V")
	...
	@OriginalMember(owner = "com.jagex.client!dd", name = "a", descriptor = "(ILclient!ll;)V")
	...
	@OriginalMember(owner = "com.jagex.client!dd", name = "a", descriptor = "(I)V")
