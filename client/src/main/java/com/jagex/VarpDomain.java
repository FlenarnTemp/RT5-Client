...
public class VarpDomain {
	...
	@OriginalMember(owner = "com.jagex.client!ch", name = "fb", descriptor = "[I")
	public static final int[] updatedVarps = new int[32];
	@OriginalMember(owner = "com.jagex.client!mk", name = "e", descriptor = "Lclient!ts;")
	public static Class226 instance;
	@OriginalMember(owner = "com.jagex.client!am", name = "h", descriptor = "I")
	public static int updatedVarpsWriterIndex = 0;

	@OriginalMember(owner = "com.jagex.client!ef", name = "a", descriptor = "(II)V")
