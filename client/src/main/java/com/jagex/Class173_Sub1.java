...
@OriginalClass("com.jagex.client!oq")
public final class Class173_Sub1 extends Class173 {

	@OriginalMember(owner = "com.jagex.client!oq", name = "l", descriptor = "I")
	private final int anInt4779;

	@OriginalMember(owner = "com.jagex.client!oq", name = "s", descriptor = "I")
	private final int anInt4785;

	@OriginalMember(owner = "com.jagex.client!oq", name = "n", descriptor = "I")
	private final int anInt4781;

	@OriginalMember(owner = "com.jagex.client!oq", name = "m", descriptor = "I")
	private final int anInt4780;

	@OriginalMember(owner = "com.jagex.client!oq", name = "<init>", descriptor = "(IIIIII)V")
	...
	@OriginalMember(owner = "com.jagex.client!oq", name = "a", descriptor = "(IBI)V")
	@Override
	public void method6248(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
	}

	@OriginalMember(owner = "com.jagex.client!oq", name = "a", descriptor = "(III)V")
	@Override
	...
	@OriginalMember(owner = "com.jagex.client!oq", name = "b", descriptor = "(III)V")
	@Override
