...
public final class Static163 {
	...
	@OriginalMember(owner = "com.jagex.client!jj", name = "R", descriptor = "Lclient!gd;")
	...
	@OriginalMember(owner = "com.jagex.client!jj", name = "W", descriptor = "I")
	public static int anInt3086 = 0;

	@OriginalMember(owner = "com.jagex.client!jj", name = "a", descriptor = "(ZIIIIZ)V")
	...
	@OriginalMember(owner = "com.jagex.client!jj", name = "a", descriptor = "(ILclient!nk;)Ljava/lang/String;")
	...
	@OriginalMember(owner = "com.jagex.client!jj", name = "d", descriptor = "(I)V")
