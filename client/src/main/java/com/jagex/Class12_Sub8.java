...
@OriginalClass("com.jagex.client!th")
public final class Class12_Sub8 extends ParticleNode {

	@OriginalMember(owner = "com.jagex.client!th", name = "i", descriptor = "I")
	private int anInt6237;

	@OriginalMember(owner = "com.jagex.client!th", name = "l", descriptor = "I")
	private int anInt6239;

	@OriginalMember(owner = "com.jagex.client!th", name = "m", descriptor = "I")
	private int anInt6240;

	@OriginalMember(owner = "com.jagex.client!th", name = "n", descriptor = "I")
	public int anInt6241;

	@OriginalMember(owner = "com.jagex.client!th", name = "p", descriptor = "I")
	private int anInt6243;

	@OriginalMember(owner = "com.jagex.client!th", name = "u", descriptor = "I")
	private int anInt6245;

	@OriginalMember(owner = "com.jagex.client!th", name = "w", descriptor = "I")
	private int anInt6246;

	@OriginalMember(owner = "com.jagex.client!th", name = "x", descriptor = "I")
	private int anInt6247;

	@OriginalMember(owner = "com.jagex.client!th", name = "y", descriptor = "I")
	private int anInt6248;

	@OriginalMember(owner = "com.jagex.client!th", name = "z", descriptor = "I")
	private int anInt6249;

	@OriginalMember(owner = "com.jagex.client!th", name = "A", descriptor = "I")
	private int anInt6250;

	@OriginalMember(owner = "com.jagex.client!th", name = "D", descriptor = "I")
	private int anInt6252;

	@OriginalMember(owner = "com.jagex.client!th", name = "E", descriptor = "I")
	public int anInt6253;

	@OriginalMember(owner = "com.jagex.client!th", name = "G", descriptor = "I")
	public int anInt6254;

	@OriginalMember(owner = "com.jagex.client!th", name = "I", descriptor = "I")
	private int anInt6256;

	@OriginalMember(owner = "com.jagex.client!th", name = "K", descriptor = "I")
	...
	@OriginalMember(owner = "com.jagex.client!th", name = "O", descriptor = "I")
	public int anInt6261;

	@OriginalMember(owner = "com.jagex.client!th", name = "s", descriptor = "Z")
	private boolean aBoolean423 = false;

	@OriginalMember(owner = "com.jagex.client!th", name = "r", descriptor = "I")
	private int anInt6244 = 0;

	@OriginalMember(owner = "com.jagex.client!th", name = "j", descriptor = "Z")
	public boolean aBoolean422 = false;

	@OriginalMember(owner = "com.jagex.client!th", name = "q", descriptor = "Lclient!jf;")
	public final Class114 aClass114_2;

	@OriginalMember(owner = "com.jagex.client!th", name = "C", descriptor = "J")
	private final long aLong198;

	@OriginalMember(owner = "com.jagex.client!th", name = "J", descriptor = "Lclient!oh;")
	public final ParticleSystem aClass12_Sub5_6;

	@OriginalMember(owner = "com.jagex.client!th", name = "P", descriptor = "Lclient!uo;")
	public Class235 aClass235_1;

	@OriginalMember(owner = "com.jagex.client!th", name = "v", descriptor = "Lclient!cm;")
	public final Class36 aClass36_8;

	@OriginalMember(owner = "com.jagex.client!th", name = "<init>", descriptor = "(Lclient!wm;Lclient!jf;Lclient!oh;J)V")
	public Class12_Sub8(@OriginalArg(0) Renderer arg0, @OriginalArg(1) Class114 arg1, @OriginalArg(2) ParticleSystem arg2, @OriginalArg(3) long arg3) {
	...
	@OriginalMember(owner = "com.jagex.client!th", name = "a", descriptor = "(JBLclient!wm;IZ)V")
	public void method5686(@OriginalArg(0) long arg0, @OriginalArg(2) Renderer arg1, @OriginalArg(3) int arg2, @OriginalArg(4) boolean arg3) {
		@Pc(54) int local54;
		if (this.aBoolean422) {
			arg3 = false;
			...
			if (this.anInt6244 > 63) {
				...
				for (@Pc(147) int local147 = 0; local147 < local54; local147++) {
					...
					if (this.aClass235_1.aShort95 <= 0 && this.aClass235_1.aShort96 <= 0) {
						...
						local175 = Renderer.anIntArray178[local171];
						local179 = Renderer.anIntArray177[local171];
						local189 = (int) ((double) this.anInt6237 * Math.random()) + this.anInt6260;
						@Pc(193) int local193 = local189 & 0x1FFF;
						local197 = Renderer.anIntArray178[local193];
						local201 = Renderer.anIntArray177[local193];
	...
	@OriginalMember(owner = "com.jagex.client!th", name = "a", descriptor = "(IJ)V")
	...
	@OriginalMember(owner = "com.jagex.client!th", name = "c", descriptor = "(B)V")
