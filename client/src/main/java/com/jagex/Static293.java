...
public final class Static293 {
	...
	@OriginalMember(owner = "com.jagex.client!qs", name = "a", descriptor = "[I")
	private static int[] anIntArray374;

	@OriginalMember(owner = "com.jagex.client!qs", name = "b", descriptor = "I")
	private static int anInt5514;

	@OriginalMember(owner = "com.jagex.client!qs", name = "c", descriptor = "I")
	private static int anInt5515;

	@OriginalMember(owner = "com.jagex.client!qs", name = "d", descriptor = "I")
	private static int anInt5516;

	@OriginalMember(owner = "com.jagex.client!qs", name = "e", descriptor = "I")
	private static int anInt5517;

	@OriginalMember(owner = "com.jagex.client!qs", name = "f", descriptor = "I")
	private static int anInt5518;

	@OriginalMember(owner = "com.jagex.client!qs", name = "g", descriptor = "I")
	private static int anInt5519;

	@OriginalMember(owner = "com.jagex.client!qs", name = "h", descriptor = "I")
	private static int anInt5520;

	@OriginalMember(owner = "com.jagex.client!qs", name = "a", descriptor = "(Lclient!wm;[IIII[I[I)V")
	private static void method5038(@OriginalArg(0) Renderer arg0, @OriginalArg(1) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int[] arg4, @OriginalArg(6) int[] arg5) {
	...
	@OriginalMember(owner = "com.jagex.client!qs", name = "a", descriptor = "(I)V")
	...
	@OriginalMember(owner = "com.jagex.client!qs", name = "a", descriptor = "([III)V")
	...
	@OriginalMember(owner = "com.jagex.client!qs", name = "b", descriptor = "(I)Z")
	...
	@OriginalMember(owner = "com.jagex.client!qs", name = "b", descriptor = "()V")
	private static void method5043() {
		anInt5517 = 0;
	}

	@OriginalMember(owner = "com.jagex.client!qs", name = "a", descriptor = "(II)V")
	...
	@OriginalMember(owner = "com.jagex.client!qs", name = "b", descriptor = "(II)V")
	...
	@OriginalMember(owner = "com.jagex.client!qs", name = "a", descriptor = "(Lclient!wm;[II)V")
	public static void method5046(@OriginalArg(0) Renderer arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2) {
		method5038(arg0, arg1, arg1.length, arg2, null, null);
	}

	@OriginalMember(owner = "com.jagex.client!qs", name = "a", descriptor = "(Lclient!wm;[II[I[I)V")
	public static void method5047(@OriginalArg(0) Renderer arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int[] arg4) {
