...
@OriginalClass("com.jagex.client!rj")
public final class Class203 {

	@OriginalMember(owner = "com.jagex.client!rj", name = "b", descriptor = "Lclient!bf;")
	private final Class19_Sub1 aClass19_Sub1_33;

	@OriginalMember(owner = "com.jagex.client!rj", name = "a", descriptor = "I")
	private final int anInt5702;

	@OriginalMember(owner = "com.jagex.client!rj", name = "<init>", descriptor = "(Lclient!bf;I)V")
	...
	@OriginalMember(owner = "com.jagex.client!rj", name = "a", descriptor = "(C)V")
	public void method5190(@OriginalArg(0) char arg0) {
		this.aClass19_Sub1_33.gl.glCallList(this.anInt5702 + arg0);
	}

	@OriginalMember(owner = "com.jagex.client!rj", name = "a", descriptor = "()V")
	public void method5191() {
		this.aClass19_Sub1_33.gl.glEndList();
	}

	@OriginalMember(owner = "com.jagex.client!rj", name = "a", descriptor = "(I)V")
