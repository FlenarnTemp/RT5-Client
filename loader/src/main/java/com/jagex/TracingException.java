...
@OriginalClass("com.jagex.loader!e")
public final class TracingException extends RuntimeException {

	@OriginalMember(owner = "com.jagex.loader!e", name = "c", descriptor = "I")
	public static int anInt7269;

	@OriginalMember(owner = "com.jagex.loader!e", name = "b", descriptor = "Ljava/lang/Throwable;")
	private Throwable aThrowable2;

	@OriginalMember(owner = "com.jagex.loader!e", name = "a", descriptor = "Ljava/lang/String;")
	private String aString71;

	@OriginalMember(owner = "com.jagex.loader!e", name = "a", descriptor = "(Ljava/applet/Applet;Ljava/lang/String;ILjava/lang/Throwable;)V")
	...
	@OriginalMember(owner = "com.jagex.loader!e", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;")
	...
	@OriginalMember(owner = "com.jagex.loader!e", name = "a", descriptor = "(ILjava/lang/String;)V")
	private static void method6504(@OriginalArg(1) String arg0) {
		System.out.println("Error: " + method6503("%0a", arg0, "\n"));
	}

	@OriginalMember(owner = "com.jagex.loader!e", name = "a", descriptor = "(Ljava/lang/Throwable;B)Ljava/lang/String;")
