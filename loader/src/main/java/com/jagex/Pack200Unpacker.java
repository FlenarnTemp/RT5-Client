...
@OriginalClass("com.jagex.loader!d")
public final class Pack200Unpacker extends unpack {

	@OriginalMember(owner = "com.jagex.loader!d", name = "a", descriptor = "(B[B)[B")
	...
	@OriginalMember(owner = "com.jagex.loader!d", name = "<init>", descriptor = "([B)V")
