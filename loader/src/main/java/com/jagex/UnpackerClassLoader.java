...
@OriginalClass("com.jagex.loader!g")
public final class UnpackerClassLoader extends ClassLoader implements ClassLoaderInterface {

	@OriginalMember(owner = "com.jagex.loader!g", name = "a", descriptor = "Ljava/util/Hashtable;")
	private final Hashtable aHashtable1 = new Hashtable();

	@OriginalMember(owner = "com.jagex.loader!g", name = "c", descriptor = "Lunpack!unpack;")
	private final unpack anUnpack1;

	@OriginalMember(owner = "com.jagex.loader!g", name = "b", descriptor = "Ljava/security/ProtectionDomain;")
	private final ProtectionDomain aProtectionDomain1;

	@OriginalMember(owner = "com.jagex.loader!g", name = "<init>", descriptor = "(Lunpack!unpack;)V")
	...
	@OriginalMember(owner = "com.jagex.loader!g", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/Class;)V")
	@Override
	public void method6513(@OriginalArg(0) String arg0, @OriginalArg(2) Class arg1) {
		this.aHashtable1.put(arg0, arg1);
	}

	@OriginalMember(owner = "com.jagex.loader!g", name = "loadClass", descriptor = "(Ljava/lang/String;Z)Ljava/lang/Class;")
	@Override
